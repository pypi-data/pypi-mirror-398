...
[![Tests](https://github.com/gridseal/gridseal/workflows/CI/badge.svg)](https://github.com/gridseal/gridseal/actions)
...
```yaml
repos:
  - repo: https://github.com/gridseal/gridseal
    rev: v1.0.0
    hooks:
      - id: gridseal
```
...
### GitHub Actions
```yaml
- uses: gridseal/gridseal-action@v1
  with:
...
- [GitHub Discussions](https://github.com/gridseal/gridseal/discussions)
- [Discord](https://discord.gg/gridseal)
- [Twitter](https://twitter.com/gridseal)
- [Bug Reports](https://github.com/gridseal/gridseal/issues)
...
- **Community Support:** [GitHub Discussions](https://github.com/gridseal/gridseal/discussions)
- **Bug Reports:** [GitHub Issues](https://github.com/gridseal/gridseal/issues)
- **Security:** security@gridseal.ai
- **Commercial:** contact@gridseal.ai
