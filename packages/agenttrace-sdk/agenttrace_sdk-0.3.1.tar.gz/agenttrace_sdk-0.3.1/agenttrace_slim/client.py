...
class AgentTrace:
    ...
    def start(self, script_name: str, metadata: Optional[Dict] = None) -> str:
        ...
        self._started = True
        self._buffer = []
        self._script_name = script_name  # Store for replay support
    ...
    def end(self, status: str = "completed") -> Dict[str, Any]:
        ...
        script_content = None
        if hasattr(self, '_script_name') and self._script_name:
            import os
            if os.path.exists(self._script_name):
                try:
                    with open(self._script_name, 'r', encoding='utf-8') as f:
