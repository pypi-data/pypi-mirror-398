...
- :doc:`streaming_optimizer_comparison` - Comparison of optimizer methods
- :doc:`defense_layers` - Adam warmup divergence prevention
- :doc:`practical_workflows` - Real-world fitting examples
