...
class UCUPError:
    ...
    def __post_init__(self):
        if self.original_exception:
            self.metadata['original_exception_type'] = type(self.original_exception).__name__
    ...
    def can_auto_recover(self) -> bool:
        ...
        return any(not strategy.requires_user_input for strategy in self.recovery_strategies)
...
class ErrorHandler:
    ...
    def handle_error(self, error: UCUPError, context: Optional[Dict[str, Any]] = None) -> Any:
        """
    ...
    def _attempt_recovery(self, error: UCUPError, context: Optional[Dict[str, Any]]) -> Any:
    ...
    def _handle_validation_error(self, error: ValidationError, context: Dict[str, Any]) -> Any:
        ...
        self.logger.warning(f"Validation error in field '{error.field}': {error.message}")
        return context

    def _handle_configuration_error(self, error: ConfigurationError, context: Dict[str, Any]) -> Any:
    ...
    def _handle_runtime_error(self, error: RuntimeError, context: Dict[str, Any]) -> Any:
    ...
    def _handle_network_error(self, error: NetworkError, context: Dict[str, Any]) -> Any:
    ...
    def _handle_coordination_error(self, error: CoordinationError, context: Dict[str, Any]) -> Any:
    ...
    def _handle_probabilistic_error(self, error: ProbabilisticError, context: Dict[str, Any]) -> Any:
    ...
    def _check_error_patterns(self, error: UCUPError):
        ...
        recent_errors = [e for e in self.error_history[-10:] if e.category == error.category]
    ...
    def _check_error_thresholds(self):
        ...
        for category in ErrorCategory:
            recent_errors = [
                ...
                if e.category == category and e.severity in (ErrorSeverity.HIGH, ErrorSeverity.CRITICAL)
            ]
...
def handle_error(error: Union[UCUPError, Exception], context: Optional[Dict[str, Any]] = None) -> Any:
    """
