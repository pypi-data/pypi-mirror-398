...
try:
    from .metrics import BenefitsDisplay, get_global_tracker, record_build_metrics, should_show_donation_prompt, record_donation_prompt_shown
except ImportError:
    # Fallback for when running from different contexts
    from ucup.metrics import BenefitsDisplay, get_global_tracker, record_build_metrics, should_show_donation_prompt, record_donation_prompt_shown
