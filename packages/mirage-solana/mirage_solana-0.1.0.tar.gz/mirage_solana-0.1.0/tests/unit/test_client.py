"""
Integration tests for Mirage Protocol Python SDK
...
from mirage.types import TransactionStatus, PrivateTransaction
from mirage.utils import validate_solana_address
...
class TestInstructionBuilder:
    ...
    def test_shield_sol_instruction_data(self):
        ...
        from mirage.solana_client import InstructionBuilder
...
class TestPDADerivation:
    ...
    def test_find_pool_pda(self):
        ...
        from mirage.solana_client import find_pool_pda
        from solders.pubkey import Pubkey
    ...
    def test_find_vault_pda(self):
        ...
        from mirage.solana_client import find_pool_pda, find_vault_pda
        from solders.pubkey import Pubkey
    ...
    def test_find_nullifier_pda(self):
        ...
        from mirage.solana_client import find_pool_pda, find_nullifier_pda
        from solders.pubkey import Pubkey
...
class TestMVPProof:
    ...
    def test_generate_mvp_proof(self):
        ...
        from mirage.client import generate_mvp_proof
...
class TestClientOffline:
    ...
    def test_shield_assets_offline(self, mock_rust_core):
        ...
        with patch.dict('sys.modules', {'mirage._rust_core': mock_rust_core}):
            # Need to reimport to get mocked version
            from mirage.client import PrivacyClient
...
class TestCommitmentData:
    ...
    def test_commitment_hex_conversion(self):
        ...
        from mirage.types import CommitmentData
