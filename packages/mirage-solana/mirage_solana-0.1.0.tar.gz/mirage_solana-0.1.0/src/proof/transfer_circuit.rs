...
impl ConstraintSynthesizer<Fr> for TransferCircuit {
    fn generate_constraints(self, cs: ConstraintSystemRef<Fr>) -> Result<(), SynthesisError> {
        ...
        let domain_separator = FpVar::new_constant(
            cs.clone(),
            Fr::from_le_bytes_mod_order(b"MIRAGE_SPENDING_KEY"),
        )?;
        ...
        let nullifier_domain = FpVar::new_constant(
            cs.clone(),
            Fr::from_le_bytes_mod_order(b"MIRAGE_NULLIFIER"),
        )?;
...
mod tests {
    ...
    fn test_transfer_circuit_valid() {
        ...
        let domain = Fr::from_le_bytes_mod_order(b"MIRAGE_SPENDING_KEY");
        ...
        let nullifier_domain = Fr::from_le_bytes_mod_order(b"MIRAGE_NULLIFIER");
