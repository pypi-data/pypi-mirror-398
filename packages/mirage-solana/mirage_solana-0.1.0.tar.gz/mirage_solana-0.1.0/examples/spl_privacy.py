...
This example demonstrates how to use Mirage for private SPL token transactions.
...
from mirage.assets import COMMON_TOKENS, get_token_mint
...
async def main():
    # Initialize Mirage client (devnet)
...
if __name__ == "__main__":
    print("🔐 Mirage SPL Token Privacy Demo")
    print()
    print("This demo shows how to use Mirage for private SPL token transactions.")
