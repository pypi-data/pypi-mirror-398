...
class AresGetPctOverlap():
    ...
    def run(self):
        ...
        for cnt, (track_1, track_2) in enumerate(combinations(polygon_getter.results.keys(), r=2)):
            ...
            results[f'{track_1}-{track_2}'] = GeometryMixin().multiframe_compute_pct_shape_overlap(shape_1=shapes_1, shape_2=shapes_2, verbose=self.verbose, core_cnt=self.core_cnt, pool=self.pool)
