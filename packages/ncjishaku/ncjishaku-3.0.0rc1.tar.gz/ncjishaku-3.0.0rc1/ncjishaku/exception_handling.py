...
async def send_traceback(
    destination: typing.Union[nextcord.abc.Messageable, nextcord.Message],
    verbosity: int,
    ...
    for page in paginator.pages:
        if isinstance(destination, nextcord.Message):
...
async def attempt_add_reaction(
    ...
    reaction: typing.Union[str, nextcord.Emoji]
