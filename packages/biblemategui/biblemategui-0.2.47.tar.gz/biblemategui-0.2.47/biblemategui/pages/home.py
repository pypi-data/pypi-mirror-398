                ...
                with ui.row().classes('items-center no-wrap'):
                    ...
                    with ui.button(icon='build').props('flat color=white round').tooltip(get_translation("Tools")):
                        with ui.menu():
                            ...
                            ui.separator()
                            ui.menu_item(get_translation("Book Analysis"), on_click=lambda: self.load_area_2_content(title='Introduction', sync=True))
                    ...
                    with ui.button(icon='auto_awesome').props('flat color=white round').tooltip(get_translation("AI")):
                        with ui.menu():
                            ui.menu_item(get_translation("Book Analysis"), on_click=lambda: self.load_area_2_content(title='Introduction'))
