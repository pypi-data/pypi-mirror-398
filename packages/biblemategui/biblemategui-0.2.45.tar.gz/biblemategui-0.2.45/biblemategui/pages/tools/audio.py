...
def bibles_audio(gui=None, bt=None, b=1, c=1, v=1, area=2, **_):
    ...
    # Start the player
    player = BibleAudioPlayer(text_list=text_list, audio_list=audio_list, start_verse=v, title=BibleBooks.abbrev["eng"][str(b)][-1]+f" {c}", next_chapter_callback=lambda: next_chapter((bt, b, c, v)))
    player.create_ui()
