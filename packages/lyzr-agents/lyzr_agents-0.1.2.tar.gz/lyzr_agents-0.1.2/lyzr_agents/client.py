"""Lyzr API client for executing agents."""
...
class LyzrAgent:
    ...
    def __init__(self, api_key: str, user_id: str, base_url: str = LYZR_API_BASE_URL):
        """Initialize the Lyzr agent client.

        Args:
            api_key: API key for Lyzr platform.
            user_id: User ID for Lyzr platform.
            base_url: Base URL for Lyzr API (optional).
        """
