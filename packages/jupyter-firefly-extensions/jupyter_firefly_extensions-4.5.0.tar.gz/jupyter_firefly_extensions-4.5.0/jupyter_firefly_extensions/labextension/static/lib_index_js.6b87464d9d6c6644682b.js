...
async function forwardToFirefly(app, filepath) {
    ...
    try {
        ...
        // Dispose the progress dialog before showing the error message
        try {
            progressDialog.dispose();
        }
        catch ( /* ignore */_d) { /* ignore */ }
        await (0,_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.showErrorMessage)('Failed to activate Firefly Viewer', `${(_a = e === null || e === void 0 ? void 0 : e.message) !== null && _a !== void 0 ? _a : e}`);
        return;
    }
    ...
    try {
        ...
        // Dispose progress dialog first, then show error message
        try {
            progressDialog.dispose();
        }
        catch ( /* ignore */_e) { /* ignore */ }
        await (0,_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.showErrorMessage)('Upload to Firefly Failed', `${(_b = e === null || e === void 0 ? void 0 : e.message) !== null && _b !== void 0 ? _b : e}`);
        return;
    }
    ...
    try {
        ...
        await (0,_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.showErrorMessage)('Open in Firefly Failed', `${(_c = e === null || e === void 0 ? void 0 : e.message) !== null && _c !== void 0 ? _c : e}`);
        return;
    }
...
//# sourceMappingURL=lib_index_js.6b87464d9d6c6644682b.js.map