...
function activateAnyFileViewerExt(app, _restorer) {
    ...
    const widgetFactory = new _jupyterlab_docregistry__WEBPACK_IMPORTED_MODULE_0__.ABCWidgetFactory({
        ...
        readOnly: true,
        // Ensure this factory takes precedence over built-ins (CSV/TSV viewers, etc.)
        // JupyterLab uses a lower defaultRank as higher priority.
        defaultRank: 0,
    });
...
//# sourceMappingURL=lib_index_js.02c541bd4a93c4a42c65.js.map