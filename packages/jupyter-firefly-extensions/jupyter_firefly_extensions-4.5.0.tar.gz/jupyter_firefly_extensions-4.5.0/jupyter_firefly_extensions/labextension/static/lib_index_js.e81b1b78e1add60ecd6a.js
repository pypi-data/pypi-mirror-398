...
/* harmony import */ var _SlateCommandExt_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./SlateCommandExt.js */ "./lib/SlateCommandExt.js");





const ANYFACTORY = 'Firefly Viewer'; // name that appears in JL "Open With" menu
...
const SUPPORTED_TYPES = [
    ...
    {
        name: 'VOTable',
        displayName: 'VOTable file',
        mimeTypes: ['application/x-votable+xml', 'text/xml'],
        extensions: ['.vot', '.xml']
    },
    ,
    {
        name: 'Table',
        displayName: 'Table file',
        mimeTypes: ['text/tbl'],
        extensions: ['.tbl']
    }
];
const SUPPORTED_TYPES1 = {
...
function activateAnyFileViewerExt(app, _restorer) {
    ...
    // SUPPORTED_TYPES.forEach((fileType) => {
    // 	if (!app.docRegistry.getFileType(fileType.name)) {
    // 		app.docRegistry.addFileType(fileType);
    // 	}
    // });
    Object.entries(SUPPORTED_TYPES1).forEach(([name, extensions]) => {
        if (!app.docRegistry.getFileType(name)) {
    ...
    const widgetFactory = new _jupyterlab_docregistry__WEBPACK_IMPORTED_MODULE_0__.ABCWidgetFactory({
        ...
        // Associate with our supported types; this keeps behavior generic and extendable.
        // fileTypes: SUPPORTED_TYPES.map((fileType) => fileType.name),
        // defaultFor: SUPPORTED_TYPES.map((fileType) => fileType.name),
        fileTypes: Object.keys(SUPPORTED_TYPES1),
        defaultFor: Object.keys(SUPPORTED_TYPES1),
        readOnly: true
    });
...
async function forwardToFirefly(app, filepath) {
    ...
    try {
        await app.commands.execute(_SlateCommandExt_js__WEBPACK_IMPORTED_MODULE_2__.SLATE_CMD_ID);
    }
    catch (e) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   SLATE_CMD_ID: () => (/* binding */ SLATE_CMD_ID),
...
const SLATE_CMD_ID = 'firefly:open-slate-viewer';
/**
...
//# sourceMappingURL=lib_index_js.e81b1b78e1add60ecd6a.js.map