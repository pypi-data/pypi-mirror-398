...
async function forwardToFirefly(app, filepath) {
    ...
    const progressDialog = new _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.Dialog({
        ...
        body: `Uploading and opening "${filepath.substring(filepath.lastIndexOf('/') + 1)}" in Firefly…`,
        buttons: []
    });
    ...
    try {
        ...
        void (0,_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.showDialog)({
            title: 'Firefly Viewer Activation Failed',
...
//# sourceMappingURL=lib_index_js.41599515a7ea6eeba213.js.map