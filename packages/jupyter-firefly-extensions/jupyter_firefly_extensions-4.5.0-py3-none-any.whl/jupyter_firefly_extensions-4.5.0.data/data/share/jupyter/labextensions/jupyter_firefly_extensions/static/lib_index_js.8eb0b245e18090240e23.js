...
async function forwardToFirefly(app, filepath) {
    ...
    // Helper to uniformly handle failures: log, close progress dialog, and show JL error
    const handleFailure = async (title, err) => {
        var _a;
        const msg = `${(_a = err === null || err === void 0 ? void 0 : err.message) !== null && _a !== void 0 ? _a : err}`;
        console.error(title, msg);
        // Don't await close per your preference
        progressDialog.close();
        await (0,_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.showErrorMessage)(title, msg);
    };
    ...
    try {
        ...
        await handleFailure('Failed to activate Firefly Viewer', e);
        return;
    }
    ...
    try {
        ...
        await handleFailure('Upload to Firefly Failed', e);
        return;
    }
    ...
    try {
        ...
        await handleFailure('Open in Firefly Failed', e);
        return;
    }
...
//# sourceMappingURL=lib_index_js.8eb0b245e18090240e23.js.map