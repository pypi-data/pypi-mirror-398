...
async function forwardToFirefly(app, filepath) {
    ...
    const handleFailure = (title, err) => {
        ...
        (0,_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.showErrorMessage)(title, msg); // shows a error dialog in JupyterLab
    };
...
const SLATE_CMD_CAPTION = 'Open the Firefly Viewer in a new tab for visualizing data as tables, images, and charts';
/**
...
//# sourceMappingURL=lib_index_js.532c3ec8dabaa28c382a.js.map