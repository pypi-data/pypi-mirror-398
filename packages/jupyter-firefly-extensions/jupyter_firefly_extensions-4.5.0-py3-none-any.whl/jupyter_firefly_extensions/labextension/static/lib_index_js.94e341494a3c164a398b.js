...
// NOTE: Use a minimal mapping of display names to extensions; JL primarily matches by extension.
const SUPPORTED_TYPES1 = {
    FITS: ['.fits', '.fit', '.fz', '.fits.gz', '.fits.zip'],
    VOTable: ['.vot', '.xml'],
    CSV: ['.csv'],
    TSV: ['.tsv'],
    Parquet: ['.parquet'],
...
//# sourceMappingURL=lib_index_js.94e341494a3c164a398b.js.map