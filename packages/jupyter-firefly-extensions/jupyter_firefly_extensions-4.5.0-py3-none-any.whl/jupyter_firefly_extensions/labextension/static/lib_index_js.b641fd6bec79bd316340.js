...
function activateAnyFileViewerExt(app, _restorer) {
    ...
    // We instead forward to Firefly and abort the normal "open widget in a tab
    // for this file" flow.
    ...
    if (!window.__fireflyCancelErrorHandlerInstalled) {
        const cancelHandler = (e) => {
            ...
            if (err && err.name === NO_OP_ERROR_NAME) {
                e.preventDefault();
...
//# sourceMappingURL=lib_index_js.b641fd6bec79bd316340.js.map