...
setup(
    name='DensityFlow2',
    version='1.3.20',
    description='Generative additive model for single cell perturbation v2',
    ...
    url='https://github.com/ZengFLab/DensityFlow2',  # 项目的 GitHub 地址

    entry_points={
        'console_scripts': [
            'DensityFlow2=DensityFlow2.DensityFlow:main'
        ],
    },
)