...
def pow(arg0, arg1, _semantic=None):
    return core.extern_elementwise(
        ...
        [arg0, arg1],
        {
            ...
            (core.dtype("bf16"), core.dtype("bf16")): (
                "__hmf_powf",
                core.dtype("bf16"),
            ),
            (core.dtype("fp16"), core.dtype("fp32")): (
                "__hmf_powf",
                core.dtype("fp16"),
            ),
            (core.dtype("bf16"), core.dtype("fp32")): (
                "__hmf_powf",
                core.dtype("bf16"),
            ),
            (core.dtype("fp32"), core.dtype("fp16")): (
                "__hmf_powf",
                core.dtype("fp32"),
            ),
            (core.dtype("fp32"), core.dtype("bf16")): (
                "__hmf_powf",
                core.dtype("fp32"),
            ),
            (core.dtype("int64"), core.dtype("int64")): (
                "__hmf_powi",
                core.dtype("int64"),
            ),
            ...
            (core.dtype("int16"), core.dtype("int16")): (
                "__hmf_powi",
                core.dtype("int16"),
            ),
            (core.dtype("int8"), core.dtype("int8")): (
                "__hmf_powi",
                core.dtype("int8"),
            ),
        },
...
@core.extern
def flip(arg0, arg1=None, _semantic=None):
    if arg1 == None:
        return core.extern_elementwise(
            "",
            "",
    ...
    return core.extern_elementwise(
        ...
        [arg0, arg1],
        {
            (core.dtype("bf16"), core.dtype("int32")): (
                "__hmf_flipDhb",
                core.dtype("bf16"),
            ),
            (core.dtype("fp16"), core.dtype("int32")): (
                "__hmf_flipDh",
                core.dtype("fp16"),
            ),
            ...
            (core.dtype("int8"), core.dtype("int32")): (
                "__hmf_flipi8",
                core.dtype("int8"),
            ),
            (core.dtype("int16"), core.dtype("int32")): (
                "__hmf_flipi16",
                core.dtype("int16"),
            ),
            (core.dtype("int32"), core.dtype("int32")): (
            ...
            (core.dtype("uint32"), core.dtype("int32")): (
                "__hmf_flipui32",
                core.dtype("uint32"),
            ),
