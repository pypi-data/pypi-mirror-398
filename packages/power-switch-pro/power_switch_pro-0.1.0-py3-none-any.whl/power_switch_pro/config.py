...
class ConfigManager:
    ...
    def get_refresh_enabled(self) -> bool:
        ...
        return self.get("refresh_enabled")
    ...
    def get_refresh_delay(self) -> int:
        ...
        return self.get("refresh_delay_minutes")
    ...
    def get_syslog_address(self) -> str:
        ...
        return self.get("syslog_ip_address")
