...
def test_raw():
    assert mi.type_info(hyperspec.Raw) == mi.RawType()


def test_msgpack_ext():
    assert mi.type_info(hyperspec.msgpack.Ext) == mi.ExtType()
...
def test_struct(kw):
    ...
    class Example(hyperspec.Struct, **kw):
        x: int
        y: int = 0
    ...
    assert mi.type_info(Model) == mi.StructType(
        ...
        fields=(
            mi.Field(
                ...
                required=True,
                default=hyperspec.NODEFAULT,
                default_factory=hyperspec.NODEFAULT,
            ),
        ),
        tag_field=None,
        tag=None,
...
def test_is_struct_runtime():
    ...
    Generated = hyperspec.defstruct("InspectStructRuntime", ["x"])
...
def test_is_struct_type_runtime():
    ...
    Generated = hyperspec.defstruct("InspectStructTypeRuntime", ["x"])
