...
## What's Changed
* Add --sync option to update packages synchronously and general code cleanup by @yesseruser in https://github.com/yesser-studios/ypkgupgr/pull/74
* Publish to pypi using uv by @yesseruser in https://github.com/yesser-studios/ypkgupgr/pull/75


**Full Changelog**: https://github.com/yesser-studios/ypkgupgr/compare/1.13.2...1.14.0
