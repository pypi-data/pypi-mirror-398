...
def _main() -> None:
    ...
    ccopenai.http_client = http_client

    if args.organization:
        ccopenai.organization = args.organization

    if args.api_key:
        ccopenai.api_key = args.api_key

    if args.api_base:
        ccopenai.base_url = args.api_base

    # azure
    if args.api_type is not None:
        ccopenai.api_type = args.api_type

    if args.azure_endpoint is not None:
        ccopenai.azure_endpoint = args.azure_endpoint

    if args.api_version is not None:
        ccopenai.api_version = args.api_version

    if args.azure_ad_token is not None:
        ccopenai.azure_ad_token = args.azure_ad_token
