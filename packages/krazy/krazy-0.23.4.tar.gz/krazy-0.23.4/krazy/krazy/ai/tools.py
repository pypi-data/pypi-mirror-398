...
class Config:
    ...
    def __init__(self, params: Dict[str, str]):
        ...
        self.open_ai_api_key = params.get('open_ai_api_key')
        self.azure_version = params.get('azure_version')
        ...
        self.summary_azure_model = params.get('summary_azure_model', 'gpt-35-turbo-16k')
        ...
        self.endpoint_url = f"{self.azure_endpoint}/openai/deployments/{self.embedding_model}/completions?api-version={self.azure_version}"
