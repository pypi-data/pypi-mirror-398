    ...
    def __init__(self,
        ...
        self.memory_collection = self.memory_client.get_or_create_collection(
            ...
            embedding_function=AzureOpenAIEmbeddingFunction(
                api_key=config.open_ai_api_key, # type: ignore
                api_base=self.config.azure_endpoint, # type: ignore
                api_version=self.config.azure_version, # type: ignore
        ...
        self.llm_options = {'azure': LLM( # using azure open ai api
            ...
            base_url=f'{self.config.azure_endpoint}',
