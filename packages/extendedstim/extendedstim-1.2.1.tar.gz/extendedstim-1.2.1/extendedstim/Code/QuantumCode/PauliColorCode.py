...
class PauliColorCode(PauliCSSCode):
    ...
    def __init__(self, d: int) -> None:
        ...
        for i in range(len(cells_in_triangle)):
            ...
            stabilizer_list_x.append(PauliOperator.HermitianOperatorFromOccupy(stabilizer_temp, []))
            stabilizer_list_z.append(PauliOperator.HermitianOperatorFromOccupy([], stabilizer_temp))
