...
from selfmemory.client.utils import api_error_handler
from selfmemory.memory.telemetry import capture_client_event
    ...
    def __init__(
        ...
        if config is not None:
            ...
            self.config = ProjectConfig(
                org_id=org_id, project_id=project_id, user_email=user_email
            )
