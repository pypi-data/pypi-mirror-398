...
export SESSION_MGMT_ENABLE_LLM_ENTITY_EXTRACTION=true  # or 'false' to disable temporarily
export SESSION_MGMT_ENABLE_ANTHROPIC=true              # or 'false' to disable temporarily
```
