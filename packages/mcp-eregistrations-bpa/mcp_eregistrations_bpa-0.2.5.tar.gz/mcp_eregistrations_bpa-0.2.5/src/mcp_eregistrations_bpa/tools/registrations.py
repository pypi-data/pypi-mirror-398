...
- POST /service/{service_id}/registration - Create registration within service
    ...
    try:
        async with BPAClient() as client:
            if service_id is not None:
                # Use service-scoped endpoint for filtered results
...
async def registration_create(
    ...
    4. Execute POST /service/{service_id}/registration API call
