...
async def role_create(
    ...
    Args:
        ...
        short_name: Short name for the role (required by BPA API).
        assigned_to: Role pool assignment string (default: "processing").
        role_type: Role type - "UserRole" for humans, "BotRole" for automation
            (default: "UserRole").
    ...
    Returns:
        dict: Created role details including:
            - id: The new role ID
            - name, short_name, description, assigned_to
            - service_id: The parent service ID
    ...
    validated_params = _validate_role_create_params(
        service_id, name, short_name, assigned_to, role_type, description
    )
...
def _validate_role_update_params(
    ...
    if (
        ...
        errors.append(
            "At least one field (name, short_name, assigned_to, or description) "
            "must be provided"
        )
...
async def role_update(
    ...
    Args:
        ...
        short_name: New short name for the role (optional).
        assigned_to: New role pool assignment string (optional).
        description: New description for the role (optional).

    Returns:
        dict: Updated role details including:
            - id, name, short_name, description, assigned_to
            - service_id: The parent service ID
    ...
    validated_params = _validate_role_update_params(
        role_id, name, short_name, assigned_to, description
    )
