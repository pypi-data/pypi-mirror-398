...
try:
    from ezmsg.neo.__version__ import version as release
except ImportError:
    release = "unknown"
...
html_baseurl = "https://www.ezmsg.org/ezmsg-neo/"

html_theme_options = {
    "logo": {
        "text": f"ezmsg.neo {version}",
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/ezmsg-org/ezmsg-neo",
...
branch = "main"
code_url = f"https://github.com/ezmsg-org/ezmsg-neo/blob/{branch}/"
