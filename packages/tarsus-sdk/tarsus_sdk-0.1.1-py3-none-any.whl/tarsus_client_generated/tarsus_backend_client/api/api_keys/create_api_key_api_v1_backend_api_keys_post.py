...
def sync_detailed(
    *,
    ...
    """Create a new API key
     ...
     Creates a new API key for the authenticated backend user.

    ⚠️ IMPORTANT: The full API key is returned only once. Make sure to save it immediately.

    Args:
        x_api_key (None | str | Unset):
        body (APIKeyCreate): Model for creating a new API key.
