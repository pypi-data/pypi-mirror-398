...
from ...models.knowledge_chunk_create import KnowledgeChunkCreate
...
def _get_kwargs(
    *,
    ...
    generate_embedding: bool | Unset = True,
    ...
    params["generate_embedding"] = generate_embedding
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = KnowledgeChunkModel.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """Create a single knowledge chunk
     ...
     Create a single knowledge chunk with optional embedding.

    Use this for storing individual chunks of text. For long texts, use POST /knowledge
    which automatically chunks the text.

    Args:
        generate_embedding (bool | Unset): Whether to generate embedding Default: True.
        ...
        body (KnowledgeChunkCreate): Request model for creating a knowledge chunk.
