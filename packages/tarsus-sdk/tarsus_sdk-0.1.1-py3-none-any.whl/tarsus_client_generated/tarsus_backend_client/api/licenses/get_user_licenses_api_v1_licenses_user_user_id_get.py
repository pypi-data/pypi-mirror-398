...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/licenses/user/{user_id}".format(
...
) -> Any | HTTPValidationError | list[LicenseModel] | None:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = LicenseModel.from_dict(response_200_item_data)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | HTTPValidationError | list[LicenseModel]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | HTTPValidationError | list[LicenseModel]
    """
