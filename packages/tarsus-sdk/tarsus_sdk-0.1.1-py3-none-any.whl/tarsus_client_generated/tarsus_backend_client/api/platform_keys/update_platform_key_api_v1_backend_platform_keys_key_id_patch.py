...
from ...models.platform_key_update import PlatformKeyUpdate
...
def sync_detailed(
    ...
    *,
    ...
    """Update a platform key

     Updates a platform key.
    Can be used to enable/disable live payment keys, update credentials, etc.

    Args:
        key_id (str):
        x_api_key (None | str | Unset):
        body (PlatformKeyUpdate): Model for updating a platform key
