...
if TYPE_CHECKING:
    from ..models.api_key_create_endpoint_permissions_type_0 import APIKeyCreateEndpointPermissionsType0
...
class APIKeyCreate:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_endpoint_permissions(data: object) -> APIKeyCreateEndpointPermissionsType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
