...
if TYPE_CHECKING:
    from ..models.enforced_schema_schema_definition import EnforcedSchemaSchemaDefinition
    from ..models.enforced_schema_validation_report_type_0 import EnforcedSchemaValidationReportType0
...
class EnforcedSchema:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_validation_report(data: object) -> EnforcedSchemaValidationReportType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
