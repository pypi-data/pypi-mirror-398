...
class ProjectCreate:
    ...
    Attributes:
        ...
        primary_product_type (None | ProjectProductType | Unset): Primary product type selected at creation
        primary_payment_type (None | PaymentType | Unset): Primary payment type selected at creation
        enabled_product_types (list[ProjectProductType] | None | Unset):
    ...
    primary_product_type: None | ProjectProductType | Unset = UNSET
    primary_payment_type: None | PaymentType | Unset = UNSET
    enabled_product_types: list[ProjectProductType] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.primary_product_type, ProjectProductType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_primary_product_type(data: object) -> None | ProjectProductType | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                primary_product_type_type_0 = ProjectProductType(data)
        ...
        def _parse_enabled_product_types(data: object) -> list[ProjectProductType] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for enabled_product_types_type_0_item_data in _enabled_product_types_type_0:
                    enabled_product_types_type_0_item = ProjectProductType(enabled_product_types_type_0_item_data)
                ...
                pass
            return cast(list[ProjectProductType] | None | Unset, data)

        enabled_product_types = _parse_enabled_product_types(d.pop("enabled_product_types", UNSET))

        def _parse_enabled_payment_types(data: object) -> list[PaymentType] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
