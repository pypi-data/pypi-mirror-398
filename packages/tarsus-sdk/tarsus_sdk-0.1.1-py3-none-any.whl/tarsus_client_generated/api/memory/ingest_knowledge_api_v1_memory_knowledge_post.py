...
from ...models.ingest_knowledge_api_v1_memory_knowledge_post_body_type_0 import (
...
def _get_kwargs(
    *,
    body: IngestKnowledgeApiV1MemoryKnowledgePostBodyType0 | None | Unset = UNSET,
    text: str,
    ...
    if isinstance(body, IngestKnowledgeApiV1MemoryKnowledgePostBodyType0):
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (IngestKnowledgeApiV1MemoryKnowledgePostBodyType0 | None | Unset):
