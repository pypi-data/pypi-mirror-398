...
from ...models.variant_update_model import VariantUpdateModel
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/api/v1/products/{product_id}/variants/{variant_id}".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = VariantModel.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Update an existing variant
     ...
     Updates an existing variant with the provided data.
    ...
    Args:
        ...
        body (VariantUpdateModel): Model for updating variants
