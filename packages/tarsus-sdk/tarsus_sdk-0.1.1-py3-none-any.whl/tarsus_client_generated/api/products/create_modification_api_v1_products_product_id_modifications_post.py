...
def _get_kwargs(
    product_id: str,
    *,
    body: ModificationDefinitionModel,
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = ModificationDefinitionModel.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Create a new modification definition for a product

     Creates a new modification definition for a product.
    ...
    Args:
        ...
        body (ModificationDefinitionModel): Definition of an available modification for a product
