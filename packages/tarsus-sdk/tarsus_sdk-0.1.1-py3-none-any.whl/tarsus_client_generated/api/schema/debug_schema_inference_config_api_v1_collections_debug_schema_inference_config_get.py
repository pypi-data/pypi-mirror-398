...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/collections/debug/schema-inference-config",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    """[DEBUG] Check schema inference configuration (temporary endpoint for troubleshooting)

     Debug endpoint to check schema inference configuration.
    This helps verify that the backend is using deterministic inference correctly.
