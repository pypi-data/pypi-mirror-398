...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/collections/{collection_name}/schema/proposal".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get latest schema proposal for a collection

     Get the latest schema proposal for a collection.
