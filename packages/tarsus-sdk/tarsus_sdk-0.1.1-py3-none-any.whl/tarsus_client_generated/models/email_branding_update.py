...
T = TypeVar("T", bound="EmailBrandingUpdate")


@_attrs_define
class EmailBrandingUpdate:
    """Model for updating email branding.
    ...
    Attributes:
        ...
        show_powered_by (bool | None | Unset):
    ...
    show_powered_by: bool | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        show_powered_by: bool | None | Unset
        if isinstance(self.show_powered_by, Unset):
            show_powered_by = UNSET
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_show_powered_by(data: object) -> bool | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        show_powered_by = _parse_show_powered_by(d.pop("show_powered_by", UNSET))
        ...
        email_branding_update.additional_properties = d
        return email_branding_update
