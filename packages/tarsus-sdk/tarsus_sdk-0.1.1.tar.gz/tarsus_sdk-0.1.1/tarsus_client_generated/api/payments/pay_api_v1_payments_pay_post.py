...
def sync_detailed(
    *,
    ...
    """Pay
     ...
     Process a payment using Stripe Payment Intent.
    Authentication is optional - works with or without customer login.

    Note: If a customer user is authenticated, their user_id will be associated with the payment.
    If not authenticated, the payment will be processed as anonymous.
