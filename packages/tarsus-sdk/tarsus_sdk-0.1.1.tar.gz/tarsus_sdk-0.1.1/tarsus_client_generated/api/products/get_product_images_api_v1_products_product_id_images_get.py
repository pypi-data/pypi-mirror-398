...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/products/{product_id}/images".format(
...
) -> Any | HTTPValidationError | list[ImageModel] | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | HTTPValidationError | list[ImageModel]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | HTTPValidationError | list[ImageModel]
    """
