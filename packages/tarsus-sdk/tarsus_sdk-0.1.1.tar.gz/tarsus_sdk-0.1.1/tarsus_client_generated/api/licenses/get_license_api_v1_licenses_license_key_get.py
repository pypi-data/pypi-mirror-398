...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/licenses/{license_key}".format(
...
) -> Any | HTTPValidationError | LicenseModel | None:
    if response.status_code == 200:
        response_200 = LicenseModel.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | HTTPValidationError | LicenseModel]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | HTTPValidationError | LicenseModel
    """
