...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/downloads/{order_id}/{item_index}".format(
            order_id=quote(str(order_id), safe=""),
            item_index=quote(str(item_index), safe=""),
        ),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Generate secure download URL for digital product

     Generate a secure signed URL for downloading a digital product.
