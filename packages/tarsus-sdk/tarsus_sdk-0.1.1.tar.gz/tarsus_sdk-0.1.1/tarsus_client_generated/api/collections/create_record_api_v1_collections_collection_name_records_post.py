...
from ...models.collection_record_create import CollectionRecordCreate
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = CollectionRecord.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    - The record ID is auto-generated using ULID (K-sortable)
    ...
    Args:
        ...
        body (CollectionRecordCreate): Request model for creating a record - only requires data
