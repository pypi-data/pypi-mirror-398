...
) -> Any | HTTPValidationError | list[FactModel] | None:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = FactModel.from_dict(response_200_item_data)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | HTTPValidationError | list[FactModel]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Categories include: 'security', 'architecture', 'business_rule', 'preference', etc.

    Args:
        category (None | str | Unset): Filter by category
        limit (int | Unset): Maximum number of facts to return Default: 100.
...
def sync(
    *,
    ...
    Returns:
        Any | HTTPValidationError | list[FactModel]
    """
