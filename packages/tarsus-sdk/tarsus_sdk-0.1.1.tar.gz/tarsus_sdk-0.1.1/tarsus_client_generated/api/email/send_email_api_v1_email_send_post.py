...
def sync_detailed(
    *,
    ...
    """Send Email
     ...
     Send an email using project-specific SMTP credentials.

    This endpoint is for developer applications to send emails.
    Requires project SMTP credentials to be configured in Developer Dashboard.
    Authentication is optional - works with or without customer login.

    Note: This endpoint uses project SMTP credentials, NOT platform credentials.
    Platform emails (registrations, unsubscribe) use separate endpoints.
