...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/collections/{collection_name}/types.ts".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Generate TypeScript types for enforced schema

     Generate TypeScript interface definition for an enforced schema.

    Returns a TypeScript file that can be imported in frontend code.
