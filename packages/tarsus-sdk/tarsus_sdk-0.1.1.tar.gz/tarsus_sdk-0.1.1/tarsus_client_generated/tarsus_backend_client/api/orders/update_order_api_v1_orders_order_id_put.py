...
from ...models.order_update_model import OrderUpdateModel
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/api/v1/orders/{order_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (OrderUpdateModel): Pydantic model for updating an existing order.
