...
from ...models.fact_update import FactUpdate
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/api/v1/memory/facts/{fact_id}".format(
            fact_id=quote(str(fact_id), safe=""),
        ),
        "params": params,
    }
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = FactModel.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (FactUpdate): Request model for updating a fact.
