...
if TYPE_CHECKING:
    from ..models.modification_update_model_rules_type_0 import ModificationUpdateModelRulesType0
...
class ModificationUpdateModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_rules(data: object) -> ModificationUpdateModelRulesType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
