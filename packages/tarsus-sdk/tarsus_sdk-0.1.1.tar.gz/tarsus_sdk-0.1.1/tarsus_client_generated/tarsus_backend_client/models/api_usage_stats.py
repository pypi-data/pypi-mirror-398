...
if TYPE_CHECKING:
    ...
    from ..models.api_usage_stats_requests_by_endpoint import APIUsageStatsRequestsByEndpoint
    from ..models.api_usage_stats_requests_by_status_code import APIUsageStatsRequestsByStatusCode
