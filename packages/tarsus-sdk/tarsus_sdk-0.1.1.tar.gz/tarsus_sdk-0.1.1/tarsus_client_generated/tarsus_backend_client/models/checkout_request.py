...
if TYPE_CHECKING:
    ...
    from ..models.checkout_request_shipping_address_type_0 import CheckoutRequestShippingAddressType0
...
class CheckoutRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_shipping_address(data: object) -> CheckoutRequestShippingAddressType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
