...
if TYPE_CHECKING:
    ...
    from ..models.product_model_bundle_components_type_0_item import ProductModelBundleComponentsType0Item
    from ..models.product_model_dimensions_type_0 import ProductModelDimensionsType0
    from ..models.product_model_metadata_type_0 import ProductModelMetadataType0
    from ..models.product_model_options import ProductModelOptions
    from ..models.product_model_package_dimensions_type_0 import ProductModelPackageDimensionsType0
...
@_attrs_define
class ProductModel:
    """Product template - shared information, variants are purchasable SKUs
    ...
    Attributes:
        ...
        options (ProductModelOptions | Unset):
        available_colors (list[str] | Unset):
        available_sizes (list[str] | Unset):
        search_keywords (list[str] | Unset):
        tags (list[str] | Unset): Product tags for categorization and filtering
        item_number (None | str | Unset):
        sku (None | str | Unset):
        dimensions (None | ProductModelDimensionsType0 | Unset):
        weight (float | None | Unset):
        package_dimensions (None | ProductModelPackageDimensionsType0 | Unset):
        materials (list[str] | None | Unset):
        manufacturer (None | str | Unset):
        metadata (None | ProductModelMetadataType0 | Unset):
        ...
        bundle_components (list[ProductModelBundleComponentsType0Item] | None | Unset):
        created_at (datetime.datetime | Unset):
        modified_at (datetime.datetime | None | Unset):
        stock (int | None | Unset): Total stock quantity aggregated from all active variants
    """
    ...
    options: ProductModelOptions | Unset = UNSET
    ...
    dimensions: None | ProductModelDimensionsType0 | Unset = UNSET
    weight: float | None | Unset = UNSET
    package_dimensions: None | ProductModelPackageDimensionsType0 | Unset = UNSET
    materials: list[str] | None | Unset = UNSET
    manufacturer: None | str | Unset = UNSET
    metadata: None | ProductModelMetadataType0 | Unset = UNSET
    ...
    bundle_components: list[ProductModelBundleComponentsType0Item] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.dimensions, Unset):
            dimensions = UNSET
        elif isinstance(self.dimensions, ProductModelDimensionsType0):
        ...
        elif isinstance(self.package_dimensions, ProductModelPackageDimensionsType0):
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, ProductModelMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_options, Unset):
            ...
            options = ProductModelOptions.from_dict(_options)
        ...
        def _parse_dimensions(data: object) -> None | ProductModelDimensionsType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                dimensions_type_0 = ProductModelDimensionsType0.from_dict(data)

                return dimensions_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | ProductModelDimensionsType0 | Unset, data)
        ...
        def _parse_package_dimensions(data: object) -> None | ProductModelPackageDimensionsType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                package_dimensions_type_0 = ProductModelPackageDimensionsType0.from_dict(data)

                return package_dimensions_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | ProductModelPackageDimensionsType0 | Unset, data)
        ...
        def _parse_metadata(data: object) -> None | ProductModelMetadataType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = ProductModelMetadataType0.from_dict(data)

                return metadata_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | ProductModelMetadataType0 | Unset, data)
        ...
        def _parse_bundle_components(data: object) -> list[ProductModelBundleComponentsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for bundle_components_type_0_item_data in _bundle_components_type_0:
                    bundle_components_type_0_item = ProductModelBundleComponentsType0Item.from_dict(
                ...
                pass
            return cast(list[ProductModelBundleComponentsType0Item] | None | Unset, data)
        ...
        product_model.additional_properties = d
