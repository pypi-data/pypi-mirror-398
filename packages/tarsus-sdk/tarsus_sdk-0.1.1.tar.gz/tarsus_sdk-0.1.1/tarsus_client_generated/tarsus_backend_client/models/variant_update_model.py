...
if TYPE_CHECKING:
    from ..models.variant_update_model_options_type_0 import VariantUpdateModelOptionsType0
...
class VariantUpdateModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_options(data: object) -> None | Unset | VariantUpdateModelOptionsType0:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
