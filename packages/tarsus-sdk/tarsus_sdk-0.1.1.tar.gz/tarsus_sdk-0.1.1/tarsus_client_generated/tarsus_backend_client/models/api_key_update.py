...
if TYPE_CHECKING:
    from ..models.api_key_update_endpoint_permissions_type_0 import APIKeyUpdateEndpointPermissionsType0
...
class APIKeyUpdate:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_endpoint_permissions(data: object) -> APIKeyUpdateEndpointPermissionsType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
