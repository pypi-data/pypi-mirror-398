...
T = TypeVar("T", bound="BodyLoginForAccessTokenApiV1AuthTokenPost")


@_attrs_define
class BodyLoginForAccessTokenApiV1AuthTokenPost:
    """
    Attributes:
        username (str):
        password (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        body_login_for_access_token_api_v1_auth_token_post = cls(
            username=username,
            password=password,
        ...
        body_login_for_access_token_api_v1_auth_token_post.additional_properties = d
        return body_login_for_access_token_api_v1_auth_token_post
