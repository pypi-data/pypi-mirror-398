...
from ..models.project_public_subscription_status_type_0 import ProjectPublicSubscriptionStatusType0
...
class ProjectPublic:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_subscription_status(data: object) -> None | ProjectPublicSubscriptionStatusType0 | Unset:
            if data is None:
                return data
