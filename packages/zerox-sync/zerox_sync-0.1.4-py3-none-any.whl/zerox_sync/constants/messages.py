...
class Messages:
    ...
    Required environment variable GOOGLE_API_KEY is missing. Please set the GOOGLE_API_KEY environment variable.
    ...
    MODEL_ACCESS_ERROR = """
    Your provided model can't be accessed. Please make sure you have access to the model and the GOOGLE_API_KEY environment variable is set correctly.
    Get your API key from: https://aistudio.google.com/apikey
    """
