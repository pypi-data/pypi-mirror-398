...
class TracesApi:
    ...
    @staticmethod
    def bytes_to_generator(data: bytes, chunk_size: int | None = None):
        if not chunk_size:
            yield data
        else:
    ...
    def get_trace_events(
        ...
        for code in _response_types_map:
            if code.startswith("2"):
                _response_types_map.pop(code)
        ...
        return sseclient.SSEClient(self.bytes_to_generator(response_data.read(), chunk_size=1024))
