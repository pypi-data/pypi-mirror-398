...
class BatchEvaluateDatasetReq(BaseModel):
    """
    BatchEvaluateDatasetReq
    """  # noqa: E501

    specs: list[EvaluateDatasetSpec]
    ...
    def from_json(cls, json_str: str) -> Self | None:
        """Create an instance of BatchEvaluateDatasetReq from a JSON string"""
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        """Create an instance of BatchEvaluateDatasetReq from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "specs": [EvaluateDatasetSpec.from_dict(_item) for _item in obj["specs"]]
