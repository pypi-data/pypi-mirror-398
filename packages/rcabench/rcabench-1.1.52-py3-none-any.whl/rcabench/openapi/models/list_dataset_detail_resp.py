...
class ListDatasetDetailResp(BaseModel):
    """
    ListDatasetDetailResp
    """  # noqa: E501

    items: list[DatasetDetailResp] | None = None
    ...
    def from_json(cls, json_str: str) -> Self | None:
        """Create an instance of ListDatasetDetailResp from a JSON string"""
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        """Create an instance of ListDatasetDetailResp from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "items": [DatasetDetailResp.from_dict(_item) for _item in obj["items"]]
