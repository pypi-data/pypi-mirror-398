...
class SortOption(BaseModel):
    ...
    direction: SortDirection | None = Field(default=None, description="Sort direction")
    var_field: StrictStr | None = Field(default=None, description="Sort field", alias="field")
