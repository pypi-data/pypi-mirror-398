...
class BatchManageInjectionLabelResp(BaseModel):
    """
    ...
    success_items: list[InjectionResp] | None = None
    ...
    def from_json(cls, json_str: str) -> Self | None:
        """Create an instance of BatchManageInjectionLabelResp from a JSON string"""
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        """Create an instance of BatchManageInjectionLabelResp from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "success_items": [InjectionResp.from_dict(_item) for _item in obj["success_items"]]
