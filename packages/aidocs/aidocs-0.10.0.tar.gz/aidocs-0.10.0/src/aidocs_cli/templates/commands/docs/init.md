---
description: 'Initialize documentation settings for your project. Analyzes codebase, asks preferences, creates docs/config.yml. Run this first! Usage: /docs:init'
---
