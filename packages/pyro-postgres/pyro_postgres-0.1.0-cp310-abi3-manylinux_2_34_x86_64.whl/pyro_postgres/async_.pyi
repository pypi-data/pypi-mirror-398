...
from pyro_postgres import IsolationLevel, Opts, Params, PyroFuture
...
class Conn:
    ...
    def exec(
        ...
        """
        Execute a query using extended protocol and return all rows.
    ...
    def exec_first(
        ...
        """
        Execute a query using extended protocol and return the first row.
