...
def __get_compound__(all_cids: list[int | str], ignore_error: bool = False) -> dict[str, ALNPCompound]: ...
...
def get_compound_conformer_ids(all_cids: list[int | str], ignore_error: bool = False) -> dict[str, list[str]]: ...
