...
- **LLMReasoner**: New reasoning engine using Claude/GPT for complex decision-making
...
- **SDK-First Architecture**: Full optimizer integration with cycle tracking and effectiveness metrics
