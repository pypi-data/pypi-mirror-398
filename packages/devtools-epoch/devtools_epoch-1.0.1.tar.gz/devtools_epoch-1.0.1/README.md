...
Use this tool online at **[DevTools.at](https://devtools.at/tools/epoch-converter)** - Free, fast, and no registration required!

## Installation

```bash
pip install devtools_epoch
```

## Usage

```python
from devtools_epoch import process, encode, decode
...
**[https://devtools.at/tools/epoch-converter](https://devtools.at/tools/epoch-converter)**
