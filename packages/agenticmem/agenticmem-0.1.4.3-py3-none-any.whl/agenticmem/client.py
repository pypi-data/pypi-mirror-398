    ...
    def rerun_profile_generation(
        ...
        *,
        ...
        if wait_for_response:
            ...
            self._fire_and_forget(
                self._rerun_profile_generation_sync,
                self._rerun_profile_generation_async,
                req,
            )
            return None
    ...
    def rerun_feedback_generation(
        ...
        *,
        ...
        if wait_for_response:
            ...
            self._fire_and_forget(
                self._rerun_feedback_generation_sync,
                self._rerun_feedback_generation_async,
                req,
            )
            return None
    ...
    def run_feedback_aggregation(
        ...
        *,
        ...
        if wait_for_response:
            ...
            self._fire_and_forget(
                self._run_feedback_aggregation_sync,
                self._run_feedback_aggregation_async,
                req,
            )
            return None
