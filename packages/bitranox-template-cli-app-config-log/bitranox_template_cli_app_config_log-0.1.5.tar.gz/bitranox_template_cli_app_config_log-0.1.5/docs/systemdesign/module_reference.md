...
* src/check_zpool_status/behaviors.py
* src/check_zpool_status/cli.py
* src/check_zpool_status/__main__.py
* src/check_zpool_status/__init__.py
* src/check_zpool_status/__init__conf__.py
* tests/test_cli.py
...
* **Location:** src/check_zpool_status/behaviors.py
...
* **Location:** src/check_zpool_status/cli.py
...
* **Location:** src/check_zpool_status/__main__.py
...
* **Location:** src/check_zpool_status/__init__conf__.py
...
1. ``check_zpool_status`` → prints CLI help (no default action).
2. ``check_zpool_status hello`` → prints greeting.
3. ``check_zpool_status fail`` → prints truncated traceback.
4. ``check_zpool_status --traceback fail`` → prints full rich traceback.
5. ``python -m check_zpool_status --traceback fail`` → matches console output.
