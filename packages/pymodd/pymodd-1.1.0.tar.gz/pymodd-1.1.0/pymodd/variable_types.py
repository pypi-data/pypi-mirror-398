    ...
    def get_template_data(self):
        return {
            ...
            "controls": {
                ...
                "abilities": {
                    "movementWheel": {"mobilePosition": {"y": 204, "x": 35}},
                    "lookWheel": {"mobilePosition": {"y": 204, "x": 407}},
                    "e": {
                        "keyUp": {"scriptName": "", "cost": {}},
                        "keyDown": {
            ...
            "body": {
                ...
                "z-index": {"layer": 3, "depth": 3},
                "name": "Human-body",
            },
            "spawnPosition": {"y": 2200, "x": 1500},
            "attributes": {
                "speed": {
                    "decimalPlaces": 0,
                    "dataType": "",
            ...
            "abilities": {
                "movementWheel": {"mobilePosition": {"y": 204, "x": 35}},
                "lookWheel": {"mobilePosition": {"y": 204, "x": 407}},
                "w": {"keyUp": "stopMovingUp", "keyDown": "moveUp"},
                "a": {"keyUp": "stopMovingLeft", "keyDown": "moveLeft"},
                "s": {"keyUp": "stopMovingDown", "keyDown": "moveDown"},
                "d": {"keyUp": "stopMovingRight", "keyDown": "moveRight"},
                "button1": {
                    "keyUp": "stopUsingItem",
                    "keyDown": "startUsingItem",
                    "mobilePosition": {"x": 326, "y": 132},
                },
                "up": {"keyUp": "stopMovingUp", "keyDown": "moveUp"},
                "down": {"keyUp": "stopMovingDown", "keyDown": "moveDown"},
                "left": {"keyUp": "stopMovingLeft", "keyDown": "moveLeft"},
                "right": {"keyUp": "stopMovingRight", "keyDown": "moveRight"},
                "e": {
                    "keyUp": "",
                    "keyDown": "pickUp",
                    "mobilePosition": {"x": 366, "y": 85},
                },
                "f": {"keyUp": "", "keyDown": "pickUp"},
                "g": {
                    "keyUp": "",
                    "keyDown": "drop",
                    "mobilePosition": {"x": 365, "y": 33},
                },
                "b": {
                    "keyUp": "",
                    "keyDown": "shop",
                    "mobilePosition": {"x": 419, "y": 32},
                },
            },
            "baseSpeed": 53,
            "price": {},
            ...
            "bodies": {
                "default": {
                    ...
                    "jointType": "weldJoint",
                    "unitAnchor": {"x": 0, "y": 33, "rotation": 0},
                    "itemAnchor": {"x": 0, "y": 0, "lowerAngle": 0, "upperAngle": 0},
                }
            },
            "variables": {},
            "effects": {
                                    ...
                                    "then": [
                                        {
                                            ...
                                            "item": {"function": "getSelectedEntity"},
                                        }
                                    ],
                                    "else": [],
                                }
...
class ItemTypeBase(VariableType):
    ...
    def get_template_data(self):
        return {
            "delayBeforeUse": 0,
            "bulletStartPosition": {"rotation": 0, "y": 0, "x": 0},
            "frames": {},
            "name": "New Item Type",
            "handle": "",
            "attributes": {},
            ...
            "destroyTimer": 30000,
            "particles": {},
            "damage": {"unitAttributes": {"health": 10}},
            "sound": {},
            "canBeUsedBy": [],
            "isUsedOnPickup": False,
            "removeWhenEmpty": False,
            "bonus": {
                "consume": {"playerAttribute": {}, "unitAttribute": {}},
                "passive": {"playerAttribute": {}, "unitAttribute": {}},
            },
            "cost": {"quantity": 0},
            "buffTypes": [],
            "carriedBy": [],
            ...
            "damageHitBox": {"width": 60, "height": 30, "offsetX": 0, "offsetY": 50},
            "damageDelay": 0,
...
class MusicBase(VariableType):
    ...
    def get_template_data(self):
        return {"file": "", "name": "New Song", "volume": 25}
...
class SoundBase(VariableType):
    ...
    def get_template_data(self):
        return {"name": "New Sound", "file": "", "volume": 100}
...
class ParticleTypeBase(VariableType):
    ...
    def get_template_data(self):
        return {
            "name": "test",
            "url": "https://cache.modd.io/asset/spriteImage/1702686897115_pymodd-logo.png",
            "z-index": {"layer": 3, "depth": 5},
            "lifeBase": 1000,
            "deathOpacityBase": 1,
...
class AbilityBase(VariableType):
    ...
    def get_template_data(self):
        return {
            "name": "New Ability",
            "eventScripts": {"startCasting": None, "stopCasting": None},
            "castDuration": None,
            "cooldown": None,
