        ...
        if shuffle_type == 'batch' or shuffle_type == 'class':
            if is_bad_class:
                ...
                if len(index_list_bad) < int(len(selected_index_list) * shuffle_mix_up_ratio):
                    ...
                    mix_up_list_added =random.sample(index_list_bad, int(len(selected_index_list) * shuffle_mix_up_ratio))
                new_selected_index_list = selected_index_list[:max_number_per_sample - int(len(selected_index_list) * shuffle_mix_up_ratio)]
            else:
            ...
            if is_bad_class and shuffle_mix_up_ratio > 0:
                ...
                new_selected_index_list = selected_index_list[:max_number_per_sample - int(len(index_list_bad) * shuffle_mix_up_ratio)]
            else:
                new_selected_index_list = selected_index_list
                mix_up_list_added = []
    else:
