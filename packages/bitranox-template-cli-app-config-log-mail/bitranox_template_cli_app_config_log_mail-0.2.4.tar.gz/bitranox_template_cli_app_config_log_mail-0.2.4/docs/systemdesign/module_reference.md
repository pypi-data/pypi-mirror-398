...
* src/bitranox_template_cli_app_config_log_mail/behaviors.py
* src/bitranox_template_cli_app_config_log_mail/cli.py
...
* **Location:** src/bitranox_template_cli_app_config_log_mail/behaviors.py
...
* **Location:** src/bitranox_template_cli_app_config_log_mail/cli.py
...
1. ``bitranox_template_cli_app_config_log_mail`` → prints CLI help (no default action).
2. ``bitranox_template_cli_app_config_log_mail hello`` → prints greeting.
3. ``bitranox_template_cli_app_config_log_mail fail`` → prints truncated traceback.
4. ``bitranox_template_cli_app_config_log_mail --traceback fail`` → prints full rich traceback.
