...
"""
    ...
    def search(
        ...
        # Run target and decoy searches sequentially
        print("Running target search...")
        run_search.run_specollate_par(rank=0, world_size=1, gConfig=config_file, forced_rank=0)
        print("Running decoy search...")
        run_search.run_specollate_par(rank=1, world_size=1, gConfig=config_file, forced_rank=1)
