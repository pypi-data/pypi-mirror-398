...
def run_atles(rank, spec_loader, gpu_device=None):
...
def run_specollate_par(rank, world_size, gConfig, forced_rank=None):
    ...
    lens, cleavs, mods = run_atles(rank, spec_loader, gpu_device)
