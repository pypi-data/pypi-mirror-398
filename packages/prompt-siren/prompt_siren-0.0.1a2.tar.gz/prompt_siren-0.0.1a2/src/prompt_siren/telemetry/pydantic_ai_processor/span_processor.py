...
from .semantic_conventions import get_attributes
from .utils import should_export_span, SpanFilter
...
class OpenInferenceSpanProcessor(SpanProcessor):
    ...
    Example:
        ...
        from openinference.instrumentation.pydantic_ai.utils import (
    ...
    def __init__(self, span_filter: SpanFilter | None = None):
    ...
    def on_end(self, span: ReadableSpan) -> None:
        ...
        try:
            ...
            logfire.warning(f"Error processing span in OpenInferenceSpanProcessor: {e}")
