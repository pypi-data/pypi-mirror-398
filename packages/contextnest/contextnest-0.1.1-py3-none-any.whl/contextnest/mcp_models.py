...
class InsertKnowledgeInput(BaseModel):
    ...
    title: Optional[str] = Field(None, description="The title of the content. If not provided, it will be extracted from the URL.")
    content: Optional[str] = Field(None, description="The actual text content to insert. If not provided, the URL will be scraped.")
