...
class TestContextNestClient:
    ...
    async def test_web_scrape_method(self, mock_client):
        ...
        result = await client.web_scrape(url="https://example.com")
        
        mock_client.call_tool.assert_called_once_with("web_scrape", arguments={"url": "https://example.com"})
        assert result == "Scrape result"

    async def test_web_scrape_method_with_save_path(self, mock_client):
        """Test the web_scrape method with save_path."""
        client = ContextNestClient()
        client.client = mock_client
        ...
        result = await client.web_scrape(url="https://example.com", save_path="/path/to/save")
        
        mock_client.call_tool.assert_called_once_with("web_scrape", arguments={"url": "https://example.com", "save_path": "/path/to/save"})
        assert result == "Scrape result"
    ...
    async def test_insert_knowledge_method(self, mock_client):
        ...
        result = await client.insert_knowledge(url="https://example.com")
        
        mock_client.call_tool.assert_called_once_with("insert_knowledge", arguments={"url": "https://example.com"})
        assert result == "Insert result"

    async def test_insert_knowledge_method_with_all_params(self, mock_client):
        """Test the insert_knowledge method with all parameters."""
        client = ContextNestClient()
        client.client = mock_client
        ...
        result = await client.insert_knowledge(url="https://example.com", title="Test", content="Test content")
