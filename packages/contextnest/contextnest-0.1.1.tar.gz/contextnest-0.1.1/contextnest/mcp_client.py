...
class ContextNestClient:
    ...
    async def web_scrape(self, url: str, save_path: Optional[str] = None) -> str:
        """
        Scrape a URL and convert it to markdown.
        
        Args:
            url: The URL to scrape.
            save_path: Optional path to save the markdown locally.
    ...
    async def search(self, query: str, limit: int = 5, k: int = 60, vector_weight: float = 1.0, fts_weight: float = 1.0) -> str:
        """
        ...
        Args:
            ...
            fts_weight: Weight for full-text search results (default: 1.0).
    ...
    async def insert_knowledge(self, url: str, title: Optional[str] = None, content: Optional[str] = None) -> str:
        """
        Insert a document into the knowledge base.
        
        Args:
            url: The source URL of the content.
            title: Optional title of the content. If not provided, it will be extracted.
            content: Optional text content to insert. If not provided, the URL will be scraped.
