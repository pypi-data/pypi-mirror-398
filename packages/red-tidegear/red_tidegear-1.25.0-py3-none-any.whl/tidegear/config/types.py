...
Jsonable = typing_extensions.TypeAliasType(
    ...
    | datetime.time | datetime.timedelta | types.NoneType | enum.Enum | typing.Sequence[Jsonable] | typing.Mapping[str, Jsonable] \
    | pydantic.BaseModel | pydantic.AnyUrl | pydantic.networks.IPvAnyAddress | pydantic.networks.IPvAnyInterface | pydantic.networks.IPvAnyNetwork",
)
"""
