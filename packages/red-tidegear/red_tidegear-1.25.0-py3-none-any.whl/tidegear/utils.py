...
def call_with_kwargs(func: typing.Callable[..., _T], /, *args: typing.Any, **kwargs: typing.Any) -> _T:
...
async def send_error(
    messageable: discord.abc.Messageable | discord.Message, /, *, func: Callable[[str], str] = ..., edit_original: bool = ..., **kwargs: Any
) -> discord.Message: ...
@overload
async def send_error(
...
@overload
async def send_error(
    messageable: discord.Interaction, /, *, func: Callable[[str], str] = ..., edit_original: typing.Literal[False] = ..., **kwargs: Any
...
async def send_error(
    ...
    **kwargs: Any,
    ...
    kwargs.setdefault("ephemeral", True)  # error messages should usually be ephemeral if possible, so default to them being ephemeral.
