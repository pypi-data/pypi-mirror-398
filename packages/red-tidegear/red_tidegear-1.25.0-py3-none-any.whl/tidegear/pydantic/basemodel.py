...
from typing import TYPE_CHECKING, Any, Callable, Literal, Self, TypeVar, overload
...
class BaseModel(pydantic.BaseModel):
    ...
    @deprecated(
        (
            "This method is deprecated, and will be removed in Tidegear 1.25.0. "
            "Consider using [`BaseModel.model_dump`](https://docs.pydantic.dev/latest/api/base_model/#pydantic.BaseModel.model_dump) "
            "or [`BaseModel.model_dump_json`](https://docs.pydantic.dev/latest/api/base_model/#pydantic.BaseModel.model_dump_json) instead."
        ),
    ...
    def json(  # pyright: ignore[reportIncompatibleMethodOverride]
        ...
        *,
        ...
        Warning: Deprecation
            ...
            Consider using [`BaseModel.model_dump(mode="json")`][pydantic.BaseModel.model_dump]
            or [`BaseModel.model_dump_json()`][pydantic.BaseModel.model_dump_json] instead.
