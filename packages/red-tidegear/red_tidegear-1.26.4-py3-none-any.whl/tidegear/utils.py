...
from typing import TYPE_CHECKING, Any, Callable, Coroutine, Generator, Literal, TypeVar, overload
...
DashboardPageFunction = TypeVar(name="DashboardPageFunction", bound=Callable[..., Coroutine[Any, Any, dict[str, Any]]])
