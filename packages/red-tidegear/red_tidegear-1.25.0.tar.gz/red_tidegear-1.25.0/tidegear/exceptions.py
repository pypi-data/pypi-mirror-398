...
class TidegearError(Exception):
    ...
    @overload
    async def send(
        self, messageable: discord.abc.Messageable | discord.Message, /, func: Callable[[str], str] = ..., edit_original: bool = ..., **kwargs: Any
    ) -> discord.Message: ...
    @overload
    async def send(
    ...
    async def send(
        ...
        **kwargs: Any,
        ...
        return await send_error(messageable, func=func, edit_original=edit_original, content=self.message, **self.send_error_kwargs | kwargs)
