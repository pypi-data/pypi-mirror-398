...
class PlanEvaluationStatusPassedWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_arc_region_switch/waiters/#planevaluationstatuspassedwaiter)
    """
...
class PlanExecutionCompletedWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_arc_region_switch/waiters/#planexecutioncompletedwaiter)
    """
    def wait(  # type: ignore[override]
