    ...
    def fetch_latest_cves(self, hours=24, severity_filter="HIGH,CRITICAL"):
        ...
        try:
            ...
            try:
                ...
                logger.error(f"❌ Error querying NVD API: {e!s}")
            ...
            if not all_cves:
                ...
                try:
                    ...
                    logger.warning(f"⚠️ Broader search also failed: {broader_e!s}")
            ...
            logger.error(f"💥 Error fetching CVEs: {e!s}")
            return {
                "success": False,
                "error": str(e),
                "cves": [],
    ...
    def analyze_cve_exploitability(self, cve_id):
        ...
        try:
            ...
            try:
                ...
                logger.error(f"❌ Network error analyzing {cve_id}: {e!s}")
                return {
                    "success": False,
            ...
            logger.error(f"💥 Error analyzing CVE {cve_id}: {e!s}")
            return {
                "success": False,
                "error": str(e),
                "cve_id": cve_id,
    ...
    def search_existing_exploits(self, cve_id):
        ...
        try:
            ...
            try:
                ...
                logger.error(f"❌ GitHub search error: {e!s}")
            ...
            try:
                ...
                logger.error(f"❌ Exploit database search error: {e!s}")
            ...
            try:
                ...
                logger.error(f"❌ Metasploit search error: {e!s}")
            ...
            logger.error(f"💥 Error searching exploits for {cve_id}: {e!s}")
            return {
                "success": False,
                "error": str(e),
                "cve_id": cve_id,
