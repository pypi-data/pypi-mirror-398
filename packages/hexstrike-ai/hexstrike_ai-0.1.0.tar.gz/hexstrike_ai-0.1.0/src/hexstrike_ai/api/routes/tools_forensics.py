...
def volatility3():
    ...
    try:
        ...
        logger.error(f"💥 Error in volatility3 endpoint: {e!s}")
        return jsonify({
...
def foremost():
    ...
    try:
        ...
        result = execute_command(command)
        logger.info("📊 Foremost file carving completed")
        return jsonify(result)
    except Exception as e:
        logger.error(f"💥 Error in foremost endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def steghide():
    ...
    try:
        ...
        logger.error(f"💥 Error in steghide endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def exiftool():
    ...
    try:
        ...
        logger.error(f"💥 Error in exiftool endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def hashpump():
    ...
    try:
        ...
        logger.error(f"💥 Error in hashpump endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
