...
def dirb():
    ...
    try:
        ...
        logger.error(f"💥 Error in dirb endpoint: {e!s}")
        return jsonify({
...
def nikto():
    ...
    try:
        ...
        logger.error(f"💥 Error in nikto endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def sqlmap():
    ...
    try:
        ...
        logger.error(f"💥 Error in sqlmap endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def wpscan():
    ...
    try:
        ...
        logger.error(f"💥 Error in wpscan endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def ffuf():
    ...
    try:
        ...
        logger.error(f"💥 Error in ffuf endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def dalfox():
    ...
    try:
        ...
        logger.error(f"💥 Error in dalfox endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def xsser():
    ...
    try:
        ...
        logger.error(f"💥 Error in xsser endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def jaeles():
    ...
    try:
        ...
        logger.error(f"💥 Error in jaeles endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def zap():
    ...
    try:
        ...
        logger.error(f"💥 Error in zap endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
