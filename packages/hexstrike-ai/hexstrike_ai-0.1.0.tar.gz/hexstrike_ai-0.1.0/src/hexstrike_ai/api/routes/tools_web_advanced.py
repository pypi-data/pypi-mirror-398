...
def gobuster():
    ...
    try:
        ...
        logger.error(f"💥 Error in gobuster endpoint: {e!s}")
        return jsonify({
...
def nuclei():
    ...
    try:
        ...
        logger.error(f"💥 Error in nuclei endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def feroxbuster():
    ...
    try:
        ...
        logger.error(f"💥 Error in feroxbuster endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def dirsearch():
    ...
    try:
        ...
        logger.error(f"💥 Error in dirsearch endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def httpx():
    ...
    try:
        ...
        logger.error(f"💥 Error in httpx endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def katana():
    ...
    try:
        ...
        logger.error(f"💥 Error in katana endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def gau():
    ...
    try:
        ...
        logger.error(f"💥 Error in gau endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def waybackurls():
    ...
    try:
        ...
        logger.error(f"💥 Error in waybackurls endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def hakrawler():
    ...
    try:
        ...
        logger.error(f"💥 Error in hakrawler endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def dnsenum():
    ...
    try:
        ...
        logger.error(f"💥 Error in dnsenum endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def fierce():
    ...
    try:
        ...
        logger.error(f"💥 Error in fierce endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def wafw00f():
    ...
    try:
        ...
        logger.error(f"💥 Error in wafw00f endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
