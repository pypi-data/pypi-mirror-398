...
def volatility():
    ...
    try:
        ...
        logger.error(f"💥 Error in volatility endpoint: {e!s}")
        return jsonify({
...
def gdb():
    ...
    try:
        ...
        logger.error(f"💥 Error in gdb endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def radare2():
    ...
    try:
        ...
        logger.error(f"💥 Error in radare2 endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def binwalk():
    ...
    try:
        ...
        logger.error(f"💥 Error in binwalk endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def ropgadget():
    ...
    try:
        ...
        logger.error(f"💥 Error in ropgadget endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def checksec():
    ...
    try:
        ...
        logger.error(f"💥 Error in checksec endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def xxd():
    ...
    try:
        ...
        logger.error(f"💥 Error in xxd endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def strings():
    ...
    try:
        ...
        logger.error(f"💥 Error in strings endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def objdump():
    ...
    try:
        ...
        logger.error(f"💥 Error in objdump endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def ghidra():
    ...
    try:
        ...
        logger.error(f"💥 Error in ghidra endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def pwntools():
    ...
    try:
        ...
        result = execute_command(command)
        logger.info("📊 Pwntools script completed")
        return jsonify(result)
    except Exception as e:
        logger.error(f"💥 Error in pwntools endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def one_gadget():
    ...
    try:
        ...
        logger.error(f"💥 Error in one-gadget endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def libc_database():
    ...
    try:
        ...
        result = execute_command(command)
        logger.info("📊 Libc-database search completed")
        return jsonify(result)
    except Exception as e:
        logger.error(f"💥 Error in libc-database endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def gdb_peda():
    ...
    try:
        ...
        logger.error(f"💥 Error in gdb-peda endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def angr():
    ...
    try:
        ...
        logger.error(f"💥 Error in angr endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def ropper():
    ...
    try:
        ...
        logger.error(f"💥 Error in ropper endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def pwninit():
    ...
    try:
        ...
        logger.info("🔧 Starting pwninit setup")
        result = execute_command(command)
        logger.info("📊 Pwninit setup completed")
        return jsonify(result)
    except Exception as e:
        logger.error(f"💥 Error in pwninit endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
