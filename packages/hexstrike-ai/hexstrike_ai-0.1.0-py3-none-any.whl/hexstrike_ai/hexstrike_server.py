...
error_handling_routes.init_app(
    error_handler, degradation_manager, execute_command_with_recovery
)
processes_routes.init_app(ProcessManager)
bugbounty_routes.init_app(
    bugbounty_manager, None, BugBountyTarget
)  # fileupload_framework=None (not implemented)
ctf_routes.init_app(ctf_manager, ctf_tools, ctf_automator, ctf_coordinator)
vuln_intel_routes.init_app(
