...
def get_error_statistics():
    ...
    try:
        ...
        logger.error(f"Error getting error statistics: {e!s}")
...
def test_error_recovery():
    ...
    try:
        ...
        logger.error(f"Error testing recovery system: {e!s}")
        return jsonify({"error": f"Server error: {e!s}"}), 500
...
def get_fallback_chains():
    ...
    try:
        ...
        logger.error(f"Error getting fallback chains: {e!s}")
        return jsonify({"error": f"Server error: {e!s}"}), 500
...
def execute_with_recovery_endpoint():
    ...
    try:
        ...
        logger.error(f"Error executing command with recovery: {e!s}")
        return jsonify({"error": f"Server error: {e!s}"}), 500
...
def classify_error_endpoint():
    ...
    try:
        ...
        logger.error(f"Error classifying error: {e!s}")
        return jsonify({"error": f"Server error: {e!s}"}), 500
...
def get_parameter_adjustments():
    ...
    try:
        ...
        logger.error(f"Error getting parameter adjustments: {e!s}")
        return jsonify({"error": f"Server error: {e!s}"}), 500
...
def get_alternative_tools():
    ...
    try:
        ...
        logger.error(f"Error getting alternative tools: {e!s}")
        return jsonify({"error": f"Server error: {e!s}"}), 500
