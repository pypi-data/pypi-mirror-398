...
def ai_generate_payload():
    ...
    try:
        ...
        logger.error(f"💥 Error in AI payload generation: {e!s}")
        return jsonify({
            "success": False,
...
def ai_test_payload():
    ...
    try:
        ...
        logger.error(f"💥 Error in AI payload testing: {e!s}")
        return jsonify({
            "success": False,
            "error": f"Server error: {e!s}",
        }), 500
...
def advanced_payload_generation():
    ...
    try:
        ...
        logger.error(f"💥 Error in advanced payload generation: {e!s}")
        return jsonify({
            "success": False,
            "error": f"Server error: {e!s}",
        }), 500
