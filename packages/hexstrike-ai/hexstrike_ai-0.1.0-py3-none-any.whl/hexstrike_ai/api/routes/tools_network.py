...
def nmap():
    ...
    try:
        ...
        logger.error(f"💥 Error in nmap endpoint: {e!s}")
        return jsonify({
...
def rustscan():
    ...
    try:
        ...
        logger.error(f"💥 Error in rustscan endpoint: {e!s}")
...
def masscan():
    ...
    try:
        ...
        logger.error(f"💥 Error in masscan endpoint: {e!s}")
        return jsonify({"error": f"Server error: {e!s}"}), 500
...
def nmap_advanced():
    ...
    try:
        ...
        logger.error(f"💥 Error in advanced nmap endpoint: {e!s}")
        return jsonify({"error": f"Server error: {e!s}"}), 500
...
def autorecon():
    ...
    try:
        ...
        logger.error(f"💥 Error in autorecon endpoint: {e!s}")
        return jsonify({"error": f"Server error: {e!s}"}), 500
...
def enum4linux():
    ...
    try:
        ...
        logger.error(f"💥 Error in enum4linux endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def enum4linux_ng():
    ...
    try:
        ...
        logger.error(f"💥 Error in enum4linux-ng endpoint: {e!s}")
        return jsonify({"error": f"Server error: {e!s}"}), 500
...
def rpcclient():
    ...
    try:
        ...
        logger.error(f"💥 Error in rpcclient endpoint: {e!s}")
        return jsonify({"error": f"Server error: {e!s}"}), 500
...
def nbtscan():
    ...
    try:
        ...
        logger.error(f"💥 Error in nbtscan endpoint: {e!s}")
        return jsonify({"error": f"Server error: {e!s}"}), 500
...
def arp_scan():
    ...
    try:
        ...
        logger.error(f"💥 Error in arp-scan endpoint: {e!s}")
        return jsonify({"error": f"Server error: {e!s}"}), 500
...
def responder():
    ...
    try:
        ...
        logger.error(f"💥 Error in responder endpoint: {e!s}")
        return jsonify({"error": f"Server error: {e!s}"}), 500
...
def netexec():
    ...
    try:
        ...
        logger.error(f"💥 Error in netexec endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def amass():
    ...
    try:
        ...
        logger.error(f"💥 Error in amass endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def subfinder():
    ...
    try:
        ...
        logger.error(f"💥 Error in subfinder endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def smbmap():
    ...
    try:
        ...
        logger.error(f"💥 Error in smbmap endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
