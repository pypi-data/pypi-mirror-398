...
def prowler():
    ...
    try:
        ...
        logger.error(f"💥 Error in prowler endpoint: {e!s}")
        return jsonify({
...
def trivy():
    ...
    try:
        ...
        logger.error(f"💥 Error in trivy endpoint: {e!s}")
        return jsonify({
            "error": f"Server error: {e!s}",
        }), 500
...
def scout_suite():
    ...
    try:
        ...
        logger.error(f"💥 Error in scout-suite endpoint: {e!s}")
...
def cloudmapper():
    ...
    try:
        ...
        logger.error(f"💥 Error in cloudmapper endpoint: {e!s}")
        return jsonify({"error": f"Server error: {e!s}"}), 500
...
def pacu():
    ...
    try:
        ...
        logger.error(f"💥 Error in pacu endpoint: {e!s}")
        return jsonify({"error": f"Server error: {e!s}"}), 500
...
def kube_hunter():
    ...
    try:
        ...
        logger.error(f"💥 Error in kube-hunter endpoint: {e!s}")
        return jsonify({"error": f"Server error: {e!s}"}), 500
...
def kube_bench():
    ...
    try:
        ...
        logger.error(f"💥 Error in kube-bench endpoint: {e!s}")
        return jsonify({"error": f"Server error: {e!s}"}), 500
...
def docker_bench_security():
    ...
    try:
        ...
        logger.error(f"💥 Error in docker-bench-security endpoint: {e!s}")
        return jsonify({"error": f"Server error: {e!s}"}), 500
...
def clair():
    ...
    try:
        ...
        logger.error(f"💥 Error in clair endpoint: {e!s}")
        return jsonify({"error": f"Server error: {e!s}"}), 500
...
def falco():
    ...
    try:
        ...
        logger.error(f"💥 Error in falco endpoint: {e!s}")
        return jsonify({"error": f"Server error: {e!s}"}), 500
...
def checkov():
    ...
    try:
        ...
        logger.error(f"💥 Error in checkov endpoint: {e!s}")
        return jsonify({"error": f"Server error: {e!s}"}), 500
...
def terrascan():
    ...
    try:
        ...
        logger.error(f"💥 Error in terrascan endpoint: {e!s}")
        return jsonify({"error": f"Server error: {e!s}"}), 500
