...
function logic [3:0] get_slave_sel_o (input logic [31:0] addr);
    unique case ($unsigned(addr)) inside
        [32'h00000000 : 32'h01ffffff]       : get_slave_sel_o = WB_SLAVE_SDRAM;
        [32'h02000000 : 32'h02ffffff],
        [32'h06000000 : 32'h060010ff]       : get_slave_sel_o = WB_SLAVE_FLASH;
        [32'h03000000 : 32'h0341dfff]       : get_slave_sel_o = WB_SLAVE_BRAM;
        [32'h05000000 : 32'h05000073]       : get_slave_sel_o = WB_SLAVE_PERIPHERALS;
...
function logic is_legal_access_sdram(input logic[31:0] addr, access_mode_t access);
    case (access)
        READ_LEGAL:  is_legal_access_sdram = ($unsigned(addr) inside {
                [32'h00000000 : 32'h01ffffff]});
        WRITE_LEGAL: is_legal_access_sdram = ($unsigned(addr) inside {
                [32'h00000000 : 32'h01ffffff]});
...
function logic is_legal_access_flash(input logic[31:0] addr, access_mode_t access);
    case (access)
        READ_LEGAL:  is_legal_access_flash = ($unsigned(addr) inside {
                [32'h02000000 : 32'h02ffffff],
                [32'h06000004 : 32'h06000013],
                [32'h06001000 : 32'h060010ff]});
        WRITE_LEGAL: is_legal_access_flash = ($unsigned(addr) inside {
                [32'h06000000 : 32'h0600000f],
                [32'h06001000 : 32'h060010ff]});
...
function logic is_legal_access_bram(input logic[31:0] addr, access_mode_t access);
    case (access)
        READ_LEGAL:  is_legal_access_bram = ($unsigned(addr) inside {
                [32'h03000000 : 32'h0341dfff]});
        WRITE_LEGAL: is_legal_access_bram = ($unsigned(addr) inside {
                [32'h03000000 : 32'h0341dfff]});
...
function logic is_legal_access_peripherals(input logic[31:0] addr, access_mode_t access);
    case (access)
        READ_LEGAL:  is_legal_access_peripherals = ($unsigned(addr) inside {
                [32'h05000000 : 32'h0500000b],
                [32'h05000010 : 32'h0500001b],
                [32'h05000020 : 32'h0500002b],
                [32'h05000040 : 32'h05000047],
                [32'h05000070 : 32'h05000073]});
        WRITE_LEGAL: is_legal_access_peripherals = ($unsigned(addr) inside {
                [32'h0500000c : 32'h0500000f],
                [32'h0500001c : 32'h0500001f],
                [32'h0500002c : 32'h0500002f],
                [32'h05000040 : 32'h05000043],
                [32'h0500004c : 32'h0500004f],
                [32'h05000060 : 32'h05000063]});
...
function logic is_addr_in_sdram (input logic [31:0] addr);
    is_addr_in_sdram = ($unsigned(addr) inside { [32'h00000000 : 32'h01ffffff] });
endfunction

// is addr in range SDRAM of the SDRAM bus slave?
function logic is_addr_in_sdram_range (input logic [31:0] addr);
    is_addr_in_sdram_range = ($unsigned(addr) inside { [32'h00000000 : 32'h01ffffff] });
endfunction
...
function logic is_addr_in_peripherals (input logic [31:0] addr);
    is_addr_in_peripherals = ($unsigned(addr) inside { [32'h05000000 : 32'h05000073] });
endfunction
...
function logic is_addr_in_peripherals_range (input logic [31:0] addr);
    is_addr_in_peripherals_range = ($unsigned(addr) inside { [32'h05000000 : 32'h05000073] });
endfunction
