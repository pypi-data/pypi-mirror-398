...
Use this tool online at **[DevTools.at](https://devtools.at/tools/html-to-markdown)** - Free, fast, and no registration required!

## Installation

```bash
pip install devtools_html_to_md
```

## Usage

```python
from devtools_html_to_md import process, encode, decode
...
**[https://devtools.at/tools/html-to-markdown](https://devtools.at/tools/html-to-markdown)**
