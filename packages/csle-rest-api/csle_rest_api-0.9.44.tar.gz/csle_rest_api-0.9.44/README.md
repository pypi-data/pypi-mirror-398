...
| `/emulation-executions/<execution_id>/five-g-core-monitor?token=<valid_token>&emulation=<emulation>`  | Start/stop 5G core monitors of an emulation execution          | `POST`                                  |
...
| `/emulation-executions/<execution_id>/five-g-cu-monitor?token=<valid_token>&emulation=<emulation>`    | Start/stop 5G CU monitors of an emulation execution            | `POST`                                  |
...
| `/emulation-executions/<execution_id>/five-g-du-monitor?token=<valid_token>&emulation=<emulation>`    | Start/stop 5G DU monitors of an emulation execution            | `POST`                                  |
