...
# 产品类型映射
PRODUCT_CTP2VT: dict[str, Asset] = {
    THOST_FTDC_PC_Futures: Asset.FUTURES,
    THOST_FTDC_PC_Options: Asset.OPTION,
    THOST_FTDC_PC_SpotOption: Asset.OPTION,
    THOST_FTDC_PC_Combination: Asset.SPREAD,
}
...
class CtpTdApi(TdApi):
    ...
    def onRspQryInstrument(
        ...
        'product': <Asset.FUTURES: '期货'>, 'size': 10, 'pricetick': 5.0, 'productID': None, 'max_volume': 500, 'min_volume': 1,
        'stop_supported': False, 'net_position': False, 'history_data': False, 'option_strike': 0, 'option_underlying': '',
        'option_type': None, 'option_listed': None, 'option_expiry': None, 'option_portfolio': '', 'option_index': '', 'en_symbol': 'nr2604.INE'}
        ------------------------------------------------------------
        ...
        """
        product: Asset = PRODUCT_CTP2VT.get(data["ProductClass"], None)
        if product:
            contract: ContractData = ContractData(
                symbol=data["InstrumentID"],
                exchange=EXCHANGE_CTP2VT[data["ExchangeID"]],
                name=data["InstrumentName"],
                asset=Asset.FUTURES if product == Asset.FUTURES else Asset.OPTION,
    ...
    def send_order(self, req: OrderRequest) -> str:
        ...
        return order.en_orderid  # type: ignore
