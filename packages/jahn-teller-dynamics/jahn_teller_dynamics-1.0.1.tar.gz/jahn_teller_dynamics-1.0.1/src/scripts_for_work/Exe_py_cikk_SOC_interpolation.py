...
from maths_utils import exp_func, fit_function
...
#df = pd.read_csv(folder + 'N3V_SOC_PBE_full.csv')
df = pd.read_csv(folder + 'N3V_SOC_HSE.csv')
...
plt.title('HSE Spin-orbit coupling in the ' + r'$\Gamma$ point')
