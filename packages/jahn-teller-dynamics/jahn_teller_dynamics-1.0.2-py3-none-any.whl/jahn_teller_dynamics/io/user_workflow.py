...
def calc_and_save_magnetic_interaction(B_fields, JT_int:qmp.Exe_tree, JT_cfg_parser:cfg_parser.old_Jahn_Teller_config_parser, complex_trf = True):
...
def create_JT_int(JT_config_parser: cfg_parser.old_Jahn_Teller_config_parser , section_to_look_for = '',complex_trf=True ):
...
def spin_orbit_JT_procedure_general( JT_config_parser: cfg_parser.old_Jahn_Teller_config_parser , section_to_look_for = '',save_raw_pars = False,complex_trf=True ):
...
def spin_orbit_JT_procedure(config_file_name:str, save_raw_pars = False, section_to_look_for = ''):
    ...
    JT_cfg_parser = cfg_parser.old_Jahn_Teller_config_parser(config_file_name)
...
def model_ZPL_procedure(JT_config_parser: cfg_parser.old_Jahn_Teller_config_parser):
    pass
...
def ZPL_procedure(JT_config_parser:cfg_parser.old_Jahn_Teller_config_parser):
