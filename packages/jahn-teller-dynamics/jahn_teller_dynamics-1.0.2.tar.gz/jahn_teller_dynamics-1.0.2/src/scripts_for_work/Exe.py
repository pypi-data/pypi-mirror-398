...
import jahn_teller_dynamics.io.JT_config_file_parsing as  old_JT_cfg
...
def main():
    ...
    try:
        JT_config_parser = old_JT_cfg.old_Jahn_Teller_config_parser(config_file_name)
        ...
        if JT_config_parser.is_ZPL_calculation():
            ...
            section_to_look_for = old_JT_cfg.single_case_section
