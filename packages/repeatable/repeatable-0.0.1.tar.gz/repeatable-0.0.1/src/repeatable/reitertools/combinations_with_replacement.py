...
def combinations_with_replacement(iterable, r):
    '''
    Non-greedy version of `itertools.combinations_with_replacement` that
    handles an arbitrarily large, repeatable iterable without writing it to
    memory.
    ...
    try:
        # create a pool of iterators and try to yield the first output
    ...
    while ptr >= 0:
        try:
            ...
            # fast forward all subsequent iterators up to their previous,
