...
[![omnipkg](https://img.shields.io/badge/omnipkg-2429%20Wins-brightgreen?logo=python&logoColor=white)](https://github.com/1minds3t/omnipkg/actions/workflows/omnipkg_vs_the_world.yml) [![pip](https://img.shields.io/badge/pip-2432%20Failures-red?logo=pypi&logoColor=white)](https://github.com/1minds3t/omnipkg/actions/workflows/omnipkg_vs_the_world.yml) [![uv](https://img.shields.io/badge/uv-2432%20Failures-red?logo=python&logoColor=white)](https://github.com/1minds3t/omnipkg/actions/workflows/omnipkg_vs_the_world.yml)
...
**Latest Version:** `2.0.4` | **Python:**  | [View on piwheels](https://www.piwheels.org/project/omnipkg/)

```bash
# Install on Raspberry Pi (ARM32)
pip3 install omnipkg==2.0.4
```

**Verified Platforms:**
- 🍓 Raspberry Pi (armv6/armv7) - Bullseye (Debian 11), Bookworm (Debian 12), Trixie (Debian 13)
- 📦 Wheel: [`https://www.piwheels.org/simple/omnipkg/omnipkg-2.0.4-py3-none-any.whl`](https://www.piwheels.org/simple/omnipkg/omnipkg-2.0.4-py3-none-any.whl)
