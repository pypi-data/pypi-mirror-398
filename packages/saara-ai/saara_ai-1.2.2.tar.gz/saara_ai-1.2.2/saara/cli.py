...
from saara.splash import display_splash, display_goodbye, display_minimal_header
...
def interactive_mode():
    ...
    # Display the beautiful Sanskrit splash screen
...
def train(
    ...
    trainer = LLMTrainer(model_id=model, config=get_pipeline(config).config)
    trainer.train(data)
