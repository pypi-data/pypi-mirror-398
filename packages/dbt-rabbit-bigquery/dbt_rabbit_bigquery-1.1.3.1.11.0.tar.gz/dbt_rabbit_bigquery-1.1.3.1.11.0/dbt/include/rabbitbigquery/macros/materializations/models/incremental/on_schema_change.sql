...
{% macro rabbitbigquery__check_for_schema_changes(source_relation, target_relation) %}
...
{% macro rabbitbigquery__process_schema_changes(on_schema_change, source_relation, target_relation) %}
...
{% macro rabbitbigquery__sync_column_schemas(on_schema_change, target_relation, schema_changes_dict) %}
