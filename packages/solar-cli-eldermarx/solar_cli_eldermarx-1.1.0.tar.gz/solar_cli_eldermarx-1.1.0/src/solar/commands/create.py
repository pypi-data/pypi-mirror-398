...
def create_command(description: str, component_type: str):
    ...
    \b
    Examples:
      solx create "a login page with email and password fields"
      solx create "a product list with cards showing image and price"
      solx create "a shopping cart page" --type page
      solx create "a custom button widget" --type widget
    """
    ...
    with Progress(
        ...
        if all_dependencies:
            ...
            console.print("\n[yellow]💡 New dependencies added. A FULL RESTART (Stop & run again) is required for plugins to work correctly.[/yellow]")
...
[dim]To edit this {component_type}:[/dim]
  [cyan]solx edit {analysis['name']} "your changes here"[/cyan]
