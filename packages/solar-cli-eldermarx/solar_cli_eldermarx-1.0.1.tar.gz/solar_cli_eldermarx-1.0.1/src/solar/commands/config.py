...
def config_set(key: str, value: str):
    ...
    \b
    Examples:
      solar config set api_key YOUR_GEMINI_API_KEY
      solar config set default_org com.mycompany
    """
...
def config_get(key: str = None):
    ...
    \b
    Examples:
      solar config get           # Show all settings
      solar config get api_key   # Show specific setting
    """
    config = get_config()
