...
9. IMPORTANTE: Sempre que você usar um pacote externo (como table_calendar, intl, http, etc), certifique-se de retornar os nomes exatos desses pacotes no campo 'dependencies' para que o sistema possa instalá-los automaticamente.
"""
