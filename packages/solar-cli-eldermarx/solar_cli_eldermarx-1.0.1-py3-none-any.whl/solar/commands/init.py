...
def show_examples():
    ...
    console.print("  [bold #FF6600]solar new [myapp][/bold #FF6600]       [dim]- Cria um novo app Flutter do zero[/dim]")
    console.print("  [bold #FF6600]solar create [desc][/bold #FF6600]    [dim]- Gera uma nova página ou widget[/dim]")
    console.print("  [bold #FF6600]solar edit [page] [desc][/bold #FF6600] [dim]- Modifica código existente[/dim]")
    console.print("  [bold #FF6600]solar run[/bold #FF6600]              [dim]- Roda seu app no simulador[/dim]\n")
...
def init_command():
    ...
    console.print("\nAgora você pode começar com: [bold]solar new nomedoapp[/bold]\n")
