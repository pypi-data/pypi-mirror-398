...
def edit_command(component_name: str, changes: str, preview: bool):
    ...
    \b
    Examples:
      solar edit Home "add a floating action button"
      solar edit ProductList "make the cards bigger with shadows"
      solar edit Login "add forgot password link"
      solar edit Cart "change the button color to green"
    """
