...
def style_command(description: str):
    ...
    \b
    Examples:
      solar style "mude a cor primária para um azul escuro"
      solar style "faça os botões terem bordas mais arredondadas"
      solar style "adicione um tema escuro com tons de roxo"
    """
