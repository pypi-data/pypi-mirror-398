...
macro_rules! generic_compare {
    ($fname:ident, $type:ty) => {
        ...
        {
            let end_: usize = right.len();
            let length: usize = starts.iter().map(|x| end_ - (*x as usize)).sum();
...
#[pyfunction(name = "compare_start_ne_1st_int64")]
...
#[pyfunction(name = "compare_start_ne_1st_int32")]
...
#[pyfunction(name = "compare_start_ne_1st_int16")]
...
#[pyfunction(name = "compare_start_ne_1st_int8")]
...
#[pyfunction(name = "compare_start_ne_1st_float32")]
...
#[pyfunction(name = "compare_start_ne_1st_float64")]
...
#[pyfunction(name = "compare_start_ne_1st_uint64")]
...
#[pyfunction(name = "compare_start_ne_1st_uint32")]
...
#[pyfunction(name = "compare_start_ne_1st_uint16")]
...
#[pyfunction(name = "compare_start_ne_1st_uint8")]
...
mod tests {
    ...
    #[test]
    fn test_array_compare_int64_ne_starts_1st() {
        let left = Array1::from_vec(vec![10, 20]);
        let right = Array1::from_vec(vec![5, 10, 25]);
        let starts = Array1::from_vec(vec![0, 1]);
        let left_booleans = Array1::from_vec(vec![false, false]);
        let right_booleans = Array1::from_vec(vec![false, false, false]);
        let (result, counts_array, total) = array_compare_int64(
            left.view(),
            right.view(),
            starts.view(),
