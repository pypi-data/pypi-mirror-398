...
def display_debug_info(
    ...
    table.add_column("C#", style="blue", justify="center", width=6)
    ...
    for info in sorted_funcs:
        ...
        cumulative_time: str = wrap(f"{ct_ms:.{precision}f}{MS}", style=rgb)
        total_time: str = wrap(f"{tt_ms:.{precision}f}{MS}", style=rgb2)
