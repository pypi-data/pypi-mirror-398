...
- [LiteLLM Wrapper](docs/litellm-wrapper.md) - Auto-tracking via LiteLLM
- [CCS Integration](docs/ccs-integration.md) - Centralized tracking setup
- [Response Analysis](docs/response-analysis.md) - Direct SDK tracking
- [Pricing](docs/pricing.md) - Custom pricing configuration
- [Building](docs/building.md) - Development and publishing
