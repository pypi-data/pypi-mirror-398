...
class GreenApi:
    ...
    def __init__(
            ...
            host: str = "https://api.green-api.com/v3",
            media: str = "https://media.green-api.com/v3",
        ...
        self.logger = logging.getLogger("max-api-client-python")
    ...
    def request(
        ...
        headers = {
            'User-Agent': 'GREEN-API_MAX_SDK_PY/1.0'
        }
