#!/usr/bin/env python3
"""
Standalone performance benchmark for lazy proxy pattern.
Run with: python benchmark_lazy_proxy.py
"""
...
def create_large_dataset(size: int = 10000) -> dict:
...
def test_xwdata_indexing_overhead():
...
def test_xwnode_indexing_overhead():
...
def test_proxy_materialization_cost():
