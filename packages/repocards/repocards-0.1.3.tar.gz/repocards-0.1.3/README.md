...
- 📄 **[Markdown Example](examples/qchapp_lungs-segmentation.md)** - Full RepoCard in Markdown format
- 📋 **[JSON Example](examples/qchapp_lungs-segmentation.json)** - Structured JSON output
