...
def sync(*, client: Union[AuthenticatedClient, Client]) -> Union[Error, State]:
    """Get application state
...
async def asyncio(*, client: Union[AuthenticatedClient, Client]) -> Union[Error, State]:
    """Get application state
