...
def _get_kwargs(key: Union[Unset, str] = UNSET) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Error, StoredAIApps]]:
    return Response(
...
def sync_detailed(
    *, client: Union[AuthenticatedClient, Client], key: Union[Unset, str] = UNSET
) -> Response[Union[Error, StoredAIApps]]:
    """Get all AI Apps
