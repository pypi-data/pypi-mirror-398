...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = Tags.model_validate(response.json())
...
def sync(*, client: Union[AuthenticatedClient, Client]) -> Union[Error, Tags]:
    """Get all tags currently applied to on any entity.
...
async def asyncio(*, client: Union[AuthenticatedClient, Client]) -> Union[Error, Tags]:
    """Get all tags currently applied to on any entity.
