...
import numpy as np
from yolov5_face.utils.general import bbox_iou
from yolov5_face.utils.torch_utils import is_parallel
...
def build_targets(p, targets, model):
    ...
    for i in range(det.nl):
        ...
        if nt:
            ...
            l_, m = ((gxi % 1.0 < g) & (gxi > 1.0)).T
            j = torch.stack((torch.ones_like(j), j, k, l_, m))
            t = t.repeat((5, 1, 1))[j]
