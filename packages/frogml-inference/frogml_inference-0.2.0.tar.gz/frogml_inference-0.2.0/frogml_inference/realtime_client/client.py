...
from frogml_inference.realtime_client.rest_helpers import (
    RestSession,
    SocketConfiguration,
)
...
try:
    ...
    from frogml_inference.exceptions import FrogmlHTTPException
...
def _get_model_api_url_from_default_environment(r_session) -> str:
    try:
        response = r_session.post(FrogMLConstants.QWAK_AUTHENTICATED_USER_ENDPOINT)
