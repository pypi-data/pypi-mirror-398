...
from odoo.addons.account_peppol_partner.models.eas_mapping import EAS_MAPPING
...
class TestAccountUblCii(AccountTestInvoicingCommon):
    ...
    @patch(
        'odoo.addons.account_peppol_partner.models.res_partner.ResPartner._build_error_peppol_endpoint',
