...
class CookiesManagement(BaseModel):
    ...
    platform_salt = peewee.CharField(verbose_name='平台盐')  # 平台盐
    platform_cookies_1 = peewee.TextField(verbose_name='cookie1')
    platform_cookies_2 = peewee.TextField(verbose_name='cookie2')
    platform_cookies_3 = peewee.TextField(verbose_name='cookie3')
