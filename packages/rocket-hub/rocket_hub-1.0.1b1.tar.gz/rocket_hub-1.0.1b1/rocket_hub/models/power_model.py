...
:LastEditTime: 2024-09-18 09:56:18
...
from rocket_hub.models.enum import ButtonPlace
from rocket_hub.models.dto_model import *
...
class PowerModel():
    ...
    :description: 权限相关操作类
    """
    def __init__(self, db_connect_key='db_rocket_hub', is_super=False, user_id="", product_id=0):
    ...
    def set_user(self, user_info, role_id_list, product_id_list, password, change_pw=False, is_add=False):
        ...
        base_user_info_model = UserInfoModel(config.get_value("base_manage_context_key", "db_rocket_hub"))
        ...
        if is_add:
            ...
            if change_pw:
                ...
                user_info.Password = UserInfoModelEx().sign_password(config.get_value("default_password", "88888888"))
        elif change_pw:
            user_info.Password = UserInfoModelEx().sign_password(password, user_info.UserID)
    ...
    def add_product_user(self, user_id, product_id_list):
        ...
        :last_editors: ChenXiaolei
        """
        product_user_model = ProductUserModel(config.get_value("base_manage_context_key", "db_rocket_hub"))
    ...
    def set_base_user(self, user_info):
        ...
        if self.product_id > 0:
            base_user_info_model = UserInfoModel(config.get_value("base_manage_context_key"), "db_rocket_hub")
            base_product_user_model = ProductUserModel(config.get_value("base_manage_context_key"), "db_rocket_hub")
