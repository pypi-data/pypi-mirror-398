...
:LastEditTime: 2022-05-24 20:41:13
:LastEditors: ChenXiaolei
:Description: AWS S3存储
"""
import base64
from enum import Enum
from rocket_framework.log import *
from rocket_framework.uuid import *
from rocket_framework.file import S3Helper

from rocket_hub.utils.random import *

from rocket_hub.models.hub_model import InvokeResult, FileUploadInfo
...
class S3:
    ...
    def upload(self, storage_config, file_name='', stream=None, file_path=''):
        ...
        try:
            conn = S3Helper(access_key, secret_key, end_point)
            ...
            invoke_result.ResultMessage = "S3上传文件出错"
