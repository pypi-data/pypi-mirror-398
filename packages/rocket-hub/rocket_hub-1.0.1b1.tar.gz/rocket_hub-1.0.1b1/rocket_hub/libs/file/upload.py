...
:LastEditTime: 2022-05-24 20:42:21
...
from rocket_hub.libs.file.oss2 import *
from rocket_hub.libs.file.cos import *
from rocket_hub.libs.file.bos import *
from rocket_hub.libs.file.s3 import *
from rocket_hub.utils.random import *
...
from rocket_hub.models.hub_model import FileUploadInfo
from rocket_hub.models.enum import AccessModeCodeType
...
class FileUpload():
    ...
    """
    def __init__(self, file_context_key='db_rocket_hub'):
    ...
    def upload_file(self, stream, file_name, file_restrict, image_width=0, image_height=0, quality=0, is_format_jpeg=0, is_water_mark=0, horizontal_align=0, vertical_align=0):
        ...
        if file_restrict.FileExtension != "":
            file_find = file_restrict.FileExtension.find(file_extension.lower().strip("."))
            if file_find == -1:
                invoke_result.ResultCode = "1"
