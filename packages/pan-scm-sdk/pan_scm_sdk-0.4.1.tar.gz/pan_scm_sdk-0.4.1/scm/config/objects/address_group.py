...
class AddressGroup(BaseObject):
    ...
    def update(
        ...
        """Update an existing address group object.
    ...
    def _apply_filters(
        ...
        if "types" in filters:
            ...
            # Fields that can be present: static or dynamic.
            filter_criteria = [
                group
    ...
    def list(
        ...
        **filters,
        ...
        """List address group objects with optional filtering.
        ...
        while True:
            ...
            data = response["data"]
            object_instances = [AddressGroupResponseModel(**item) for item in data]
    ...
    def fetch(
        ...
        """Fetch a single address group by name.
