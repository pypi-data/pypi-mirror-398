...
async def zerox(
    ...
    **kwargs
    ...
    :param on_page_completed: Async callback function explicitly called after each page processing. Signature: async def callback(page_num, status, message, stats)
    :type on_page_completed: callable, optional
    ...
    with tempfile.TemporaryDirectory() as temp_dir_:
        ...
        if maintain_format:
            ...
            results = await process_pages_in_batches(
                ...
                output_token_count,
                prior_page,
                on_page_completed=on_page_completed,  # Pass callback
            )
