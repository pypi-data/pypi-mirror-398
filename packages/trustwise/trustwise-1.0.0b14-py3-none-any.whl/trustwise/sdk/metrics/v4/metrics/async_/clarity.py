...
class ClarityMetricAsync(BaseMetric[ClarityRequest, ClarityResponse]):
    ...
    async def evaluate(self, *, text: str, **kwargs) -> ClarityResponse:
    ...
    async def batch_evaluate(self, inputs: list[dict]) -> list[ClarityResponse]:
