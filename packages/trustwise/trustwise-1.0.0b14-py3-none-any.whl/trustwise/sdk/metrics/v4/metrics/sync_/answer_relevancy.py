...
class AnswerRelevancyMetric(BaseMetric[AnswerRelevancyRequest, AnswerRelevancyResponse]):
    ...
    def evaluate(self, *, query: str, response: str, **kwargs) -> AnswerRelevancyResponse:
