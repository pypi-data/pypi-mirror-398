...
Use this tool online at **[DevTools.at](https://devtools.at/tools/xml-json)** - Free, fast, and no registration required!

## Installation

```bash
pip install devtools_xml_json
```

## Usage

```python
from devtools_xml_json import process, encode, decode
...
**[https://devtools.at/tools/xml-json](https://devtools.at/tools/xml-json)**
