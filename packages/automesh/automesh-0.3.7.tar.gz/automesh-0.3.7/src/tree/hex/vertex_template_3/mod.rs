...
pub const DATA: [[usize; 11]; 12] = [
    [0, 1, 4, 1, 3, 2, 0, 5, 7, 6, 0],   // (0, 1, 4) = (5, 3, 2)
    [1, 2, 4, 3, 2, 0, 1, 15, 6, 4, 5],  // (1, 2, 4) = (5, 0, 3)
    [2, 3, 4, 2, 0, 1, 3, 10, 4, 5, 15], // (2, 3, 4) = (5, 1, 0)
    [3, 0, 4, 0, 1, 3, 2, 0, 5, 7, 10],  // (3, 0, 4) = (5, 2, 1)
    [1, 5, 2, 7, 6, 2, 3, 15, 4, 0, 5],  // (1, 5, 2) = (0, 4, 3)
    [2, 5, 3, 6, 4, 0, 2, 15, 5, 1, 5],  // (2, 5, 3) = (1, 4, 0)
    [3, 5, 0, 4, 5, 1, 0, 10, 7, 3, 0],  // (3, 5, 0) = (2, 4, 1)
    [0, 5, 1, 5, 7, 3, 1, 10, 6, 2, 0],  // (0, 5, 1) = (3, 4, 2)
    [1, 0, 5, 5, 4, 6, 7, 5, 0, 2, 15],  // (1, 0, 5) = (4, 2, 3)
    [2, 1, 5, 7, 5, 4, 6, 15, 1, 0, 10], // (2, 1, 5) = (4, 3, 0)
    [0, 3, 5, 4, 6, 7, 5, 0, 2, 3, 5],   // (0, 3, 5) = (4, 1, 2)
    [3, 2, 5, 6, 7, 5, 4, 10, 3, 1, 0],  // (3, 2, 5) = (4, 0, 1)
];
