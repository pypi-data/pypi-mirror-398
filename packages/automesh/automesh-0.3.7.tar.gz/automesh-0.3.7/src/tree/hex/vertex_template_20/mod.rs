...
pub const DATA: [[usize; 11]; 8] = [
    [0, 1, 5, 5, 4, 0, 5, 15, 6, 0, 3],
    [0, 4, 1, 1, 5, 4, 0, 5, 7, 10, 2],
    [0, 3, 4, 0, 1, 5, 0, 0, 3, 15, 6],
    [0, 5, 3, 4, 0, 1, 10, 10, 2, 5, 7],
    [2, 3, 5, 6, 7, 3, 10, 10, 5, 5, 0],
    [2, 4, 3, 2, 6, 7, 5, 0, 4, 15, 1],
    [2, 1, 4, 3, 2, 6, 15, 5, 0, 10, 5],
    [2, 5, 1, 7, 3, 2, 15, 15, 1, 0, 4],
];
