...
pub const DATA: [[usize; 11]; 12] = [
    [0, 1, 5, 5, 4, 0, 5, 15, 10, 2, 5],
    [0, 4, 1, 1, 5, 4, 0, 5, 15, 6, 0],
    [0, 3, 4, 0, 1, 5, 0, 0, 5, 7, 10],
    [0, 5, 3, 4, 0, 1, 10, 10, 0, 3, 15],
    [1, 4, 2, 3, 7, 5, 5, 5, 15, 4, 0],
    [1, 0, 4, 1, 3, 7, 5, 0, 5, 6, 10],
    [1, 5, 0, 5, 1, 3, 15, 10, 0, 2, 15],
    [2, 4, 3, 2, 6, 7, 5, 0, 10, 5, 5],
    [2, 1, 4, 3, 2, 6, 15, 5, 0, 4, 15],
    [2, 5, 1, 7, 3, 2, 15, 15, 5, 0, 10],
    [3, 4, 0, 0, 4, 6, 0, 0, 10, 7, 5],
    [3, 5, 2, 6, 2, 0, 10, 15, 5, 1, 10],
];
