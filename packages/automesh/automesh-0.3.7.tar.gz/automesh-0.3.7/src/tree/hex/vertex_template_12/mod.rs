...
pub const DATA: [[usize; 11]; 12] = [
    [0, 1, 5, 5, 10, 0, 5, 15, 10, 10, 5],
    [0, 4, 1, 1, 5, 4, 0, 5, 15, 15, 0],
    [1, 2, 5, 7, 15, 1, 15, 15, 10, 0, 5],
    [1, 4, 2, 3, 15, 5, 5, 5, 15, 10, 0],
    [2, 3, 5, 6, 15, 3, 10, 10, 15, 5, 0],
    [2, 4, 3, 2, 10, 7, 5, 0, 10, 10, 5],
    [3, 0, 5, 4, 10, 2, 0, 10, 15, 15, 0],
    [3, 4, 0, 0, 0, 6, 0, 0, 10, 15, 5],
    [4, 1, 0, 1, 0, 2, 5, 5, 0, 10, 15],
    [4, 2, 1, 3, 5, 0, 5, 15, 5, 10, 10],
    [5, 1, 2, 7, 15, 4, 15, 15, 10, 0, 5],
    [5, 0, 1, 5, 15, 6, 10, 5, 15, 5, 0],
];
