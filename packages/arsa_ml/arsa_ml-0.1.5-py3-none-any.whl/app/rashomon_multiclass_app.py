...
def run_app_from_file(plots_file):
    ...
    with st.container():
        ...
        with rashomon_set_col:
            ...
            rashomon_table.update_layout(
                # title={
                #     'text': "Models present in the Rashomon Set",
                #     'y':0.97,
                #     'x':0.05,
                #     'xanchor': 'left',
                #     'yanchor': 'top',
                #     'font': dict(size=14, color='#6C929E')
                # },
            ...
            with st.container(key='basics', height="stretch"):
                ...
                st.markdown(
                        ...
                        <div style="font-size:15px; margin-bottom:10px;">
                            <span style="color:#6C929E; font-family: 'Inter', sans-serif;font-weight:600;">Base model : </span>
                ...
                st.markdown(
                        f"""
                        <div style="font-size:15px; margin-bottom:10px;">
                            <span style="color:#6C929E; font-weight:600; font-family: 'Inter', sans-serif;">Base metric : </span>
                ...
                st.markdown(
                        f"""
                        <div style="font-size:15px; margin-bottom:10px;">
                            <span style="color:#6C929E; font-weight:600; font-family: 'Inter', sans-serif;">Base model's score : </span>
...
# RATIOS VS EPSILONS
    ...
    with st.container():
        ...
        with per_sample_col:
            ...
            height=100,
            font=plot_font,
            xaxis=dict(title_font=dict(color="#989898"), tickfont=dict(color="#989898"),title_standoff=50),
            yaxis=dict(title_font=dict(color="#989898"), tickfont=dict(color="#989898")),
            legend=dict(font=dict(color="#989898", size=10)),
            title={
