...
class PolicyV2:
    ...
    # extract_response_schema: bool = field(metadata={"json": "extractResponseSchema"})
    response_tracking_field: str = field(metadata={"json": "responseTrackingField"})
    is_response_tracking_enabled: bool = field(metadata={"json": "isResponseTrackingEnabled"})
