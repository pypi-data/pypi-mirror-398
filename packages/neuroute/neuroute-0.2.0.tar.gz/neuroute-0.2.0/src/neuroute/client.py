"""
Neuroute SDK Client - Main interface for querying AI API.
"""
...
class NeurouteClient:
    """
    Client for interacting with the Neuroute SDK backend.

    This client provides rate-limited access to AI capabilities via a backend service.

    Usage:
        >>> from neuroute import NeurouteClient
        >>> client = NeurouteClient(api_key="csk_your_api_key")
    ...
    def __init__(self, api_key: str, backend_url: Optional[str] = None):
        """
        Initialize the Neuroute client.
    ...
    def query(self, prompt: str) -> str:
        """
        Send a query to the AI and return the text response.
        ...
        Example:
            >>> client = NeurouteClient(api_key="csk_xxx")
    ...
    def __repr__(self):
        ...
        return f"NeurouteClient(api_key={masked_key}, backend_url={self.backend_url})"
