"""
Custom exceptions for the Claude SDK.
"""
...
class QueryTooLongError(ClaudeSDKError):
    """Query exceeds 100 character limit."""
    pass


class RateLimitExceededError(ClaudeSDKError):
...
class InvalidAPIKeyError(ClaudeSDKError):
...
class ServiceDisabledError(ClaudeSDKError):
