...
class Cycle(Serializable):
    ...
    def init_evaluation(self):
        # Definition der allgemeinen Evaluationsattribute
        #q_dot_min = self.get_common_value('Q_DOT_MIN')
        return {}

    def specific_init(self):
        # Platzhalter für zusätzliche spezifische Initialisierungen
        # Diese Methode wird von den abgeleiteten Klassen überschrieben
        pass

    

    def hp_plot(self, f_name, fig_ax=[]):
