...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "/opt/_internal/cpython-3.13.9/include/python3.13/Python.h"
        ],
        "extra_compile_args": [
            "-fpermissive"
        ],
        "include_dirs": [
            ...
            "/opt/_internal/cpython-3.13.9/include/python3.13",
            "/tmp/build-env-qjx_z04e/lib/python3.13/site-packages/numpy/_core/include"
        ],
        "language": "c++",
        "libraries": [
            "ndi"
