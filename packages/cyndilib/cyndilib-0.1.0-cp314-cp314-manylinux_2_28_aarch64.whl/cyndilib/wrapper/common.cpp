...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "/opt/_internal/cpython-3.14.0/include/python3.14/Python.h"
        ],
        "extra_compile_args": [
            "-fpermissive"
        ],
        "include_dirs": [
            ...
            "/opt/_internal/cpython-3.14.0/include/python3.14",
            "/tmp/build-env-valkvra1/lib/python3.14/site-packages/numpy/_core/include"
        ],
        "language": "c++",
        "libraries": [
            "ndi"
