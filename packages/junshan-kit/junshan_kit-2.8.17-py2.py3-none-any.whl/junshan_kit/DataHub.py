...
# <multi-datasets>
def CIFAR100(binary = False, print_info=False, class0=0, class1=1, root="./exp_data/CIFAR100", normalize = True):
    
    # transform
    transform_list: List[Callable] = [transforms.ToTensor()]
...
def CIFAR10(binary, print_info=False, class0=0, class1=1, root="./exp_data/CIFAR10", normalize = True):
...
def QMNIST(binary, print_info=False, class0=0, class1=1, root="./exp_data/QMNIST"):
...
def MNIST(binary, print_info=False, class0=0, class1=1, root="./exp_data/MNIST"):
    transform = torchvision.transforms.ToTensor()
...
def Caltech101_Resize_32(binary, print_info=False, class0=0, class1=1, 
                            train_ratio=0.7, split=True, root="./exp_data/Caltech101",
                            normalize=True,
                            ):
    # transform
    transform_list: List[Callable] = [transforms.Grayscale(num_output_channels=3),
                                        transforms.ToTensor(),
...
def SVHN(binary, class0=0, class1=1, root="./exp_data/SVHN", print_info = False, normalize = True):
...
def GTSRB(binary, class0=0, class1=1, root="./exp_data/GTSRB", print_info = False, normalize = True, resize_size = 32):
    # transform
    transform_list: List[Callable] = [transforms.Resize((resize_size, resize_size)),  
                                        transforms.ToTensor()]
...
def Flowers102(binary=False, class0=0, class1=1, root="./exp_data/Flowers102", print_info=False, normalize=True, resize=True):
    ...
    transform_list.append(transforms.ToTensor()) # to Tensor
