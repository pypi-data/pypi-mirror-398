...
class TestLogitsMatching(unittest.TestCase):
    def test_logits_matching(self):
        model_name = "Intel/tiny-random-llama2"
        ...
        self.assertTrue(
            np.allclose(hf_logits.numpy(), opt_logits.numpy(), atol=1e-4, rtol=1e-4),
