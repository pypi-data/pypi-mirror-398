...
Use this tool online at **[DevTools.at](https://devtools.at/tools/flexbox-generator)** - Free, fast, and no registration required!

## Installation

```bash
pip install devtools_flexbox
```

## Usage

```python
from devtools_flexbox import process, encode, decode
...
**[https://devtools.at/tools/flexbox-generator](https://devtools.at/tools/flexbox-generator)**
