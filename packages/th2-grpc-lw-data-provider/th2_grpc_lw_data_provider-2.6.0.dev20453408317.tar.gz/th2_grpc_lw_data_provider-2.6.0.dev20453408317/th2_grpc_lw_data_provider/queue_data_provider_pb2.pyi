...
class MessageGroupsQueueSearchRequest(google.protobuf.message.Message):
    ...
    class BookGroups(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["book_id", b"book_id", "group", b"group"]) -> None: ...
    ...
    def HasField(self, field_name: typing.Literal["end_timestamp", b"end_timestamp", "start_timestamp", b"start_timestamp", "sync_interval", b"sync_interval"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["end_timestamp", b"end_timestamp", "external_queue", b"external_queue", "keep_alive", b"keep_alive", "message_group", b"message_group", "raw_only", b"raw_only", "send_raw_directly", b"send_raw_directly", "start_timestamp", b"start_timestamp", "sync_interval", b"sync_interval"]) -> None: ...
...
class MessageLoadedStatistic(google.protobuf.message.Message):
    ...
    class GroupStat(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["book_id", b"book_id", "group", b"group"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["book_id", b"book_id", "count", b"count", "group", b"group"]) -> None: ...
...
class EventQueueSearchRequest(google.protobuf.message.Message):
    ...
    class BookScopes(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["book_id", b"book_id"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["book_id", b"book_id", "scope", b"scope"]) -> None: ...
    ...
    def HasField(self, field_name: typing.Literal["end_timestamp", b"end_timestamp", "start_timestamp", b"start_timestamp", "sync_interval", b"sync_interval"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["end_timestamp", b"end_timestamp", "event_scopes", b"event_scopes", "external_queue", b"external_queue", "keep_alive", b"keep_alive", "start_timestamp", b"start_timestamp", "sync_interval", b"sync_interval"]) -> None: ...
...
class EventLoadedStatistic(google.protobuf.message.Message):
    ...
    class ScopeStat(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["book_id", b"book_id", "scope", b"scope"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["book_id", b"book_id", "count", b"count", "scope", b"scope"]) -> None: ...
