...
This is a simple server for use in testing or debugging Raystack apps. It hasn't
...
from raystack.core.handlers.wsgi import LimitedStream
from raystack.core.wsgi import get_wsgi_application
from raystack.db import connections
from raystack.utils.module_loading import import_string

__all__ = ("WSGIServer", "WSGIRequestHandler")

logger = logging.getLogger("raystack.server")
...
def get_internal_wsgi_application():
    ...
    for Raystack's internal server (runserver); external WSGI servers should just
    be configured to point to the correct application object directly.

    If settings.WSGI_APPLICATION is not set (is ``None``), return
    whatever ``raystack.core.wsgi.get_wsgi_application`` returns.
    """
