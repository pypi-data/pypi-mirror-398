...
from raystack.core.exceptions import ObjectDoesNotExist
from raystack.core.serializers import base
from raystack.db import DEFAULT_DB_ALIAS, models
from raystack.utils.xmlutils import SimplerXMLGenerator, UnserializableContentError
...
class Serializer(base.Serializer):
    ...
    def start_serialization(self):
        ...
        self.xml.startElement("raystack-objects", {"version": "1.0"})
    ...
    def end_serialization(self):
        ...
        """
        self.indent(0)
        self.xml.endElement("raystack-objects")
