...
# should remain as long as the oldest supported Raystack version supports that
# Python version.
...
def get_complete_version(version=None):
    """
    Return a tuple of the raystack version. If version argument is non-empty,
    check for correctness of the tuple provided.
    """
    if version is None:
        from raystack import __version__ as version
    else:
