...
from raystack.core.exceptions import SuspiciousFileOperation
from raystack.utils.functional import (
    SimpleLazyObject,
    cached_property,
    keep_lazy_text,
    lazy,
...
from raystack.utils.translation import gettext as _
from raystack.utils.translation import gettext_lazy, pgettext
...
class TruncateHTMLParser(HTMLParser):
    ...
    def void_elements(self):
        from raystack.utils.html import VOID_ELEMENTS
