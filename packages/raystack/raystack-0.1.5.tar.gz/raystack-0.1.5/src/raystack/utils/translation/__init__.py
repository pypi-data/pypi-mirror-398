...
# from raystack.utils.autoreload import autoreload_started, file_changed
from raystack.utils.functional import lazy
...
# without having to first configure Raystack, and (2) if some other code creates
...
class Trans:
    ...
    def __getattr__(self, real_name):
        ...
        if settings.USE_I18N:
            from raystack.utils.translation import trans_real as trans
            from raystack.utils.translation.reloader import (
            ...
            from raystack.utils.translation import trans_null as trans
