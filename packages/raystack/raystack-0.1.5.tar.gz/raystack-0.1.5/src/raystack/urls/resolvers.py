...
from raystack.core.checks import Error, Warning
from raystack.core.checks.urls import check_resolver
from raystack.core.exceptions import ImproperlyConfigured
from raystack.utils.datastructures import MultiValueDict
from raystack.utils.functional import cached_property
from raystack.utils.http import RFC3986_SUBDELIMS, escape_leading_slashes
from raystack.utils.regex_helper import _lazy_re_compile, normalize
from raystack.utils.translation import get_language
...
def _route_to_regex(route, is_endpoint):
    ...
    and {'pk': <raystack.urls.converters.IntConverter>}.
    """
    parts = ["^"]
        ...
        if "(?P<" in route or route.startswith("^") or route.endswith("$"):
            warnings.append(
                Warning(
                    ...
                    "when migrating to raystack.urls.path().".format(self.describe()),
                    id="2_0.W001",
                )
            )
        return warnings
...
class URLPattern:
    ...
    def _check_callback(self):
        from raystack.views import View
...
class URLResolver:
    ...
    def resolve_error_handler(self, view_type):
        ...
        if not callback:
            ...
            # raystack.conf.urls imports this file.
            from raystack.conf import urls
