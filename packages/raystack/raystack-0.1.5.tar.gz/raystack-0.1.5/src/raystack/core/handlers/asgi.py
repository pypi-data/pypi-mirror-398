...
from raystack.core.exceptions import RequestAborted, RequestDataTooBig
from raystack.core.handlers import base
from raystack.http import (
    FileResponse,
    HttpRequest,
    HttpResponse,
...
from raystack.urls import set_script_prefix
from raystack.utils.functional import cached_property

logger = logging.getLogger("raystack.request")
...
class ASGIHandler(base.BaseHandler):
    ...
    async def __call__(self, scope, receive, send):
        ...
        if scope["type"] != "http":
            raise ValueError(
                "Raystack can only handle ASGI/HTTP connections, not %s." % scope["type"]
            )
