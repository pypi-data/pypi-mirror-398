...
const std::string& LoadgenVersion() {
  static const std::string str = "6.0.3";
  return str;
}

const std::string& LoadgenBuildDateLocal() {
  static const std::string str = "2025-12-23T01:08:27.565313";
  return str;
}

const std::string& LoadgenBuildDateUtc() {
  static const std::string str = "2025-12-23T01:08:27.565333";
  return str;
}

const std::string& LoadgenGitRevision() {
  static const std::string str = "27db053025";
  return str;
}

const std::string& LoadgenGitCommitDate() {
  static const std::string str = "2025-12-23T01:07:48Z";
  return str;
}
...
const std::string& LoadgenGitLog() {
  static const std::string str = R"LGVG_RSLD(27db0530255bb8e72fd7fdffaf0f0005b1f6461a [LoadGen] Bump version from 6.0.2 to 6.0.3 (#2417))LGVG_RSLD";
  return str;
}
...
3635493697c278414e4bda8c5ca0f42e234eb721 /VERSION.txt
...
804c355f3239809b2bb33cf87b57235cd75a86e5 /mlperf.conf
e5eb5e553bdeefb8e22274f51b3688ffe59c293c /mlperf_conf.h
