...
class MusubiTraining:
    ...
    def train(
        ...
        *,
        ...
        convert_for_comfyui: bool = False,
        output_name: str = "output_lora_model",
        max_train_steps: int = 2000,
        seed: int = 42,
    ) -> None:
        ...
        if convert_for_comfyui:
            trained_model_path = os.path.join(self.absolute_path_output, f"{output_name}.safetensors")
            self._convert_for_comfyui(model_path=trained_model_path)
