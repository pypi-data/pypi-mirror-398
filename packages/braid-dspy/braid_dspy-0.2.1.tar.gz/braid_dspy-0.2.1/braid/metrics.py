...
class PPDAnalyzer:
    ...
    MODEL_CONFIGS: Dict[str, ModelConfig] = {
        ...
        "o1-mini": ModelConfig("o1-mini", 3.0, 12.0, "openai"),
        ...
        "claude-3.5-opus": ModelConfig("claude-3.5-opus", 15.0, 75.0, "anthropic"),
        "claude-3.7-sonnet": ModelConfig("claude-3.7-sonnet", 3.0, 15.0, "anthropic"),
        "claude-4.5-sonnet": ModelConfig("claude-4.5-sonnet", 3.0, 15.0, "anthropic"),  # Estimated
        "claude-4.5-opus": ModelConfig("claude-4.5-opus", 15.0, 75.0, "anthropic"),  # Estimated
        # Google Models
        ...
        "gemini-2.0-pro-exp": ModelConfig(
            "gemini-2.0-pro-exp", 0.00, 0.00, "google"
        ),  # Currently free in experimental
        "gemini-2.5-flash": ModelConfig("gemini-2.5-flash", 0.10, 0.40, "google"),  # Estimated
        "gemini-3.0-pro": ModelConfig("gemini-3.0-pro", 1.25, 5.00, "google"),  # Estimated
        "gemini-3.0-flash": ModelConfig("gemini-3.0-flash", 0.10, 0.40, "google"),  # Estimated
        # Local/Open Models (estimated inference costs)
        "llama-3.1-70b": ModelConfig("llama-3.1-70b", 0.50, 0.70, "local"),
        "llama-3.1-8b": ModelConfig("llama-3.1-8b", 0.10, 0.15, "local"),
        "mistral-7b": ModelConfig("mistral-7b", 0.10, 0.15, "local"),
        "deepseek-v3": ModelConfig("deepseek-v3", 0.14, 0.28, "local"),
    }
