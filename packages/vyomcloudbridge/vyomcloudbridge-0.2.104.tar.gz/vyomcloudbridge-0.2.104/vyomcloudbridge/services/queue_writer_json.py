...
class ThreadSafeRabbitMQPool:  # This is deprecated file, please use QueueWriter from queue_write.py
...
class QueueWriterJson:  # This is deprecated file, please use QueueWriter from queue_write.py
...
def main():
    ...
    try:
        writer = QueueWriterJson(log_level=logging.INFO)
