...
try:
    ...
    from . import NXSCreateSECoPCPFS_test
...
# test fixture
class NXSCreateSECoPCPDBTest(
        NXSCreateSECoPCPFS_test.NXSCreateSECoPCPFSTest):

    # constructor
    # \param methodName name of the test method
    def __init__(self, methodName):
        NXSCreateSECoPCPFS_test.NXSCreateSECoPCPFSTest.__init__(
            self, methodName)
    ...
    # \brief Common set up
    def setUp(self):
        NXSCreateSECoPCPFS_test.NXSCreateSECoPCPFSTest.setUp(self)
        self._sv.setUp()
        self.openConf()
    ...
    def tearDown(self):
        NXSCreateSECoPCPFS_test.NXSCreateSECoPCPFSTest.tearDown(self)
        self.closeConfig()
        self._sv.tearDown()
