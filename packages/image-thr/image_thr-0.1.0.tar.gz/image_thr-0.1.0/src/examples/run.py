...
import time
import cv2
from image_thr import threshold_image, ContourObject
...
def process_image(image_path, width=300, height=300, user_low=None, user_high=None, mode=0):
    ...
    objects = contoursToObjects(contour_boxes, (local_fov_x, local_fov_y), local_distance, gray_cv.shape, MIN_SIZE, MAX_SIZE, (0,0))
