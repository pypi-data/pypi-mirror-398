...
def read_kf_data(
    ...
    portfolios_total_r = read_kf_portfolios(portfolios_filename, start_date, end_date, weighting)
    factors = read_factors(factors_filename, start_date, end_date)

    factors = portfolios_total_r.merge(factors, left_index=True, right_index=True, how="left")
    rf = factors["RF"]
