...
class BaseEstimatedStrategy(BaseStrategy, ABC):
    ...
    def _fit(self, training_data: TrainingData) -> None:
        ...
        valid_stocks = list(n_valid_points[n_valid_points >= self.PERCENTAGE_VALID_POINTS].index)
        ...
        training_data.simple_excess_returns = training_data.simple_excess_returns.loc[start_date:]
