...
if TYPE_CHECKING:
    from rubigram.enums import ButtonTextboxTypeLine, ButtonTextboxTypeKeypad
...
class ButtonTextbox(Object):
    ...
    **Represents a textbox input button.**
    ...
    """
    type_line: Optional[Union[str, ButtonTextboxTypeLine]] = None
    type_keypad: Optional[Union[str, ButtonTextboxTypeKeypad]] = None
