...
class Update(Object):
    ...
    **Represents an incoming update in Rubigram.**
    ...
    async def reply(
        ...
        chat_keypad_type: Optional[Union[str, ChatKeypadType]] = None,
    ...
    async def reply_file(
        ...
        type: Optional[Union[str, FileType]] = FileType.FILE,
        chat_keypad: Optional[Keypad] = None,
        inline_keypad: Optional[Keypad] = None,
        chat_keypad_type: Optional[Union[str, ChatKeypadType]] = None,
        disable_notification: bool = False,
    ...
    async def download(
        ...
        **Download the file attached to the current message.**
        ...
        return await self.client.download_file(
            ...
            file_name or self.new_message.file.file_name or None,
            directory,
            chunk_size,
            in_memory
        )
