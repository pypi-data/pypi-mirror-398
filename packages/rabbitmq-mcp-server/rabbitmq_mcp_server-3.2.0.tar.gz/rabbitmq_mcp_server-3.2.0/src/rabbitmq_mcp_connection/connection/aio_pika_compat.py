...
# mypy: disable-error-code="valid-type,no-redef"
...
try:  # pragma: no cover - real dependency path
    ...
    aio_pika_module = SimpleNamespace(
    ...
    _aio_pika_placeholder: Any = aio_pika_module
    RobustConnection: type[Any] = type("RobustConnection", (), {})
    AbstractChannel: type[Any] = type("AbstractChannel", (), {})
    AbstractConnection: type[Any] = type("AbstractConnection", (), {})
    _aio_pika = _aio_pika_placeholder
