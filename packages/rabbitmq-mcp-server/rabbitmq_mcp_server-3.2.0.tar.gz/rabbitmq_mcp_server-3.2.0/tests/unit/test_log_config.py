...
def test_log_config_rejects_invalid_retention(
    base_payload: dict[str, Any], retention_days: int
):
...
def test_log_config_requires_queue_size_over_minimum(
    base_payload: dict[str, Any], queue_size: int
):
    with pytest.raises(ValidationError):
...
def test_log_config_rejects_invalid_batch_size(
    base_payload: dict[str, Any], batch_size: int
):
    with pytest.raises(ValidationError):
