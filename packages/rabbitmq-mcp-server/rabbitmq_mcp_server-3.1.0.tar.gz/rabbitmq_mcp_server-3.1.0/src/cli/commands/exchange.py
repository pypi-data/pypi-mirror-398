...
@click.option(
    "--name",
    required=True,
    help="Exchange name (alphanumeric, dot, dash or underscore)",
)
@click.option(
    "--type",
    "exchange_type",
    required=True,
    help="Exchange type: direct|topic|fanout|headers",
)
@click.option(
    "--durable/--no-durable",
    default=False,
    show_default=True,
    help="Create exchange as durable",
)
@click.option(
