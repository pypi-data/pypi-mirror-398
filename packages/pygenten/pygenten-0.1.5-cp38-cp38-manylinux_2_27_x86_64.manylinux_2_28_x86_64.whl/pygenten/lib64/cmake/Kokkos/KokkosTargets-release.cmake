...
set_target_properties(Kokkos::kokkoscore PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libkokkoscore.so.4.7.0"
  IMPORTED_SONAME_RELEASE "libkokkoscore.so.4.7"
  )

list(APPEND _cmake_import_check_targets Kokkos::kokkoscore )
list(APPEND _cmake_import_check_files_for_Kokkos::kokkoscore "${_IMPORT_PREFIX}/lib64/libkokkoscore.so.4.7.0" )
...
set_target_properties(Kokkos::kokkoscontainers PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libkokkoscontainers.so.4.7.0"
  IMPORTED_SONAME_RELEASE "libkokkoscontainers.so.4.7"
  )

list(APPEND _cmake_import_check_targets Kokkos::kokkoscontainers )
list(APPEND _cmake_import_check_files_for_Kokkos::kokkoscontainers "${_IMPORT_PREFIX}/lib64/libkokkoscontainers.so.4.7.0" )
...
set_target_properties(Kokkos::kokkosalgorithms PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libkokkosalgorithms.so.4.7.0"
  IMPORTED_SONAME_RELEASE "libkokkosalgorithms.so.4.7"
  )

list(APPEND _cmake_import_check_targets Kokkos::kokkosalgorithms )
list(APPEND _cmake_import_check_files_for_Kokkos::kokkosalgorithms "${_IMPORT_PREFIX}/lib64/libkokkosalgorithms.so.4.7.0" )
...
set_target_properties(Kokkos::kokkossimd PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libkokkossimd.so.4.7.0"
  IMPORTED_SONAME_RELEASE "libkokkossimd.so.4.7"
  )

list(APPEND _cmake_import_check_targets Kokkos::kokkossimd )
list(APPEND _cmake_import_check_files_for_Kokkos::kokkossimd "${_IMPORT_PREFIX}/lib64/libkokkossimd.so.4.7.0" )
