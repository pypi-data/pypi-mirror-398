...
TEST_F(TestCategory, batched_scalar_team_vector_gemm_nt_nt_bhalf_bhalf) {
  ...
  test_batched_teamvectorgemm<TestDevice, ::Test::bhalfScalarType, ::Test::bhalfScalarType, param_tag_type,
                              Algo::Gemm::Unblocked>();
}
...
TEST_F(TestCategory, batched_scalar_team_vector_gemm_nt_nt_half_half) {
  ...
  test_batched_teamvectorgemm<TestDevice, ::Test::halfScalarType, ::Test::halfScalarType, param_tag_type,
                              Algo::Gemm::Unblocked>();
}
...
TEST_F(TestCategory, batched_scalar_team_vector_gemm_nt_nt_float_float) {
  ...
  test_batched_teamvectorgemm<TestDevice, float, float, param_tag_type, Algo::Gemm::Unblocked>();
}
...
TEST_F(TestCategory, batched_scalar_team_vector_gemm_nt_nt_double_double) {
  ...
  test_batched_teamvectorgemm<TestDevice, double, double, param_tag_type, Algo::Gemm::Unblocked>();
}
