...
set_target_properties(Kokkos::kokkoscore PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libkokkoscore.4.7.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libkokkoscore.4.7.dylib"
  )

list(APPEND _cmake_import_check_targets Kokkos::kokkoscore )
list(APPEND _cmake_import_check_files_for_Kokkos::kokkoscore "${_IMPORT_PREFIX}/lib/libkokkoscore.4.7.0.dylib" )
...
set_target_properties(Kokkos::kokkoscontainers PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libkokkoscontainers.4.7.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libkokkoscontainers.4.7.dylib"
  )

list(APPEND _cmake_import_check_targets Kokkos::kokkoscontainers )
list(APPEND _cmake_import_check_files_for_Kokkos::kokkoscontainers "${_IMPORT_PREFIX}/lib/libkokkoscontainers.4.7.0.dylib" )
...
set_target_properties(Kokkos::kokkosalgorithms PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libkokkosalgorithms.4.7.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libkokkosalgorithms.4.7.dylib"
  )

list(APPEND _cmake_import_check_targets Kokkos::kokkosalgorithms )
list(APPEND _cmake_import_check_files_for_Kokkos::kokkosalgorithms "${_IMPORT_PREFIX}/lib/libkokkosalgorithms.4.7.0.dylib" )
...
set_target_properties(Kokkos::kokkossimd PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libkokkossimd.4.7.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libkokkossimd.4.7.dylib"
  )

list(APPEND _cmake_import_check_targets Kokkos::kokkossimd )
list(APPEND _cmake_import_check_files_for_Kokkos::kokkossimd "${_IMPORT_PREFIX}/lib/libkokkossimd.4.7.0.dylib" )
