...
class RealtorFactory:
    ...
    def get_realtor(self, country: str, listing_type: str = 'for_sale', config: str = None):
        ...
        if country == 'canada':
            ...
            if listing_type == "for_sale":
                ...
                realtor_service_obj = HousingCom(
                    ReportingService(
                        column_mapping_cfg_fpath = "config/column_mapping_cfg_housing_com_rent.json",
                        column_lst = [
                            'ID', 'Bedrooms', 'Bathrooms', 'Size', 
                            'House Category', 
                            'Rent', 'Address', "Realtor Brokerage", "Website", "Latitude", "Longitude", "InsertedDate"
                        ],
                        summary_col_lst = ['Bedrooms',  'House Category']
                    )
                )
