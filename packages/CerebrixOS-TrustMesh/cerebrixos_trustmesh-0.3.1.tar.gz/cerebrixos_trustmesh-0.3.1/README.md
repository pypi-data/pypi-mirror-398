...
- Install: `pip install CerebrixOS-TrustMesh`
...
`CerebrixOS-TrustMesh {paste JWT here}` OR `CerebrixOS-TrustMesh --jwt enrollment.txt`
...
`CerebrixOS-TrustMesh --jwt enrollment.txt --assumePublic`
...
`CerebrixOS-TrustMesh --jwt enrollment.txt --autoTunnelListener`
