...
@mcp.tool()
async def nia_read(
    source_type: Annotated[Literal["repository", "documentation", "package"], Field(description="Source type")],
    # Repository params
    source_identifier: Annotated[Optional[str], Field(description="Repo: owner/repo:path. Docs: URL/ID")] = None,
    metadata: Annotated[Optional[Dict[str, Any]], Field(description="Search result metadata")] = None,
    # Documentation params
    doc_source_id: Annotated[Optional[str], Field(description="Doc source UUID/name/URL")] = None,
    ...
    """Read content from repo/docs/package. source_type determines which params to use."""
    try:
        client = await ensure_api_client()
        ...
        if source_type == "repository":
            ...
            if not result or not result.get("success"):
                error_msg = result.get("error", "Unknown error") if result else "Failed to fetch content"
                return [TextContent(type="text", text=f"❌ Error reading repository file: {error_msg}")]
...
async def nia_grep(
    ...
    # Repository params
    repository: Annotated[Optional[str], Field(description="owner/repo for repository search")] = None,
    # Documentation params
    doc_source_id: Annotated[Optional[str], Field(description="Doc source UUID/name/URL")] = None,
    # Package params
    registry: Annotated[Optional[Literal["npm", "py_pi", "crates_io", "golang_proxy", "ruby_gems"]], Field(description="Package registry")] = None,
    ...
    """Regex search in repo/docs/package code."""
    try:
        client = await ensure_api_client()
...
async def nia_explore(
    ...
    # Repository params
    repository: Annotated[Optional[str], Field(description="owner/repo")] = None,
    ...
    """Explore file structure of repo or documentation."""
    try:
        client = await ensure_api_client()
