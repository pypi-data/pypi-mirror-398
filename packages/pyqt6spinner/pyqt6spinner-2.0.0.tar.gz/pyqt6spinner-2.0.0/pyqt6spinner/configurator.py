...
class SpinnerConfigurator(QWidget):
    ...
    def randomize(self) -> None:
        assert self.sb_roundness
        assert self.sb_opacity
        assert self.sb_fadeperc
        assert self.sb_lines
        assert self.sb_line_length
        assert self.sb_line_width
        assert self.sb_inner_radius
