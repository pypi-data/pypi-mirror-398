...
measured PDF from nanocrystalline platinum.  It is the same refinement
as is done using PDFgui in this chapter of the book, only this time
using Diffpy-CMI. It is required that "fitBulkNi.py" be run prior to
...
# 9: We define a function 'make_recipe' to make the recipe that
# the fit will follow.
