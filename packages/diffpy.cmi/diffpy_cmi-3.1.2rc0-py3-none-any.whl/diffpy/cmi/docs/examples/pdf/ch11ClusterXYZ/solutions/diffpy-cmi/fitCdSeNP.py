...
# Config ##############################
# 2: Give a file path to where your PDF (.gr) and structure (.cif) files are
# located.
...
# 6: We specify initial values for an isotropic expansion factor,
# scale, isotropic thermal parameters per element, and a
