"""Please see notes in Chapter 8 of the 'PDF to the People' book for
additional explanation of the code.

This Diffpy-CMI script will carry out a structural refinement of a
measured PDF from SrFe2As2.  It is the same refinement as is done using
...
# between each temperature step.
SHOW_PLOT = False


# Functions that will carry out the refinement ##################
# 9: We define a function 'make_recipe' to make the recipe that the
# fit will follow.
...
def main():
    ...
    # 24: We should sort our data files and temperatures in some
    # meaningful way!
    ...
    for cif in cif_files:
        # 27: Here we load in the cif file, and get a string that represents
        # the structure.
        ...
        for file, temp in zip(data_files, temps):
            ...
            # set this profile in our recipe, and then tell this profile which
            # range to
            # fit over.
            profile = Profile()
            parser = PDFParser()
