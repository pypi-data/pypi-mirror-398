...
if TYPE_CHECKING:
    from ..models.nearby_success_places_item import NearbySuccessPlacesItem


T = TypeVar("T", bound="NearbySuccess")
...
class NearbySuccess:
    """
    Attributes:
        places (list[NearbySuccessPlacesItem] | Unset):
        status (int | Unset):  Example: 200.
    """

    places: list[NearbySuccessPlacesItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _places is not UNSET:
            ...
            for places_item_data in _places:
                places_item = NearbySuccessPlacesItem.from_dict(places_item_data)
        ...
        nearby_success.additional_properties = d
        return nearby_success
