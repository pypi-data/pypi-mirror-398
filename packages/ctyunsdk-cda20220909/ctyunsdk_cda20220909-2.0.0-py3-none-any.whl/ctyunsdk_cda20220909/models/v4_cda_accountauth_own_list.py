...
@dataclass_json
@dataclass
class V4CdaAccountauthOwnListRequest(CtyunOpenAPIRequest):
...
@dataclass_json
@dataclass
class V4CdaAccountauthOwnListResponse(CtyunOpenAPIResponse):
    statusCode: Optional[int] = None  # 返回状态码（800为成功，900为失败）
    errorCode: Optional[str] = None  # 错误码，为product.module.code三段式码
    error: Optional[str] = None  # 错误码，为product.module.code三段式码
    message: Optional[str] = None  # 失败时的错误描述，一般为英文描述
    description: Optional[str] = None  # 失败时的错误描述，一般为中文描述
    returnObj: Optional['V4CdaAccountauthOwnListReturnObj'] = None  # 成功时返回的数据
...
@dataclass_json
@dataclass
class V4CdaAccountauthOwnListReturnObj:
    totalCount: Optional[int] = None  # 总共数量
    currentCount: Optional[int] = None  # 当前数量
    accountAuthList: Optional[List['V4CdaAccountauthOwnListReturnObjAccountAuthList']] = None  # 专线网关列表


@dataclass_json
@dataclass
class V4CdaAccountauthOwnListReturnObjAccountAuthList:
