...
def main() -> None:
    ...
    # Files which must not be copied into the job, regardless of INCLUDE/EXCLUDE
    # and never copied nor linked
    NEVER_COPY = {".gitignore"}
    ...
    for name in os.listdir(project_root):
        ...
        # Never copy files in NEVER_COPY
