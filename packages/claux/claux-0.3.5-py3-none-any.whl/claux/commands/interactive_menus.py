...
class MCPConfigMenu(TableMenu):
    ...
    def handle_selection(self, item_id: str) -> Optional[str]:
        ...
        # Reload configs to update active indicator
        self._load_configs()

        # Show success message
        self.console.print(
            f"\n[success]✓[/success] {t('cli.interactive.mcp_switched', config=item_id)}"
        )
        self.console.print(
            f"[warning]![/warning] {t('cli.interactive.mcp_restart')}\n"
        )

        # Pause to let user read the message
        typer.pause(t("cli.common.press_enter"))

        # Return "back" to refresh menu and update icons
        return "back"
...
class AgentProfilesMenu(TableMenu):
    ...
    def handle_selection(self, item_id: str) -> Optional[str]:
        ...
        # Reload profiles to update active indicator
        self._load_profiles()
        ...
        # Show success message
        self.console.print(
            f"\n[success]✓[/success] {t('cli.interactive.agents_activated', profile=item_id)}"
        )
        self.console.print(
