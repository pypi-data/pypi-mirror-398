...
Use this tool online at **[DevTools.at](https://devtools.at/tools/timestamp)** - Free, fast, and no registration required!

## Installation

```bash
pip install devtools_timestamp
```

## Usage

```python
from devtools_timestamp import process, encode, decode
...
**[https://devtools.at/tools/timestamp](https://devtools.at/tools/timestamp)**
