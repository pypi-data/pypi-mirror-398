...
class TierTaskInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["tier_num", "task_id", "status", "collection_ids", "source_type", "source_collection_ids", "parent_task_id", "started_at", "completed_at", "duration_ms", "errors", "error_summary", "performance", "ray_job_id", "source_documents_fetched", "documents_after_source_filter", "documents_missing_input_fields", "documents_submitted_to_engine", "documents_written"]
