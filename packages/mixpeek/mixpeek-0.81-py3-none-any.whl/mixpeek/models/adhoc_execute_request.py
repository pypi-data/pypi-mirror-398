...
class AdhocExecuteRequest(BaseModel):
    ...
    input_schema: Dict[str, BucketSchemaFieldInput] = Field(description="REQUIRED. Input schema defining expected inputs. Each key is an input name, value is a BucketSchemaField.")
