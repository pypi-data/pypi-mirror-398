...
class RetrieverModelOutput(BaseModel):
    ...
    input_schema: Optional[Dict[str, BucketSchemaFieldOutput]] = Field(default=None, description="JSON Schema describing expected user inputs (REQUIRED). Properties must use BucketSchemaField for consistency with ingestion schemas.")
