...
class PaginationResponse(BaseModel):
    """
    PaginationResponse.  Supports both offset-based and cursor-based pagination: - Offset-based: Use page/page_size for navigation - Cursor-based: Use next_cursor for efficient deep pagination
    """ # noqa: E501
    total: StrictInt
    page: StrictInt
    page_size: StrictInt
