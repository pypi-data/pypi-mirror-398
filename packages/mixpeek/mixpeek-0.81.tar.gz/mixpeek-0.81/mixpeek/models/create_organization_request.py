...
class CreateOrganizationRequest(BaseModel):
    ...
    logo_url: Optional[StrictStr] = Field(default=None, description="Organization logo URL (e.g., from Clearbit Logo API). If not provided, will be auto-generated from first user's email domain.")
