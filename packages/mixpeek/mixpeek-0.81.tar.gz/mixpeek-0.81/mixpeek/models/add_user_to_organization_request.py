...
class AddUserToOrganizationRequest(BaseModel):
    ...
    logo_url: Optional[StrictStr] = Field(default=None, description="Organization logo URL (e.g., from Clearbit Logo API). If provided and organization doesn't have a logo, this will be set.")
