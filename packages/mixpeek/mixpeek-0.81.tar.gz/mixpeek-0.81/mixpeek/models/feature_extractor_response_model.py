...
class FeatureExtractorResponseModel(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["feature_extractor_name", "version", "feature_extractor_id", "description", "icon", "input_schema", "output_schema", "parameter_schema", "supported_input_types", "max_inputs", "default_parameters", "required_vector_indexes", "required_payload_indexes", "position_fields", "costs"]
