...
class PublicRetrieverAPIApi:
    ...
    def execute_retriever_name(
        ...
        return_urls: Annotated[Optional[StrictBool], Field(description="Whether to return signed URLs for media assets (images, videos, audio). Default: True for public retrievers to enable media rendering. Set to False if you only need metadata without URLs.")] = None,
        ...
        :param return_urls: Whether to return signed URLs for media assets (images, videos, audio). Default: True for public retrievers to enable media rendering. Set to False if you only need metadata without URLs.
    ...
    def _execute_retriever_name_serialize(
        ...
        if return_urls is not None:
            ...
            _query_params.append(('return_urls', return_urls))
    ...
    def list_retrievers(
        ...
        page_size: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Results per page (max 100)")] = None,
        ...
        :type page: int
        :param page_size: Results per page (max 100)
        :type page_size: int
