...
"""
    ...
    def grade_all_submissions(
        ...
        """
        Grade all submissions in a Google Drive folder.
        Returns a simple list of grades that can be directly used by other functions.
        ...
        Returns:
            List of grade dictionaries: [{'student_name': str, 'score': float, 'feedback': str}, ...]
        """
        import tempfile
...
"""
    ...
    def grade_all_image_submissions(
        self,
        submissions_folder_id: str,
        question_file_id: str,
        answer_key_file_id: str,
        ...
        """
        Grade all image submissions in a Google Drive folder using Gemini Vision.
        Returns a simple list of grades that can be directly used by other functions.
    ...
    def upload_grades_to_moodle(
        ...
        Returns:
            Number of grades successfully uploaded (int)
        """
        ...
        try:
            ...
            uploaded_count = len(user_mapping)
            self.logger.info(f"Successfully uploaded {uploaded_count} grades to assignment {assignment_id}")
