        ...
        if train_size == 0 or train_size == 1:
            ...
            for i in range(windows):
                ...
                if train_size == 0:
                    ...
                    test_idx = test_idx.index.to_numpy(copy=True)  # type: ignore
                    ...
                    train_idx = train_idx.index.to_numpy(copy=True)  # type: ignore
                    if shuffle:
        ...
        if self._config.exit_on_last_bar:
            for exec in self._executions:
                for sym in exec.symbols:
                    ...
                    if len(sym_dates):
                        exit_dates[sym] = sym_dates.max()  # type: ignore
