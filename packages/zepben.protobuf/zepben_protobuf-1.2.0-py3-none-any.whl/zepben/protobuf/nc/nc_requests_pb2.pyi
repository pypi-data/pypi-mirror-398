...
class IncludedEnergizingContainers(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    INCLUDED_ENERGIZING_CONTAINERS_LV_SUBSTATIONS: _ClassVar[IncludedEnergizingContainers]
...
class IncludedEnergizedContainers(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    INCLUDED_ENERGIZED_CONTAINERS_LV_SUBSTATIONS: _ClassVar[IncludedEnergizedContainers]
...
INCLUDED_ENERGIZING_CONTAINERS_LV_SUBSTATIONS: IncludedEnergizingContainers
...
INCLUDED_ENERGIZED_CONTAINERS_LV_SUBSTATIONS: IncludedEnergizedContainers
...
class GetNetworkHierarchyRequest(_message.Message):
    __slots__ = ("messageId", "includeGeographicalRegions", "includeSubgeographicalRegions", "includeSubstations", "includeFeeders", "includeCircuits", "includeLoops", "includeLvSubstations", "includeLvFeeders")
    MESSAGEID_FIELD_NUMBER: _ClassVar[int]
    INCLUDEGEOGRAPHICALREGIONS_FIELD_NUMBER: _ClassVar[int]
    INCLUDESUBGEOGRAPHICALREGIONS_FIELD_NUMBER: _ClassVar[int]
    INCLUDESUBSTATIONS_FIELD_NUMBER: _ClassVar[int]
    INCLUDEFEEDERS_FIELD_NUMBER: _ClassVar[int]
    INCLUDECIRCUITS_FIELD_NUMBER: _ClassVar[int]
    INCLUDELOOPS_FIELD_NUMBER: _ClassVar[int]
    INCLUDELVSUBSTATIONS_FIELD_NUMBER: _ClassVar[int]
    INCLUDELVFEEDERS_FIELD_NUMBER: _ClassVar[int]
    messageId: int
    includeGeographicalRegions: bool
    includeSubgeographicalRegions: bool
    includeSubstations: bool
    includeFeeders: bool
    includeCircuits: bool
    includeLoops: bool
    includeLvSubstations: bool
    includeLvFeeders: bool
    def __init__(self, messageId: _Optional[int] = ..., includeGeographicalRegions: bool = ..., includeSubgeographicalRegions: bool = ..., includeSubstations: bool = ..., includeFeeders: bool = ..., includeCircuits: bool = ..., includeLoops: bool = ..., includeLvSubstations: bool = ..., includeLvFeeders: bool = ...) -> None: ...
