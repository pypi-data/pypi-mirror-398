...
class GetNetworkHierarchyResponse(_message.Message):
    __slots__ = ("messageId", "geographicalRegions", "subGeographicalRegions", "substations", "feeders", "circuits", "loops", "lvSubstations", "lvFeeders")
    ...
    LVSUBSTATIONS_FIELD_NUMBER: _ClassVar[int]
    LVFEEDERS_FIELD_NUMBER: _ClassVar[int]
    messageId: int
