...
class AcLineSegment(_message.Message):
    __slots__ = ("cd", "perLengthImpedanceMRID", "cutMRIDs", "clampMRIDs", "phaseMRIDs")
    ...
    PHASEMRIDS_FIELD_NUMBER: _ClassVar[int]
    ...
    phaseMRIDs: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, cd: _Optional[_Union[_Conductor_pb2.Conductor, _Mapping]] = ..., perLengthImpedanceMRID: _Optional[str] = ..., cutMRIDs: _Optional[_Iterable[str]] = ..., clampMRIDs: _Optional[_Iterable[str]] = ..., phaseMRIDs: _Optional[_Iterable[str]] = ...) -> None: ...
