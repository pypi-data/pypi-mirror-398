...
class ShuntCompensator(_message.Message):
    __slots__ = ("rce", "sectionsNull", "sectionsSet", "groundedNull", "groundedSet", "nomUNull", "nomUSet", "phaseConnection", "groundingTerminalMRID")
    ...
    GROUNDINGTERMINALMRID_FIELD_NUMBER: _ClassVar[int]
