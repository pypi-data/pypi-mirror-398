...
class Cut(_message.Message):
    __slots__ = ("sw", "lengthFromTerminal1Null", "lengthFromTerminal1Set", "acLineSegmentMRID")
    ...
    def __init__(self, sw: _Optional[_Union[_Switch_pb2.Switch, _Mapping]] = ..., lengthFromTerminal1Null: _Optional[_Union[_struct_pb2.NullValue, str]] = ..., lengthFromTerminal1Set: _Optional[float] = ..., acLineSegmentMRID: _Optional[str] = ...) -> None: ...
