...
class BaseVoltage(_message.Message):
    __slots__ = ("io", "nominalVoltage")
    IO_FIELD_NUMBER: _ClassVar[int]
    NOMINALVOLTAGE_FIELD_NUMBER: _ClassVar[int]
    io: _IdentifiedObject_pb2.IdentifiedObject
    nominalVoltage: int
    def __init__(self, io: _Optional[_Union[_IdentifiedObject_pb2.IdentifiedObject, _Mapping]] = ..., nominalVoltage: _Optional[int] = ...) -> None: ...
