...
class EmailVerificationBackend(ModelBackend):
    ...
    def authenticate(self, request, username=None, password=None, **kwargs):
        ...
        if not email_addresses.exists():
            # No EmailAddress in Allauth - create one for this user
            # This handles cases where user was just created via registration
            if user.email:
                ...
                # User has no email at all - block login
                return None
