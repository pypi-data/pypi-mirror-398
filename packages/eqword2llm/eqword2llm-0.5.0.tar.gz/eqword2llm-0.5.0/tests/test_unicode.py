...
from eqword2llm.constants import SYMBOL_MAP
...
class TestConverterWithUnicode:
    ...
    def test_escape_latex_converts_math_symbols_in_unicode_context(self) -> None:
        ...
        text = "関数 f(x) ≥ 0 のとき"
        result = math_converter._escape_latex(text)
        assert "関数" in result
