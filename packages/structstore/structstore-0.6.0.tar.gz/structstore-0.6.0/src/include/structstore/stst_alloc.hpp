...
class SharedAlloc {
    ...
    OffsetPtr<MemberMapStorage> member_map_storage;
...
public:
    ...
    inline MemberMapStorage& member_maps() { return *member_map_storage.get(); }

    inline const MemberMapStorage& member_maps() const { return *member_map_storage.get(); }
