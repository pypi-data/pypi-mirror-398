...
Use this tool online at **[DevTools.at](https://devtools.at/tools/unix-permissions)** - Free, fast, and no registration required!

## Installation

```bash
pip install devtools_unix_perms
```

## Usage

```python
from devtools_unix_perms import process, encode, decode
...
**[https://devtools.at/tools/unix-permissions](https://devtools.at/tools/unix-permissions)**
