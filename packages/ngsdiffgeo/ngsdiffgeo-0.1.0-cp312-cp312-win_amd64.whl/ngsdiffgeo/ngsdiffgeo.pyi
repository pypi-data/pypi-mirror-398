...
class Alternation(ngsolve.fem.CoefficientFunction):
    def __init__(self, cf: ngsolve.fem.CoefficientFunction, rank: typing.SupportsInt, dim: typing.SupportsInt) -> None:
        ...
    @property
    def dim(self) -> int:
        ...
...
class KForm(TensorField):
    def __init__(self, cf: ngsolve.fem.CoefficientFunction, k: typing.SupportsInt, dim: typing.SupportsInt) -> None:
        ...
    def d(self) -> KForm:
        ...
...
class RiemannianManifold:
    def Christoffel(self, second_kind: bool = False) -> ngsolve.fem.CoefficientFunction:
        ...
        """
    def Contraction(self, tf: ..., vf: ..., slot: typing.SupportsInt = 0) -> ...:
        """
    ...
    def J(self, tf: ..., vb: ngsolve.comp.VorB = ...) -> ...:
        ...
        """
    def KForm(self, cf: ngsolve.fem.CoefficientFunction, k: typing.SupportsInt) -> ...:
        """
    ...
    def LichnerowiczLaplacian(self, tf: ...) -> ...:
        ...
        """
    def Lower(self, tf: ..., index: typing.SupportsInt = 0) -> ...:
        """
        Lower a tensor index using the manifold metric
        """
    def Raise(self, tf: ..., index: typing.SupportsInt = 0) -> ...:
        """
    ...
    def S(self, tf: ..., vb: ngsolve.comp.VorB = ...) -> ...:
        ...
        """
    def Trace(self, tf: ..., vb: ngsolve.comp.VorB = ..., index1: typing.SupportsInt = 0, index2: typing.SupportsInt = 1) -> ...:
        """
        Trace of TensorField in two indices. Default are the first two.
        """
    def Transpose(self, tf: ..., index1: typing.SupportsInt = 0, index2: typing.SupportsInt = 1) -> ...:
        """
...
class ScalarField(KForm):
    @staticmethod
    def from_cf(cf: ngsolve.fem.CoefficientFunction, dim: typing.SupportsInt = -1) -> ScalarField:
        ...
    def __init__(self, cf: ngsolve.fem.CoefficientFunction, dim: typing.SupportsInt = -1) -> None:
        ...
...
class ThreeForm(KForm):
    @staticmethod
    def from_cf(cf: ngsolve.fem.CoefficientFunction, dim: typing.SupportsInt = -1) -> ThreeForm:
        ...
    def __init__(self, cf: ngsolve.fem.CoefficientFunction, dim: typing.SupportsInt = -1) -> None:
        ...
class TwoForm(KForm):
    @staticmethod
    def from_cf(cf: ngsolve.fem.CoefficientFunction, dim: typing.SupportsInt = -1) -> TwoForm:
        ...
    def __init__(self, cf: ngsolve.fem.CoefficientFunction, dim: typing.SupportsInt = -1) -> None:
        ...
class VectorField(TensorField):
    ...
    def __init__(self, cf: ngsolve.fem.CoefficientFunction) -> None:
        ...
def GradCF(arg0: ngsolve.fem.CoefficientFunction, arg1: typing.SupportsInt) -> ngsolve.fem.CoefficientFunction:
    """
