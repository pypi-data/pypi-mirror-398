...
class RecipeCompServer(BaseComponent):
    ...
    def RemoveRecipe(self, rcpIdentifier, rcpTypeStr):
        # type: (str, Literal["recipe_shaped", "recipe_shapeless", "recipe_furnace", "recipe_brewing_mix", "recipe_brewing_container", "recipe_smithing_transform", "recipe_smithing_trim", "recipe_smithing_trim", "recipe_smithing_trim", "recipe_smithing_trim"]) -> bool
        """
        动态禁用配方
        """
        pass
