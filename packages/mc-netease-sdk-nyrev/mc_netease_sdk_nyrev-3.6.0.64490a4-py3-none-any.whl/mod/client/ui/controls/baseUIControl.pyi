...
from typing import Tuple, Any, Callable, Dict, Optional, Literal, TypedDict, overload
...
class BaseUIControl(object):
    ...
    def SetFullSize(self, axis, paramDict):
        # type: (Literal["x", "y"], __FullSizeDict) -> bool
        """
        设置控件的大小，支持比例形式以及绝对值
        """
        pass
    ...
    def GetFullSize(self, axis):
        # type: (Literal["x", "y"]) -> __FullSizeDict
        """
        获取控件的大小，支持百分比以及绝对值
        """
        pass
    ...
    def SetFullPosition(self, axis, paramDict):
        # type: (Literal["x", "y"], __FullPositionDict) -> bool
        """
    ...
    def GetFullPosition(self, axis):
        # type: (Literal["x", "y"]) -> __FullPositionDict
        """
    ...
    def GetAnchorFrom(self):
        # type: () -> Literal["top_left", "top_middle", "top_right", "left_middle", "center", "right_middle", "bottom_left", "bottom_middle", "bottom_right"]
        """
    ...
    def PauseAnimation(self, propertyName="all"):
        # type: (Literal["all", "size", "offset", "alpha", "clip", "color", "flip_book", "aseprite_flip_book", "uv", "wait"]) -> bool
        """
        暂停动画，暂停后的动画会停在当前的状态
        """
        pass
    ...
    def SetAnimation(self, propertyName, namespace, animName, autoPlay=False):
        # type: (Literal["size", "offset", "alpha", "clip", "color", "flip_book", "aseprite_flip_book", "uv", "wait"], str, str, bool) -> bool
        """
    ...
    def RemoveAnimation(self, propertyName):
        # type: (Literal["size", "offset", "alpha", "clip", "color", "flip_book", "aseprite_flip_book", "uv", "wait"]) -> bool
        """
