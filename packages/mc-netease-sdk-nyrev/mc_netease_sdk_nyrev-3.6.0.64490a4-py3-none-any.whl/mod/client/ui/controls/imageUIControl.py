...
from typing import Tuple, Optional, Literal, overload
...
class ImageUIControl(BaseUIControl):
    ...
    def SetClipDirection(self, clipDirection):
        # type: (Literal["fromLeftToRight", "fromRightToLeft", "fromOutsideToInside", "fromTopToBottom", "fromBottomToTop"]) -> bool
        """
        设置图片控件的裁剪方向
        """
        pass
    ...
    def GetClipDirection(self):
        # type: () -> Literal["fromLeftToRight", "fromRightToLeft", "fromOutsideToInside", "fromTopToBottom", "fromBottomToTop"]
        """
        获取图片控件的裁剪方向
        """
        pass
    ...
    def SetImageAdaptionType(self, imageAdaptionType, imageAdaptionData=None):
        # type: (Literal["normal", "filled", "oldNineSlice", "originNineSlice"], Optional[Tuple[float, float, float, float]]) -> bool
        """
        设置图片控件的图片适配方式以及信息
        """
        pass
