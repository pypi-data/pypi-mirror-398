...
if TYPE_CHECKING:
    ...
    ObservationFinder = Any  # Placeholder for type checking
...
class IQMTarget(Target):
    ...
    def __new__(
        ...
        *,
        ...
        # Calculate num_qubits for Qiskit 1.4.3 Target.__new__ compatibility
        num_qubits = len(component_to_idx)
        # Call Target.__new__ with the correct parameters
        instance = super().__new__(cls, num_qubits=num_qubits)
        return instance
    ...
    def __init__(
        ...
        *,
        ...
        # Target.__new__ already handled the num_qubits, now do normal init
        super().__init__()
        ...
        #
        # NOTE: We use approach (1) with our Qiskit 1.4.3 compatibility fix in __new__ above
