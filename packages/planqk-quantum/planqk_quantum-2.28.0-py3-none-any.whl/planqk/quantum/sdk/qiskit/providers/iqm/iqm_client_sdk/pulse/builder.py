...
Locus = list[str]  # Stub: represents qubit names

class QuantumOpTable(dict):
    """Stub implementation of QuantumOpTable"""
    pass

class QuantumOp:
    """Stub implementation of QuantumOp"""
    pass

# Stub types for calibration data
OpCalibrationDataTree = dict  # Stub: represents calibration data tree

# Stub scheduling types
...
# Stub functions needed by CircuitOperation
def build_quantum_ops(*args, **kwargs):
    """Stub implementation"""
    return QuantumOpTable()

def load_yaml(path: str):
    """Stub implementation"""
    return {"experiment": {"gate_definitions": {}, "gates": {}}}
