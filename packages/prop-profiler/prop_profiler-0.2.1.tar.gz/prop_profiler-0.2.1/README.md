...
- `PROP_PROFILER_ESOL_MODEL`
- `PROP_PROFILER_LOGD_MODEL`
- `PROP_PROFILER_ACID_MODEL`
- `PROP_PROFILER_BASE_MODEL`
- `PROP_PROFILER_MODEL_DIR` (shared directory for all model files)
