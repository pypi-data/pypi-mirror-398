...
export default [
  {
    ...
    component: ComponentCreator('/solace-agent-mesh/docs', '3e6'),
    routes: [
      {
        path: '/solace-agent-mesh/docs',
        component: ComponentCreator('/solace-agent-mesh/docs', '54f'),
        routes: [
          {
            path: '/solace-agent-mesh/docs',
            component: ComponentCreator('/solace-agent-mesh/docs', 'fa5'),
            routes: [
              {
