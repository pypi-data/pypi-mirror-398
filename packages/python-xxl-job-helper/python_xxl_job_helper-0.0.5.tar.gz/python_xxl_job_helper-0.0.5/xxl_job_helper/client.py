...
class XxlJobClient:
    ...
    async def update_task_triger(
            self, task_id: int, task_param: Optional[str] = None, is_end: Optional[bool] = None
    ) -> Dict[str, Any]:
        """
        更新任务triger
        :param task_id: 任务ID
...
if __name__ == '__main__':
    ...
    print(asyncio.run(xxl_client.update_task_triger(task_id=7, task_param=json.dumps(executor_param))))
