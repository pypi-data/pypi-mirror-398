...
Use this tool online at **[DevTools.at](https://devtools.at/tools/qr-generator)** - Free, fast, and no registration required!

## Installation

```bash
pip install devtools_qr
```

## Usage

```python
from devtools_qr import process, encode, decode
...
**[https://devtools.at/tools/qr-generator](https://devtools.at/tools/qr-generator)**
