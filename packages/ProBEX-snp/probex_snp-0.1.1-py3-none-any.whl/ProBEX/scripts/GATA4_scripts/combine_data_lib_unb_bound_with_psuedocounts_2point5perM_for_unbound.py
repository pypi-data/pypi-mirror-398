...
if __name__ == "__main__":
    ...
    combined_df.to_csv("./output/GATA4/merged_df_GATA4_with_pseudocounts_2point5.csv", index=False)
    print("File saved: merged_df_GATA4_with_pseudocounts_2point5.csv")
    end_time = time.time()
