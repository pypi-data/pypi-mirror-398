...
if __name__ == "__main__":
    ...
    base_path = './output/GATA4/intersected_rsids_based_scatterPlot'
    bound_vs_unbound_path = './output/GATA4/bound_vs_unbound'
    output_dir = './output/GATA4/mean_heatmaps_from_scatter'
