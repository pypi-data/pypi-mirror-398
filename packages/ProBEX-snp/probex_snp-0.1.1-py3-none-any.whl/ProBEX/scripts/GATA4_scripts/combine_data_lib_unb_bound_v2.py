...
FILES_REPS = [
    ("100", "R52_36_Vs_R52_37.csv"), ("500", "R52_38_Vs_R52_39.csv"), ("1000", "R52_40_Vs_R52_41.csv"),
    ("1500", "R52_42_Vs_R52_43.csv"), ("2000", "R52_44_Vs_R52_45.csv"), ("3000", "R52_46_Vs_R52_47.csv"),
...
if __name__ == "__main__":
    ...
    combined_df.to_csv("./output/GATA4/merged_df_GATA4_without_pseudocounts.csv", index=False)
    print("File saved: merged_df_GATA4_without_pseudocounts.csv")
    end_time = time.time()
