...
def process_files(df_excel, bound_range, output_folder):
    for bound_file_number in bound_range:
        ...
        unbound_file_path = f'./output/GATA4/CarriedForward/R52_{unbound_file_number:02}.csv'
...
def main():
    ...
    parser.add_argument('--file_ranges', nargs='+', required=False, default=['34-47', '50-63'], help="List of file ranges, e.g., 1-14 18-31")
    ...
    parser.add_argument('--output_folder', type=str, default='./output/GATA4/bound_vs_unbound_without_pseudocounts', help="Output folder (default: '../bound_vs_unbound')")
