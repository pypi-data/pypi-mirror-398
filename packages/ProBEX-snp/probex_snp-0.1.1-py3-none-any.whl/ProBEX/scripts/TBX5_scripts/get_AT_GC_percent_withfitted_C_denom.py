...
input_file = './output/TBX5/bound_vs_unbound/R52_70_Vs_R52_71.csv'
...
sequence_output_path = './output/TBX5/fitting/rsID_sequence_percentages.xlsx'
sequence_df.to_excel(sequence_output_path, index=False)

# CSV to EXCEL
csv_path = "./output/TBX5/fitting/iteration_results_withunb_with_bi/fitted_K_results_iteration_10.csv"
df = pd.read_csv(csv_path)
excel_path = os.path.splitext(csv_path)[0] + ".xlsx"
df.to_excel(excel_path, index=False)

fitted_c_results_path = "./output/TBX5/fitting/iteration_results_withunb_with_bi/fitted_K_results_iteration_10.xlsx"
external_df = pd.read_excel(fitted_c_results_path)
merged_df = pd.merge(sequence_df, external_df, on='rsID', how='inner')

final_output_path = './output/TBX5/fitting/updated_CORREL_with_bi.xlsx'
