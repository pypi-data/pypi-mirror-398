...
def process_files(meme_excel, reference_csv, output_fasta, output_bed):
    ...
    #merged_df.to_csv("./output/TBX5/merged_output_500.csv", index=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--meme_excel", default='./output/TBX5/motif_affect_TBX5/MEME/200_sequences_for_meme.xlsx', help="Path to meme Excel file.")
    parser.add_argument("--reference_csv", default='./output/TBX5/bound_vs_unbound/R52_70_Vs_R52_71.csv', help="CSV file with chrLoc and Pattern. You can use any file from TF NKX2.5")
    parser.add_argument("--output_fasta", default='./output/TBX5/motif_affect_TBX5/MEME/SNPs_200.fa', help="Output FASTA file path.")
    parser.add_argument("--output_bed", default='./output/TBX5/motif_affect_TBX5/MEME/SNPs_200.bed', help="Output BED file path.")
