...
class EnrichmentHeatmapGenerator:
    def __init__(self, data_dir, desired_order, output_dir='./output/TBX5/'):
...
class EnrichmentHeatmapGenerator:
    ...
    def generate_final_dataframe(self):
        ...
        self.final_df_sorted = self.final_df.sort_values(by='3000_nM_Bound_2 (R52_94)', ascending=False) #change this according to the TF
    ...
    def create_heatmap(self):
        ...
        plt.tight_layout()
        plt.savefig(os.path.join(self.output_dir, 'HeatMap_controls_TBX5.png'), dpi=360)
        #plt.show()
...
if __name__ == '__main__':
    ...
    desired_order = [
	    '3000_nM_Bound_2 (R52_94)', '2000_nM_Bound_2 (R52_92)', '1500_nM_Bound_2 (R52_90)',
	    '1000_nM_Bound_2 (R52_88)', '500_nM_Bound_2 (R52_86)', '100_nM_Bound_2 (R52_84)', '0_nM_Bound_2 (R52_82)',
	    '0_nM_Bound (R52_66)', '100_nM_Bound (R52_68)', '500_nM_Bound (R52_70)', '1000_nM_Bound (R52_72)',
	    '1500_nM_Bound (R52_74)', '2000_nM_Bound (R52_76)', '3000_nM_Bound (R52_78)'
	]
