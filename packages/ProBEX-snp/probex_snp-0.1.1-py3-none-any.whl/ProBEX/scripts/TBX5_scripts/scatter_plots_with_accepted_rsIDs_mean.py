...
class PolygonPlotter:
    def __init__(self, folder_path, plot_output_folder, table_output_folder, unbound_path, accepted_rsids_file):
	    ...
	    "3000 nM Bound": ["R52_78_Vs_R52_79.csv", "R52_94_Vs_R52_95.csv"],
	    "2000 nM Bound": ["R52_76_Vs_R52_77.csv", "R52_92_Vs_R52_93.csv"],
	    "1500 nM Bound": ["R52_74_Vs_R52_75.csv", "R52_90_Vs_R52_91.csv"],
	    "1000 nM Bound": ["R52_72_Vs_R52_73.csv", "R52_88_Vs_R52_89.csv"],
	    "500 nM Bound": ["R52_70_Vs_R52_71.csv", "R52_86_Vs_R52_87.csv"],
	    "100 nM Bound": ["R52_68_Vs_R52_69.csv", "R52_84_Vs_R52_85.csv"],
	    "0 nM Bound": ["R52_66_Vs_R52_67.csv", "R52_82_Vs_R52_83.csv"]
	}
    ...
    def create_latex_document(self):
        ...
        latex_file_path = './output/TBX5/scatter_plot_document_mean.tex'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--plot_output_folder', type=str, default='./output/TBX5/plots_mean_scatter/', help="Folder to save the scatter plots.")
    parser.add_argument('--table_output_folder', type=str, default='./output/TBX5/tables_mean_scatter/', help="Folder to save the table outputs.")
