...
inc_counts, dec_counts, all_positions = load_and_process_data('./output/TBX5/motif_affect_TBX5/processed_increased_sequences.csv', './output/TBX5/motif_affect_TBX5/processed_decreased_sequences.csv')
plot_contribution(inc_counts, dec_counts, all_positions, "./output/TBX5/motif_affect_TBX5/contribution_bar_plot_lightblue_orange_red_withoutgrid.png")
plot_reversed_contribution(inc_counts, dec_counts, "./output/TBX5/motif_affect_TBX5/contribution_bar_plot_lightblue_orange_red_reverse_withoutgrid.png")
plot_subset_contribution(inc_counts, dec_counts, list(range(15, 21)), list(range(1, 7)), "./output/TBX5/motif_affect_TBX5/Pos_motif_affect_forward_withoutgrid.png")
plot_subset_contribution(inc_counts, dec_counts, list(range(20, 14, -1)), list(range(1, 7)), "./output/TBX5/motif_affect_TBX5/Pos_motif_affect_reverse_withoutgrid.png")
