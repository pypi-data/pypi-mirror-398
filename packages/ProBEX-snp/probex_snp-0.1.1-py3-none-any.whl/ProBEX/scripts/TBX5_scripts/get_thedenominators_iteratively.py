...
def save_fractions(rsIDs, Frac_all, Frac_lib_conc,
                   filename_all="./output/TBX5/fitting/frac_all_interm.txt",
                   filename_lib="./output/TBX5/fitting/frac_lib_con_interm.txt"):
...
def fit_all_Ks(merged_df, batch_size, result_dir="./output/TBX5/fitting/results_1000"):
...
if __name__ == "__main__":
    ...
    os.makedirs('./output/TBX5/fitting/results_1000', exist_ok=True)
    merged_df = pd.read_csv("./output/TBX5/merged_df_TBX5_without_pseudocounts.csv")
