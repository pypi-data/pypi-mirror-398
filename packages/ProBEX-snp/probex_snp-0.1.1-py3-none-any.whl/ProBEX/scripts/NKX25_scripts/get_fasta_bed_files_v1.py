...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_folder", default='./output/NKX25/bound_vs_unbound', help="Input folder containing CSV files.")
    parser.add_argument("--output_fasta_folder", default='./output/NKX25/bound_vs_unbound/NKX25_fasta_files', help="Output folder to save FASTA files.")
    parser.add_argument("--output_bed_folder", default='./output/NKX25/bound_vs_unbound/NKX25_bed_files', help="Output folder to save BED files.")
