...
FILES_REPS = [
    ("0", "R52_01_Vs_R52_02.csv"), ("100", "R52_03_Vs_R52_04.csv"), ("500", "R52_05_Vs_R52_06.csv"), ("1000", "R52_07_Vs_R52_08.csv"),
    ("1500", "R52_09_Vs_R52_10.csv"), ("2000", "R52_11_Vs_R52_12.csv"), ("3000", "R52_13_Vs_R52_14.csv"), ("0", "R52_18_Vs_R52_19.csv"),
...
def suffix_unbound(file):
    ...
    return f"R1_unb" if unb_num < 17 else f"R2_unb"

def suffix_bound(file):
    bnd_num = int(file.split("_Vs_")[1].split("_")[1].replace(".csv", ""))
    return f"R1_b" if bnd_num < 17 else f"R2_b"
...
if __name__ == "__main__":
    ...
    combined_df.to_csv("./output/NKX25/merged_df_NKX25_with_zeronM_pseudocounts_2point5.csv", index=False)
    print("File saved: merged_df_NKX25_with_zeronM_pseudocounts_2point5.csv")
    end_time = time.time()
