...
results_dir = "../fitting/iteration_results_withunb_with_bi_with_pseudocounts"
os.makedirs(results_dir, exist_ok=True)
merged_df_combined = pd.read_csv("../merged_df_NKX25_with_pseudocounts.csv")
denom_df = pd.read_csv("../fitting/results_1000/denominators_iteration_361.csv")
