...
def plot_reversed_contribution(inc_counts, dec_counts, output_path):
    ...
    """
    subset_positions = list(range(35, 0, -1))  # Reversed positions
    new_positions = list(range(1, 36))
...
inc_counts, dec_counts, all_positions = load_and_process_data('./output/NKX25/motif_affect_NKX25/processed_increased_sequences.csv', './output/NKX25/motif_affect_NKX25/processed_decreased_sequences.csv')
plot_contribution(inc_counts, dec_counts, all_positions, "./output/NKX25/motif_affect_NKX25/contribution_bar_plot_lightblue_orange_red_withoutgrid.png")
plot_reversed_contribution(inc_counts, dec_counts, "./output/NKX25/motif_affect_NKX25/contribution_bar_plot_lightblue_orange_red_reverse_withoutgrid.png")
plot_subset_contribution(inc_counts, dec_counts, list(range(16, 21)), list(range(1, 6)), "./output/NKX25/motif_affect_NKX25/Pos_motif_affect_forward_withoutgrid.png")
plot_subset_contribution(inc_counts, dec_counts, list(range(20, 15, -1)), list(range(1, 6)), "./output/NKX25/motif_affect_NKX25/Pos_motif_affect_reverse_withoutgrid.png")
