...
input_path = Path("./output/NKX25/fitting/iteration_results_withunb_with_bi/fitted_K_results_iteration_10.xlsx")
...
output_meme = Path("./output/NKX25/motif_affect_NKX25/MEME/200_sequences_for_meme.xlsx")
output_lsgkm = Path("./output/NKX25/LSGKM/all_sequences_for_lsgm.xlsx")
