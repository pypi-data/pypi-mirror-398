...
class DataProcessor:
    ...
    def load_data(self):
        ...
        try:
            self.df_dict = {
                'df_0nM_B_R1': pd.read_csv('./output/NKX25/CarriedForward/R52_01.csv'),
                'df_0nM_B_R2': pd.read_csv('./output/NKX25/CarriedForward/R52_18.csv'),
                'df_0nM_UnB_R1': pd.read_csv('./output/NKX25/CarriedForward/R52_02.csv'),
                'df_0nM_UnB_R2': pd.read_csv('./output/NKX25/CarriedForward/R52_19.csv'),
                'df_lib1': pd.read_csv('./output/NKX25/CarriedForward/R52_16.csv'),
                'df_lib2': pd.read_csv('./output/NKX25/CarriedForward/R52_17.csv'),
                'seq_count_df': pd.read_excel('./output/NKX25_row_counts_summary.xlsx')
            }
    ...
    def get_total_counts(self):
        ...
        try:
            self.total_counts = {
                'R1': self.df_dict['seq_count_df'].loc[self.df_dict['seq_count_df']['Sample'].str.contains('R52_02'), 'Carried Sequences'].values[0],
                'R2': self.df_dict['seq_count_df'].loc[self.df_dict['seq_count_df']['Sample'].str.contains('R52_19'), 'Carried Sequences'].values[0],
                'Lib1': self.df_dict['seq_count_df'].loc[self.df_dict['seq_count_df']['Sample'].str.contains('R52_16'), 'Carried Sequences'].values[0],
                'Lib2': self.df_dict['seq_count_df'].loc[self.df_dict['seq_count_df']['Sample'].str.contains('R52_17'), 'Carried Sequences'].values[0],
                'B_R1': self.df_dict['seq_count_df'].loc[self.df_dict['seq_count_df']['Sample'].str.contains('R52_01'), 'Carried Sequences'].values[0],
                'B_R2': self.df_dict['seq_count_df'].loc[self.df_dict['seq_count_df']['Sample'].str.contains('R52_18'), 'Carried Sequences'].values[0]
            }
...
def main():
    ...
    parser.add_argument('--excel_file', default='./output/NKX25/rsID_filtering.xlsx', help="Path to the input Excel file (default: 'rsID_filtering.xlsx')")
