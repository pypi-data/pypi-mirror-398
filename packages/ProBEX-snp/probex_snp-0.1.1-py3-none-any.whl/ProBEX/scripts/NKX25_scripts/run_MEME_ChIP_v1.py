...
if __name__ == "__main__":
    ...
    fasta_folder_path = "./output/NKX25/bound_vs_unbound/NKX25_fasta_files/" 
    output_base_path = "./output/NKX25/bound_vs_unbound/meme-output_MEME/"
    
    #fasta_folder_path = "../motif_affect_NKX25/MEME/" 
    #output_base_path = "../motif_affect_NKX25/MEME/meme-output_MEME/"
