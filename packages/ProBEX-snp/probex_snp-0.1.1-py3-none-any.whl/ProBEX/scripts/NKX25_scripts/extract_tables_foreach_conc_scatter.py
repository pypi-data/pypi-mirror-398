...
def main():
    ...
    parser.add_argument("--input_dir", default="./output/NKX25/tables_tex_scatter_plots", help="Directory containing .tex files.")
    parser.add_argument("--output_dir", default="./output/NKX25/scatter_plots_tables", help="Directory to save the output files.")
