...
class DataProcessor:
    def __init__(self, data_dir, accepted_rsids_file, desired_order, output_csv='/home/dell/Desktop/snpoiss_bind_n_seq/output/NKX25_enrich_data.csv'):
    ...
    def plot_heatmap(self, corr_matrix):
        ...
        plt.tight_layout()
        plt.savefig("/home/dell/Desktop/snpoiss_bind_n_seq/output/NKX25/corr_heatmap_rep1_2_with_accepted_rsIDs.png")
        # plt.show()
    ...
    def plot_scatter_3000nM(self):
        ...
        col_r1 = '3000_nM_Bound (R52_13)'
        col_r2 = '3000_nM_Bound_2 (R52_30)'
        ...
        if col_r1 in self.ext_df.columns and col_r2 in self.ext_df.columns:
            ...
            sns.regplot(
                x=x,
                y=y,
                scatter_kws={'color': '#FAA73F', 'edgecolor': 'black', 's': 60},
            ...
            plt.xlabel('3000 nM Bound (R52_13) - Replicate 1', fontsize=12)
            plt.ylabel('3000 nM Bound_2 (R52_30) - Replicate 2', fontsize=12)
            plt.title('Scatter Plot of 3000 nM Enrichment Values (R1 vs R2)', fontsize=14, weight='bold')
            plt.grid(True)
            plt.tight_layout()
            plt.savefig("/home/dell/Desktop/snpoiss_bind_n_seq/output/NKX25/scatter_3000nM_R1_vs_R2.png")
            # plt.show()
...
if __name__ == "__main__":
    ...
    data_dir = '/home/dell/Desktop/snpoiss_bind_n_seq/output/NKX25/bound_vs_unbound/'
    accepted_rsids_file = '/home/dell/Desktop/snpoiss_bind_n_seq/output/NKX25_accepted_rsIDs.csv'
    desired_order = [
        '3000_nM_Bound (R52_13)', '2000_nM_Bound (R52_11)', '1500_nM_Bound (R52_09)', '1000_nM_Bound (R52_07)',
