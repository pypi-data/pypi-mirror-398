...
if __name__ == "__main__":
    ...
    paths = {
        "output_folder": "./output/NKX25/fitting/linePlots_fittedK",
        "merged_df_path": "./output/NKX25/merged_df_NKX25_with_pseudocounts_2point5.csv",
        "denominators_lambda_unb_bi_path": "./output/NKX25/fitting/iteration_results_withunb_with_bi/updated_unbound_denominators_iteration_10.csv",
        "k_values_lambda_bi_path": "./output/NKX25/fitting/iteration_results_withunb_with_bi/fitted_K_results_iteration_10.csv",
        "denominators_lambda_b_bi_path": "./output/NKX25/fitting/iteration_results_withunb_with_bi/updated_bound_denominators_iteration_10.csv"
    }
    csv_files_order = [
