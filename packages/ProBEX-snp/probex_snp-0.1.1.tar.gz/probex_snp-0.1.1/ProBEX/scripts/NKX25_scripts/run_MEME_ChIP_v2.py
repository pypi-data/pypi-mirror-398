...
class MemeChipProcessor:
    ...
    def run_meme_chip(self, fasta_file_path, output_dir):
        try:
            ...
            logging.info("  ")
            subprocess.run(
                ['/home/dell/meme/bin/meme', fasta_file_path, '-mod', 'anr', '-dna', '-revcomp', '-minw', '5', '-maxw', '6', '-nmotifs', '5', '-oc', output_dir],
                check=True
            )
...
if __name__ == "__main__":
    ...
    fasta_folder_path = "./output/NKX25/motif_affect_NKX25/MEME/" 
    output_base_path = "./output/NKX25/motif_affect_NKX25/MEME/meme-output_MEME_200_anr/"
