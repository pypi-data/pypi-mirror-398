...
def plot_subset_contribution(inc_counts, dec_counts, subset_positions, new_positions, output_path):
    ...
    plt.savefig(output_path)
    plt.show()
inc_counts, dec_counts, all_positions = load_and_process_data('../motif_affect_NKX25/processed_increased_sequences.csv', '../motif_affect_NKX25/processed_decreased_sequences.csv')
plot_contribution(inc_counts, dec_counts, all_positions, "../motif_affect_NKX25/contribution_bar_plot_lightblue_orange_red_withoutgrid.png")
plot_reversed_contribution(inc_counts, dec_counts, "../motif_affect_NKX25/contribution_bar_plot_lightblue_orange_red_reverse_withoutgrid.png")
plot_subset_contribution(inc_counts, dec_counts, list(range(16, 21)), list(range(1, 6)), "../motif_affect_NKX25/Pos_motif_affect_forward_withoutgrid.png") #16
plot_subset_contribution(inc_counts, dec_counts, list(range(20, 15, -1)), list(range(1, 6)), "../motif_affect_NKX25/Pos_motif_affect_reverse_withoutgrid.png") #15
