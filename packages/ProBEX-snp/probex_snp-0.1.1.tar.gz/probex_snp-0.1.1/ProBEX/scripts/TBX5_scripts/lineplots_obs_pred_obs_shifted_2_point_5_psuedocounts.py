...
class CombinedEnrichmentPlotter:
    ...
    def process_observed_files(self):
        ...
        try:
            ...
            for _, row in merged_df.iterrows():
                ...
                concentrations = ['100', '1000', '1500', '2000', '3000']
                replicates = ['R1', 'R2']
    ...
    def calculate_observed_enrich_lambda_withbi(self):
        ...
        try:
            merged_df = pd.read_csv(self.merged_df_path)
            concentrations = np.array([100, 1000, 1500, 2000, 3000])
    ...
    def process_predicted_data(self):
        ...
        try:
            ...
            deno_lambda_b_R1 = {
                ...
                '1000': denominators_b.iloc[1, 0],
                '1500': denominators_b.iloc[2, 0],
                '2000': denominators_b.iloc[3, 0],
                '3000': denominators_b.iloc[4, 0]
            }

            deno_lambda_b_R2 = {
                '100': denominators_b.iloc[5, 0],
                '1000': denominators_b.iloc[6, 0],
                '1500': denominators_b.iloc[7, 0],
                '2000': denominators_b.iloc[8, 0],
                '3000': denominators_b.iloc[9, 0]
            }
            
            deno_lambda_unb_R1 = {
                '100': denominators_unb.iloc[0, 0],
                '1000': denominators_unb.iloc[1, 0],
                '1500': denominators_unb.iloc[2, 0],
                '2000': denominators_unb.iloc[3, 0],
                '3000': denominators_unb.iloc[4, 0]
            }

            deno_lambda_unb_R2 = {
                '100': denominators_unb.iloc[5, 0],
                '1000': denominators_unb.iloc[6, 0],
                '1500': denominators_unb.iloc[7, 0],
                '2000': denominators_unb.iloc[8, 0],
                '3000': denominators_unb.iloc[9, 0]
            }        
    ...
    def save_all_plotting_data_to_excel(self):
        ...
        concentration_order = ['100 nM', '1000 nM', '1500 nM', '2000 nM', '3000 nM']
...
if __name__ == "__main__":
    ...
    paths = {
        "output_folder": "./output/TBX5/fitting/linePlots_fittedK",
        "merged_df_path": "./output/TBX5/merged_df_TBX5_with_pseudocounts_2point5.csv",
        "denominators_lambda_unb_bi_path": "./output/TBX5/fitting/iteration_results_withunb_with_bi/updated_unbound_denominators_iteration_10.csv",
        "k_values_lambda_bi_path": "./output/TBX5/fitting/iteration_results_withunb_with_bi/fitted_K_results_iteration_10.csv",
        "denominators_lambda_b_bi_path": "./output/TBX5/fitting/iteration_results_withunb_with_bi/updated_bound_denominators_iteration_10.csv"
    }
    csv_files_order = [
