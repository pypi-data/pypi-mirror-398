...
def main():
    ...
    fitted_k_file = "./output/TBX5/fitting/iteration_results_withunb_with_bi/fitted_K_results_iteration_10.csv"
    increased_rsids_path = "./output/TBX5/motif_affect_TBX5/TBX5increased_rsIDs.txt"
    decreased_rsids_path = "./output/TBX5/motif_affect_TBX5/TBX5decreased_rsIDs.txt"
    allele_info_file = "./output/TBX5/bound_vs_unbound/R52_70_Vs_R52_71.csv"
    output_dir = "./output/TBX5/fitting/K_value_heatmaps"
    ...
    if not increased_matrix.empty:
        ...
        increased_matrix_sorted.to_excel('increased_matrix_sorted_scatter_ref_alts_TBX5.xlsx', index=False)
    ...
    if not decreased_matrix.empty:
        ...
        decreased_matrix_sorted.to_excel('decreased_matrix_sorted_scatter_ref_alts_TBX5.xlsx', index=False)
