...
class PolygonPlotter:
    def __init__(self, folder_path, plot_output_folder, table_output_folder, unbound_path, accepted_rsids_file):
		...
		"R52_78_Vs_R52_79.csv": "3000 nM Bound",
		"R52_76_Vs_R52_77.csv": "2000 nM Bound",
		"R52_74_Vs_R52_75.csv": "1500 nM Bound",
		"R52_72_Vs_R52_73.csv": "1000 nM Bound",
		"R52_70_Vs_R52_71.csv": "500 nM Bound", 
		"R52_68_Vs_R52_69.csv": "100 nM Bound",
		"R52_66_Vs_R52_67.csv": "0 nM Bound",   
		"R52_82_Vs_R52_83.csv": "0 nM Bound_2",
		"R52_84_Vs_R52_85.csv": "100 nM Bound_2", 
		"R52_86_Vs_R52_87.csv": "500 nM Bound_2", 
		"R52_88_Vs_R52_89.csv": "1000 nM Bound_2",
		"R52_90_Vs_R52_91.csv": "1500 nM Bound_2",
		"R52_92_Vs_R52_93.csv": "2000 nM Bound_2", 
		"R52_94_Vs_R52_95.csv": "3000 nM Bound_2"
	}
...
''')
            ...
            for csv_file in sorted(self.csv_files, key=self.extract_number):
                ...
                f.write(f'\\centering\n')
                f.write(f'\\includegraphics[width=\\textwidth]{{{plot_rel}}}\n')
                f.write(f'\\caption{{Scatter plot for {base_name_escaped}.}}\n')
                f.write(f'\\end{{figure}}\n')
                f.write(f'\\input{{{table_rel}}}\n')
                f.write(r'\clearpage' + '\n')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--folder_path', type=str, default='./output/TBX5/bound_vs_unbound/', help="Folder containing the CSV files.")
    parser.add_argument('--plot_output_folder', type=str, default='./output/TBX5/scatter_plots/', help="Folder to save the scatter plots.")
    parser.add_argument('--table_output_folder', type=str, default='./output/TBX5/tables_tex_scatter_plots/', help="Folder to save the table outputs.")
    parser.add_argument('--unbound_path',  type=str, default='./output/TBX5/CarriedForward/', help="Folder containing the unbound files.")
    parser.add_argument('--accepted_rsids_file', type=str, default='./output/TBX5_accepted_rsIDs.csv', help="CSV file with accepted rsIDs.")
