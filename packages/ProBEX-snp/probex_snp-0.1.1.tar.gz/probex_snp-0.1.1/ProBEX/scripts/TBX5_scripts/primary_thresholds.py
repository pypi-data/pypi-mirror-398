    ...
    def process(self):
        ...
        for filename in self.selected_files:
            if filename.endswith(".csv"):
                ...
                summary_df.to_csv("./output/TBX5/summary_5MPass.csv", index=False)
        ...
        labels_df.to_excel("./output/TBX5_labels.xlsx", index=False)
        logging.debug("Saved final labels with '5/MPass' column to TBX5_labels.xlsx.")

def parse_arguments():
    parser = argparse.ArgumentParser(description="Process RSID CSV files.")
    parser.add_argument('--input-dir', type=str, default='./output/TBX5/processsed_files/rsID_added', help="Input directory with CSV files (default: current directory)")
    parser.add_argument('--carried-dir', type=str, default='./output/TBX5/Carried', help="Directory to save carried CSV files (default: './Carried')")
    parser.add_argument('--not-carried-dir', type=str, default='./output/TBX5/notCarried', help="Directory to save not carried CSV files (default: './notCarried')")
    parser.add_argument('--output-excel', type=str, default='./output/TBX5_row_counts_summary.xlsx', help="Output Excel file for summary (default: './output.xlsx')")
    parser.add_argument('--selected-files', nargs='+', default=["R52_66.csv", "R52_68.csv", "R52_70.csv", "R52_72.csv", "R52_74.csv", "R52_76.csv", "R52_78.csv", "R52_82.csv", "R52_84.csv", "R52_86.csv", "R52_88.csv", "R52_90.csv", "R52_92.csv", "R52_94.csv"], help="List of selected CSV files for filtering (optional)")
    parser.add_argument('--rsids-file', type=str, default='./data/rsIDs.csv', help="CSV file with expected rsIDs (default: './rsIDs.csv')")
    parser.add_argument('--output_folder', type=str, default='./output/TBX5/CarriedForward', help="Folder to save processed data (default: './CarriedForward')")
    parser.add_argument('--output_file', type=str, default='./output/TBX5/rsID_filtering.xlsx', help='Path to save the processed output file')
    parser.add_argument('--output-label-file', type=str, default='./output/TBX5_labels.csv', help="Output CSV file for labels (default: './output_labels.csv')")
