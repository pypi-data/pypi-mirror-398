...
class DataProcessor:
    def __init__(self, data_dir, accepted_rsids_file, desired_order, output_csv='./output/TBX5_original_control.csv'):
    ...
    def plot_heatmap(self, corr_matrix):
        ...
        plt.tight_layout()
        plt.savefig("./output/TBX5/corr_heatmap_rep1_2_with_accepted_rsIDs.png")
        #plt.show()
