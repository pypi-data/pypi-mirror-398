...
Description:
	...
	1. Data Loading: Loads the accepted rsIDs from a CSV file (`GATA4_accepted_rsIDs.csv`). Loads and filters the enrichment data from multiple CSV files within a specified directory.
...
"""
class DataProcessor:
    def __init__(self, data_dir, accepted_rsids_file, desired_order, output_csv='./output/GATA4_original_control.csv'):
    ...
    def plot_heatmap(self, corr_matrix):
        ...
        plt.tight_layout()
        plt.savefig("./output/GATA4/corr_heatmap_rep1_2_with_accepted_rsIDs.png")
        plt.show()
