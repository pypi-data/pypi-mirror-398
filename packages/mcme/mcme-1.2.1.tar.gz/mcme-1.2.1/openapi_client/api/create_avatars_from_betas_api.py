...
class CreateAvatarsFromBetasApi(object):
    ...
    def create_avatar_from_betas(self, betas_request : Annotated[SchemasBetasAvatarRequest, Field(..., description="Betas for creating avatar")], **kwargs) -> DocschemasDocBaseSingleJSONAPIResponse:  # noqa: E501
        ...
        Creates an avatar from shape parameters. The betas are used to create a SMPL model. <b>This is a paid endpoint.</b> Creating an avatar from shape betas will deduct 100 credits from the user's account. Credits are only deducted after the avatar is successfully created. Check out the <a href=\"https://me.meshcapade.com/credits\">credits</a> page for more information on credits.  # noqa: E501
