...
class AssetsApi(object):
    ...
    @validate_arguments
    def list_assets(self, include : Annotated[Optional[StrictStr], Field(description="Comma separated tags to include as relationships")] = None, limit : Annotated[Optional[conint(strict=True, ge=1)], Field(description="Paginated avatar limit amount (Default 20)")] = None, page : Annotated[Optional[conint(strict=True, ge=1)], Field(description="Pagination")] = None, filter_field : Annotated[Optional[StrictStr], Field(description="Filter by field")] = None, **kwargs) -> DocschemasDocBaseJSONAPIResponse:  # noqa: E501
        """List assets  # noqa: E501

        Lists all assets the user owns. To include only certain asset types, include a filter query parameter like this: `filter[type]=motion,avatar`. Otherwise, all asset types will be included. To specify whether to include public and/or private assets, use a filter query parameter like this: `filter[visibility]=public,private`. By default, only your private assets will be returned. Use the `include` query parameter string to include related assets. For example, for avatar assets, related assets can be already exported meshes, preview images that have been generated or alternate preview images.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_assets(include, limit, page, filter_field, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the list_assets_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.list_assets_with_http_info(include, limit, page, filter_field, **kwargs)  # noqa: E501

    @validate_arguments
    def list_assets_with_http_info(self, include : Annotated[Optional[StrictStr], Field(description="Comma separated tags to include as relationships")] = None, limit : Annotated[Optional[conint(strict=True, ge=1)], Field(description="Paginated avatar limit amount (Default 20)")] = None, page : Annotated[Optional[conint(strict=True, ge=1)], Field(description="Pagination")] = None, filter_field : Annotated[Optional[StrictStr], Field(description="Filter by field")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List assets  # noqa: E501
        ...
        >>> thread = api.list_assets_with_http_info(include, limit, page, filter_field, async_req=True)
        >>> result = thread.get()
