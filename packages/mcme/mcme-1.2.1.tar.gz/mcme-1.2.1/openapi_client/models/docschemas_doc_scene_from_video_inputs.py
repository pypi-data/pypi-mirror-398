...
class DocschemasDocSceneFromVideoInputs(BaseModel):
    """
    DocschemasDocSceneFromVideoInputs
    """
    lock_feet: Optional[StrictBool] = Field(None, alias="lockFeet")
    max_person_count: Optional[StrictInt] = Field(None, alias="maxPersonCount")
    model_version: Optional[StrictStr] = Field(None, alias="modelVersion")
    scene_name: Optional[StrictStr] = Field(None, alias="sceneName")
    __properties = ["lockFeet", "maxPersonCount", "modelVersion", "sceneName"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocSceneFromVideoInputs:
        """Create an instance of DocschemasDocSceneFromVideoInputs from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocSceneFromVideoInputs:
        """Create an instance of DocschemasDocSceneFromVideoInputs from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocSceneFromVideoInputs.parse_obj(obj)

        _obj = DocschemasDocSceneFromVideoInputs.parse_obj({
            "lock_feet": obj.get("lockFeet"),
            "max_person_count": obj.get("maxPersonCount"),
