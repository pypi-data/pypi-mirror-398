...
class DocschemasDocCreateFromSMPLRequest(BaseModel):
    """
    DocschemasDocCreateFromSMPLRequest
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocCreateFromSMPLRequest:
        """Create an instance of DocschemasDocCreateFromSMPLRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocCreateFromSMPLRequest:
        """Create an instance of DocschemasDocCreateFromSMPLRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocCreateFromSMPLRequest.parse_obj(obj)

        _obj = DocschemasDocCreateFromSMPLRequest.parse_obj({
            "name": obj.get("name")
        })
        return _obj
