...
class DocschemasDocCreateTeamInputs(BaseModel):
    """
    DocschemasDocCreateTeamInputs
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocCreateTeamInputs:
        """Create an instance of DocschemasDocCreateTeamInputs from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocCreateTeamInputs:
        """Create an instance of DocschemasDocCreateTeamInputs from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocCreateTeamInputs.parse_obj(obj)

        _obj = DocschemasDocCreateTeamInputs.parse_obj({
            "name": obj.get("name")
        })
        return _obj
