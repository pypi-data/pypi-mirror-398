...
class DocschemasDocTeamJSONAPIResponse(BaseModel):
    """
    DocschemasDocTeamJSONAPIResponse
    """
    data: Optional[DocschemasDocTeamResponse] = None
    included: Optional[conlist(DocschemasDocTeamInvitesAndUsersResponse)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocTeamJSONAPIResponse:
        """Create an instance of DocschemasDocTeamJSONAPIResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocTeamJSONAPIResponse:
        """Create an instance of DocschemasDocTeamJSONAPIResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocTeamJSONAPIResponse.parse_obj(obj)

        _obj = DocschemasDocTeamJSONAPIResponse.parse_obj({
            "data": DocschemasDocTeamResponse.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "included": [DocschemasDocTeamInvitesAndUsersResponse.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
