...
class DocschemasDocTeamInviteOrUserAttributes(BaseModel):
    """
    DocschemasDocTeamInviteOrUserAttributes
    """
    age_in_seconds: Optional[StrictInt] = None
    created_at: Optional[StrictInt] = None
    email: Optional[StrictStr] = None
    role: Optional[StrictStr] = None
    __properties = ["age_in_seconds", "created_at", "email", "role"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocTeamInviteOrUserAttributes:
        """Create an instance of DocschemasDocTeamInviteOrUserAttributes from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocTeamInviteOrUserAttributes:
        """Create an instance of DocschemasDocTeamInviteOrUserAttributes from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocTeamInviteOrUserAttributes.parse_obj(obj)

        _obj = DocschemasDocTeamInviteOrUserAttributes.parse_obj({
            "age_in_seconds": obj.get("age_in_seconds"),
