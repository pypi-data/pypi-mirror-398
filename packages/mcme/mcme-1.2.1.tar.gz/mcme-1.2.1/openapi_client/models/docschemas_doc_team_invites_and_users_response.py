...
class DocschemasDocTeamInvitesAndUsersResponse(BaseModel):
    """
    DocschemasDocTeamInvitesAndUsersResponse
    """
    attributes: Optional[DocschemasDocTeamInviteOrUserAttributes] = None
    id: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    __properties = ["attributes", "id", "type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocTeamInvitesAndUsersResponse:
        """Create an instance of DocschemasDocTeamInvitesAndUsersResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocTeamInvitesAndUsersResponse:
        """Create an instance of DocschemasDocTeamInvitesAndUsersResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocTeamInvitesAndUsersResponse.parse_obj(obj)

        _obj = DocschemasDocTeamInvitesAndUsersResponse.parse_obj({
            "attributes": DocschemasDocTeamInviteOrUserAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
            "id": obj.get("id"),
            "type": obj.get("type")
        })
        return _obj
