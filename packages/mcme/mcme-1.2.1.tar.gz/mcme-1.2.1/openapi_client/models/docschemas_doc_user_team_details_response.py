...
class DocschemasDocUserTeamDetailsResponse(BaseModel):
    """
    DocschemasDocUserTeamDetailsResponse
    """
    attributes: Optional[DocschemasDocUserTeamDetailsAttributes] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocUserTeamDetailsResponse:
        """Create an instance of DocschemasDocUserTeamDetailsResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocUserTeamDetailsResponse:
        """Create an instance of DocschemasDocUserTeamDetailsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocUserTeamDetailsResponse.parse_obj(obj)

        _obj = DocschemasDocUserTeamDetailsResponse.parse_obj({
            "attributes": DocschemasDocUserTeamDetailsAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
            "id": obj.get("id"),
            "type": obj.get("type")
        })
        return _obj
