...
class DocschemasDocExportInputs(BaseModel):
    ...
    avatar_scene_index: Optional[StrictInt] = Field(None, alias="avatarSceneIndex")
    ...
    __properties = ["animation", "avatarSceneIndex", "compatibilityMode", "filename", "format", "pose"]
    ...
    def from_dict(cls, obj: dict) -> DocschemasDocExportInputs:
        ...
        _obj = DocschemasDocExportInputs.parse_obj({
            ...
            "avatar_scene_index": obj.get("avatarSceneIndex"),
