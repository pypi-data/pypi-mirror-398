...
class DocschemasDocUserJSONAPIResponse(BaseModel):
    ...
    included: Optional[conlist(DocschemasDocUserTeamDetailsResponse)] = None
    ...
    def from_dict(cls, obj: dict) -> DocschemasDocUserJSONAPIResponse:
        ...
        _obj = DocschemasDocUserJSONAPIResponse.parse_obj({
            ...
            "included": [DocschemasDocUserTeamDetailsResponse.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
