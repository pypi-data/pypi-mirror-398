...
class DocschemasDocUserTeamDetailsAttributes(BaseModel):
    """
    DocschemasDocUserTeamDetailsAttributes
    """
    name: Optional[StrictStr] = None
    num_seats: Optional[StrictInt] = Field(None, alias="numSeats")
    num_seats_occupied: Optional[StrictInt] = Field(None, alias="numSeatsOccupied")
    role: Optional[StrictStr] = None
    __properties = ["name", "numSeats", "numSeatsOccupied", "role"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocUserTeamDetailsAttributes:
        """Create an instance of DocschemasDocUserTeamDetailsAttributes from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocUserTeamDetailsAttributes:
        """Create an instance of DocschemasDocUserTeamDetailsAttributes from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocUserTeamDetailsAttributes.parse_obj(obj)

        _obj = DocschemasDocUserTeamDetailsAttributes.parse_obj({
            "name": obj.get("name"),
            "num_seats": obj.get("numSeats"),
            "num_seats_occupied": obj.get("numSeatsOccupied"),
            "role": obj.get("role")
        })
        return _obj
