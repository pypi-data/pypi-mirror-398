...
class UserApi(object):
    ...
    @validate_arguments
    def describe_user(self, include : Annotated[Optional[StrictStr], Field(description="Comma separated tags to include as relationships")] = None, **kwargs) -> DocschemasDocUserJSONAPIResponse:  # noqa: E501
        """Describes the user  # noqa: E501

        Describe the current user's information, including details such as name, email, and credit balance. If an `include=team` URL query param is provided, then this will also include details about the user's team, including the team name and ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.describe_user(include, async_req=True)
        >>> result = thread.get()
        ...
        return self.describe_user_with_http_info(include, **kwargs)  # noqa: E501

    @validate_arguments
    def describe_user_with_http_info(self, include : Annotated[Optional[StrictStr], Field(description="Comma separated tags to include as relationships")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Describes the user  # noqa: E501
        ...
        >>> thread = api.describe_user_with_http_info(include, async_req=True)
        >>> result = thread.get()
