...
class CreateSceneFromVideoApi(object):
    ...
    @validate_arguments
    def create_scene_from_video(self, **kwargs) -> DocschemasDocBaseSingleJSONAPIResponse:  # noqa: E501
        """Initiate scene from Video creation  # noqa: E501

        Constructs an empty scene in preparation for creating a scene from video. The client has to upload a video to the scene before starting the fitting process. The uploaded video gets \"attached\" to this scene. The fitting process might take a couple of minutes to complete. This will be indicated by the status of the scene. </br> First step is calling this endpoint to create the empty scene </br> Then request a presigned PUT url to upload your video to from [POST /scenes/{assetID}/video](#post-/scenes/-assetID-/video) </br> After you've uploaded a video you can kick off the inference process to produce the final scene filled with multiple avatars. </br> Start the process by calling [POST /scenes/{assetID}/fit-to-video](#post-/scenes/-assetID-/fit-to-video)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_scene_from_video(async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the create_scene_from_video_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.create_scene_from_video_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def create_scene_from_video_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Initiate scene from Video creation  # noqa: E501
        ...
        >>> thread = api.create_scene_from_video_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method create_scene_from_video" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def scene_fit_to_video(self, asset_id : Annotated[StrictStr, Field(..., description="Scene ID")], input : Annotated[DocschemasDocSceneFromVideoInputs, Field(..., description="Request parameters")], **kwargs) -> DocschemasDocBaseSingleJSONAPIResponse:  # noqa: E501
        """Start fitting process to Video from multiple avatars  # noqa: E501

        Starts the fitting process to create a scene with multiple avatars from Video. </br> Call endpoint [POST /scenes/create/from-video](#post-/scenes/create/from-video) before calling this endpoint. </br> Has to be run on the same scene as the preparation call. One video has to be uploaded before starting the fitting process. </br> The fitting process might take a couple of minutes to complete. This will be indicated by the status of the scene asset. </br> <b>This is a paid endpoint.</b> Creating a scene from a video will deduct 500 credits from the user's account. Credits are only deducted after the avatar is successfully created. Check out the <a href=\"https://me.meshcapade.com/credits\">credits</a> page for more information on credits.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.scene_fit_to_video(asset_id, input, async_req=True)
        >>> result = thread.get()

        :param asset_id: Scene ID (required)
        :type asset_id: str
        :param input: Request parameters (required)
        :type input: DocschemasDocSceneFromVideoInputs
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the scene_fit_to_video_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.scene_fit_to_video_with_http_info(asset_id, input, **kwargs)  # noqa: E501

    @validate_arguments
    def scene_fit_to_video_with_http_info(self, asset_id : Annotated[StrictStr, Field(..., description="Scene ID")], input : Annotated[DocschemasDocSceneFromVideoInputs, Field(..., description="Request parameters")], **kwargs) -> ApiResponse:  # noqa: E501
        """Start fitting process to Video from multiple avatars  # noqa: E501
        ...
        >>> thread = api.scene_fit_to_video_with_http_info(asset_id, input, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method scene_fit_to_video" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/scenes/{assetID}/fit-to-video', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def upload_video_to_scene(self, asset_id : Annotated[StrictStr, Field(..., description="Scene ID")], **kwargs) -> DocschemasDocBaseSingleJSONAPIResponse:  # noqa: E501
        """Request Video upload URL for scene creation  # noqa: E501

        Request Video upload URL for a scene.  Creates a link between the video image asset and the scene asset in preparation for fitting the avatar to the scan. If this endpoint is called, a Video has to be uploaded before starting the fitting process, otherwise it will fail. You can call `DELETE /videos/{videoid}` to delete the Video The upload URL is a presigned PUT URL that can be used to upload the file to the server..  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.upload_video_to_scene(asset_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the upload_video_to_scene_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.upload_video_to_scene_with_http_info(asset_id, **kwargs)  # noqa: E501

    @validate_arguments
    def upload_video_to_scene_with_http_info(self, asset_id : Annotated[StrictStr, Field(..., description="Scene ID")], **kwargs) -> ApiResponse:  # noqa: E501
        """Request Video upload URL for scene creation  # noqa: E501
        ...
        >>> thread = api.upload_video_to_scene_with_http_info(asset_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method upload_video_to_scene" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
