...
class DocschemasDocCreditBundleResponse(BaseModel):
    """
    DocschemasDocCreditBundleResponse
    """
    attributes: Optional[DocschemasDocCreditBundleAttributes] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocCreditBundleResponse:
        """Create an instance of DocschemasDocCreditBundleResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocCreditBundleResponse:
        """Create an instance of DocschemasDocCreditBundleResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocCreditBundleResponse.parse_obj(obj)

        _obj = DocschemasDocCreditBundleResponse.parse_obj({
            "attributes": DocschemasDocCreditBundleAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
            "id": obj.get("id"),
            "type": obj.get("type")
        })
        return _obj
