...
class DocschemasDocPatchTeamInputs(BaseModel):
    """
    DocschemasDocPatchTeamInputs
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocPatchTeamInputs:
        """Create an instance of DocschemasDocPatchTeamInputs from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocPatchTeamInputs:
        """Create an instance of DocschemasDocPatchTeamInputs from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocPatchTeamInputs.parse_obj(obj)

        _obj = DocschemasDocPatchTeamInputs.parse_obj({
            "name": obj.get("name")
        })
        return _obj
