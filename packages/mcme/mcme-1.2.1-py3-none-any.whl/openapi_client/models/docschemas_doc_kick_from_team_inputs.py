...
class DocschemasDocKickFromTeamInputs(BaseModel):
    """
    DocschemasDocKickFromTeamInputs
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocKickFromTeamInputs:
        """Create an instance of DocschemasDocKickFromTeamInputs from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocKickFromTeamInputs:
        """Create an instance of DocschemasDocKickFromTeamInputs from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocKickFromTeamInputs.parse_obj(obj)

        _obj = DocschemasDocKickFromTeamInputs.parse_obj({
            "email": obj.get("email")
        })
        return _obj
