...
class DocschemasDocInviteToTeamInputs(BaseModel):
    """
    DocschemasDocInviteToTeamInputs
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocInviteToTeamInputs:
        """Create an instance of DocschemasDocInviteToTeamInputs from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocInviteToTeamInputs:
        """Create an instance of DocschemasDocInviteToTeamInputs from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocInviteToTeamInputs.parse_obj(obj)

        _obj = DocschemasDocInviteToTeamInputs.parse_obj({
            "email": obj.get("email")
        })
        return _obj
