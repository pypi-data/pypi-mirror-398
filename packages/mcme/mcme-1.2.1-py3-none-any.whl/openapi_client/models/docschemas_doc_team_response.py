...
class DocschemasDocTeamResponse(BaseModel):
    """
    DocschemasDocTeamResponse
    """
    attributes: Optional[DocschemasDocTeamAttributes] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocTeamResponse:
        """Create an instance of DocschemasDocTeamResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocTeamResponse:
        """Create an instance of DocschemasDocTeamResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocTeamResponse.parse_obj(obj)

        _obj = DocschemasDocTeamResponse.parse_obj({
            "attributes": DocschemasDocTeamAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
            "id": obj.get("id"),
            "type": obj.get("type")
        })
        return _obj
