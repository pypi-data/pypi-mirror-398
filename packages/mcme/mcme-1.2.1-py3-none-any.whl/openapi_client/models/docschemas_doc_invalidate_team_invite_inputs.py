...
class DocschemasDocInvalidateTeamInviteInputs(BaseModel):
    """
    DocschemasDocInvalidateTeamInviteInputs
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocInvalidateTeamInviteInputs:
        """Create an instance of DocschemasDocInvalidateTeamInviteInputs from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocInvalidateTeamInviteInputs:
        """Create an instance of DocschemasDocInvalidateTeamInviteInputs from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocInvalidateTeamInviteInputs.parse_obj(obj)

        _obj = DocschemasDocInvalidateTeamInviteInputs.parse_obj({
            "email": obj.get("email")
        })
        return _obj
