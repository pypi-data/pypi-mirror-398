...
class DocschemasDocTeamAttributes(BaseModel):
    """
    DocschemasDocTeamAttributes
    """
    name: Optional[StrictStr] = None
    num_seats: Optional[StrictInt] = Field(None, alias="numSeats")
    __properties = ["name", "numSeats"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocTeamAttributes:
        """Create an instance of DocschemasDocTeamAttributes from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocTeamAttributes:
        """Create an instance of DocschemasDocTeamAttributes from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocTeamAttributes.parse_obj(obj)

        _obj = DocschemasDocTeamAttributes.parse_obj({
            "name": obj.get("name"),
