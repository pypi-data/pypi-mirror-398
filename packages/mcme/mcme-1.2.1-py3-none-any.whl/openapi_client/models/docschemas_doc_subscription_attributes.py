...
class DocschemasDocSubscriptionAttributes(BaseModel):
    ...
    next_charge_amount: Optional[Union[StrictFloat, StrictInt]] = None
    next_charge_amount_currency_symbol: Optional[StrictStr] = None
    ...
    __properties = ["end_date", "next_charge_amount", "next_charge_amount_currency_symbol", "next_top_up_amount", "next_top_up_date", "plan", "start_date", "subscription_state", "top_up_cadence"]
    ...
    def from_dict(cls, obj: dict) -> DocschemasDocSubscriptionAttributes:
        ...
        _obj = DocschemasDocSubscriptionAttributes.parse_obj({
            ...
            "next_charge_amount": obj.get("next_charge_amount"),
            "next_charge_amount_currency_symbol": obj.get("next_charge_amount_currency_symbol"),
