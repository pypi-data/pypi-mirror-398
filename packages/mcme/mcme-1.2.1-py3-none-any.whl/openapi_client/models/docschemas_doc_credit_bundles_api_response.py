...
class DocschemasDocCreditBundlesAPIResponse(BaseModel):
    """
    DocschemasDocCreditBundlesAPIResponse
    """
    data: Optional[conlist(DocschemasDocCreditBundleResponse)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocCreditBundlesAPIResponse:
        """Create an instance of DocschemasDocCreditBundlesAPIResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocCreditBundlesAPIResponse:
        """Create an instance of DocschemasDocCreditBundlesAPIResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocCreditBundlesAPIResponse.parse_obj(obj)

        _obj = DocschemasDocCreditBundlesAPIResponse.parse_obj({
            "data": [DocschemasDocCreditBundleResponse.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
