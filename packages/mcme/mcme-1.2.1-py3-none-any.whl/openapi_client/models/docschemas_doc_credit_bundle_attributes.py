...
class DocschemasDocCreditBundleAttributes(BaseModel):
    """
    DocschemasDocCreditBundleAttributes
    """
    credits: Optional[StrictInt] = None
    currency: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    price: Optional[Union[StrictFloat, StrictInt]] = None
    __properties = ["credits", "currency", "name", "price"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocCreditBundleAttributes:
        """Create an instance of DocschemasDocCreditBundleAttributes from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocCreditBundleAttributes:
        """Create an instance of DocschemasDocCreditBundleAttributes from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocCreditBundleAttributes.parse_obj(obj)

        _obj = DocschemasDocCreditBundleAttributes.parse_obj({
