...
class OpenAIEmbeddingProvider(BaseEmbeddingProvider):
    ...
    # Parameters that should go into extra_body for OpenAI API
    _EXTRA_BODY_PARAMS: Set[str] = (
        set()
    )  # OpenAI doesn't typically need extra_body params
    ...
    def __init__(self, config: Dict[str, Any], **kwargs: Any) -> None:
        ...
        try:
            ...
            if (
                ...
                # Typical format: "got an unexpected keyword argument 'param_name'"
                import re
