...
SCANNER_PAYLOADS = {
    ...
    "js_setTimeout_string": PayloadEntry(
        ...
        severity="high",
        contexts=["javascript"],
        tags=["javascript", "setTimeout", "timer", "eval"],
        waf_evasion=False,
        bypasses=[],
        cvss_score=6.1,
    ),
    "js_setInterval_string": PayloadEntry(
        ...
        severity="high",
        contexts=["javascript"],
        tags=["javascript", "setInterval", "timer", "eval"],
        waf_evasion=False,
        bypasses=[],
        cvss_score=6.1,
    ),
    # JavaScript Constructor Techniques
    "js_Function_constructor": PayloadEntry(
        ...
        severity="high",
        contexts=["javascript"],
        tags=["javascript", "function", "constructor", "indirect"],
        waf_evasion=True,
    ...
    "js_array_constructor_chain": PayloadEntry(
        ...
        severity="high",
        contexts=["javascript"],
        tags=["javascript", "constructor", "indirect", "array"],
        waf_evasion=True,
    ...
    "url_js_setTimeout": PayloadEntry(
        ...
        severity="high",
        contexts=["url"],
        tags=["javascript", "protocol", "setTimeout", "url"],
        waf_evasion=False,
        bypasses=[],
        cvss_score=6.1,
    ),
