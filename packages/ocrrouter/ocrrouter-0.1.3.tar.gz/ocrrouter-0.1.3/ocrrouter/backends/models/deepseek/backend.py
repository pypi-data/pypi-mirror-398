...
class DeepSeekBackend(BaseModelBackend):
    ...
    Example:
        ...
        >>> backend = DeepSeekBackend(settings)
    ...
    async def analyze(
        ...
        **kwargs: Any,
        ...
        2. Runs the DeepSeek model for layout detection and content extraction
        ...
        # Run DeepSeek model based on output_mode
        ...
        # The results are list[list[ContentBlock]], same format as MinerU
