...
class Node(ABC):
    ...
    Note:
        This is an abstract class. Use the concrete implementations:
        MiscellaneousNode, ParallelNode, RouterNode, or AgentNode.
    """
    ...
    def _emit_created(
        ...
        """
        Emit the node_created event to Kinesis.
        ...
        if success:
            ...
            logger.info(f"Created node: {self.node_id} ({self.node_type})")
    ...
    def create(self) -> bool:
        """
        Create the node by emitting the node_created event.

        This abstract method must be implemented by subclasses to define
        how the node is created and what data is included in the event.
...
class MiscellaneousNode(Node):
    ...
    def create(self) -> bool:
        ...
        return self._emit_created(status='started')
...
class RouterNode(Node):
    ...
    def create(self) -> bool:
        ...
        return self._emit_created(status='started', metadata=self.metadata)
