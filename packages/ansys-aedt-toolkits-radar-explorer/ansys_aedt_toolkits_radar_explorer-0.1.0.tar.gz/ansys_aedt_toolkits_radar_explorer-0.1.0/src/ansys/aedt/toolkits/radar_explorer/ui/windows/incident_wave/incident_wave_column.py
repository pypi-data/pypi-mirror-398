...
################################################################################
## Form generated from reading UI file 'post_2d_column.ui'
##
...
class Ui_LeftColumn(object):
    def setupUi(self, LeftColumn):
        ...
        self.menu_incident_wave = QWidget()
        self.menu_incident_wave.setObjectName("menu_incident_wave")
        self.menu_home_layout = QVBoxLayout(self.menu_incident_wave)
        ...
        self.incident_wave_vertical_layout = QVBoxLayout()
        self.incident_wave_vertical_layout.setObjectName("incident_wave_vertical_layout")

        self.menu_home_layout.addLayout(self.incident_wave_vertical_layout)

        self.verticalSpacer = QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)

        self.menu_home_layout.addItem(self.verticalSpacer)

        self.menus.addWidget(self.menu_incident_wave)
