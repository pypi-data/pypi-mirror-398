...
from .exceptions import ChecksumConfigError, ChecksumMismatchError
...
def load_model(
    ...
    if source == "local":
        ...
        try:
            verify_local_model_checksums(model_path, model_cfg)
        except (ChecksumConfigError, ChecksumMismatchError) as e:
            raise ModelLoadError("Local model checksum verification failed", e)
