...
Use this tool online at **[DevTools.at](https://devtools.at/tools/sql-formatter)** - Free, fast, and no registration required!

## Installation

```bash
pip install devtools_sql_formatter
```

## Usage

```python
from devtools_sql_formatter import process, encode, decode
...
**[https://devtools.at/tools/sql-formatter](https://devtools.at/tools/sql-formatter)**
