...
- 🔍 **Auto-discovery** - Automatically finds your Cursor databases on macOS, Linux, and Windows
- 📁 **Project organized** - Exports conversations grouped by workspace/project
- 🛠️ **Tool call tracking** - Includes full tool call details (file edits, terminal commands, searches)
- ✅ **Approval tracking** - Shows which changes were approved/rejected by the user
- 📊 **Statistics** - Get quick stats about your conversation history
...
Output:
```
🔍 Searching for Cursor databases...

Default search paths:
  ✅ /Users/you/Library/Application Support/Cursor/User/globalStorage/state.vscdb
  ❌ /Users/you/Library/Application Support/Cursor Nightly/User/globalStorage/state.vscdb
  ...
...
output/
├── my-project/
│   ├── 2024-01-15_10-30-00_Add_dark_mode_toggle.txt
│   └── 2024-01-16_14-22-10_Fix_login_bug.txt
├── another-project/
│   └── 2024-01-17_09-00-00_Refactor_API.txt
└── unknown/
    └── 2024-01-18_11-45-00_abc123.txt
```
