...
<c-lbdocs.codeblock_title title="templates/theme_info.html">
{% verbatim %}
```html
{% load lb_tags %}
...
<c-lbdocs.codeblock_title title="static_src/input.css">
```css
@import "tailwindcss";
@plugin "daisyui" {
...
<c-lbdocs.codeblock_title title="urls.py">
```python
...
<c-lbdocs.codeblock_title title="views.py">
```python
