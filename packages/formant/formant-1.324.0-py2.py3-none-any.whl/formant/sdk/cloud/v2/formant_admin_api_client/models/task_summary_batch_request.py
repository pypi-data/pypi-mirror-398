...
T = TypeVar("T", bound="TaskSummaryBatchRequest")

@attr.s(auto_attribs=True)
class TaskSummaryBatchRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        task_summary_batch_request = cls(
            items=items,
            ignore_duplicates=ignore_duplicates,
            without_device_tags=without_device_tags,
        )

        task_summary_batch_request.additional_properties = d
        return task_summary_batch_request
