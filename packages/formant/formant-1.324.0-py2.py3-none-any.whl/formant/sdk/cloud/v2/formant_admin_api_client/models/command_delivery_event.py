...
class CommandDeliveryEvent:
    ...
    Attributes:
        ...
        metadata (Union[Unset, CommandDeliveryEventMetadata]): User-customizable metadata associated with this event in
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.command_delivery_event_metadata import \
            CommandDeliveryEventMetadata
        from ..models.command_delivery_event_tags import \
