...
if TYPE_CHECKING:
  ...
  from ..models.command_template_parameter_meta import \
...
class CommandTemplate:
    """
    Attributes:
        name (str): Name of this command template.
        command (str): Function, script, or routine that will be executed by a command in this template.
        parameter_enabled (bool): If you want to send parameters with your command, set this to `true`.
        ...
        parameter_meta (Union[Unset, CommandTemplateParameterMeta]): You can use this to add many parameters in a more
            structured way.
