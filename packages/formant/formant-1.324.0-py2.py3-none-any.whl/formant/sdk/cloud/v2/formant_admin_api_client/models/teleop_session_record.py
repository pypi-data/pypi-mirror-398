...
from ..models.teleop_session_record_stream_type import \
...
if TYPE_CHECKING:
  ...
  from ..models.teleop_session_record_metadata import \
...
class TeleopSessionRecord:
    ...
    Attributes:
        ...
        metadata (Union[Unset, TeleopSessionRecordMetadata]): User-customizable metadata associated with this event in
