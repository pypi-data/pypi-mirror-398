...
def _parse_response(*, response: httpx.Response) -> Optional[IntegrationListResponse]:
...
def _build_response(*, response: httpx.Response) -> Response[IntegrationListResponse]:
    return Response(
