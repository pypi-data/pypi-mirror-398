...
class Command:
    """
    Attributes:
        device_id (str): ID of the device on which this command should run.
        command (str): Function, script, or routine to execute.
        ...
        stream_type (Union[Unset, None, CommandStreamType]): Used by Formant agent only, ignore.
        tags (Union[Unset, None, CommandTags]): Tags associated with this command instance.
