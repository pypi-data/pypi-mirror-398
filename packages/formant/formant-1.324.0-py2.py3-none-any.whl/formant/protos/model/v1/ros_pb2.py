...
_ROSTOPICTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='STD_MSGS_FLOAT32', index=10, number=20,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='SENSOR_MSGS_JOINT_STATE', index=11, number=10,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='GEOMETRY_MSGS_POSE_WITH_COVARIANCE', index=12, number=11,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='SENSOR_MSGS_POINT_CLOUD2', index=13, number=12,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='SENSOR_MSGS_LASER_SCAN', index=14, number=13,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='GEOMETRY_MSGS_POINT', index=15, number=14,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='VISUALIZATION_MSGS_MARKER_ARRAY', index=16, number=15,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='NAV_MSGS_ODOMETRY', index=17, number=16,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='SENSOR_MSGS_JOY', index=18, number=17,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='NAV_MSGS_OCCUPANCY_GRID', index=19, number=18,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='SENSOR_MSGS_NAV_SAT_FIX', index=20, number=19,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_ROSTOPIC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='rosVersion', full_name='v1.model.ROSTopic.rosVersion', index=3,
...
_ROSLOCALIZATION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='rosVersion', full_name='v1.model.ROSLocalization.rosVersion', index=6,
...
_ROSMESSAGETOPUBLISH = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='map', full_name='v1.model.ROSMessageToPublish.map', index=13,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='location', full_name='v1.model.ROSMessageToPublish.location', index=14,
...
_ROSMESSAGETOPUBLISH.fields_by_name['map'].message_type = protos_dot_model_dot_v1_dot_navigation__pb2._MAP
_ROSMESSAGETOPUBLISH.fields_by_name['location'].message_type = protos_dot_model_dot_v1_dot_navigation__pb2._LOCATION
...
_ROSMESSAGETOPUBLISH.oneofs_by_name['data'].fields.append(
  _ROSMESSAGETOPUBLISH.fields_by_name['map'])
_ROSMESSAGETOPUBLISH.fields_by_name['map'].containing_oneof = _ROSMESSAGETOPUBLISH.oneofs_by_name['data']
_ROSMESSAGETOPUBLISH.oneofs_by_name['data'].fields.append(
  _ROSMESSAGETOPUBLISH.fields_by_name['location'])
_ROSMESSAGETOPUBLISH.fields_by_name['location'].containing_oneof = _ROSMESSAGETOPUBLISH.oneofs_by_name['data']
