...
_AGENTCONFIGURATIONDOCUMENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='realtime', full_name='v1.model.AgentConfigurationDocument.realtime', index=12,
...
_REALTIMECONFIGURATION = _descriptor.Descriptor(
  name='RealtimeConfiguration',
  full_name='v1.model.RealtimeConfiguration',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='ros_streams', full_name='v1.model.RealtimeConfiguration.ros_streams', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='custom_streams', full_name='v1.model.RealtimeConfiguration.custom_streams', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='hardware_streams', full_name='v1.model.RealtimeConfiguration.hardware_streams', index=2,
      number=3, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TELEOPROSSTREAMCONFIGURATION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='label', full_name='v1.model.TeleopRosStreamConfiguration.label', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='ros_version', full_name='v1.model.TeleopRosStreamConfiguration.ros_version', index=12,
...
_TELEOPHARDWARESTREAMCONFIGURATION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='label', full_name='v1.model.TeleopHardwareStreamConfiguration.label', index=13,
...
_TELEOPCUSTOMSTREAMCONFIGURATION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='label', full_name='v1.model.TeleopCustomStreamConfiguration.label', index=8,
      number=9, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_AGENTCONFIGURATIONDOCUMENT.fields_by_name['realtime'].message_type = _REALTIMECONFIGURATION
...
_REALTIMECONFIGURATION.fields_by_name['ros_streams'].message_type = _TELEOPROSSTREAMCONFIGURATION
_REALTIMECONFIGURATION.fields_by_name['custom_streams'].message_type = _TELEOPCUSTOMSTREAMCONFIGURATION
_REALTIMECONFIGURATION.fields_by_name['hardware_streams'].message_type = _TELEOPHARDWARESTREAMCONFIGURATION
...
DESCRIPTOR.message_types_by_name['RealtimeConfiguration'] = _REALTIMECONFIGURATION
...
RealtimeConfiguration = _reflection.GeneratedProtocolMessageType('RealtimeConfiguration', (_message.Message,), {
  'DESCRIPTOR' : _REALTIMECONFIGURATION,
  '__module__' : 'protos.model.v1.config_pb2'
  # @@protoc_insertion_point(class_scope:v1.model.RealtimeConfiguration)
  })
_sym_db.RegisterMessage(RealtimeConfiguration)
