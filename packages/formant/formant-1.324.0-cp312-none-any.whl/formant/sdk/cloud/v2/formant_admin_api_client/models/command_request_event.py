...
from ..models.command_request_event_stream_type import \
    CommandRequestEventStreamType
from ..models.command_request_event_type import CommandRequestEventType
from ..types import UNSET, Unset

if TYPE_CHECKING:
  from ..models.command_request_event_metadata import \
      CommandRequestEventMetadata
  from ..models.command_request_event_tags import CommandRequestEventTags
  from ..models.notification_muted import NotificationMuted




T = TypeVar("T", bound="CommandRequestEvent")
...
class CommandRequestEvent:
    ...
    Attributes:
        ...
        command_id (str):
        type (Union[Unset, CommandRequestEventType]):
        user_id (Union[Unset, None, str]): User ID associated with this event.
        id (Union[Unset, str]):
        created_at (Union[Unset, datetime.datetime]):
        updated_at (Union[Unset, datetime.datetime]):
        tags (Union[Unset, CommandRequestEventTags]):
        ...
        metadata (Union[Unset, CommandRequestEventMetadata]): User-customizable metadata associated with this event in
        ...
        stream_type (Union[Unset, None, CommandRequestEventStreamType]):
    ...
    command_id: str
    type: Union[Unset, CommandRequestEventType] = UNSET
    user_id: Union[Unset, None, str] = UNSET
    id: Union[Unset, str] = UNSET
    created_at: Union[Unset, datetime.datetime] = UNSET
    updated_at: Union[Unset, datetime.datetime] = UNSET
    tags: Union[Unset, 'CommandRequestEventTags'] = UNSET
    ...
    metadata: Union[Unset, 'CommandRequestEventMetadata'] = UNSET
    message: Union[Unset, str] = UNSET
    viewed: Union[Unset, bool] = UNSET
    device_id: Union[Unset, None, str] = UNSET
    stream_name: Union[Unset, None, str] = UNSET
    stream_type: Union[Unset, None, CommandRequestEventStreamType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type,  Unset):
            ...
            type = CommandRequestEventType(_type)
        ...
        if isinstance(_tags,  Unset):
            ...
            tags = CommandRequestEventTags.from_dict(_tags)
        ...
        metadata: Union[Unset, CommandRequestEventMetadata]
        if isinstance(_metadata,  Unset):
            metadata = UNSET
        else:
            metadata = CommandRequestEventMetadata.from_dict(_metadata)
        ...
        if _stream_type is None:
            ...
            stream_type = CommandRequestEventStreamType(_stream_type)
        ...
        command_request_event.additional_properties = d
        return command_request_event
