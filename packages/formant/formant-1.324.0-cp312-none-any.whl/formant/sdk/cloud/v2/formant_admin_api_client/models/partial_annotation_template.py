...
if TYPE_CHECKING:
  ...
  from ..models.partial_annotation_template_tags import \
...
class PartialAnnotationTemplate:
    ...
    Attributes:
        ...
        fields (Union[Unset, List['AnnotationField']]): JSON object containing the fields for this annotation template.
