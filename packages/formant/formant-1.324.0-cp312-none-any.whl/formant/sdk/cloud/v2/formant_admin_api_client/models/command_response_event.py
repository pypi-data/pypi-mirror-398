...
from ..models.command_response_event_stream_type import \
    CommandResponseEventStreamType
from ..models.command_response_event_type import CommandResponseEventType
from ..types import UNSET, Unset

if TYPE_CHECKING:
  from ..models.command_response_event_metadata import \
      CommandResponseEventMetadata
  from ..models.command_response_event_tags import CommandResponseEventTags
  from ..models.notification_muted import NotificationMuted




T = TypeVar("T", bound="CommandResponseEvent")
...
class CommandResponseEvent:
    ...
    Attributes:
        ...
        command_id (str):
        type (Union[Unset, CommandResponseEventType]):
        id (Union[Unset, str]):
        created_at (Union[Unset, datetime.datetime]):
        updated_at (Union[Unset, datetime.datetime]):
        tags (Union[Unset, CommandResponseEventTags]):
        ...
        metadata (Union[Unset, CommandResponseEventMetadata]): User-customizable metadata associated with this event in
        ...
        stream_type (Union[Unset, None, CommandResponseEventStreamType]):
    ...
    command_id: str
    type: Union[Unset, CommandResponseEventType] = UNSET
    id: Union[Unset, str] = UNSET
    created_at: Union[Unset, datetime.datetime] = UNSET
    updated_at: Union[Unset, datetime.datetime] = UNSET
    tags: Union[Unset, 'CommandResponseEventTags'] = UNSET
    ...
    metadata: Union[Unset, 'CommandResponseEventMetadata'] = UNSET
    message: Union[Unset, str] = UNSET
    viewed: Union[Unset, bool] = UNSET
    device_id: Union[Unset, None, str] = UNSET
    stream_name: Union[Unset, None, str] = UNSET
    stream_type: Union[Unset, None, CommandResponseEventStreamType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.command_response_event_metadata import \
            CommandResponseEventMetadata
        from ..models.command_response_event_tags import \
        ...
        if isinstance(_type,  Unset):
            ...
            type = CommandResponseEventType(_type)
        ...
        if isinstance(_tags,  Unset):
            ...
            tags = CommandResponseEventTags.from_dict(_tags)
        ...
        metadata: Union[Unset, CommandResponseEventMetadata]
        if isinstance(_metadata,  Unset):
            metadata = UNSET
        else:
            metadata = CommandResponseEventMetadata.from_dict(_metadata)
        ...
        if _stream_type is None:
            ...
            stream_type = CommandResponseEventStreamType(_stream_type)
        ...
        command_response_event.additional_properties = d
        return command_response_event
