...
from ..models.partial_email_configuration_email_type import \
    PartialEmailConfigurationEmailType
from ..models.partial_email_configuration_language import \
...
class PartialEmailConfiguration:
    ...
    Attributes:
        ...
        language (Union[Unset, PartialEmailConfigurationLanguage]):
    ...
    language: Union[Unset, PartialEmailConfigurationLanguage] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_language,  Unset):
            ...
            language = PartialEmailConfigurationLanguage(_language)
