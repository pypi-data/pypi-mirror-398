...
if TYPE_CHECKING:
  ...
  from ..models.device_configuration_template_tags import \
...
class DeviceConfigurationTemplate:
    ...
    Attributes:
        ...
        tags (Union[Unset, DeviceConfigurationTemplateTags]):
    """
    ...
    tags: Union[Unset, 'DeviceConfigurationTemplateTags'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_tags,  Unset):
            ...
            tags = DeviceConfigurationTemplateTags.from_dict(_tags)
