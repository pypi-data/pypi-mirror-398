...
class PartialAdapter:
    ...
    Attributes:
        ...
        name (Union[Unset, str]): Name of this adapter.
        file_id (Union[Unset, str]): ID of the zip file which contains the adapter you want to add.
        exec_command (Union[Unset, str]): Enter the execution command to start this adapter (typically `./start.sh`).
