...
T = TypeVar("T", bound="PointCloudViewConfiguration")

@attr.s(auto_attribs=True)
class PointCloudViewConfiguration:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        point_cloud_view_configuration = cls(
            camera=camera,
        )

        point_cloud_view_configuration.additional_properties = d
        return point_cloud_view_configuration
