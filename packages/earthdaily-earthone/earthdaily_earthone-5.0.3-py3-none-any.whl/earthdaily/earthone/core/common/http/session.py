...
class Session(requests.Session):
    ...
    :py:class:`~earthdaily.earthone.client.services.service.Service` or register it as the
    default session class using
    :py:meth:`~earthdaily.earthone.client.services.service.Service.set_default_session_class`.
