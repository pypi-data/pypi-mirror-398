...
class DocumentState(StrEnum):
    ...
    MODIFIED : enum
        ...
        :py:meth:`~earthdaily.earthone.catalog.Product.get` or
        :py:meth:`~earthdaily.earthone.catalog.Product.save`), but at least one
        attribute value has since been changed.  You can
        :py:meth:`~earthdaily.earthone.catalog.Product.save` a modified catalog object
    ...
    SAVED : enum
        ...
        (using :py:meth:`~earthdaily.earthone.catalog.Product.get` or
        :py:meth:`~earthdaily.earthone.catalog.Product.save`).
    DELETED : enum
    ...
    :py:meth:`~earthdaily.earthone.catalog.Product.reload`.
    """
...
class File(MappingAttribute):
    ...
    ----------
    href : str
        If the :py:class:`~earthdaily.earthone.catalog.StorageState` is
        :py:attr:`~earthdaily.earthone.catalog.StorageState.AVAILABLE`, this field is required
        and it must be a valid reference to either a JP2 or a GeoTiff file using the
        ``gs`` scheme.  If the :py:class:`~earthdaily.earthone.catalog.StorageState` is
        :py:attr:`~earthdaily.earthone.catalog.StorageState.REMOTE`, this field is optional
    ...
    size_bytes : int
        ...
        :py:class:`~earthdaily.earthone.catalog.StorageState` is
        :py:attr:`~earthdaily.earthone.catalog.StorageState.AVAILABLE`.
    hash : str
    ...
    provider_id : str
        ...
        :py:class:`~earthdaily.earthone.catalog.StorageState` is
        :py:attr:`~earthdaily.earthone.catalog.StorageState.REMOTE`.
    provider_href : str
