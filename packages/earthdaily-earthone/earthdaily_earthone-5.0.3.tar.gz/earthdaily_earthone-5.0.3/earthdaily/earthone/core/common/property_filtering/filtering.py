...
class Expression(object):
    ...
    * :py:attr:`Property.isnotnull`
    ...
    >>> e = p.foo == 5
    >>> type(e)
    <class 'earthdaily.earthone.common.property_filtering.filtering.EqExpression'>
    >>> e = p.foo.any_of([1, 2, 3, 4, 5])
    >>> type(e)
    <class 'earthdaily.earthone.common.property_filtering.filtering.OrExpression'>
    >>> e = 5 < p.foo < 10
    >>> type(e)
    <class 'earthdaily.earthone.common.property_filtering.filtering.RangeExpression'>
    >>> e = (5 < p.foo < 10) & p.foo.any_of([1, 2, 3, 4, 5])
    >>> type(e)
    <class 'earthdaily.earthone.common.property_filtering.filtering.AndExpression'>
    >>> e = p.foo.isnotnull
    >>> type(e)
    <class 'earthdaily.earthone.common.property_filtering.filtering.IsNotNullExpression'>
    >>> e = p.foo.isnull
    >>> type(e)
    <class 'earthdaily.earthone.common.property_filtering.filtering.IsNullExpression'>
    """
