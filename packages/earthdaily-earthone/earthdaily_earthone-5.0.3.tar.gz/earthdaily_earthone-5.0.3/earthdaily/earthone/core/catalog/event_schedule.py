...
class EventSchedule(AuthCatalogObject):
    ...
    def search(cls, client=None, request_params=None, headers=None):
        ...
        Return an `~earthdaily.earthone.catalog.EventScheduleSearch` instance for searching
        ...
        Returns
        -------
        :class:`~earthdaily.earthone.catalog.EventScheduleSearch`
            An instance of the `~earthdaily.earthone.catalog.EventScheduleSearch` class
