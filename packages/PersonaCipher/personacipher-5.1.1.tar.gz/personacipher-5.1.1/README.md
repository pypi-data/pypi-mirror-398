...
Note:  If you are using linux then go read the [TODO](https://github.com/cyb2rS2c/PersonaCipher/blob/main/TODO.md) to set everything automatically.
## Project tree:
```
├── assets
│   ├── images
...
## Screenshots
View - [Screenshots](https://github.com/cyb2rS2c/PersonaCipher/tree/main/PIP/images.md)
...
## License
This project is licensed under the MIT License - see the [LICENSE](https://github.com/cyb2rS2c/PersonaCipher/blob/main/LICENSE) file for details.
