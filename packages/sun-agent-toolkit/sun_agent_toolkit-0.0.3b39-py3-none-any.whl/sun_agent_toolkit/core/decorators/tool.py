...
from sun_agent_toolkit.core.utils.snake_case import snake_case
...
TOOL_METADATA_KEY = "__sat_tool__"


def Tool(tool_params: ToolDecoratorParams) -> Callable[[Callable[..., Any]], Callable[..., Any]]:
    """
    ...
    Example:
        ```python
        class MyService:
            @Tool({"description": "Adds two numbers", "parameters_schema": AddNumbersParameters})
...
def validate_decorator_parameters(method: Callable[..., Any]) -> dict[str, int]:
    """
    ...
    parameters_index: int | None = None
    wallet_client_index: int | None = None
    ...
    for idx, param in enumerate(params):
        ...
        elif isinstance(ann, type) and issubclass(ann, WalletClientBase):
    ...
    result: dict[str, int] = {"parameters": parameters_index}
