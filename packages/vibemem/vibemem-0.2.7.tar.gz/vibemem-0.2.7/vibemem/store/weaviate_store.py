    ...
    def search(self, req: SearchRequest) -> list[SearchHit]:
        ...
        try:
            ...
            if qr is None:
                try:
                    ...
                    # Fall back to BM25 for any query-time error; hybrid can fail for vector/index issues.
                    try:
        ...
        for obj in getattr(qr, "objects", []) or []:
            ...
            try:
                ...
                # Skip invalid legacy/corrupted records instead of failing the whole search.
                continue
