...
class LiftedOptions:
    ...
    @overload
    def __init__(self, variant_options: LiftedKPKCOptions | LiftedExhaustiveOptions) -> None: ...
...
class SearchContextOptions:
    ...
    @overload
    def __init__(self, mode: GroundedOptions | LiftedOptions) -> None: ...

    @property
    def mode(self) -> GroundedOptions | LiftedOptions: ...

    @mode.setter
    def mode(self, arg: GroundedOptions | LiftedOptions, /) -> None: ...
...
class ExhaustiveLiftedApplicableActionGenerator(IApplicableActionGenerator):
    @staticmethod
    def create(problem: pymimir.advanced.formalism.Problem, event_handler: IExhaustiveLiftedApplicableActionGeneratorEventHandler | None = None, binding_event_handler: ISatisficingBindingGeneratorEventHandler | None = None) -> ExhaustiveLiftedApplicableActionGenerator: ...
...
class KPKCLiftedApplicableActionGenerator(IApplicableActionGenerator):
    @staticmethod
    def create(problem: pymimir.advanced.formalism.Problem, options: LiftedKPKCOptions, event_handler: IKPKCLiftedApplicableActionGeneratorEventHandler | None = None, binding_event_handler: ISatisficingBindingGeneratorEventHandler | None = None) -> KPKCLiftedApplicableActionGenerator: ...
...
class ExhaustiveLiftedAxiomEvaluator(IAxiomEvaluator):
    @staticmethod
    def create(problem: pymimir.advanced.formalism.Problem, event_handler: IExhaustiveLiftedAxiomEvaluatorEventHandler | None = None, binding_event_handler: ISatisficingBindingGeneratorEventHandler | None = None) -> ExhaustiveLiftedAxiomEvaluator: ...
...
class KPKCLiftedAxiomEvaluator(IAxiomEvaluator):
    @staticmethod
    def create(problem: pymimir.advanced.formalism.Problem, event_handler: IKPKCLiftedAxiomEvaluatorEventHandler | None = None, binding_event_handler: ISatisficingBindingGeneratorEventHandler | None = None) -> KPKCLiftedAxiomEvaluator: ...
...
class IHeuristic:
    ...
    def compute_heuristic(self, state: State, goal: pymimir.advanced.formalism.GroundConjunctiveCondition | None = None) -> float: ...
