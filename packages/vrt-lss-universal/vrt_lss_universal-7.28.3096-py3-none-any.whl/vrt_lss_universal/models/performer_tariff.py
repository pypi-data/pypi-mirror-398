...
class PerformerTariff(BaseModel):
    ...
    constraints: Optional[Annotated[List[PerformerTariffConstraint], Field(min_length=0, max_length=100)]] = Field(default=None, description="A list of tariff components that apply from the start of movement or execution of work on orders.")
