...
cavaquinho = SimpleNamespace(
    ...
    cgbd   = Tuning("C5 G4 B4  D5"),  # Portugal; maybe doesn't exist, but we list it for symmetry
    cgad   = Tuning("C5 G4 A4  D5"),  # Portugal
    aacise = Tuning("A4 A4 C#5 E5"),  # Portugal
    dacise = Tuning("D5 A4 C#5 E5"),  # Portugal; uncommon, but exists
    dabe   = Tuning("D5 A4 B4  E5"),  # Portugal
    dgbd   = braguinha,               # Brazil, the same tuning as that of Madeiran braguinha
