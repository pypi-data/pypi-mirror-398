...
from pbx_admin.views.views import LoginView
...
class AdminSite:
    ...
    def get_admin(self, model):
        try:
            ...
            raise ImproperlyConfigured(f"The model {model.__name__} is not registered") from e
    ...
    def get_urls(self):
        ...
        urlpatterns += [
            path(
                "login/",
                LoginView.as_view(template_name="pbx_admin/login.html"),
                name="login",
            ),
            path(
                "logout/",
