...
class RepositoriesFileApi(object):
    ...
    def set_label(self, file_file_repository_href, set_label,  **kwargs):  # noqa: E501
        """Set a label  # noqa: E501

        Set a single pulp_label on the object to a specific value or null.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_label(file_file_repository_href, set_label, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.set_label_with_http_info(file_file_repository_href, set_label,  **kwargs)  # noqa: E501

    def set_label_with_http_info(self, file_file_repository_href, set_label,  **kwargs):  # noqa: E501
        """Set a label  # noqa: E501

        Set a single pulp_label on the object to a specific value or null.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_label_with_http_info(file_file_repository_href, set_label, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('file_file_repository_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['file_file_repository_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `file_file_repository_href` when calling `set_label`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '{file_file_repository_href}set_label/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def unset_label(self, file_file_repository_href, unset_label,  **kwargs):  # noqa: E501
        """Unset a label  # noqa: E501

        Unset a single pulp_label on the object.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.unset_label(file_file_repository_href, unset_label, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.unset_label_with_http_info(file_file_repository_href, unset_label,  **kwargs)  # noqa: E501

    def unset_label_with_http_info(self, file_file_repository_href, unset_label,  **kwargs):  # noqa: E501
        """Unset a label  # noqa: E501

        Unset a single pulp_label on the object.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.unset_label_with_http_info(file_file_repository_href, unset_label, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('file_file_repository_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['file_file_repository_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `file_file_repository_href` when calling `unset_label`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '{file_file_repository_href}unset_label/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
