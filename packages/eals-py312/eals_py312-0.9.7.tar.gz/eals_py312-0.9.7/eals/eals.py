...
_USE_NUMBA = bool(_strtobool(os.environ.get("USE_NUMBA", "True")))
_USE_NUMBA_PARALLEL = bool(_strtobool(os.environ.get("USE_NUMBA_PARALLEL", "True")))
...
def _calc_loss_csr(indptr, indices, data, U, V, SV, Wi, user_count, regularization):
