...
if __name__ == "__main__":
    ...
    # Read data
    X_breast, y_breast = SkUtilsIO("../omicNetwork/Databases/metabData_ccRCC4.csv").from_csv(label_column='Factors')
    X_tr, y_tr = SkUtilsIO("../omicNetwork/Databases/geneData_ccRCC4.csv").from_csv(label_column='Factors')

    name_mapping_transformer = FeatureRenaming(load_metabolite_mapping("new-synonym", X_breast, "ccRCC4_Cancer" ))
    ...
    dosya_adi = "ccRCC4_react_error_v0.txt"
    count = 1
    ...
    with open(dosya_adi, 'w') as json_file:
        ...
        for train_index, test_index in skf.split(X_breast, y_breast):
            try :
                ...
                react_diff_score = "ccRCC4_react_v0_diff_score_fold_" + str(count) + ".txt"
                ...
                break
    with open('scores_react_ccRCC4_v0.txt', 'w') as f:
        try:
