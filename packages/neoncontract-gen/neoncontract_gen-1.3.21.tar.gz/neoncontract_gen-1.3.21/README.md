...
pip install https://github.com/LetA-Tech/mcfo-neoncontract/releases/download/gen/python/v1.3.21/neoncontract_gen-1.3.21-py3-none-any.whl
```
...
pip install "neoncontract-gen @ git+https://github.com/LetA-Tech/mcfo-neoncontract.git@gen/python/v1.3.21#subdirectory=gen/python"
```
