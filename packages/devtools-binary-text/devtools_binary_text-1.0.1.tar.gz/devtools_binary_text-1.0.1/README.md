...
Use this tool online at **[DevTools.at](https://devtools.at/tools/binary-text)** - Free, fast, and no registration required!

## Installation

```bash
pip install devtools_binary_text
```

## Usage

```python
from devtools_binary_text import process, encode, decode
...
**[https://devtools.at/tools/binary-text](https://devtools.at/tools/binary-text)**
