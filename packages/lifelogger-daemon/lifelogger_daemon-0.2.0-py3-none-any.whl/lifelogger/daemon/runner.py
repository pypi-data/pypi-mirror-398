...
class LifeloggerDaemon:
    ...
    def __init__(self, config: Config):
        ...
        if config.capture.enable_keypress:
            keypress_screenshot_callback = None
            if config.capture.enable_screenshot_on_keypress:
                keypress_screenshot_callback = self.screenshot_capture.capture_for_keypress

            self.keyboard_capture = KeyboardCapture(
                on_event=self._on_event,
                on_keypress_screenshot=keypress_screenshot_callback,
                screenshot_keys=config.capture.screenshot_keypress_keys,
                screenshot_with_modifiers=config.capture.screenshot_keypress_with_modifiers,
            )
