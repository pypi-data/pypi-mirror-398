...
from paymentus_xotp.configuration import Configuration
from paymentus_xotp.api_response import ApiResponse
import paymentus_xotp.models
from paymentus_xotp import rest
from paymentus_xotp.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'python-server-sdk'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(paymentus_xotp.models, klass)
