...
class Address(BaseModel):
    ...
    Schema: Address
    """ # noqa: E501
    line1: Optional[StrictStr] = Field(default=None, description="Customer address line 1")
    line2: Optional[StrictStr] = Field(default=None, description="Customer address line 1")
    state: Optional[StrictStr] = Field(default=None, description="State/Province")
    zip_code: Optional[StrictStr] = Field(default=None, description="Zip/Postal code", alias="zip-code")
    city: Optional[StrictStr] = Field(default=None, description="Customer address city")
    country: Optional[StrictStr] = Field(default=None, description="Client country")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["line1", "line2", "state", "zip-code", "city", "country"]
