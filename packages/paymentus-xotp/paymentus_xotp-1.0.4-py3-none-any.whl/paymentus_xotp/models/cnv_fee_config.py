...
class CnvFeeConfig(BaseModel):
    """
    Schema: CnvFeeConfig
    """ # noqa: E501
    convenience_fee_type_code: Optional[StrictStr] = Field(default=None, description="Property: convenienceFeeTypeCode", alias="convenienceFeeTypeCode")
    convenience_fee: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Property: convenienceFee", alias="convenienceFee")
    merchant_fee_type_code: Optional[StrictStr] = Field(default=None, description="Property: merchantFeeTypeCode", alias="merchantFeeTypeCode")
    merchant_fee: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Property: merchantFee", alias="merchantFee")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["convenienceFeeTypeCode", "convenienceFee", "merchantFeeTypeCode", "merchantFee"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CnvFeeConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CnvFeeConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "convenienceFeeTypeCode": obj.get("convenienceFeeTypeCode"),
            "convenienceFee": obj.get("convenienceFee"),
            "merchantFeeTypeCode": obj.get("merchantFeeTypeCode"),
            "merchantFee": obj.get("merchantFee")
        })
