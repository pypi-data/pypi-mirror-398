...
class PaymentComponent(BaseModel):
    ...
    reference_number: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Property: reference-number", alias="reference-number")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["payment-amount", "payment-type-code", "reference-number"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PaymentComponent from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PaymentComponent from a dict"""
        if obj is None:
            return None
