...
from paymentus_xotp.models.autopay_response_header import AutopayResponseHeader
from paymentus_xotp.models.autopay_response_payment_method import AutopayResponsePaymentMethod
...
class AutopayListResponseItem(BaseModel):
    """
    Schema: AutopayListResponseItem
    """ # noqa: E501
    error: Optional[ErrorItem] = None
    header: Optional[AutopayResponseHeader] = None
    payment_method: Optional[AutopayResponsePaymentMethod] = Field(default=None, alias="payment-method")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["error", "header", "payment-method"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AutopayListResponseItem from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AutopayListResponseItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "error": ErrorItem.from_dict(obj.get("error")) if obj.get("error") is not None else None,
            "header": AutopayResponseHeader.from_dict(obj.get("header")) if obj.get("header") is not None else None,
            "payment-method": AutopayResponsePaymentMethod.from_dict(obj.get("payment-method")) if obj.get("payment-method") is not None else None
        })
