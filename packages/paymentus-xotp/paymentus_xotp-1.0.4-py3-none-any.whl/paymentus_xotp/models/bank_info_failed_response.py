...
from paymentus_xotp.models.bank_info_failed_item import BankInfoFailedItem
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class BankInfoFailedResponse(BaseModel):
    """
    Schema: BankInfoFailedResponse
    """ # noqa: E501
    bank_info_response: Optional[BankInfoFailedItem] = Field(default=None, alias="bank-info-response")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["bank-info-response"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of BankInfoFailedResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of bank_info_response
        if self.bank_info_response:
            _dict['bank-info-response'] = self.bank_info_response.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of BankInfoFailedResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "bank-info-response": BankInfoFailedItem.from_dict(obj.get("bank-info-response")) if obj.get("bank-info-response") is not None else None
        })
