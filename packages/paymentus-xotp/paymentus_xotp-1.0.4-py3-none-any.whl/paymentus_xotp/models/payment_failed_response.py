...
from paymentus_xotp.models.payment_failed_item import PaymentFailedItem
try:
...
class PaymentFailedResponse(BaseModel):
    ...
    """ # noqa: E501
    payment_response: Optional[PaymentFailedItem] = Field(default=None, alias="payment-response")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "payment-response": PaymentFailedItem.from_dict(obj.get("payment-response")) if obj.get("payment-response") is not None else None
        })
