...
class PaymentOperationTypeEnum(str, Enum):
    """
    Possible values are      SALE - Submit payment      CONV_FEE - query processing fee      VOID - Cancel payment 
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PaymentOperationTypeEnum from a JSON string"""
