...
from paymentus_xotp.models.user_update_request_item import UserUpdateRequestItem
try:
...
class UserUpdateRequest(BaseModel):
    ...
    """ # noqa: E501
    user_profile: UserUpdateRequestItem = Field(alias="user-profile")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "user-profile": UserUpdateRequestItem.from_dict(obj.get("user-profile")) if obj.get("user-profile") is not None else None
        })
