...
class AutopayResponseSchedule(BaseModel):
    """
    Schema: AutopayResponseSchedule
    """ # noqa: E501
    header: AutopayResponseHeader
    payment_method: AutopayResponsePaymentMethod = Field(alias="payment-method")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["header", "payment-method"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AutopayResponseSchedule from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AutopayResponseSchedule from a dict"""
        if obj is None:
            return None
