...
from paymentus_xotp.models.user_response_item import UserResponseItem
try:
...
class UserResponse(BaseModel):
    ...
    Schema: UserResponse
    """ # noqa: E501
    user_info_response: UserResponseItem = Field(alias="user-info-response")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "user-info-response": UserResponseItem.from_dict(obj.get("user-info-response")) if obj.get("user-info-response") is not None else None
        })
