...
from paymentus_xotp.models.profile_response_status_enum import ProfileResponseStatusEnum
try:
...
class ProfileItem(BaseModel):
    ...
    Schema: ProfileItem
    """ # noqa: E501
    status: ProfileResponseStatusEnum
    ...
    __properties: ClassVar[List[str]] = ["status", "token", "type", "account-number", "card-holder-name", "credit-card-expiry-date", "active", "zip", "default", "profile-description", "bank-name", "used-for-Autopay", "used-deferred-payments"]
