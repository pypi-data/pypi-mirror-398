...
from paymentus_xotp.models.client_account_item import ClientAccountItem
from paymentus_xotp.models.user_info import UserInfo
try:
...
class UserRequestItem(BaseModel):
    """
    Schema: UserRequestItem
    """ # noqa: E501
    user_info: UserInfo = Field(alias="user-info")
    client_account: Optional[List[ClientAccountItem]] = Field(default=None, description="Property: client-account", alias="client-account")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["user-info", "client-account"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of UserRequestItem from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in client_account (list)
        _items = []
        if self.client_account:
            for _item in self.client_account:
                if _item:
                    _items.append(_item.to_dict())
            _dict['client-account'] = _items
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of UserRequestItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "user-info": UserInfo.from_dict(obj.get("user-info")) if obj.get("user-info") is not None else None,
            "client-account": [ClientAccountItem.from_dict(_item) for _item in obj.get("client-account")] if obj.get("client-account") is not None else None
        })
