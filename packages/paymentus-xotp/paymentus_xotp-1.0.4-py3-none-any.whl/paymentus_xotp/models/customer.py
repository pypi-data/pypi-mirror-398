...
class Customer(BaseModel):
    ...
    Schema: Customer
    """ # noqa: E501
    first_name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=64)]] = Field(default=None, description="customer first name or business contact first name", alias="first-name")
    ...
    last_name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=64)]] = Field(default=None, description="customer last name or business contact last name", alias="last-name")
    day_phone_nr: Optional[StrictStr] = Field(default=None, description="day phone number", alias="day-phone-nr")
