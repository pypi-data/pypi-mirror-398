...
class StagedResponse(BaseModel):
    """
    Schema: StagedResponse
    """ # noqa: E501
    status: ResponseStatusEnum
    staged_id: Optional[StrictStr] = Field(default=None, description="Property: staged-id", alias="staged-id")
    url: Optional[StrictStr] = Field(default=None, description="Property: url")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["status", "staged-id", "url"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of StagedResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of StagedResponse from a dict"""
        if obj is None:
            return None
