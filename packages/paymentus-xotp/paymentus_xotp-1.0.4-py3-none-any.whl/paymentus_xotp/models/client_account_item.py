...
class ClientAccountItem(BaseModel):
    """
    Schema: ClientAccountItem
    """ # noqa: E501
    account_number: Annotated[str, Field(min_length=1, strict=True, max_length=32)] = Field(description="Customer's account number", alias="account-number")
    auth_token1: Annotated[str, Field(min_length=1, strict=True, max_length=32)] = Field(description="Liability token 1", alias="auth-token1")
    ...
    __properties: ClassVar[List[str]] = ["account-number", "auth-token1", "payment-type-code"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ClientAccountItem from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ClientAccountItem from a dict"""
        if obj is None:
            return None
