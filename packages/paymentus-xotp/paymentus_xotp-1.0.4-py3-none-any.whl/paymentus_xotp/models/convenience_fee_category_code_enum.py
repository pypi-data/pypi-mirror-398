...
class ConvenienceFeeCategoryCodeEnum(str, Enum):
    """
    Schema: ConvenienceFeeCategoryCodeEnum
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ConvenienceFeeCategoryCodeEnum from a JSON string"""
