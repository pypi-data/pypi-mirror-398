...
from paymentus_xotp.models.profile_list import ProfileList
try:
...
class ListProfilesResponse(BaseModel):
    """
    Schema: ListProfilesResponse
    """ # noqa: E501
    list_profiles_response: ProfileList = Field(alias="list-profiles-response")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["list-profiles-response"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of list_profiles_response
        if self.list_profiles_response:
            _dict['list-profiles-response'] = self.list_profiles_response.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "list-profiles-response": ProfileList.from_dict(obj.get("list-profiles-response")) if obj.get("list-profiles-response") is not None else None
        })
