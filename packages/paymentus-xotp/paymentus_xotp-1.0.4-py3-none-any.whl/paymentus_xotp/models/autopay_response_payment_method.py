...
class AutopayResponsePaymentMethod(BaseModel):
    """
    Schema: AutopayResponsePaymentMethod
    """ # noqa: E501
    type: PaymentMethodTypeEnum
    account_number: StrictStr = Field(description="Account number of the autopay", alias="account-number")
    token: Optional[StrictStr] = Field(default=None, description="Token of the autopay")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["type", "account-number", "token"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AutopayResponsePaymentMethod from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AutopayResponsePaymentMethod from a dict"""
        if obj is None:
            return None
