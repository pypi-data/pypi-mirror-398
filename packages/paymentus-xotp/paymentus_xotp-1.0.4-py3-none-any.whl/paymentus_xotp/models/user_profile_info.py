...
class UserProfileInfo(BaseModel):
    ...
    """ # noqa: E501
    first_name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=64)]] = Field(default=None, description="Customer first name", alias="first-name")
    last_name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=64)]] = Field(default=None, description="Customer last name", alias="last-name")
    email: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=256)]] = Field(default=None, description="The contact email for the user")
    day_phone_nr: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=32)]] = Field(default=None, description="Customer day phone number", alias="day-phone-nr")
    zip_code: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=32)]] = Field(default=None, description="Customer zip code", alias="zip-code")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["first-name", "last-name", "email", "day-phone-nr", "zip-code"]
