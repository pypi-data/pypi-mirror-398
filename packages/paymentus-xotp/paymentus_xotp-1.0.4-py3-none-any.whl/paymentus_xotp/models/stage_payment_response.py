...
from paymentus_xotp.models.stage_payment_response_item import StagePaymentResponseItem
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class StagePaymentResponse(BaseModel):
    """
    Schema: StagePaymentResponse
    """ # noqa: E501
    payment_response: StagePaymentResponseItem = Field(alias="payment-response")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["payment-response"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of StagePaymentResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.payment_response:
            _dict['payment-response'] = self.payment_response.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of StagePaymentResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "payment-response": StagePaymentResponseItem.from_dict(obj.get("payment-response")) if obj.get("payment-response") is not None else None
        })
