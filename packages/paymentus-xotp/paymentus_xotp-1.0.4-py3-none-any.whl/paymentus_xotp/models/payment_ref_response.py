...
class PaymentRefResponse(BaseModel):
    """
    Schema: PaymentRefResponse
    """ # noqa: E501
    last_payment_response: PaymentResponseItem = Field(alias="last-payment-response")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PaymentRefResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PaymentRefResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "last-payment-response": PaymentResponseItem.from_dict(obj.get("last-payment-response")) if obj.get("last-payment-response") is not None else None
        })
