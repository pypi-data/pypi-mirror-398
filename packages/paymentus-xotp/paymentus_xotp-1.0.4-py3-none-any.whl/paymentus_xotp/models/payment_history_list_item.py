...
from paymentus_xotp.models.payment_history_header import PaymentHistoryHeader
from paymentus_xotp.models.payment_history_payment_method import PaymentHistoryPaymentMethod
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class PaymentHistoryListItem(BaseModel):
    """
    Schema: PaymentHistoryListItem
    """ # noqa: E501
    header: PaymentHistoryHeader
    payment_method: PaymentHistoryPaymentMethod = Field(alias="payment-method")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PaymentHistoryListItem from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PaymentHistoryListItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "header": PaymentHistoryHeader.from_dict(obj.get("header")) if obj.get("header") is not None else None,
            "payment-method": PaymentHistoryPaymentMethod.from_dict(obj.get("payment-method")) if obj.get("payment-method") is not None else None
        })
