...
from paymentus_xotp.models.user_find_response_item import UserFindResponseItem
try:
...
class UserFindResponse(BaseModel):
    """
    Schema: UserFindResponse
    """ # noqa: E501
    user_info_response: UserFindResponseItem = Field(alias="user-info-response")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["user-info-response"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of UserFindResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of user_info_response
        if self.user_info_response:
            _dict['user-info-response'] = self.user_info_response.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of UserFindResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "user-info-response": UserFindResponseItem.from_dict(obj.get("user-info-response")) if obj.get("user-info-response") is not None else None
        })
