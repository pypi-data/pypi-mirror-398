...
class PaymentFailedItem(BaseModel):
    """
    Schema: PaymentFailedItem
    """ # noqa: E501
    payment_status: ResponseStatusEnum = Field(alias="payment-status")
    errors: List[ErrorItem] = Field(description="Property: errors")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["payment-status", "errors"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PaymentFailedItem from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PaymentFailedItem from a dict"""
        if obj is None:
            return None
