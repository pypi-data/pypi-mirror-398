...
from paymentus_xotp.models.profile_failed_item import ProfileFailedItem
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class ProfileFailedResponse(BaseModel):
    """
    Schema: ProfileFailedResponse
    """ # noqa: E501
    profile_response: Optional[ProfileFailedItem] = Field(default=None, alias="profile-response")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["profile-response"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ProfileFailedResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of profile_response
        if self.profile_response:
            _dict['profile-response'] = self.profile_response.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ProfileFailedResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "profile-response": ProfileFailedItem.from_dict(obj.get("profile-response")) if obj.get("profile-response") is not None else None
        })
