...
from paymentus_xotp.models.user_failed_item import UserFailedItem
try:
...
class UserFailedResponse(BaseModel):
    """
    Schema: UserFailedResponse
    """ # noqa: E501
    user_info_response: UserFailedItem = Field(alias="user-info-response")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of UserFailedResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of UserFailedResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "user-info-response": UserFailedItem.from_dict(obj.get("user-info-response")) if obj.get("user-info-response") is not None else None
        })
