...
from paymentus_xotp.models.payment_history_list_item import PaymentHistoryListItem
try:
...
class PaymentHistoryItem(BaseModel):
    """
    Schema: PaymentHistoryItem
    """ # noqa: E501
    errors: Optional[List[ErrorItem]] = Field(default=None, description="Property: errors")
    payment: Optional[List[PaymentHistoryListItem]] = Field(default=None, description="Schema: PaymentHistoryPaymentList")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["errors", "payment"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PaymentHistoryItem from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PaymentHistoryItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "payment": [PaymentHistoryListItem.from_dict(_item) for _item in obj.get("payment")] if obj.get("payment") is not None else None
        })
