...
class AutopayFailedItem(BaseModel):
    """
    Schema: AutopayFailedItem
    """ # noqa: E501
    payment_schedule_status: ResponseStatusEnum = Field(alias="payment-schedule-status")
    errors: List[ErrorItem] = Field(description="Property: errors")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["payment-schedule-status", "errors"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AutopayFailedItem from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AutopayFailedItem from a dict"""
        if obj is None:
            return None
