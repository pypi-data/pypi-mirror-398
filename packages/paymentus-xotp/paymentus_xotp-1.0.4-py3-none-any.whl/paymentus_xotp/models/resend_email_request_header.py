...
class ResendEmailRequestHeader(BaseModel):
    """
    Schema: ResendEmailRequestHeader
    """ # noqa: E501
    account_number: StrictStr = Field(description="Property: account-number", alias="account-number")
    reference_number: StrictStr = Field(description="Property: reference-number", alias="reference-number")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["account-number", "reference-number"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ResendEmailRequestHeader from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ResendEmailRequestHeader from a dict"""
        if obj is None:
            return None
