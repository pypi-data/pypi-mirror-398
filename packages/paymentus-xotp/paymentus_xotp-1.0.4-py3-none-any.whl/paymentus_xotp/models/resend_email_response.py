...
from paymentus_xotp.models.resend_email_response_item import ResendEmailResponseItem
try:
...
class ResendEmailResponse(BaseModel):
    """
    Schema: ResendEmailResponse
    """ # noqa: E501
    resend_email_response: ResendEmailResponseItem = Field(alias="resend-email-response")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["resend-email-response"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of resend_email_response
        if self.resend_email_response:
            _dict['resend-email-response'] = self.resend_email_response.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "resend-email-response": ResendEmailResponseItem.from_dict(obj.get("resend-email-response")) if obj.get("resend-email-response") is not None else None
        })
