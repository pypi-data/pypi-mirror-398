...
from paymentus_xotp.models.payment_ref_failed_item import PaymentRefFailedItem
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class PaymentRefFailedResponse(BaseModel):
    """
    Schema: PaymentRefFailedResponse
    """ # noqa: E501
    last_payment_response: PaymentRefFailedItem = Field(alias="last-payment-response")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["last-payment-response"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PaymentRefFailedResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of last_payment_response
        if self.last_payment_response:
            _dict['last-payment-response'] = self.last_payment_response.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PaymentRefFailedResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "last-payment-response": PaymentRefFailedItem.from_dict(obj.get("last-payment-response")) if obj.get("last-payment-response") is not None else None
        })
