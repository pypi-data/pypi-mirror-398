...
from paymentus_xotp.models.profile_request_item import ProfileRequestItem
try:
...
class ProfileRequest(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "profile": ProfileRequestItem.from_dict(obj.get("profile")) if obj.get("profile") is not None else None
        })
