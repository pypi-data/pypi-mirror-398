...
class PaymentStatusTypeEnum(str, Enum):
    """
    Schema: PaymentStatusTypeEnum
    """
    ...
    VOID = 'VOID'
    AUTH = 'AUTH'
    CARD_PRESENT_STAGED = 'CARD_PRESENT_STAGED'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PaymentStatusTypeEnum from a JSON string"""
