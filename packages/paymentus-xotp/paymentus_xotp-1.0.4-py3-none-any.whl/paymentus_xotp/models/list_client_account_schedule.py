...
class ListClientAccountSchedule(BaseModel):
    """
    Schema: ListClientAccountSchedule
    """ # noqa: E501
    schedule_type: Optional[ScheduleTypeCodeEnum] = Field(default=None, alias="schedule-type")
    schedule_day: Optional[StrictStr] = Field(default=None, description="Property: schedule-day", alias="schedule-day")
    payment_method_type: Optional[PaymentMethodTypeEnum] = Field(default=None, alias="payment-method-type")
    amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Property: amount")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["schedule-type", "schedule-day", "payment-method-type", "amount"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ListClientAccountSchedule from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ListClientAccountSchedule from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "schedule-type": obj.get("schedule-type"),
            "schedule-day": obj.get("schedule-day"),
            "payment-method-type": obj.get("payment-method-type"),
