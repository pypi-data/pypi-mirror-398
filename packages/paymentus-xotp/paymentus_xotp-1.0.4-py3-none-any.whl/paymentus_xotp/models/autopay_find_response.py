...
from paymentus_xotp.models.autopay_details import AutopayDetails
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class AutopayFindResponse(BaseModel):
    """
    Schema: AutopayFindResponse
    """ # noqa: E501
    payment_schedule_response: List[AutopayDetails] = Field(description="Property: payment-schedule-response", alias="payment-schedule-response")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["payment-schedule-response"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AutopayFindResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in payment_schedule_response (list)
        _items = []
        if self.payment_schedule_response:
            for _item in self.payment_schedule_response:
                if _item:
                    _items.append(_item.to_dict())
            _dict['payment-schedule-response'] = _items
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AutopayFindResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "payment-schedule-response": [AutopayDetails.from_dict(_item) for _item in obj.get("payment-schedule-response")] if obj.get("payment-schedule-response") is not None else None
        })
