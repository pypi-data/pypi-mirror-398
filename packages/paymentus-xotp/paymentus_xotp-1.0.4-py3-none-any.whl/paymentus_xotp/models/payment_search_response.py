...
from paymentus_xotp.models.payment_search_item import PaymentSearchItem
try:
...
class PaymentSearchResponse(BaseModel):
    """
    Schema: PaymentSearchResponse
    """ # noqa: E501
    last_payment_response: Optional[PaymentSearchItem] = Field(default=None, alias="last-payment-response")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PaymentSearchResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PaymentSearchResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "last-payment-response": PaymentSearchItem.from_dict(obj.get("last-payment-response")) if obj.get("last-payment-response") is not None else None
        })
