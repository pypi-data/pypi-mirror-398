...
from paymentus_xotp.models.payment_history_item import PaymentHistoryItem
try:
...
class PaymentHistoryResponse(BaseModel):
    ...
    """ # noqa: E501
    payment_history_response: PaymentHistoryItem = Field(alias="payment-history-response")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["payment-history-response"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of payment_history_response
        if self.payment_history_response:
            _dict['payment-history-response'] = self.payment_history_response.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "payment-history-response": PaymentHistoryItem.from_dict(obj.get("payment-history-response")) if obj.get("payment-history-response") is not None else None
        })
