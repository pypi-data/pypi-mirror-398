...
class AccountInquiryDetail(BaseModel):
    """
    Schema: AccountInquiryDetail
    """ # noqa: E501
    address: Address
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AccountInquiryDetail from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AccountInquiryDetail from a dict"""
        if obj is None:
            return None
