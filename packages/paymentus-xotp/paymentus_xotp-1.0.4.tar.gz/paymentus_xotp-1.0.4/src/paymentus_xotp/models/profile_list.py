...
from paymentus_xotp.models.profile_list_item import ProfileListItem
try:
...
class ProfileList(BaseModel):
    ...
    Schema: ProfileList
    """ # noqa: E501
    profile: List[ProfileListItem] = Field(description="Property: profile")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "profile": [ProfileListItem.from_dict(_item) for _item in obj.get("profile")] if obj.get("profile") is not None else None
        })
