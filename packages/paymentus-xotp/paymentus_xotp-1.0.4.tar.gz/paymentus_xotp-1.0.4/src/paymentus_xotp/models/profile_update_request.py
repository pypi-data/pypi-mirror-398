...
from paymentus_xotp.models.profile_update_item import ProfileUpdateItem
try:
...
class ProfileUpdateRequest(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "profile": ProfileUpdateItem.from_dict(obj.get("profile")) if obj.get("profile") is not None else None
        })
