...
from paymentus_xotp.models.autopay_list_response_item import AutopayListResponseItem
try:
...
class AutopayListResponse(BaseModel):
    """
    Schema: AutopayListResponse
    """ # noqa: E501
    payment_schedule_response: List[AutopayListResponseItem] = Field(description="Schema: AutopayList", alias="payment-schedule-response")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AutopayListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AutopayListResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "payment-schedule-response": [AutopayListResponseItem.from_dict(_item) for _item in obj.get("payment-schedule-response")] if obj.get("payment-schedule-response") is not None else None
        })
