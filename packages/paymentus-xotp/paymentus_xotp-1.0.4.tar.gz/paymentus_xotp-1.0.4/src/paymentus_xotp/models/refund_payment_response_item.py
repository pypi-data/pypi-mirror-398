...
class RefundPaymentResponseItem(BaseModel):
    """
    Schema: RefundPaymentResponseItem
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of RefundPaymentResponseItem from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of RefundPaymentResponseItem from a dict"""
        if obj is None:
            return None
