...
class AutopayDetails(BaseModel):
    """
    Schema: AutopayDetails
    """ # noqa: E501
    schedule: AutopayResponseSchedule
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AutopayDetails from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AutopayDetails from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "schedule": AutopayResponseSchedule.from_dict(obj.get("schedule")) if obj.get("schedule") is not None else None
        })
