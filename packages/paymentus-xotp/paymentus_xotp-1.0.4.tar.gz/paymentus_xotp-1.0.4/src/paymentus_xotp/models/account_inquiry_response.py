...
from paymentus_xotp.models.account_inquiry_item import AccountInquiryItem
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class AccountInquiryResponse(BaseModel):
    """
    Schema: AccountInquiryResponse
    """ # noqa: E501
    account_info_response: Optional[AccountInquiryItem] = Field(default=None, alias="account-info-response")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["account-info-response"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AccountInquiryResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of account_info_response
        if self.account_info_response:
            _dict['account-info-response'] = self.account_info_response.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AccountInquiryResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "account-info-response": AccountInquiryItem.from_dict(obj.get("account-info-response")) if obj.get("account-info-response") is not None else None
        })
