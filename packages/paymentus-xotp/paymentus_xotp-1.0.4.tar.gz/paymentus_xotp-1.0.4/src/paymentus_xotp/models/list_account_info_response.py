...
from paymentus_xotp.models.list_account_info_item import ListAccountInfoItem
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class ListAccountInfoResponse(BaseModel):
    """
    Schema: ListAccountInfoResponse
    """ # noqa: E501
    list_account_info_facades_response: ListAccountInfoItem = Field(alias="list-account-info-facades-response")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["list-account-info-facades-response"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ListAccountInfoResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of list_account_info_facades_response
        if self.list_account_info_facades_response:
            _dict['list-account-info-facades-response'] = self.list_account_info_facades_response.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ListAccountInfoResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "list-account-info-facades-response": ListAccountInfoItem.from_dict(obj.get("list-account-info-facades-response")) if obj.get("list-account-info-facades-response") is not None else None
        })
