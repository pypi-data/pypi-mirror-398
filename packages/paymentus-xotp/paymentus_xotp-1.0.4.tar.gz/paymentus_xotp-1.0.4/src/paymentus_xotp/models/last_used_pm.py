...
class LastUsedPM(BaseModel):
    """
    Schema: LastUsedPM
    """ # noqa: E501
    type: PaymentMethodTypeEnum
    account_number: StrictStr = Field(description="Property: account-number", alias="account-number")
    fi_name: Optional[StrictStr] = Field(default=None, description="Property: fi-name", alias="fi-name")
    card_holder_name: Optional[StrictStr] = Field(default=None, description="Property: card-holder-name", alias="card-holder-name")
    default_flag: Optional[StrictBool] = Field(default=None, description="Property: default-flag", alias="default-flag")
    credit_card_expiry_date: Optional[CreditCardExpiryDate] = Field(default=None, alias="credit-card-expiry-date")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["type", "account-number", "fi-name", "card-holder-name", "default-flag", "credit-card-expiry-date"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of LastUsedPM from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of LastUsedPM from a dict"""
        if obj is None:
            return None
