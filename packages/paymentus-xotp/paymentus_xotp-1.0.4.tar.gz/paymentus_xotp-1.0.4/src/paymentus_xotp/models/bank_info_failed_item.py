...
class BankInfoFailedItem(BaseModel):
    """
    Schema: BankInfoFailedItem
    """ # noqa: E501
    validation_status: ResponseStatusEnum = Field(alias="validation-status")
    errors: List[ErrorItem] = Field(description="Property: errors")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["validation-status", "errors"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of BankInfoFailedItem from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of BankInfoFailedItem from a dict"""
        if obj is None:
            return None
