...
from paymentus_xotp.models.resend_email_request_item import ResendEmailRequestItem
try:
...
class ResendEmailRequest(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ResendEmailRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ResendEmailRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "payment": ResendEmailRequestItem.from_dict(obj.get("payment")) if obj.get("payment") is not None else None
        })
