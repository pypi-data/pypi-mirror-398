...
from paymentus_xotp.models.staged_response import StagedResponse
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class StagePaymentResponseItem(BaseModel):
    """
    Schema: StagePaymentResponseItem
    """ # noqa: E501
    response: List[StagedResponse] = Field(description="Property: response")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of StagePaymentResponseItem from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of StagePaymentResponseItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "response": [StagedResponse.from_dict(_item) for _item in obj.get("response")] if obj.get("response") is not None else None
        })
