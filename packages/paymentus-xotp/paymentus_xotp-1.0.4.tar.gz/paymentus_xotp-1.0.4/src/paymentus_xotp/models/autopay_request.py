...
from paymentus_xotp.models.payment import Payment
try:
...
class AutopayRequest(BaseModel):
    """
    Schema: AutopayRequest
    """ # noqa: E501
    payment_schedule: Payment = Field(alias="payment-schedule")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["payment-schedule"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AutopayRequest from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of payment_schedule
        if self.payment_schedule:
            _dict['payment-schedule'] = self.payment_schedule.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AutopayRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "payment-schedule": Payment.from_dict(obj.get("payment-schedule")) if obj.get("payment-schedule") is not None else None
        })
