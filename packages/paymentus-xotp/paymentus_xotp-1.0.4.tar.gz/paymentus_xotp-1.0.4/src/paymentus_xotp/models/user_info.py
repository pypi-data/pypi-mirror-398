...
from paymentus_xotp.models.user_profile_info import UserProfileInfo
try:
...
class UserInfo(BaseModel):
    ...
    Schema: UserInfo
    """ # noqa: E501
    login_id: Annotated[str, Field(min_length=1, strict=True, max_length=32)] = Field(description="The current login id for the target user", alias="login-id")
    password: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=256)]] = Field(default=None, description="Password to be provided for login id change.")
    force_password_change: Optional[StrictBool] = Field(default=None, description="Indicates if the user should be forced to change their password upon next login", alias="force-password-change")
    profile: Optional[UserProfileInfo] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["login-id", "password", "force-password-change", "profile"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "force-password-change": obj.get("force-password-change"),
            "profile": UserProfileInfo.from_dict(obj.get("profile")) if obj.get("profile") is not None else None
        })
