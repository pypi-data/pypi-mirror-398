...
class PaymentHeaderPaymentDate(BaseModel):
    """
    Property: payment-date
    """ # noqa: E501
    date_str: Optional[StrictStr] = Field(default=None, description="Payment execution date in the format MMddyyyy", alias="date-str")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["date-str"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PaymentHeaderPaymentDate from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PaymentHeaderPaymentDate from a dict"""
        if obj is None:
            return None
