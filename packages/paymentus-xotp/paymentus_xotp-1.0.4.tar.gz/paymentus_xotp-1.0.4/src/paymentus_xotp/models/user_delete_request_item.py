...
class UserDeleteRequestItem(BaseModel):
    """
    Schema: UserDeleteRequestItem
    """ # noqa: E501
    user: UserLoginId
    user_info: UserLoginId = Field(alias="user-info")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of UserDeleteRequestItem from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of UserDeleteRequestItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "user-info": UserLoginId.from_dict(obj.get("user-info")) if obj.get("user-info") is not None else None
        })
