...
from paymentus_xotp.models.make_payment_response_item import MakePaymentResponseItem
try:
...
class MakePaymentResponse(BaseModel):
    """
    Schema: MakePaymentResponse
    """ # noqa: E501
    payment_response: MakePaymentResponseItem = Field(alias="payment-response")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of MakePaymentResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of MakePaymentResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "payment-response": MakePaymentResponseItem.from_dict(obj.get("payment-response")) if obj.get("payment-response") is not None else None
        })
