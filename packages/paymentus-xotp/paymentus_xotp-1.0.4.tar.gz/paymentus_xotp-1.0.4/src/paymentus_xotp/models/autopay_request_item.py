...
class AutopayRequestItem(BaseModel):
    """
    Schema: AutopayRequestItem
    """ # noqa: E501
    payment_method_category: Optional[PaymentMethodCategoryEnum] = Field(default=None, alias="payment-method-category")
    payment_method: Optional[PaymentMethod] = Field(default=None, alias="payment-method")
    customer: Optional[Customer] = None
    header: Optional[PaymentHeader] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["payment-method-category", "payment-method", "customer", "header"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AutopayRequestItem from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AutopayRequestItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "header": PaymentHeader.from_dict(obj.get("header")) if obj.get("header") is not None else None
        })
