...
from paymentus_xotp.models.profile_item import ProfileItem
try:
...
class ProfileResponse(BaseModel):
    ...
    """ # noqa: E501
    profile_response: ProfileItem = Field(alias="profile-response")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "profile-response": ProfileItem.from_dict(obj.get("profile-response")) if obj.get("profile-response") is not None else None
        })
