...
from paymentus_xotp.models.payment_response_list import PaymentResponseList
try:
...
class PaymentResponse(BaseModel):
    ...
    """ # noqa: E501
    payment_response: PaymentResponseList = Field(alias="payment-response")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "payment-response": PaymentResponseList.from_dict(obj.get("payment-response")) if obj.get("payment-response") is not None else None
        })
