...
from paymentus_xotp.models.cnv_fee_response_item import CnvFeeResponseItem
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class CnvFeeResponse(BaseModel):
    """
    Schema: CnvFeeResponse
    """ # noqa: E501
    payment_response: Optional[CnvFeeResponseItem] = Field(default=None, alias="payment-response")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CnvFeeResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CnvFeeResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "payment-response": CnvFeeResponseItem.from_dict(obj.get("payment-response")) if obj.get("payment-response") is not None else None
        })
