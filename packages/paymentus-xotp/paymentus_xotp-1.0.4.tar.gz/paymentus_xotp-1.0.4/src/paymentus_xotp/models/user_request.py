...
from paymentus_xotp.models.user_request_item import UserRequestItem
try:
...
class UserRequest(BaseModel):
    ...
    Schema: UserRequest
    """ # noqa: E501
    user_profile: UserRequestItem = Field(alias="user-profile")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "user-profile": UserRequestItem.from_dict(obj.get("user-profile")) if obj.get("user-profile") is not None else None
        })
