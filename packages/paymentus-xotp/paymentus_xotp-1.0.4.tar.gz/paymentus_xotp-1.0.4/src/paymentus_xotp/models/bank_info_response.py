...
from paymentus_xotp.models.bank_info_response_item import BankInfoResponseItem
try:
...
class BankInfoResponse(BaseModel):
    """
    Schema: BankInfoResponse
    """ # noqa: E501
    bank_info_response: Optional[BankInfoResponseItem] = Field(default=None, alias="bank-info-response")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "bank-info-response": BankInfoResponseItem.from_dict(obj.get("bank-info-response")) if obj.get("bank-info-response") is not None else None
        })
