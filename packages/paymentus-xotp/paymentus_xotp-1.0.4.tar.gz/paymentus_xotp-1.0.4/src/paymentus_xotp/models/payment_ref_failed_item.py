...
class PaymentRefFailedItem(BaseModel):
    """
    Schema: PaymentRefFailedItem
    """ # noqa: E501
    reference_number: Optional[StrictStr] = Field(default=None, description="Reference number of the payment", alias="reference-number")
    errors: Optional[List[ErrorItem]] = Field(default=None, description="Property: errors")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["reference-number", "errors"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PaymentRefFailedItem from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PaymentRefFailedItem from a dict"""
        if obj is None:
            return None
