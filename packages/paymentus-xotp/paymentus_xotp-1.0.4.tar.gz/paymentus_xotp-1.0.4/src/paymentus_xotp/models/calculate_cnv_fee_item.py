...
class CalculateCnvFeeItem(BaseModel):
    """
    Schema: CalculateCnvFeeItem
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["header", "payment-method", "payment-method-category"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CalculateCnvFeeItem from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CalculateCnvFeeItem from a dict"""
        if obj is None:
            return None
