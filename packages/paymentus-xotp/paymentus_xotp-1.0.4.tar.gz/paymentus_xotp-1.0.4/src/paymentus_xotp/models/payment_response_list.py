...
class PaymentResponseList(BaseModel):
    """
    Schema: PaymentResponseList
    """ # noqa: E501
    response: List[PaymentResponseItem] = Field(description="Property: response")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PaymentResponseList from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PaymentResponseList from a dict"""
        if obj is None:
            return None
