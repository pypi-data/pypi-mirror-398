...
from paymentus_xotp.models.autopay_failed_item import AutopayFailedItem
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class AutopayFailedResponse(BaseModel):
    """
    Schema: AutopayFailedResponse
    """ # noqa: E501
    payment_schedule_response: Optional[AutopayFailedItem] = Field(default=None, alias="payment-schedule-response")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AutopayFailedResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of payment_schedule_response
        if self.payment_schedule_response:
            _dict['payment-schedule-response'] = self.payment_schedule_response.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AutopayFailedResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "payment-schedule-response": AutopayFailedItem.from_dict(obj.get("payment-schedule-response")) if obj.get("payment-schedule-response") is not None else None
        })
