...
class ScheduleTypeCodeEnum(str, Enum):
    """
    The type (frequency) of payment schedule
    """
    ...
    LIABILITY_OR_PAST_DUE = 'LIABILITY_OR_PAST_DUE'
    ANNUAL = 'ANNUAL'
    SEMI_ANNUAL = 'SEMI_ANNUAL'
    QUARTERLY = 'QUARTERLY'
    INS_ANNUAL = 'INS_ANNUAL'
    INS_SEMI_ANNUAL = 'INS_SEMI_ANNUAL'
    INS_QUARTERLY = 'INS_QUARTERLY'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ScheduleTypeCodeEnum from a JSON string"""
