...
from paymentus_xotp.models.list_client_account import ListClientAccount
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class ListAccountInfoItem(BaseModel):
    """
    Schema: ListAccountInfoItem
    """ # noqa: E501
    client_account: List[ListClientAccount] = Field(description="Property: client-account", alias="client-account")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["client-account"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ListAccountInfoItem from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ListAccountInfoItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "client-account": [ListClientAccount.from_dict(_item) for _item in obj.get("client-account")] if obj.get("client-account") is not None else None
        })
