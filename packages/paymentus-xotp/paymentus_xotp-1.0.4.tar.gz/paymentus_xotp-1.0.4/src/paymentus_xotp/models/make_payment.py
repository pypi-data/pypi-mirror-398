...
from paymentus_xotp.models.make_payment_item import MakePaymentItem
try:
...
class MakePayment(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of MakePayment from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of MakePayment from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "payment": MakePaymentItem.from_dict(obj.get("payment")) if obj.get("payment") is not None else None
        })
