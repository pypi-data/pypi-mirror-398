...
class UserLoginId(BaseModel):
    ...
    Schema: UserLoginId
    """ # noqa: E501
    login_id: StrictStr = Field(description="User Login Id", alias="login-id")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of UserLoginId from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of UserLoginId from a dict"""
        if obj is None:
            return None
