...
class AutopayResponse(BaseModel):
    """
    Schema: AutopayResponse
    """ # noqa: E501
    payment_schedule_response: PaymentResponseItem = Field(alias="payment-schedule-response")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AutopayResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AutopayResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "payment-schedule-response": PaymentResponseItem.from_dict(obj.get("payment-schedule-response")) if obj.get("payment-schedule-response") is not None else None
        })
