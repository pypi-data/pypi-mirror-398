...
class UserFailedItem(BaseModel):
    """
    Schema: UserFailedItem
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of UserFailedItem from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of UserFailedItem from a dict"""
        if obj is None:
            return None
