...
class PaymentHistoryPaymentMethod(BaseModel):
    """
    Schema: PaymentHistoryPaymentMethod
    """ # noqa: E501
    account_number: StrictStr = Field(description="Masked account number of the payment method", alias="account-number")
    type: PaymentMethodTypeEnum
    routing_number: Optional[StrictStr] = Field(default=None, description="Routing number of the payment method", alias="routing-number")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["account-number", "type", "routing-number"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PaymentHistoryPaymentMethod from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PaymentHistoryPaymentMethod from a dict"""
        if obj is None:
            return None
