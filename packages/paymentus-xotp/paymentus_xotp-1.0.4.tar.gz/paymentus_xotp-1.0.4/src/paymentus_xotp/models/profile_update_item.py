...
class ProfileUpdateItem(BaseModel):
    """
    Schema: ProfileUpdateItem
    """ # noqa: E501
    default_flag: Optional[StrictBool] = Field(default=None, description="This default-flag is for making the payment method a default payment method.", alias="default-flag")
    ...
    __properties: ClassVar[List[str]] = ["default-flag", "profile-description", "has-contact-info", "external-owner-id"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ProfileUpdateItem from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ProfileUpdateItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "default-flag": obj.get("default-flag"),
