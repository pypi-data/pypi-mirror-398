...
from paymentus_xotp.models.refund_payment_response_item import RefundPaymentResponseItem
try:
...
class RefundPaymentResponse(BaseModel):
    """
    Schema: RefundPaymentResponse
    """ # noqa: E501
    payment_response: RefundPaymentResponseItem = Field(alias="payment-response")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of RefundPaymentResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of RefundPaymentResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "payment-response": RefundPaymentResponseItem.from_dict(obj.get("payment-response")) if obj.get("payment-response") is not None else None
        })
