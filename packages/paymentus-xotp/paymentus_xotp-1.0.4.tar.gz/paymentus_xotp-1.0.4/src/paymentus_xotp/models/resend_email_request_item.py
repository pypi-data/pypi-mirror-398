...
from paymentus_xotp.models.resend_email_request_header import ResendEmailRequestHeader
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class ResendEmailRequestItem(BaseModel):
    """
    Schema: ResendEmailRequestItem
    """ # noqa: E501
    header: ResendEmailRequestHeader
    customer: Optional[Customer] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["header", "customer"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ResendEmailRequestItem from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ResendEmailRequestItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "header": ResendEmailRequestHeader.from_dict(obj.get("header")) if obj.get("header") is not None else None,
