...
from paymentus_xotp.models.user_delete_request_item import UserDeleteRequestItem
try:
...
class UserDeleteRequest(BaseModel):
    ...
    """ # noqa: E501
    user_profile: UserDeleteRequestItem = Field(alias="user-profile")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["user-profile"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.user_profile:
            _dict['user-profile'] = self.user_profile.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "user-profile": UserDeleteRequestItem.from_dict(obj.get("user-profile")) if obj.get("user-profile") is not None else None
        })
