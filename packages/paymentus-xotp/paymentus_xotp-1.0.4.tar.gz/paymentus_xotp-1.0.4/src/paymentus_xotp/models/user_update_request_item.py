...
from paymentus_xotp.models.user_login_id import UserLoginId
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class UserUpdateRequestItem(BaseModel):
    """
    Schema: UserUpdateRequestItem
    """ # noqa: E501
    user: UserLoginId
    user_info: UserInfo = Field(alias="user-info")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["user", "user-info"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of UserUpdateRequestItem from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of UserUpdateRequestItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "user": UserLoginId.from_dict(obj.get("user")) if obj.get("user") is not None else None,
