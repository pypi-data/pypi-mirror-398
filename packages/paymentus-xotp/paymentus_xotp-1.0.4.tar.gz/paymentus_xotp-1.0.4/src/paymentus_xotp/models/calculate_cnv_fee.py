...
from paymentus_xotp.models.calculate_cnv_fee_item import CalculateCnvFeeItem
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class CalculateCnvFee(BaseModel):
    """
    Schema: CalculateCnvFee
    """ # noqa: E501
    payment: CalculateCnvFeeItem
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CalculateCnvFee from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CalculateCnvFee from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "payment": CalculateCnvFeeItem.from_dict(obj.get("payment")) if obj.get("payment") is not None else None
        })
