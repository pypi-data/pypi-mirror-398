...
conf = openapi_client.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "https://secure1.paymentus.com/api" if host is None else host
        """Default Base url
        """
    ...
    def auth_settings(self):
        ...
        if 'X-Ext-Session-App' in self.api_key:
            auth['X-Ext-Session-App'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'X-Ext-Session-App',
                'value': self.get_api_key_with_prefix(
                    'X-Ext-Session-App',
                ),
            }
        if 'X-Ext-Session-Id' in self.api_key:
            auth['X-Ext-Session-Id'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'X-Ext-Session-Id',
                'value': self.get_api_key_with_prefix(
                    'X-Ext-Session-Id',
                ),
            }
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "https://secure1.paymentus.com/api",
                'description': "No description provided",
            },
            {
                'url': "https://secure2.paymentus.com/api",
                'description': "No description provided",
            },
            {
                'url': "https://secure3.paymentus.com/api",
                'description': "No description provided",
            },
            {
                'url': "https://secure4.paymentus.com/api",
                'description': "No description provided",
            },
            {
                'url': "https://secure5.paymentus.com/api",
                'description': "No description provided",
            },
            {
                'url': "https://secure6.paymentus.com/api",
                'description': "No description provided",
            },
            {
                'url': "https://secure7.paymentus.com/api",
                'description': "No description provided",
            },
            {
                'url': "https://secure8.paymentus.com/api",
                'description': "No description provided",
            },
            {
                'url': "https://developer.paymentus.io/api",
                'description': "No description provided",
            }
        ]
