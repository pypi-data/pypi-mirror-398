# Generated from /home/runner/work/_temp/setup-uv-cache/sdists-v9/.tmpn0XStK/apyds_bnf-0.0.11a2/Dsp.g4 by ANTLR 4.13.2
# encoding: utf-8
from antlr4 import *
...
def serializedATN():
    return [
        4,1,36,132,2,0,7,0,2,1,7,1,2,2,7,2,1,0,5,0,8,8,0,10,0,12,0,11,9,
        ...
        124,8,2,1,2,5,2,127,8,2,10,2,12,2,130,9,2,1,2,0,1,4,3,0,2,4,0,8,
        1,0,10,15,1,0,6,7,1,0,16,17,2,0,15,15,18,19,1,0,12,13,1,0,20,21,
        1,0,22,25,1,0,26,27,157,0,9,1,0,0,0,2,47,1,0,0,0,4,57,1,0,0,0,6,
        8,5,35,0,0,7,6,1,0,0,0,8,11,1,0,0,0,9,7,1,0,0,0,9,10,1,0,0,0,10,
        24,1,0,0,0,11,9,1,0,0,0,12,21,3,2,1,0,13,15,5,35,0,0,14,13,1,0,0,
        0,15,16,1,0,0,0,16,14,1,0,0,0,16,17,1,0,0,0,17,18,1,0,0,0,18,20,
        3,2,1,0,19,14,1,0,0,0,20,23,1,0,0,0,21,19,1,0,0,0,21,22,1,0,0,0,
        22,25,1,0,0,0,23,21,1,0,0,0,24,12,1,0,0,0,24,25,1,0,0,0,25,29,1,
        0,0,0,26,28,5,35,0,0,27,26,1,0,0,0,28,31,1,0,0,0,29,27,1,0,0,0,29,
        30,1,0,0,0,30,32,1,0,0,0,31,29,1,0,0,0,32,33,5,0,0,1,33,1,1,0,0,
        0,34,48,3,4,2,0,35,40,3,4,2,0,36,37,5,1,0,0,37,39,3,4,2,0,38,36,
        ...
        2,0,0,46,48,3,4,2,0,47,34,1,0,0,0,47,43,1,0,0,0,48,3,1,0,0,0,49,
        50,6,2,-1,0,50,58,5,36,0,0,51,52,5,3,0,0,52,53,3,4,2,0,53,54,5,4,
        0,0,54,58,1,0,0,0,55,56,7,0,0,0,56,58,3,4,2,13,57,49,1,0,0,0,57,
        51,1,0,0,0,57,55,1,0,0,0,58,128,1,0,0,0,59,60,10,17,0,0,60,61,5,
        5,0,0,61,127,3,4,2,18,62,63,10,16,0,0,63,64,7,1,0,0,64,127,3,4,2,
        17,65,66,10,12,0,0,66,67,7,2,0,0,67,127,3,4,2,13,68,69,10,11,0,0,
        69,70,7,3,0,0,70,127,3,4,2,12,71,72,10,10,0,0,72,73,7,4,0,0,73,127,
        3,4,2,11,74,75,10,9,0,0,75,76,7,5,0,0,76,127,3,4,2,10,77,78,10,8,
        0,0,78,79,7,6,0,0,79,127,3,4,2,9,80,81,10,7,0,0,81,82,7,7,0,0,82,
        127,3,4,2,8,83,84,10,6,0,0,84,85,5,14,0,0,85,127,3,4,2,7,86,87,10,
        5,0,0,87,88,5,28,0,0,88,127,3,4,2,6,89,90,10,4,0,0,90,91,5,29,0,
        0,91,127,3,4,2,5,92,93,10,3,0,0,93,94,5,30,0,0,94,127,3,4,2,4,95,
        96,10,2,0,0,96,97,5,31,0,0,97,127,3,4,2,3,98,99,10,1,0,0,99,100,
        5,32,0,0,100,127,3,4,2,2,101,102,10,15,0,0,102,103,5,8,0,0,103,108,
        3,4,2,0,104,105,5,1,0,0,105,107,3,4,2,0,106,104,1,0,0,0,107,110,
        1,0,0,0,108,106,1,0,0,0,108,109,1,0,0,0,109,111,1,0,0,0,110,108,
        1,0,0,0,111,112,5,9,0,0,112,127,1,0,0,0,113,114,10,14,0,0,114,123,
        5,3,0,0,115,120,3,4,2,0,116,117,5,1,0,0,117,119,3,4,2,0,118,116,
        1,0,0,0,119,122,1,0,0,0,120,118,1,0,0,0,120,121,1,0,0,0,121,124,
        1,0,0,0,122,120,1,0,0,0,123,115,1,0,0,0,123,124,1,0,0,0,124,125,
        1,0,0,0,125,127,5,4,0,0,126,59,1,0,0,0,126,62,1,0,0,0,126,65,1,0,
        0,0,126,68,1,0,0,0,126,71,1,0,0,0,126,74,1,0,0,0,126,77,1,0,0,0,
        126,80,1,0,0,0,126,83,1,0,0,0,126,86,1,0,0,0,126,89,1,0,0,0,126,
        92,1,0,0,0,126,95,1,0,0,0,126,98,1,0,0,0,126,101,1,0,0,0,126,113,
        1,0,0,0,127,130,1,0,0,0,128,126,1,0,0,0,128,129,1,0,0,0,129,5,1,
        0,0,0,130,128,1,0,0,0,14,9,16,21,24,29,40,43,47,57,108,120,123,126,
        128
    ]
...
class DspParser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "<INVALID>", "<INVALID>", "<INVALID>", 
                      ...
                      "<INVALID>", "<INVALID>", "<INVALID>", "<INVALID>", 
                      "<INVALID>", "<INVALID>", "<INVALID>", "<INVALID>", 
                      "<INVALID>", "WHITESPACE", "COMMENT", "NEWLINE", "SYMBOL" ]
    ...
    def rule_pool(self):
        ...
        try:
            ...
            if (((_la) & ~0x3f) == 0 and ((1 << _la) & 68719541260) != 0):
                self.state = 12
                self.rule_()
                self.state = 21
                self._errHandler.sync(self)
    ...
    def rule_(self):
        ...
        try:
            ...
            if la_ == 1:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if (((_la) & ~0x3f) == 0 and ((1 << _la) & 68719541256) != 0):
                    self.state = 35
                    self.term(0)
                    self.state = 40
                    self._errHandler.sync(self)
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        ...
                        self.state = 69
                        _la = self._input.LA(1)
                        if not((((_la) & ~0x3f) == 0 and ((1 << _la) & 819200) != 0)):
                            self._errHandler.recoverInline(self)
                        else:
                            self._errHandler.reportMatch(self)
                            self.consume()
