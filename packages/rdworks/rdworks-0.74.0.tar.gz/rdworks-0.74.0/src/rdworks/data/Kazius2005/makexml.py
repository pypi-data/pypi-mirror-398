...
for name, smarts in [
    ...
    [
        ...
        "$(O=N(~O)a);!$(O=N(O)c[$(aS(=O)=O),$(aaS(=O)=O),$(aaaS(=O)=O),$(aC((F)F)F),$(aaC((F)F)F),$(aaaC((F)F)F)])",
    ],
    ...
    [
        "bay-region in Polycyclic Aromatic Hydrocarbons",
        "[cH]1[cH]ccc2c1c3c(cc2)cc[cH][cH]3",
    ],
    [
        "K-region in Polycyclic Aromatic Hydrocarbons",
        "[cH]1cccc2c1[cH][cH]c3c2ccc[cH]3",
    ],
    [
        "sulphonate-bonded carbon (alkyl alkane sulphonate or dialkyl sulphate)",
        "[$([C,c]OS(=O)(=O)O!@[c,C]),$([c,C]S(=O)(=O)O!@[c,C])]",
    ],
    ["aliphatic N-nitro", "O=N(~O)N"],
    [
        "aB unsaturated aldehyde (including a-carbonyl aldehyde)",
        "[$(O=[CH]C=C),$(O=[CH]C=O)]",
    ],
    ["diazonium", "[N;v4]#N"],
    ...
    [
        ...
        "[CH3][NH]a;![CH3][NH]a[$(a[$(C((F)F)F),$(S=O),$(C(=O)O)]),$(aa[$(C((F)F)F),$(S=O),$(C(=O)O)]),$(aaa[$(C((F)F)F),$(S=O),$(C(=O)O)])]",
    ],
    [
        "ester derivative of aromatic hydroxylamine (including original specific toxicophore)",
