...
@dataclass_json
@dataclass
class V4HpfsListSfsByLabelRequest(CtyunOpenAPIRequest):
    regionID: str  # 资源池 ID
    labelList: List['V4HpfsListSfsByLabelRequestLabelList']  # 待查询的并行文件标签列表
...
@dataclass_json
@dataclass
class V4HpfsListSfsByLabelRequestLabelList:
...
@dataclass_json
@dataclass
class V4HpfsListSfsByLabelResponse(CtyunOpenAPIResponse):
    statusCode: Optional[int] = None  # 返回状态码（800为成功，900为失败）
    errorCode: Optional[str] = None  # 错误码，为product.module.code三段式码
    error: Optional[str] = None  # 错误码，为product.module.code三段式码
    message: Optional[str] = None  # 失败时的错误描述，一般为英文描述
    description: Optional[str] = None  # 失败时的错误描述，一般为中文描述
    returnObj: Optional['V4HpfsListSfsByLabelReturnObj'] = None  # 成功时返回的数据
...
@dataclass_json
@dataclass
class V4HpfsListSfsByLabelReturnObj:
    list: Optional[List['V4HpfsListSfsByLabelReturnObjList']] = None  # 返回的文件列表
...
@dataclass_json
@dataclass
class V4HpfsListSfsByLabelReturnObjList:
