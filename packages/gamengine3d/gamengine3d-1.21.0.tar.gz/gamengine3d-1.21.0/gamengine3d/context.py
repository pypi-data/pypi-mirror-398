...
class Functions:
    def __init__(self):
        ...
        self.draw_cube = lambda pos=vector3d.zero, size=vector3d(3), color=Color.light_blue, emit=False: None
        self.draw_sphere = lambda pos=vector3d.zero, radius=2, color=Color.light_red, segments=32, rings=16, emit=False: None
        self.draw_cylinder = lambda pos=vector3d.zero, length=2, radius=.5, color=Color.light_yellow, segments=32, emit=False: None
