...
Creates HallucinationMetric instances with proper configuration.
"""
...
class HallucinationMetricFactory(BaseMetricFactory):
    """Factory for creating HallucinationMetric instances.

    HallucinationMetric evaluates whether the LLM's output contains
    hallucinated or fabricated information not supported by the context.
    ...
    Required LLMTestCase fields:
        ...
        - context: List of context strings (not retrieval_context)
    ...
    def create(self, config: MetricConfig) -> Any:
        """Create a HallucinationMetric instance.

        Args:
            config: Metric configuration.

        Returns:
            HallucinationMetric instance.
        """
