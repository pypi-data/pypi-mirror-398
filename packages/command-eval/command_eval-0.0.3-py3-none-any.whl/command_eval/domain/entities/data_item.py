...
class DataItem:
    ...
    Attributes:
        ...
        query_source: Source of the query (file path or inline text).
        command: The command to execute.
        actual_file: The actual output file path for command execution (renamed from output_file).
        pre_commands: Commands to run before the main command.
        query_append_text: Text to append to the query (optional).
