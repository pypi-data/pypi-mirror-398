...
from command_eval.application.evaluation_use_case import (
    EvaluationRequest,
    EvaluationUseCase,
    EvaluationUseCaseResult,
)
...
def get_evaluation_port(sdk: str) -> EvaluationPort:
    ...
    """
    if sdk == "deepeval":
        from command_eval.infrastructure.adapters.deepeval_adapter import (
            DeepEvalAdapter,
        )

        return DeepEvalAdapter()
    elif sdk == "ragas":
        from command_eval.infrastructure.adapters.ragas_adapter import (
            RagasAdapter,
        )
...
def format_result(
    result: EvaluationUseCaseResult, verbose: bool, output_format: str = "text"
) -> str:
