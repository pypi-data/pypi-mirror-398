...
class TestInput:
    ...
    Attributes:
        ...
        query: The final query text.
        command: The command to execute.
        actual_file: Path for command output (renamed from output_file).
    ...
    def create(
        ...
        query_append_text: str | None = None,
        ...
        Args:
            ...
            command: The command to execute.
            actual_file: Path for command output.
            pre_commands: Commands to run before main command (optional).
            query_append_text: Text to append to query (optional).
            evaluation_specs: SDK-independent evaluation specifications.

        Returns:
            A tuple of (TestInput, TestInputBuilt event).
        """
        # Join query with append text if provided
        final_query = query
        if query_append_text:
            final_query = f"{query}{query_append_text}"
