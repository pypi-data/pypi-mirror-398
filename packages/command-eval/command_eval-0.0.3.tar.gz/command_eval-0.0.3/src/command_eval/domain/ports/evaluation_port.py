...
class TestCaseResult:
    ...
    Attributes:
        ...
        metrics: Scores for each metric type (legacy, for backward compat).
        reason: Overall reason for the evaluation result (optional).
...
class EvaluationResponse:
    ...
    def create(
        ...
        overall_score = (
            sum(d.score for d in details) / total_count
            if total_count > 0
            else 0.0
        )
