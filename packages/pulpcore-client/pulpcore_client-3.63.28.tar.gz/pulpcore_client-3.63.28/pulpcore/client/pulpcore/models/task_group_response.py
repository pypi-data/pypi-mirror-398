...
class TaskGroupResponse(object):
    ...
    def __init__(self, pulp_href=None, prn=None, description=None, all_tasks_dispatched=None, waiting=None, skipped=None, running=None, completed=None, canceled=None, failed=None, canceling=None, group_progress_reports=None, tasks=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def prn(self):
        """Gets the prn of this TaskGroupResponse.  # noqa: E501

        The Pulp Resource Name (PRN).  # noqa: E501

        :return: The prn of this TaskGroupResponse.  # noqa: E501
        :rtype: str
        """
        return self._prn
    ...
    @prn.setter
    def prn(self, prn):
        """Sets the prn of this TaskGroupResponse.

        The Pulp Resource Name (PRN).  # noqa: E501

        :param prn: The prn of this TaskGroupResponse.  # noqa: E501
        :type: str
        """
