...
class DistributionsApi(object):
    ...
    def list(self,  **kwargs):  # noqa: E501
        ...
        :param str pulp_type: Pulp type  * `core.artifact` - core.artifact * `file.file` - file.file
        :param list[str] pulp_type__in: Multiple values may be separated by commas.  * `core.artifact` - core.artifact * `file.file` - file.file
        :param str q:
