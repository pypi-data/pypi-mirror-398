...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_last_updated=None, pulp_labels=None, pulp_href=None, base_path=None, pulp_created=None, name=None, content_guard=None, base_url=None, hidden=False, local_vars_configuration=None):  # noqa: E501
