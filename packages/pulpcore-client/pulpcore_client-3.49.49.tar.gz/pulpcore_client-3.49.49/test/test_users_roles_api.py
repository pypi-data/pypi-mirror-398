...
from pulpcore.client.pulpcore.api.users_roles_api import UsersRolesApi  # noqa: E501
...
class TestUsersRolesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = pulpcore.client.pulpcore.api.users_roles_api.UsersRolesApi()  # noqa: E501
