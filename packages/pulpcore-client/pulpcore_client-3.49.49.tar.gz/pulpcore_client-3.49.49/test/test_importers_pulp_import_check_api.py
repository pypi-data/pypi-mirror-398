...
from pulpcore.client.pulpcore.api.importers_pulp_import_check_api import ImportersPulpImportCheckApi  # noqa: E501
...
class TestImportersPulpImportCheckApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = pulpcore.client.pulpcore.api.importers_pulp_import_check_api.ImportersPulpImportCheckApi()  # noqa: E501
