...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["hidden", "content_guard", "base_path", "no_content_change_since", "base_url", "pulp_labels", "pulp_href", "name", "pulp_last_updated", "pulp_created", "prn"]
