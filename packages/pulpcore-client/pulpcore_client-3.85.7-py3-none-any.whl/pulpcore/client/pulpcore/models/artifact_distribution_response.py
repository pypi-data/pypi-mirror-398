...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_last_updated", "pulp_labels", "no_content_change_since", "name", "prn", "pulp_href", "hidden", "pulp_created", "content_guard", "base_url", "base_path"]
