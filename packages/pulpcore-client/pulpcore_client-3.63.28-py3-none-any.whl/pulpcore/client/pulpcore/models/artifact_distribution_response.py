...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, prn=None, name=None, base_path=None, no_content_change_since=None, hidden=False, pulp_created=None, pulp_labels=None, pulp_last_updated=None, base_url=None, content_guard=None, pulp_href=None, local_vars_configuration=None):  # noqa: E501
