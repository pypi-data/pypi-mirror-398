"""
Layer 2 Agent: Environment-based business logic wrapper for runpod
...
from src.clients.runpod.primitives_agent import PrimitivesAgent
from src.business.context import ServiceContext


class BusinessAgent:
    """
    Agent-ready wrapper for runpod business logic (Layer 2).
    ...
    def __init__(
        ...
        self._ctx.runpod = self.primitives.raw
