...
from pycharter.runtime_validator.streaming import StreamingValidator
...
class KafkaValidator:
    ...
    def __init__(
        ...
        self.validator = StreamingValidator(model)
        ...
        try:
            for kafka_message in consumer:
                ...
                try:
                    ...
                    # Validate message
                    result = self.validator.validate_record(data, strict=self.strict)
    ...
    def validate_message(self, message_value: Union[str, bytes, Dict[str, Any]]) -> ValidationResult:
        ...
        return self.validator.validate_record(data, strict=self.strict)
