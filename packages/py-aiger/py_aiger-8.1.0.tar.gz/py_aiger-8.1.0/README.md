...
For developers, see the [Development workflow](#development-workflow) section below.
...
Commit the resulting `uv.lock` whenever dependencies change, and use
`uv run <command>` for recurring tasks such as:
