...
from localargo.core.executors import (
    ...
    execute_ca_distribution,
    execute_ca_setup,
    execute_cert_manager_installation,
    execute_cluster_creation,
    execute_coredns_setup,
...
class ExecutionEngine:
    ...
    Initializes the execution engine with a list of steps.
    """
...
STANDARD_UP_STEPS = [
    ...
    ExecutionStep(
        name="coredns",
        description="Configure CoreDNS for in-cluster domain resolution",
        check_function=check_coredns,
        execute_function=execute_coredns_setup,
        requires_client=False,
    ),
    ExecutionStep(
        name="cert-manager",
        description="Install cert-manager",
        check_function=check_cert_manager,
        execute_function=execute_cert_manager_installation,
        requires_client=False,
    ),
    ExecutionStep(
        name="ca",
        description="Set up dev Root CA and certificates",
        check_function=check_ca,
        execute_function=execute_ca_setup,
        requires_client=False,
    ),
    ExecutionStep(
        name="ca-distribution",
        description="Distribute CA certificate to app namespaces",
        check_function=check_ca_distribution,
        execute_function=execute_ca_distribution,
        requires_client=False,
    ),
    ExecutionStep(
        name="secrets",
