#THIS IS timediffz 1.0.0.6 (fractionals mode) - made by wedu_official
import sys
# noinspection PyUnresolvedReferences
try: from fractionals import Fraction #cython
except: raise ImportError('you need to setup fractionals via this command cd (full path of folder where setupfractionals.py is in, found in the library files) & python(3 or nothing) setupfractionals.py build_ext --inplace')
