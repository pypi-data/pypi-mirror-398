...
pipx install verdict-ai[openai]
pipx install verdict-ai[gemini]
```
...
**Solution:** Check [Anthropic API status](https://status.anthropic.com) and try again.
...
- [x] Alternative LLM providers (Claude, OpenAI, Gemini)
