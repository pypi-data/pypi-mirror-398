...
from ..models import coordination_v1alpha2 as m_coordination_v1alpha2


class LeaseCandidate(res.NamespacedResourceG, m_coordination_v1alpha2.LeaseCandidate):
    """* **Extends**: ``models.coordination_v1alpha2.LeaseCandidate``
    ...
    _api_info = res.ApiInfo(
        resource=res.ResourceDef('coordination.k8s.io', 'v1alpha2', 'LeaseCandidate'),
