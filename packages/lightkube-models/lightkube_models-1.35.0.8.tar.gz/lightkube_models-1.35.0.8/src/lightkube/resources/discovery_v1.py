...
from ..models import discovery_v1 as m_discovery_v1


class EndpointSlice(res.NamespacedResourceG, m_discovery_v1.EndpointSlice):
    """* **Extends**: ``models.discovery_v1.EndpointSlice``
    ...
    _api_info = res.ApiInfo(
        resource=res.ResourceDef('discovery.k8s.io', 'v1', 'EndpointSlice'),
