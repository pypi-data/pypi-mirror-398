...
# for sTraj in ["Rosette"]:
    ...
    if sMethod == "Proposed":
        ...
        t0 = time()
        arrDcf = mad.calDcf(int(nPix), arrK, arrI0, sWind="poly", fInit=1) # *ovTraj
        tExe = time() - t0
    ...
    arrM0_Norm = mad.normImg(arrM0, "ene", mskFov=mskFov)
    arrM0Rec_Norm = mad.normImg(arrM0Rec, "ene", mskFov=mskFov)
