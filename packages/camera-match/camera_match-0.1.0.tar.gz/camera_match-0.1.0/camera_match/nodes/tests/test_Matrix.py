...
from camera_match import LinearMatrix, RootPolynomialMatrix, TetrahedralMatrix
...
class TestLinearMatrix:
    ...
    def test_solve(self):
        ...
        np.testing.assert_allclose(source, MATRIX_REFERENCE, atol=0.17)
...
class TestRootPolynomialMatrix:
    ...
    def test_solve(self):
        ...
        np.testing.assert_allclose(source, MATRIX_REFERENCE, atol=0.07)
...
class TestTetrahedralMatrix:
    ...
    def test_solve(self):
        ...
        np.testing.assert_allclose(
            ...
            np.array(
                [
                    ...
                    [6.60064011e-02, 2.18117094e-01, 1.24311189e00],
                    [2.71190988e-01, 8.27376560e-01, 1.24083296e00],
        ...
        np.testing.assert_allclose(source, MATRIX_REFERENCE, atol=0.15)
