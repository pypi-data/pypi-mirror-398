...
The following versions of **FeinCMS** are supported:

- `FeinCMS>=22.0.0,<=25.5.1`
...
- Run `pip install feincms-all-in-one-accessibility`
...
### Base.html
Just add this tag in your base.html footer(your main template of fein CMS website) `<script id="aioa-adawidget" src="{{ AIOA_URL }}"></script>`:
```python
  <footer>
