...
def create_sub_process(organization_id: int, device_group_name: str, task_id: int, title: str, description: str, resource_id: int, source: str, space_timestamp: int, template_name: str, exp_folder_id: int = None, exp_folder_path: str = None, priority: str = None): ...
...
def list_new_experiments(task_id: int, since_exp_id: int, exp_folder_id: int = None, limit: int = 50): ...
...
def add_fitting_result(task_id: int, sub_process_id_list: list, big_picture_id: int, small_picture_id: int, data_id: int = None): ...
...
def create_exp_folder(task_id: int, exp_folder_name: str, parent_exp_folder_id: int = None, exp_folder_description: str = None): ...
...
def move_experiments_to_exp_folder(task_id: int, sub_process_ids: list[int], target_exp_folder_id: int = None): ...
def get_exp_folder_tree(task_id: int): ...
def check_exp_folder_empty(exp_folder_id: int): ...
def list_sub_processes_by_folder(task_id: int, exp_folder_id: int = None, before_exp_id: int = None, limit: int = 10): ...
def batch_query_experiments(device_group_name: str, task_id: int, exp_ids: list[int]): ...
def count_experiments_by_folder(task_id: int, exp_folder_id: int = None): ...
...
def get_latest_sub_process_id_by_folder(device_group_name: str, task_id: int, exp_folder_id: int = None): ...
def list_marked_exps(organization_id: int = None, device_group_name: str = None, task_id: int = None, page: int = 1, per_page: int = 10): ...
