...
class DirectGroup(CloudGroup):
    ...
    def submit_direct_exp(self, exp_obj: Experiment, reg_cloud_exp_id: bool = False, task_id: int | None = None, exp_folder_path: str = None) -> int: ...
    def pull_direct_result(self, direct_exp_id: int, waiting_for_finished: bool = True, timeout: int = 300) -> Result | None: ...
    def reg_exp_id(self, task_id: int, exp_folder_path: str, exp_obj: Experiment | None = None, data_shape: dict | None = None, title: str | None = None, desc: str | None = None, space_timestamp: int | None = None): ...
