...
def show_progress(result: Result, finished: bool, exp_detail: dict, device_group_name: str = None, task_id: int = None, space_id: int = None, enable_plot: bool = False, select_fields: list[str] | str | None = None): ...
