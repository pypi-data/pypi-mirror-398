...
from minjiang_client.com.task import add_fitting_result as add_fitting_result, count_experiments_by_folder as count_experiments_by_folder, create_exp_folder as create_exp_folder, create_sub_process as create_sub_process, create_task as create_task, download_result_chunk_from_cache as download_result_chunk_from_cache, get_fitting_result as get_fitting_result, get_sub_process_detail as get_sub_process_detail, get_sub_process_msg as get_sub_process_msg, get_sub_process_result as get_sub_process_result, get_task_detail as get_task_detail, list_exp_folders_by_parent as list_exp_folders_by_parent, list_new_experiments as list_new_experiments, list_sub_processes as list_sub_processes, list_sub_processes_by_folder as list_sub_processes_by_folder, list_tasks as list_tasks, terminate_task as terminate_task
...
from minjiang_client.utils.task_status import CANCELED as CANCELED, COMPLETE as COMPLETE, ERROR as ERROR, TIMEOUT as TIMEOUT, __TASK_STATUS__ as __TASK_STATUS__
...
class CloudGroup(Group):
    ...
    @staticmethod
    def list_new_exps(task_id: int, since_exp_id: int, exp_folder_id: int = None, limit: int = 50): ...
    @staticmethod
    def count_exps_by_folder(task_id: int, exp_folder_id: int = None): ...
    @staticmethod
    def list_exps_by_folder(task_id: int, exp_folder_id: int = None, before_exp_id: int = None, limit: int = 10): ...
    def create_exp_folder(self, task_id: int, folder_path: str): ...
    ...
    def submit_exp(self, exp: Experiment, task_id: int = None, space_timestamp: int = None, template_name: str = None, source: str = 'SDK', attachment: dict[str, int] = None, exp_folder_id: int = None, exp_folder_path: str = None, priority: str = None): ...
    @staticmethod
    ...
    def submit_fitting_result(self, task_id: int, exp_id: int, img_file: str, table_file: str | None = None, space_parameters: list[dict] = None, update_space: bool = True): ...
