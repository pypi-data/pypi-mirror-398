...
class TripsApi:
    ...
    @validate_call
    def approve_trips_batch(
        self,
        file_key: Annotated[UUID, Field(description="File key, unique identifier.")],
        request_body: Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(min_length=0, max_length=15001, description="Approve trips request.")],
        ...
        :type file_key: str
        :param request_body: Approve trips request. (required)
        ...
        _param = self._approve_trips_batch_serialize(
            file_key=file_key,
    ...
    @validate_call
    def approve_trips_batch_with_http_info(
        self,
        file_key: Annotated[UUID, Field(description="File key, unique identifier.")],
        request_body: Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(min_length=0, max_length=15001, description="Approve trips request.")],
        _request_timeout: Union[
    ...
    @validate_call
    def approve_trips_batch_without_preload_content(
        self,
        file_key: Annotated[UUID, Field(description="File key, unique identifier.")],
        request_body: Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(min_length=0, max_length=15001, description="Approve trips request.")],
        _request_timeout: Union[
    ...
    def _approve_trips_batch_serialize(
        self,
        file_key,
        request_body,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/studio/experiments/{file_key}/trips/batch/verification',
    ...
    def _create_trip_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/studio/experiments/{file_key}/trips',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _delete_custom_tracks_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/studio/experiments/{file_key}/trips/batch/tracks-custom',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _delete_trip_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/studio/experiments/{file_key}/trips/{essence_key}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _delete_trips_batch_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/studio/experiments/{file_key}/trips/batch/table',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _read_trip_stops_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/studio/experiments/{file_key}/trips/{essence_key}/stops/batch/table',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _read_trips_charts_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/studio/experiments/{file_key}/trips/batch/charts',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _read_trips_metrics_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/studio/experiments/{file_key}/trips/batch/metrics',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _read_trips_tracks_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/studio/experiments/{file_key}/trips/batch/tracks/{tracks_type}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def reject_trips_batch(
        self,
        file_key: Annotated[UUID, Field(description="File key, unique identifier.")],
        request_body: Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(min_length=0, max_length=15001, description="Reject trips request.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param file_key: File key, unique identifier. (required)
        :type file_key: str
        :param request_body: Reject trips request. (required)
        :type request_body: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._reject_trips_batch_serialize(
            file_key=file_key,
            request_body=request_body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def reject_trips_batch_with_http_info(
        self,
        file_key: Annotated[UUID, Field(description="File key, unique identifier.")],
        request_body: Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(min_length=0, max_length=15001, description="Reject trips request.")],
        _request_timeout: Union[
    ...
    @validate_call
    def reject_trips_batch_without_preload_content(
        self,
        file_key: Annotated[UUID, Field(description="File key, unique identifier.")],
        request_body: Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(min_length=0, max_length=15001, description="Reject trips request.")],
        _request_timeout: Union[
    ...
    def _reject_trips_batch_serialize(
        self,
        file_key,
        request_body,
        _request_auth,
