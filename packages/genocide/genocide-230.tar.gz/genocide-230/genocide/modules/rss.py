...
from genocide.defines import Config, Object, Repeater
from genocide.defines import elapsed, fmt, find, last, launch, objs
from genocide.defines import fntime, getpath, spl, update, write
