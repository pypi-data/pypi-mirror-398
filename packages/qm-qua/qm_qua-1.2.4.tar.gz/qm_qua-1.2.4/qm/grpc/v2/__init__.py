...
class Range(betterproto.Message):
    """inclusive range if sides given"""

    from_: Optional[Optional[int]] = betterproto.message_field(
        1, wraps=betterproto.TYPE_INT64, optional=True
    )
    to: Optional[Optional[int]] = betterproto.message_field(
        2, wraps=betterproto.TYPE_INT64, optional=True
    )
...
class GetControllersResponseController(betterproto.Message):
    ...
    temperatures: Dict[str, float] = betterproto.map_field(
...
class QmServiceSimulateRequest(betterproto.Message):
    ...
    config: Optional["_qua_config__.QuaConfig"] = betterproto.message_field(
        5, optional=True
    )
...
@dataclass(eq=False, repr=False)
class ResetDigitalFiltersRequest(betterproto.Message):
    quantum_machine_id: str = betterproto.string_field(1)


@dataclass(eq=False, repr=False)
class ResetDigitalFiltersResponse(betterproto.Message):
    success: "ResetDigitalFiltersResponseResetDigitalFiltersResponseSuccess" = (
        betterproto.message_field(1, group="response_oneof")
    )
    error: "ResetDigitalFiltersResponseResetDigitalFiltersResponseError" = (
        betterproto.message_field(2, group="response_oneof")
    )


@dataclass(eq=False, repr=False)
class ResetDigitalFiltersResponseResetDigitalFiltersResponseSuccess(
    betterproto.Message
):
    pass
...
@dataclass(eq=False, repr=False)
class ResetDigitalFiltersResponseResetDigitalFiltersResponseError(betterproto.Message):
    details: str = betterproto.string_field(1)
...
@dataclass(eq=False, repr=False)
class GetJobNamedResultsHeadersRequest(betterproto.Message):
    job_id: str = betterproto.string_field(1)
    outputs: List["GetJobNamedResultsHeadersRequestOutput"] = betterproto.message_field(
        2
    )


@dataclass(eq=False, repr=False)
class GetJobNamedResultsHeadersRequestOutput(betterproto.Message):
    output_name: str = betterproto.string_field(1)
    flat_format: bool = betterproto.bool_field(2)


@dataclass(eq=False, repr=False)
class GetJobNamedResultsHeadersResponse(betterproto.Message):
    success: "GetJobNamedResultsHeadersResponseGetJobNamedResultsHeadersResponseSuccess" = betterproto.message_field(
        1, group="response_oneof"
    )
    error: "GetJobNamedResultsHeadersResponseGetJobNamedResultsHeadersResponseError" = (
        betterproto.message_field(2, group="response_oneof")
    )


@dataclass(eq=False, repr=False)
class GetJobNamedResultsHeadersResponseGetJobNamedResultsHeadersResponseSuccess(
    betterproto.Message
):
    headers: List[
...
@dataclass(eq=False, repr=False)
class GetJobNamedResultsHeadersResponseGetJobNamedResultsHeadersResponseSuccessOutputHeader(
    betterproto.Message
):
    count_so_far: int = betterproto.int32_field(1)
    has_data_loss: bool = betterproto.bool_field(2)
    output_name: str = betterproto.string_field(3)
    simple_dtype: str = betterproto.string_field(4)
    shape: List[int] = betterproto.int32_field(5)


@dataclass(eq=False, repr=False)
class GetJobNamedResultsHeadersResponseGetJobNamedResultsHeadersResponseError(
    betterproto.Message
):
    details: str = betterproto.string_field(1)
...
class GetJobNamedResultHeaderResponseGetJobNamedResultHeaderResponseSuccess(
    ...
    shape: List[int] = betterproto.int32_field(5)
    output_name: str = betterproto.string_field(6)


@dataclass(eq=False, repr=False)
class GetNamedResultsRequest(betterproto.Message):
    job_id: str = betterproto.string_field(1)
    outputs: List["GetNamedResultsRequestOutput"] = betterproto.message_field(2)


@dataclass(eq=False, repr=False)
class GetNamedResultsRequestOutput(betterproto.Message):
    output_name: str = betterproto.string_field(1)
    range: "Range" = betterproto.message_field(2)
...
class GetNamedResultResponseGetNamedResultResponseSuccess(betterproto.Message):
    ...
    output_name: str = betterproto.string_field(5)
...
class QmServiceStub(betterproto.ServiceStub):
    ...
    async def reset_digital_filters(
        self,
        reset_digital_filters_request: "ResetDigitalFiltersRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
    ) -> "ResetDigitalFiltersResponse":
        return await self._unary_unary(
            "/qm.grpc.v2.QmService/ResetDigitalFilters",
            reset_digital_filters_request,
            ResetDigitalFiltersResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
...
class JobServiceStub(betterproto.ServiceStub):
    ...
    async def get_job_named_results_headers(
        self,
        get_job_named_results_headers_request: "GetJobNamedResultsHeadersRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
    ) -> "GetJobNamedResultsHeadersResponse":
        return await self._unary_unary(
            "/qm.grpc.v2.JobService/GetJobNamedResultsHeaders",
            get_job_named_results_headers_request,
            GetJobNamedResultsHeadersResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def get_named_results(
        self,
        get_named_results_request: "GetNamedResultsRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
...
class QmServiceBase(ServiceBase):
    ...
    async def reset_digital_filters(
        self, reset_digital_filters_request: "ResetDigitalFiltersRequest"
    ) -> "ResetDigitalFiltersResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def __rpc_reset_digital_filters(
        self,
        stream: "grpclib.server.Stream[ResetDigitalFiltersRequest, ResetDigitalFiltersResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.reset_digital_filters(request)
        await stream.send_message(response)
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            ...
            "/qm.grpc.v2.QmService/ResetDigitalFilters": grpclib.const.Handler(
                self.__rpc_reset_digital_filters,
                grpclib.const.Cardinality.UNARY_UNARY,
...
class JobServiceBase(ServiceBase):
    ...
    async def get_job_named_results_headers(
        self, get_job_named_results_headers_request: "GetJobNamedResultsHeadersRequest"
    ) -> "GetJobNamedResultsHeadersResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def get_named_results(
        self, get_named_results_request: "GetNamedResultsRequest"
    ) -> AsyncIterator[GetNamedResultResponse]:
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
        yield GetNamedResultResponse()
    ...
    async def __rpc_get_job_named_results_headers(
        self,
        stream: "grpclib.server.Stream[GetJobNamedResultsHeadersRequest, GetJobNamedResultsHeadersResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.get_job_named_results_headers(request)
        await stream.send_message(response)
    ...
    async def __rpc_get_named_results(
        self,
        stream: "grpclib.server.Stream[GetNamedResultsRequest, GetNamedResultResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.get_named_results,
            stream,
            request,
        )
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            ...
            "/qm.grpc.v2.JobService/GetJobNamedResultsHeaders": grpclib.const.Handler(
                self.__rpc_get_job_named_results_headers,
                grpclib.const.Cardinality.UNARY_UNARY,
            ...
            "/qm.grpc.v2.JobService/GetNamedResults": grpclib.const.Handler(
                self.__rpc_get_named_results,
                grpclib.const.Cardinality.UNARY_STREAM,
