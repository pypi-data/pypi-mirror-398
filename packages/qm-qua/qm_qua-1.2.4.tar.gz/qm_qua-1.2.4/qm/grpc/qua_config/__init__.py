...
class QuaConfig(betterproto.Message):
    ...
    v2: "QuaConfigQuaConfigV2" = betterproto.message_field(2, group="config_version")
...
@dataclass(eq=False, repr=False)
class QuaConfigQuaConfigV2(betterproto.Message):
    controller_config: "QuaConfigControllerConfig" = betterproto.message_field(1)
    logical_config: "QuaConfigLogicalConfig" = betterproto.message_field(2)


@dataclass(eq=False, repr=False)
class QuaConfigControllerConfig(betterproto.Message):
    control_devices: Dict[str, "QuaConfigDeviceDec"] = betterproto.map_field(
...
@dataclass(eq=False, repr=False)
class QuaConfigLogicalConfig(betterproto.Message):
    elements: Dict[str, "QuaConfigElementDec"] = betterproto.map_field(
        1, betterproto.TYPE_STRING, betterproto.TYPE_MESSAGE
    )
    oscillators: Dict[str, "QuaConfigOscillator"] = betterproto.map_field(
...
class QuaConfigAnalogOutputPortDec(betterproto.Message):
    offset: Optional[float] = betterproto.double_field(1, optional=True)
    filter: "QuaConfigAnalogOutputPortFilter" = betterproto.message_field(2)
    delay: Optional[int] = betterproto.uint32_field(3, optional=True)
    channel_weights: Dict[int, float] = betterproto.map_field(
        4, betterproto.TYPE_UINT32, betterproto.TYPE_DOUBLE
    )
    shareable: Optional[bool] = betterproto.bool_field(5, optional=True)
    crosstalk: Dict[int, float] = betterproto.map_field(
        6, betterproto.TYPE_UINT32, betterproto.TYPE_DOUBLE
    )
    min_voltage_limit: Optional[float] = betterproto.double_field(7, optional=True)
    max_voltage_limit: Optional[float] = betterproto.double_field(8, optional=True)
...
class QuaConfigMicrowaveAnalogOutputPortDec(betterproto.Message):
    sampling_rate: Optional[float] = betterproto.double_field(1, optional=True)
    full_scale_power_dbm: Optional[int] = betterproto.int32_field(2, optional=True)
    band: Optional[int] = betterproto.int32_field(3, optional=True)
    delay: Optional[int] = betterproto.uint32_field(4, optional=True)
    shareable: Optional[bool] = betterproto.bool_field(5, optional=True)
    ...
    upconverters_v2: "QuaConfigMicrowaveAnalogOutputPortDecUpConvertersContainer" = (
        betterproto.message_field(7)
    )

    def __post_init__(self) -> None:
        super().__post_init__()
        if self.is_set("upconverters"):
            warnings.warn(
                "QuaConfigMicrowaveAnalogOutputPortDec.upconverters is deprecated",
                DeprecationWarning,
            )


@dataclass(eq=False, repr=False)
class QuaConfigMicrowaveAnalogOutputPortDecUpConvertersContainer(betterproto.Message):
    value: Dict[int, "QuaConfigUpConverterConfigDec"] = betterproto.map_field(
        1, betterproto.TYPE_UINT32, betterproto.TYPE_MESSAGE
    )
...
class QuaConfigMicrowaveAnalogInputPortDec(betterproto.Message):
    sampling_rate: Optional[float] = betterproto.double_field(1, optional=True)
    gain_db: Optional[int] = betterproto.int32_field(2, optional=True)
    shareable: Optional[bool] = betterproto.bool_field(3, optional=True)
    band: Optional[int] = betterproto.int32_field(4, optional=True)
...
class QuaConfigOctoDacAnalogOutputPortDec(betterproto.Message):
    ...
    crosstalk_v2: "QuaConfigOctoDacAnalogOutputPortDecCrosstalkContainer" = (
        betterproto.message_field(10)
    )
    min_voltage_limit: Optional[
        "QuaConfigOctoDacAnalogOutputPortDecVoltageLimitContainer"
    ] = betterproto.message_field(11, optional=True)
    max_voltage_limit: Optional[
        "QuaConfigOctoDacAnalogOutputPortDecVoltageLimitContainer"
    ] = betterproto.message_field(12, optional=True)

    def __post_init__(self) -> None:
        super().__post_init__()
        if self.is_set("crosstalk"):
            warnings.warn(
                "QuaConfigOctoDacAnalogOutputPortDec.crosstalk is deprecated",
                DeprecationWarning,
            )


@dataclass(eq=False, repr=False)
class QuaConfigOctoDacAnalogOutputPortDecCrosstalkContainer(betterproto.Message):
    value: Dict[int, float] = betterproto.map_field(
        1, betterproto.TYPE_UINT32, betterproto.TYPE_DOUBLE
    )


@dataclass(eq=False, repr=False)
class QuaConfigOctoDacAnalogOutputPortDecVoltageLimitContainer(betterproto.Message):
    """whereas an object can be by leaving it unfilled."""

    value: Optional[float] = betterproto.double_field(1, optional=True)
...
class QuaConfigIirFilter(betterproto.Message):
    ...
    exponential_v2: "QuaConfigIirFilterExponentialParametersContainer" = (
        betterproto.message_field(3)
    )
    high_pass_v2: Optional[
        "QuaConfigIirFilterHighPassContainer"
    ] = betterproto.message_field(4, optional=True)
    exponential_dc_gain: Optional[
        "QuaConfigIirFilterExponentialDcGainContainer"
    ] = betterproto.message_field(5, optional=True)

    def __post_init__(self) -> None:
        super().__post_init__()
        if self.is_set("exponential"):
            warnings.warn(
                "QuaConfigIirFilter.exponential is deprecated", DeprecationWarning
            )
        if self.is_set("high_pass"):
            warnings.warn(
                "QuaConfigIirFilter.high_pass is deprecated", DeprecationWarning
            )


@dataclass(eq=False, repr=False)
class QuaConfigIirFilterExponentialParametersContainer(betterproto.Message):
    value: List["QuaConfigExponentialParameters"] = betterproto.message_field(1)


@dataclass(eq=False, repr=False)
class QuaConfigIirFilterHighPassContainer(betterproto.Message):
    value: Optional[float] = betterproto.double_field(1, optional=True)


@dataclass(eq=False, repr=False)
class QuaConfigIirFilterExponentialDcGainContainer(betterproto.Message):
    value: Optional[float] = betterproto.double_field(1, optional=True)
...
class QuaConfigAnalogOutputPortFilter(betterproto.Message):
    ...
    feedforward_v2: "QuaConfigAnalogOutputPortFilterFeedforwardContainer" = (
        betterproto.message_field(4)
    )

    def __post_init__(self) -> None:
        super().__post_init__()
        if self.is_set("feedforward"):
            warnings.warn(
                "QuaConfigAnalogOutputPortFilter.feedforward is deprecated",
                DeprecationWarning,
            )


@dataclass(eq=False, repr=False)
class QuaConfigAnalogOutputPortFilterFeedforwardContainer(betterproto.Message):
    value: List[float] = betterproto.double_field(1)


@dataclass(eq=False, repr=False)
class QuaConfigAnalogInputPortDec(betterproto.Message):
    offset: Optional[float] = betterproto.double_field(1, optional=True)
    gain_db: Optional[Optional[int]] = betterproto.message_field(
        2, wraps=betterproto.TYPE_INT32, optional=True
    )
    shareable: Optional[bool] = betterproto.bool_field(3, optional=True)
...
class QuaConfigDigitalOutputPortDec(betterproto.Message):
    shareable: Optional[bool] = betterproto.bool_field(1, optional=True)
    inverted: Optional[bool] = betterproto.bool_field(2, optional=True)
...
class QuaConfigDigitalInputPortDec(betterproto.Message):
    deadtime: Optional[int] = betterproto.uint32_field(1, optional=True)
    polarity: Optional["QuaConfigDigitalInputPortDecPolarity"] = betterproto.enum_field(
        2, optional=True
    )
    threshold: Optional[float] = betterproto.double_field(3, optional=True)
    shareable: Optional[bool] = betterproto.bool_field(4, optional=True)
...
class QuaConfigWaveformDec(betterproto.Message):
    ...
    array: "QuaConfigWaveformArrayDec" = betterproto.message_field(
        4, group="waveform_oneof"
    )
...
@dataclass(eq=False, repr=False)
class QuaConfigWaveformArrayDec(betterproto.Message):
    samples_array: List["QuaConfigWaveformSamples"] = betterproto.message_field(1)


@dataclass(eq=False, repr=False)
class QuaConfigWaveformSamples(betterproto.Message):
    samples: List[float] = betterproto.double_field(1)
