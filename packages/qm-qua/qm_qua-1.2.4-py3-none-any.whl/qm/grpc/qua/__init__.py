...
class QuaProgramDirection(betterproto.Enum):
    INCOMING = 0
    OUTGOING = 1
...
class QuaProgramVarDeclaration(betterproto.Message):
    ...
    struct_member: "QuaProgramVarDeclarationStructMember" = betterproto.message_field(7)


@dataclass(eq=False, repr=False)
class QuaProgramVarDeclarationStructMember(betterproto.Message):
    name: str = betterproto.string_field(1)
    position: int = betterproto.int32_field(2)


@dataclass(eq=False, repr=False)
class QuaProgramExternalStreamDeclaration(betterproto.Message):
    stream_id: int = betterproto.uint32_field(1)
    expected_types: List["QuaProgramVarDeclaration"] = betterproto.message_field(2)
    """Ordered"""

    direction: "QuaProgramDirection" = betterproto.enum_field(3)
...
class QuaProgramAnyStatement(betterproto.Message):
    ...
    load_waveform: "QuaProgramLoadWaveformStatement" = betterproto.message_field(
        28, group="statement_oneof"
    )
    send_to_external_stream: "QuaProgramSendToExternalStreamStatement" = (
        betterproto.message_field(29, group="statement_oneof")
    )
    receive_from_external_stream: "QuaProgramReceiveFromExternalStreamStatement" = (
        betterproto.message_field(30, group="statement_oneof")
    )
    arbitrary: "QuaProgramArbitraryStatement" = betterproto.message_field(
        100, group="statement_oneof"
    )
    arbitrary_context: "QuaProgramArbitraryContextStatement" = (
        betterproto.message_field(101, group="statement_oneof")
    )
...
@dataclass(eq=False, repr=False)
class QuaProgramArbitraryStatement(betterproto.Message):
    loc: str = betterproto.string_field(100)
    name: str = betterproto.string_field(1)
...
@dataclass(eq=False, repr=False)
class QuaProgramArbitraryContextStatement(betterproto.Message):
    loc: str = betterproto.string_field(100)
    name: str = betterproto.string_field(1)
    data: Optional["betterproto_lib_google_protobuf.Any"] = betterproto.message_field(
        2, optional=True
    )
    body: "QuaProgramStatementsCollection" = betterproto.message_field(3)
...
@dataclass(eq=False, repr=False)
class QuaProgramSendToExternalStreamStatement(betterproto.Message):
    loc: str = betterproto.string_field(100)
    stream: "QuaProgramExternalStreamRefExpression" = betterproto.message_field(1)
    struct: "QuaProgramStructVarRefExpression" = betterproto.message_field(2)


@dataclass(eq=False, repr=False)
class QuaProgramReceiveFromExternalStreamStatement(betterproto.Message):
    loc: str = betterproto.string_field(100)
    stream: "QuaProgramExternalStreamRefExpression" = betterproto.message_field(1)
    struct: "QuaProgramStructVarRefExpression" = betterproto.message_field(2)
...
@dataclass(eq=False, repr=False)
class QuaProgramLoadWaveformStatement(betterproto.Message):
    loc: str = betterproto.string_field(100)
    qe: "QuaProgramQuantumElementReference" = betterproto.message_field(1)
    pulse: "QuaProgramPulseReference" = betterproto.message_field(2)
    waveform_index: "QuaProgramAnyScalarExpression" = betterproto.message_field(3)
...
@dataclass(eq=False, repr=False)
class QuaProgramStructVarRefExpression(betterproto.Message):
    name: str = betterproto.string_field(2)
    loc: str = betterproto.string_field(100)


@dataclass(eq=False, repr=False)
class QuaProgramExternalStreamRefExpression(betterproto.Message):
