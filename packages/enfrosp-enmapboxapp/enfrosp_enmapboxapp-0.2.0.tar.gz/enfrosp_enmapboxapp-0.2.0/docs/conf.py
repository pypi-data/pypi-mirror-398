...
"""
Documentation build configuration file for enfrosp_enmapboxapp.

This file is used to configure the Sphinx documentation build
process for the enfrosp_enmapboxapp project. It defines the necessary settings and extensions to generate the documentation.
...
# -*- coding: utf-8 -*-
#
# enfrosp_enmapboxapp documentation build configuration file, created by
...
project = 'EnFROSP EnMAP-Box-App'
copyright = "2025, Daniel Scheffler"
...
version = enfrosp_enmapboxapp.__version__
# The full version, including alpha/beta/rc tags.
release = enfrosp_enmapboxapp.__version__
...
htmlhelp_basename = 'enfrosp_enmapboxappdoc'
...
latex_documents = [
    (master_doc, 'enfrosp_enmapboxapp.tex',
     'EnFROSP EnMAP-Box-App Documentation',
...
man_pages = [
    (master_doc, 'enfrosp_enmapboxapp',
     'EnFROSP EnMAP-Box-App Documentation',
     [author], 1)
]
