...
def rain_to_01process(rain01h_ob_fos,used_coords = "time"):
    ...
    rain01h_ob_fos_hap = meteva_base.max_on_level_time_dtime_id(rain01h_ob_fos_hap,rain01h_ob_fos_hap_move01,how = "outer",default=0)
    ...
    rain02h_ob_fos_hap = meteva_base.sum_of_sta(rain01h_ob_fos_hap,used_coords=[used_coords],span = 2)
    ...
    rain02h_ob_fos_hap_sprate02 =meteva_base.min_on_level_time_dtime_id(rain02h_ob_fos_hap,rain02h_ob_fos_hap_back01,how = "outer",default=0)
...
def rain_process_start(rain01h_ob_fos,used_coords = "time"):
    ...
    delta = meteva_base.change(rain02h_ob_fos_hap_sprate02,used_coords=used_coords,delta=1)
    # if used_coords =="time":
...
def rain_process_lenght(rain01h_ob_fos,used_coords = "time",record_on = "end"):
    ...
    for dh in range(max_move):
        ...
        rain02h_ob_fos_hap_sprate02_m = meteva_base.mutiply_on_level_time_dtime_id(rain02h_ob_fos_hap_sprate02_m,
                                                                                   rain02h_ob_fos_hap_sprate02)
        lenght = meteva_base.add_on_level_time_dtime_id(lenght, rain02h_ob_fos_hap_sprate02_m,how="left",default=0)
    delta = meteva_base.change(rain02h_ob_fos_hap_sprate02, used_coords=used_coords, delta=1)
    ...
    rain_end_01 = delta.copy()
    rain_end_01.iloc[:, 6:] = values[...]
    lenght = meteva_base.mutiply_on_level_time_dtime_id(lenght,rain_end_01,how="left",default=0)
    return lenght
...
def rain_process_peak(rain01h_ob_fos,used_coords = "time"):
    ...
    rain01h_ob_fos_sprate02 = meteva_base.mutiply_on_level_time_dtime_id(rain01h_ob_fos,process01,how="right",default=0)
    ...
    for dh in range(1,max_move):
        ...
        rain01h_ob_fos_move = meteva_base.mutiply_on_level_time_dtime_id(rain01h_ob_fos_move,
                                                                                   process01,how="right",default=0)
        max_value = meteva_base.max_on_level_time_dtime_id(max_value, rain01h_ob_fos_move)
    ...
    peak = meteva_base.minus_on_level_time_dtime_id(rain01h_ob_fos_sprate02,max_value,how="left",default=0)
    ...
    peak_time.iloc[:,6:] = 0
    peak_time = meteva_base.max_on_level_time_dtime_id(peak_time,peak,how = "left",default=0)
    peak_value = meteva_base.mutiply_on_level_time_dtime_id(rain01h_ob_fos,peak_time)
...
def is_max_of_oneday(sta,used_coords = "time",start_hour_of_one_day = 0,keep_zeros = True):
    ...
    sta_max = meteva_base.max_of_sta(sta,used_coords=used_coords,span = 24)
    sta_max_last_time = meteva_base.sele_by_para(sta_max,ob_hour=start_hour_of_one_day)
    ...
    sta_max_all = meteva_base.concat(sta_max_list)
    sta_minus = meteva_base.minus_on_level_time_dtime_id(sta,sta_max_all,how="inner")
    ...
    if not keep_zeros:
        ...
        values[values != 0] = 1
        sta0.iloc[:,6:] = values
        sta_minus = meteva_base.mutiply_on_level_time_dtime_id(sta_minus,sta0,how="inner")
...
def is_min_of_oneday(sta,used_coords = "time",start_hour_of_one_day = 0):
    ...
    sta_min = meteva_base.min_of_sta(sta,used_coords=used_coords,span = 24)
    sta_min_last_time = meteva_base.sele_by_para(sta_min,ob_hour=start_hour_of_one_day)
    ...
    sta_min_all = meteva_base.concat(sta_min_list)
    sta_minus = meteva_base.minus_on_level_time_dtime_id(sta_min_all,sta,how="inner")
    values = sta_minus.values[:,6:]
    values[values==0] = 1
    values[values<0] = 0
    sta_minus.iloc[:, 6:] =values[:,:]
