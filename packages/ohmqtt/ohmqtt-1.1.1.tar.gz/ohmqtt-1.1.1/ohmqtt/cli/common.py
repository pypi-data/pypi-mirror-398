...
def add_broker_arguments(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--client_id", type=str, help="The client ID to use when connecting to the broker. By default, a random client ID is generated by the broker."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--password", type=str, help="The password for broker authentication (will be encoded as UTF-8)"
    )
    parser.add_argument(
