...
# =============================================================================
# Async/Parallel Support Functions
# =============================================================================
...
def diarize_audio_only(
    ...
    This function is designed to run in parallel with transcription.
    ...
    logging.info(f"Speaker diarization completed: {len(segments)} segments found")
    return segments
...
def merge_diarization_with_transcript(
    ...
    This is the second step after parallel execution of transcription and diarization.
...
async def diarize_audio_only_async(
    file_name: str,
    diarization_model: str,
    hf_token: str,
    num_speakers: int = None,
    ...
    """
    Async wrapper for diarize_audio_only.
    Runs the blocking diarization in a thread pool.
    """
    loop = asyncio.get_event_loop()
    return await loop.run_in_executor(
        _executor,
        lambda: diarize_audio_only(
            file_name=file_name,
