...
| `output_utils.py` | 437 | `OutputWriter` 多格式导出（JSON、TXT、SRT、WEBVTT、RTTM） |
...
### OutputWriter 类 (`output_utils.py:76-340`)
...
| `save_rttm_annotations()` | 保存 RTTM 说话人分离文件 |
| `save_results()` | 主入口，根据 export_formats 保存所有格式 |

### 格式验证 (`output_utils.py:31-73`)
