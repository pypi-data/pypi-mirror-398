...
#   timestamp: 2025-12-26T08:02:32+00:00
...
class GraphPatchSubmitRequest(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    extensions: Extensions | None = None
...
class GraphPatchSubmitResponse(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    accepted: StrictBool
    ...
    new_revision: Annotated[StrictInt | None, Field(ge=0)] = None
...
class Run(BaseModel):
    ...
    extensions: Extensions | None = None
    graph_state: TaskGraph | None = None
