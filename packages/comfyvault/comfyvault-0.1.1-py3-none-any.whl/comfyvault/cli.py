...
@click.group()
@click.version_option(version="0.1.0", prog_name="comfyvault")
def app():
    """ComfyVault: A secure, terminal-only password manager."""
    pass
...
def init():
    ...
    print("[bold green]Welcome to ComfyVault![/bold green]")
...
def add(service, username, generate):
    ...
    if not vault.is_initialized():
        print("[red]Vault not found. Run 'comfyvault init' first.[/red]")
        raise click.Exit(1)
