import warnings
try: import td1
except Exception: warnings.warn(f"time_diffz 1.0 (fractions mode) failed to load correctly :(, using any fractions mode related function WOULD give an error and fall because of this, the error")
try: import td2
except Exception: warnings.warn(f"time_diffz 1.0 (fractionals mode) failed to load correctly :(, using any fractionals mode related function WOULD give an error and fall because of this, the error")
