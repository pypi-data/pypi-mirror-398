...
<p align="center">
  <img alt="Shows a bar chart with benchmark results." width="500px" src="https://raw.githubusercontent.com/astral-sh/ty/0.0.7/docs/assets/ty-benchmark-cli.svg">
</p>
...
See the
[contributing guide](https://github.com/astral-sh/ty/blob/0.0.7/CONTRIBUTING.md) for more details.
...
ty is licensed under the MIT license ([LICENSE](https://github.com/astral-sh/ty/blob/0.0.7/LICENSE) or
