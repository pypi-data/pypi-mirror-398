...
struct TapAPITradeLoginAuth
{
    ...
    TAPISTR_30                    AppID;                                ///< 应用程序号
    TAPIForceModifyPasswordType    ISModifyPassword;                    ///< 是否修改密码
    ...
    TAPISTR_40                  LoginIP;                            ///< 登录用户IP
    TAPISTR_50                  LoginMac;                           ///< 登录用户MAC
};
...
struct TapAPITradeLoginRspInfo
{
    ...
    TAPISTR_40                    CurrentLoginIP;                        ///< 当前登录服务器IP
    TAPIUINT32                    CurrentLoginPort;                    ///< 当前登录服务器端口
};
...
struct TapAPISubmitUserLoginInfo
{
    ...
    TAPISTR_50                  ItemFalg;                           ///< 信息采集项采集结果标识
    TAPISTR_30                    GatherLibVersion;                    ///< 采集库版本信息
    TAPIYNFLAG                  IsTestKey;                            ///< 是否测试密钥
    TAPIOperatingSystemType     OperatingSystmeType;                ///< 操作系统类型
};
...
struct TapAPINewOrder
{
    ...
    TAPIClientIDType            ClientID;                            ///< 客户子账号，如果存在子账号，则自行上报子账号(北斗星后台用))
...
//! 客户改单请求
//! 必填项有ServerFlag，OrderNo,以及委托价和委托量。其他字段暂时没有用。
...
struct TapAPIFillInfo
{
    ...
    TAPISTR_50                  OrderSystemNo;                      ///< 委托系统号
    TAPISTR_70                  UpperMatchNo;                       ///< 上手成交号
    TAPIREAL64                  ClosePositionPrice;                 ///< 指定平仓持仓价格
};
...
struct TapAPICloseInfo
{
    ...
    TAPIMatchSourceType            OpenMatchSource;      ///< 成交来源
    TAPIMatchSourceType            CloseMatchSource;     ///< 成交来源
...
//! 客户账单查询请求结构(启明星、北斗星专用)
struct TapAPIBillQryReq
{
    TAPISTR_20                    UserNo;             ///< 用户编号
    TAPIBillTypeType            BillType;           ///< 账单类型
    TAPIDATE                    BillDate;           ///< 账单日期
    TAPIBillFileTypeType        BillFileType;       ///< 帐单文件类型
};

//! 客户账单查询应答结构(启明星、北斗星专用)
struct TapAPIBillQryRsp
{
    TapAPIBillQryReq            Reqdata;      ///< 账单查询请求数据
    TAPIINT32                    BillLen;      ///< 账单文件长度
...
struct TapAPIHisDeliveryQryRsp
{
    ...
    TAPISTR_10                    CommodityCurrencyGroupy;            ///< 品种币种组
    TAPISTR_10                    CommodityCurrency;                    ///< 品种币种
...
struct TapAPIAccountFeeRentQryRsp
{
    ...
    TAPISTR_10                        CurrencyGroupNo;         ///< 币种组号
    TAPISTR_10                        CurrencyNo;              ///< 币种编号
    TAPIREAL64                        OpenCloseFee;            ///< 开平手续费
    TAPIREAL64                        CloseTodayFee;           ///< 平今手续费
    TAPISTR_10                      ContractNo;              ///< 合约
};
...
struct TapAPIAccountMarginRentQryRsp
{
    ...
    TAPICommodityType                CommodityType;            ///< 品种类型
    TAPISTR_10                        CommodityNo;              ///< 品种编号
    TAPISTR_10                        ContractNo;               ///< 合约代码1
    TAPISTR_10                        StrikePrice;              ///< 执行价
    TAPICallOrPutFlagType            CallOrPutFlag;            ///< 看涨看跌标示1
    TAPICalculateModeType            CalculateMode;            ///< 计算方式
    TAPISTR_10                        CurrencyGroupNo;          ///< 币种组号
    TAPISTR_10                        CurrencyNo;               ///< 币种编号
    TAPIREAL64                        InitialMargin;            ///< 买初始保证金
    TAPIREAL64                        MaintenanceMargin;        ///< 买维持保证金
    TAPIREAL64                        SellInitialMargin;        ///< 卖初始保证金
    TAPIREAL64                        SellMaintenanceMargin;    ///< 卖维持保证金
    TAPIREAL64                        LockMargin;               ///< 锁仓比例
};
...
struct TapAPISecondCertificationReq
{
    ...
    TAPISecondLoginTypeType LoginType;                 ///< 二次认证登录类型
};
...
struct TapAPISecondCertificationRsp
{
   TAPIPasswordType        PasswordType;              ///< 密码类型
   TAPISTR_10              VertificateCode;           ///< 二次认证码
   TAPISTR_10              SecondDate;                ///< 下一次二次认证日期
};
...
struct TapAPIManageInfo
{
    ...
    TAPISTR_20             AccountNo;                           ///< 客户资金账号
    TAPISTR_200            SendAccount;                        ///< 发送账号(手机号或者邮箱)
...
//! 客户现货锁定量查询请求结构，使用客户资金账号进行流控(北斗星专用)
struct TapAPISpotLockQryReq
{
    TAPISTR_20                    StreamAccountNo;                ///< 客户资金帐号，流控
    TAPISTR_20                    AccountNo;                        ///< 客户资金帐号
};
...
struct TapAPISpotLockInfo
{
    ...
    TAPIUINT32                    CoveredQty;                        ///< 已备兑量
    TAPIUINT32                    CanCoveredQty;                    ///< 可备兑量
};
...
{
    TAPISTR_20                    AccountNo;                            ///< 客户资金账号
    TAPISpecialOrderTypeType    SpecialOrderType;                    ///< 特殊业务类型
    TAPIOrderSourceType            OrderSource;                        ///< 委托来源
...
struct TapAPISpecialOrderInfo
{
    ...
    TAPICombineStrategyType     CombineStrategy;                    ///< 组合策略代码
    TAPISTR_50                  CombineNo;                            ///< 组合编码
    ...
    TAPISTR_10                    StrikePrice;                        ///< 执行价格1
    TAPICallOrPutFlagType        CallOrPutFlag;                        ///< 看张看跌1
    TAPISideType                OrderSide1;                            ///< 买入卖出
    TAPIUINT32                    CombineQty1;                        ///< 组合数量1
    TAPIHedgeFlagType            HedgeFlag1;                            ///< 投机保值1

    TAPISTR_10                    ContractNo2;                        ///< 合约2
    TAPISTR_10                    StrikePrice2;                        ///< 执行价格2
    TAPICallOrPutFlagType        CallOrPutFlag2;                        ///< 看张看跌2
    TAPISideType                OrderSide2;                            ///< 买入卖出
    TAPIUINT32                    CombineQty2;                        ///< 组合数量1
    TAPIHedgeFlagType            HedgeFlag2;                            ///< 投机保值2
...
struct TapAPIContractQuoteInfo
{
    ...
    TAPIREAL64                    LastPrice;                          ///< 最新价
    TAPIREAL64                    PreSettlePrice;                     ///< 昨结算价
    TAPIREAL64                    PreClosingPrice;                    ///< 昨收盘价
    TAPIREAL64                    LimitUpPrice;                       ///< 涨停价
    TAPIREAL64                    LimitDownPrice;                     ///< 跌停价
};
...
{
    TAPISTR_20                    UserNo;                                    ///< 用户编号
    TAPICertificateType         CertificateType;                        ///< 证件类型
    TAPISTR_50                  CertificateNo;                            ///< 证件号码
    TAPISTR_40                  EMail;                                    ///< 电子邮箱账号
    TAPISTR_20                  PhoneNo;                                ///< 手机号
};
...
{
    TAPISTR_10                    ExchangeNo;                            ///< 交易所编码
    TAPIREAL64                    BeginPrice;                         ///< 起始价位
    TAPIREAL64                    EndPrice;                           ///< 结束价位
    TAPIREAL64                    TickSize;                           ///< 最小变动价
};

//! 柜台配置文件查询请求结构
struct TapAPIManagerConfigFileQryReq
{
    TAPISTR_50                  FileName;                           ///< 文件名
    TAPISTR_50                  FileDirectory;                      ///< 文件所在目录，如果文件名为空则返回全部该目录下文件
};

//! 柜台配置文件查询应答结构
struct TapAPIManagerConfigFileQryRsp
{
    TapAPIManagerConfigFileQryReq Reqdata;                          ///< 柜台配置文件查询请求数据
    TAPIINT32                      ManagerConfigFileLen;             ///< 柜台配置账单文件长度
    TAPICHAR                      ManagerConfigFileText[1];         ///< 变长柜台配置内容，长度由BillLen指定
};
