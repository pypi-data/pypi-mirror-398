...
class ApiGenerator:
    ...
    def load_constant(self) -> None:
        """"""
        if self.name == "md":
            module_names = ["esunny_md_commen_typedef", "esunny_md_data_typedef"]
#            module_names = ["tap_md_commen_typedef", "tap_md_data_typedef"]
        elif self.name == "td":
            module_names = ["esunny_td_commen_typedef", "esunny_td_data_typedef"]
#            module_names = ["tap_td_commen_typedef", "tap_td_data_typedef"]
    ...
    def load_struct(self) -> None:
        """加载Struct"""
        module_names = ["esunny_md_data_struct", "esunny_md_commen_struct", "esunny_td_data_struct", "esunny_td_commen_struct"]
...
if __name__ == "__main__":
    ...
    td_generator = ApiGenerator("../include/esunny/EsTradeAPI.h", "esunny", "td", "TdApi")
    td_generator.run()
