...
Use this tool online at **[DevTools.at](https://devtools.at/tools/sql-escape)** - Free, fast, and no registration required!

## Installation

```bash
pip install devtools_sql_escape
```

## Usage

```python
from devtools_sql_escape import process, encode, decode
...
**[https://devtools.at/tools/sql-escape](https://devtools.at/tools/sql-escape)**
