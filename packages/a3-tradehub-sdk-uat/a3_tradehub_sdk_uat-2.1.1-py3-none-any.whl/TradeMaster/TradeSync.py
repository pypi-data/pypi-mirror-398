...
class TradeHub:
    ...
    def invalid_sess(self, session_ID):
        ...
        # }
        # response = self._init_post(_endpoints_key="getInvalidSession", data=payload)
        # print(response)
    ...
    def on_open(self, ws):
        ...
        print(initCon, "subscription_callback")
    ...
    def start_websocket(self, socket_open_callback=None, socket_close_callback=None, socket_error_callback=None,
        ...
        print(self.__subscribe_callback)
    ...
    def get_HistoricalData(self, instrument, resolution, from_datetime, to_datetime):
        ...
        if getHistoricalResp['stat'] == 'Not_Ok':
            print(getHistoricalResp)
