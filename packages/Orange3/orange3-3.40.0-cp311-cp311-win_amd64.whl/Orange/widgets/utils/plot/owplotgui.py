    ...
    def paint(self, painter, option, index):
        ...
        if option.state & QStyle.State_MouseOver:
            if not full_selection or (full_selection and is_selected):
                txt = [_tr.m[3378, " Add "], _tr.m[3379, " Remove "]][is_selected]
...
class OWPlotGUI:
    ...
    def __init__(self, master):
        ...
        self.color_model = DomainModel(
            placeholder=_tr.m[3380, "(Same color)"], valid_types=DomainModel.PRIMITIVE)
        self.shape_model = DomainModel(
            placeholder=_tr.m[3381, "(Same shape)"], valid_types=DiscreteVariable)
        self.size_model = DomainModel(
            placeholder=_tr.m[3382, "(Same size)"], valid_types=ContinuousVariable)
        self.label_model = DomainModel(placeholder=_tr.m[3383, "(No labels)"])
    ...
    _buttons = {
        Zoom: (_tr.m[3384, 'Zoom'], 'state', ZOOMING, None, 'Dlg_zoom'),
        ZoomReset: (_tr.m[3385, 'Reset zoom'], None, None, None, 'Dlg_zoom_reset'),
        Pan: (_tr.m[3386, 'Pan'], 'state', PANNING, None, 'Dlg_pan_hand'),
        SimpleSelect: (_tr.m[3387, 'Select'], 'state', SELECT, None, 'Dlg_arrow'),
        Select: (_tr.m[3388, 'Select'], 'state', SELECT, None, 'Dlg_arrow'),
        SelectionAdd: (_tr.m[3389, 'Add to selection'], 'selection_behavior', SELECTION_ADD, None,
                       'Dlg_select_add'),
        SelectionRemove: (_tr.m[3390, 'Remove from selection'], 'selection_behavior', SELECTION_REMOVE, None,
                          'Dlg_select_remove'),
        SelectionToggle: (_tr.m[3391, 'Toggle selection'], 'selection_behavior', SELECTION_TOGGLE, None,
                          'Dlg_select_toggle'),
        SelectionOne: (_tr.m[3392, 'Replace selection'], 'selection_behavior', SELECTION_REPLACE, None,
                       'Dlg_arrow'),
        SendSelection: (_tr.m[3393, 'Send selection'], None, None, 'send_selection', 'Dlg_send'),
        ClearSelection: (_tr.m[3394, 'Clear selection'], None, None, 'clear_selection', 'Dlg_clear'),
        ShufflePoints: (_tr.m[3395, 'ShufflePoints'], None, None, 'shuffle_points', 'Dlg_sort')
    }

    _check_boxes = {
        AnimatePlot : (_tr.m[3396, 'Animate plot'], 'animate_plot', 'update_animations'),
        AnimatePoints : (_tr.m[3397, 'Animate points'], 'animate_points', 'update_animations'),
        AntialiasPlot : (_tr.m[3398, 'Antialias plot'], 'antialias_plot', 'update_antialiasing'),
        AntialiasPoints : (_tr.m[3399, 'Antialias points'], 'antialias_points', 'update_antialiasing'),
        AntialiasLines : (_tr.m[3400, 'Antialias lines'], 'antialias_lines', 'update_antialiasing'),
        AutoAdjustPerformance : (_tr.m[3401, 'Disable effects for large datasets'], 'auto_adjust_performance',
                                 'update_performance')
    }
    ...
    def antialiasing_check_box(self, widget):
        ...
        '''
        self._check_box(widget, 'use_antialiasing', _tr.m[3402, 'Use antialiasing'], 'update_antialiasing')

    def jitter_size_slider(self, widget, label=_tr.m[3403, "Jittering: "]):
    ...
    def jitter_numeric_check_box(self, widget):
        self._check_box(
            widget=widget,
            value="jitter_continuous", label=_tr.m[3404, "Jitter numeric values"],
    ...
    def show_legend_check_box(self, widget):
        ...
        '''
        self._check_box(widget, 'show_legend', _tr.m[3405, 'Show legend'],
    ...
    def regression_line_check_box(self, widget):
        self._master.cb_reg_line = \
            self._check_box(widget=widget, value="show_reg_line",
                            label=_tr.m[3408, "Show regression line"],
    ...
    def label_only_selected_check_box(self, widget):
        self._check_box(widget=widget, value="label_only_selected",
                        label=_tr.m[3409, "Label only selection and subset"],
                        cb_name=self._plot.update_labels)

    def filled_symbols_check_box(self, widget):
        self._check_box(widget, 'show_filled_symbols', _tr.m[3410, 'Show filled symbols'],
                        'update_filled_symbols')

    def grid_lines_check_box(self, widget):
        self._check_box(widget, 'show_grid', _tr.m[3411, 'Show gridlines'],
    ...
    def animations_check_box(self, widget):
        ...
        '''
        self._check_box(widget, 'use_animations', _tr.m[3412, 'Use animations'], 'update_animations')
    ...
    def point_size_slider(self, widget, label=_tr.m[3413, "Symbol size: "]):
        '''
            Creates a slider that controls point size
        '''
        return self._slider(widget, 'point_width', label, 1, 20, 1, 'sizes_changed')

    def alpha_value_slider(self, widget, label=_tr.m[3414, "Opacity: "]):
        '''
    ...
    def point_properties_box(self, widget, box=_tr.m[3419, 'Attributes']):
        '''
    ...
    def zoom_select_toolbar(self, widget, text=_tr.m[3420, 'Zoom / Select'], orientation=Qt.Horizontal,
    ...
    def theme_combo_box(self, widget):
        c = gui.comboBox(widget, self._plot, "theme_name", _tr.m[3421, "Theme"],
                         callback=self._plot.update_theme, sendSelectedValue=1)
        c.addItem(_tr.m[3422, 'Default'])
        c.addItem(_tr.m[3423, 'Light'])
        c.addItem(_tr.m[3424, 'Dark'])
        return c

    def box_zoom_select(self, parent):
        box_zoom_select = gui.vBox(parent, _tr.m[3425, "Zoom/Select"])
