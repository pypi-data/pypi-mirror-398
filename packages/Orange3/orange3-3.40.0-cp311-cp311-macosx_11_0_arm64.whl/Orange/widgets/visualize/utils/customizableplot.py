...
class Updater:
    ...
    FONT_FAMILY_LABEL, SIZE_LABEL, IS_ITALIC_LABEL = \
        _tr.m[4070, "Font family"], _tr.m[4071, "Font size"], _tr.m[4072, "Italic"]

    WIDTH_LABEL, ALPHA_LABEL, STYLE_LABEL, ANTIALIAS_LABEL = \
        _tr.m[4073, "Width"], _tr.m[4074, "Opacity"], _tr.m[4075, "Style"], _tr.m[4076, "Antialias"]
    LINE_STYLES = {_tr.m[4077, "Solid line"]: Qt.SolidLine,
                   _tr.m[4078, "Dash line"]: Qt.DashLine,
                   _tr.m[4079, "Dot line"]: Qt.DotLine,
                   _tr.m[4080, "Dash dot line"]: Qt.DashDotLine,
                   _tr.m[4081, "Dash dot dot line"]: Qt.DashDotDotLine}
    DEFAULT_LINE_STYLE = _tr.m[4082, "Solid line"]
...
class CommonParameterSetter:
    ...
    LABELS_BOX = _tr.m[4083, "Fonts"]
    ANNOT_BOX = _tr.m[4084, "Annotations"]
    PLOT_BOX = _tr.m[4085, "Figure"]

    FONT_FAMILY_LABEL = _tr.m[4086, "Font family"]
    AXIS_TITLE_LABEL = _tr.m[4087, "Axis title"]
    AXIS_TICKS_LABEL = _tr.m[4088, "Axis ticks"]
    LEGEND_LABEL = _tr.m[4089, "Legend"]
    LABEL_LABEL = _tr.m[4090, "Label"]
    LINE_LAB_LABEL = _tr.m[4091, "Line label"]
    X_AXIS_LABEL = "x-axis title"
    Y_AXIS_LABEL = "y-axis title"
    TITLE_LABEL = _tr.m[4092, "Title"]
    LINE_LABEL = _tr.m[4093, "Lines"]
