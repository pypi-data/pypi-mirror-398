...
class ErrorBarsDialog(QWidget):
    ...
    def __init__(
        ...
        button_diff = QRadioButton(_tr.m[4095, "Difference from plotted value"],
                                   checked=True)
        button_abs = QRadioButton(_tr.m[4096, "Absolute position on the plot"])
        ...
        form = QFormLayout()
        form.addRow(QLabel(_tr.m[4097, "Upper:"]), upper_combo)
        form.addRow(QLabel(_tr.m[4098, "Lower:"]), lower_combo)
