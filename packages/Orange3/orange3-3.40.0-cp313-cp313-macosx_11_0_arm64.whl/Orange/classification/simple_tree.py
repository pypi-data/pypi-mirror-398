...
class SimpleTreeModel(Model):
    def __init__(self, learner, data):
        ...
        if len(data.domain.class_vars) != 1:
            ...
            raise ValueError(_tr.m[65, "Number of classes should be 1: {}"].format(n_cls))
        ...
        for attr in data.domain.attributes:
            if attr.is_discrete:
                ...
                raise ValueError((_tr.m[68, "Only Continuous and Discrete "] + _tr.m[69, "variables are supported"]))
