...
from config import HIVEMIND_FILENAME, FLOWCHART_FILENAME, get_complexity_label
from utils import (
    sanitize_filename,
    create_anchor,
    format_list,
...
async def write_files(
    ...
    """
    Write hivemind.md and flowchart.mmd to directory.
    
    Args:
        dir_path: Directory to write files to
        hivemind_content: Content for hivemind.md
        flowchart_content: Content for flowchart.mmd
