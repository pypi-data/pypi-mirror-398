...
Original C++ source file: core/kernels/dense_table_ops_dummy.cc, core/ops/dense_table_ops.cc
"""
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx, "DenseTableInit", name, vars, "table_handle", table_handle)
      return _result
      ...
      pass
    try:
      _result = _dispatcher_for_dense_table_init(
      ...
      _result = _dispatch.dispatch(
            dense_table_init, (), dict(vars=vars, table_handle=table_handle,
                                       name=name)
          )
...
_dispatcher_for_dense_table_init = dense_table_init._tf_type_based_dispatcher.Dispatch
...
def dense_table_push_pull(vars, grads, learning_rate, table_handle, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx, "DenseTablePushPull", name, vars, grads, learning_rate,
      ...
      pass
    try:
      _result = _dispatcher_for_dense_table_push_pull(
          (vars, grads, learning_rate, table_handle, name,), None)
      if _result is not NotImplemented:
        return _result
      ...
      _result = _dispatch.dispatch(
            dense_table_push_pull, (), dict(vars=vars, grads=grads,
...
_dispatcher_for_dense_table_push_pull = dense_table_push_pull._tf_type_based_dispatcher.Dispatch
