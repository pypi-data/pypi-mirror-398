...
Original C++ source file: core/kernels/data/balance_dataset_ops_dummy.cc, core/ops/balance_dataset_ops.cc
"""
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx, "BalanceDataset", name, input_dataset, "output_types",
      ...
      pass
    try:
      _result = _dispatcher_for_balance_dataset(
      ...
      _result = _dispatch.dispatch(
            balance_dataset, (), dict(input_dataset=input_dataset,
...
_dispatcher_for_balance_dataset = balance_dataset._tf_type_based_dispatcher.Dispatch
