"""InfraprotectInformation resource API."""
...
class InfraprotectInformationResource:
    """API methods for infraprotect_information.

    Infraprotect information about the current organisation
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.infraprotect_information.CreateSpecType(...)
    ...
    def get(
        ...
        *,
        ...
        """Get a infraprotect_information by name.
        ...
        try:
            ...
            raise F5XCValidationError("infraprotect_information", "get", e, response) from e
