...
class DataTypeResource:
    """API methods for data_type.

    A data_type is defined by a set of rules. these rules include the...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.data_type.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("data_type", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing data_type.

        Replace data_type replaces an existing object in the storage backend...
        ...
        try:
            ...
            raise F5XCValidationError("data_type", "replace", e, response) from e
    ...
    def list(
        ...
        """List data_type resources in a namespace.

        List the set of data_type in a namespace
        ...
        try:
            return [DataTypeListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("data_type", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a data_type by name.

        Get data_type reads a given object from storage backend for...
        ...
        try:
            ...
            raise F5XCValidationError("data_type", "get", e, response) from e
    ...
    def delete(
        ...
        Delete the specified data_type
