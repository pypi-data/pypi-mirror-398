...
from f5xc_py_substrate.resources.cloud_link.models import (
    CloudLinkListItem,
    ...
    AWSBYOCType,
    AWSBYOCListType,
    DirectConnectGatewayStatusType,
    BGPPeerType,
    VirtualInterfaceStatusType,
    DirectConnectConnectionStatusType,
    AWSStatusType,
    ObjectRefType,
    AWSType,
    AzureStatusType,
    ...
    DeleteRequest,
    GCPPartnerMetadata,
    GCPCloudInterconnectAttachmentStatusType,
    GCPStatusType,
    ObjectRefType,
    ...
    ListResponseItem,
    ListResponse,
    ReapplyConfigRequest,
    ReapplyConfigResponse,
    ReplaceResponse,
)
...
class CloudLinkResource:
    """API methods for cloud_link.

    CloudLink is used to establish private connectivity from customer...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.cloud_link.CreateSpecType(...)
    ...
    def reapply_config(
        ...
        try:
            return ReapplyConfigResponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("cloud_link", "reapply_config", e, response) from e
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("cloud_link", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing cloud_link.
        ...
        try:
            ...
            raise F5XCValidationError("cloud_link", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[CloudLinkListItem]:
        """List cloud_link resources in a namespace.
        ...
        try:
            return [CloudLinkListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("cloud_link", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("cloud_link", "get", e, response) from e
    ...
    def delete(
        ...
        Delete the specified cloud_link
