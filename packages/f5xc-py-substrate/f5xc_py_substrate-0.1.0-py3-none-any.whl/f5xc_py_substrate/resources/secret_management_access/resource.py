"""SecretManagementAccess resource API."""
...
from f5xc_py_substrate.resources.secret_management_access.models import (
    SecretManagementAccessListItem,
    Empty,
    ProtobufAny,
...
class SecretManagementAccessResource:
    """API methods for secret_management_access.

    secret_management_access object is used to define configuration on...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.secret_management_access.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new secret_management_access.

        Create secret_management_access creates a new object in storage...
        ...
        try:
            ...
            raise F5XCValidationError("secret_management_access", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing secret_management_access.

        Replace secret_management_access replaces an existing object in...
        ...
        try:
            ...
            raise F5XCValidationError("secret_management_access", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[SecretManagementAccessListItem]:
        """List secret_management_access resources in a namespace.
        ...
        try:
            return [SecretManagementAccessListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("secret_management_access", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a secret_management_access by name.

        Get secret_management_access reads a given object from storage...
        ...
        try:
            ...
            raise F5XCValidationError("secret_management_access", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a secret_management_access.
