"""Pydantic models for infraprotect_deny_list_rule."""
...
class InfraprotectDenyListRuleListItem(F5XCBaseModel):
    """List item for infraprotect_deny_list_rule resources."""
...
class CreateSpecType(F5XCBaseModel):
    ...
    one_day: Optional[Any] = None
    one_hour: Optional[Any] = None
    one_month: Optional[Any] = None
    one_year: Optional[Any] = None
...
class ListResponseItem(F5XCBaseModel):
    """By default a summary of infraprotect_deny_list_rule is returned in..."""
