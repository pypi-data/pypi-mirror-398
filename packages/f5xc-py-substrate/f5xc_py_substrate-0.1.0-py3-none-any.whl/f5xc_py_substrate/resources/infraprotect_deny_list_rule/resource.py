"""InfraprotectDenyListRule resource API."""
...
from f5xc_py_substrate.resources.infraprotect_deny_list_rule.models import (
    InfraprotectDenyListRuleListItem,
...
class InfraprotectDenyListRuleResource:
    """API methods for infraprotect_deny_list_rule.

    DDoS transit Deny List Rule information
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.infraprotect_deny_list_rule.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new infraprotect_deny_list_rule.
        ...
        try:
            ...
            raise F5XCValidationError("infraprotect_deny_list_rule", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing infraprotect_deny_list_rule.
        ...
        try:
            ...
            raise F5XCValidationError("infraprotect_deny_list_rule", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[InfraprotectDenyListRuleListItem]:
        """List infraprotect_deny_list_rule resources in a namespace.
        ...
        try:
            return [InfraprotectDenyListRuleListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("infraprotect_deny_list_rule", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a infraprotect_deny_list_rule by name.
        ...
        try:
            ...
            raise F5XCValidationError("infraprotect_deny_list_rule", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a infraprotect_deny_list_rule.
