...
from f5xc_py_substrate.resources.irule.models import (
    IruleListItem,
    ObjectRefType,
...
class IruleResource:
    """API methods for irule.

    iRule object defines the iRule that can be used in CRUD, to create...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.irule.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        Create iRule in a given namespace. If one already exists it will...
        ...
        try:
            ...
            raise F5XCValidationError("irule", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing irule.

        Replace iRule in a given namespace.
        ...
        try:
            ...
            raise F5XCValidationError("irule", "replace", e, response) from e
    ...
    def list(
        ...
        """List irule resources in a namespace.

        List the set of irule in a namespace
        ...
        try:
            return [IruleListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("irule", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("irule", "get", e, response) from e
