"""Pydantic models for tpm_api_key."""
...
class TpmApiKeyListItem(F5XCBaseModel):
    """List item for tpm_api_key resources."""
...
class CreateSpecType(F5XCBaseModel):
    ...
    category_ref: Optional[list[ObjectRefType]] = None
    need_mtls: Optional[bool] = None
...
class ReplaceSpecType(F5XCBaseModel):
    """Replace a APIKey object's revocation or enable/disable status. A revoked..."""
...
class ListResponseItem(F5XCBaseModel):
    """By default a summary of tpm_api_key is returned in 'List'. By setting..."""
