...
class UsbPolicyResource:
    """API methods for usb_policy.

    USB policy is used to specify list of USB devices allowed to be...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.usb_policy.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("usb_policy", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing usb_policy.
        ...
        try:
            ...
            raise F5XCValidationError("usb_policy", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[UsbPolicyListItem]:
        """List usb_policy resources in a namespace.
        ...
        try:
            return [UsbPolicyListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("usb_policy", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("usb_policy", "get", e, response) from e
