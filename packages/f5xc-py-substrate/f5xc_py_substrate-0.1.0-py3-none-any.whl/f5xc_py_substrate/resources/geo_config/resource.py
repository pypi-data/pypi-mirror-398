...
class GeoConfigResource:
    """API methods for geo_config.

    Geo Config.
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.geo_config.CreateSpecType(...)
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("geo_config", "get", e, response) from e
