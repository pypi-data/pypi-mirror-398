"""K8sPodSecurityAdmission resource API."""
...
from f5xc_py_substrate.resources.k8s_pod_security_admission.models import (
    K8sPodSecurityAdmissionListItem,
    Empty,
    ObjectRefType,
...
class K8sPodSecurityAdmissionResource:
    """API methods for k8s_pod_security_admission.

    Pod security admission allows users to enforce Pod Security Standards
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.k8s_pod_security_admission.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new k8s_pod_security_admission.

        Create k8s_pod_security_admission will create the object in the...
        ...
        try:
            return K8sPodSecurityAdmissioncreateresponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("k8s_pod_security_admission", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing k8s_pod_security_admission.

        Replacing an k8s_pod_security_admission object will update the...
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return K8sPodSecurityAdmissionreplaceresponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("k8s_pod_security_admission", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[K8sPodSecurityAdmissionListItem]:
        """List k8s_pod_security_admission resources in a namespace.
        ...
        try:
            return [K8sPodSecurityAdmissionListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("k8s_pod_security_admission", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a k8s_pod_security_admission by name.
        ...
        try:
            return K8sPodSecurityAdmissiongetresponse(**filtered_response)
        except ValidationError as e:
            raise F5XCValidationError("k8s_pod_security_admission", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a k8s_pod_security_admission.
