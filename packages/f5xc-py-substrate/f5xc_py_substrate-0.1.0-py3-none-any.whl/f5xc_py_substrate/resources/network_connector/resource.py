...
class NetworkConnectorResource:
    """API methods for network_connector.

    Network Connector is used to create connection between two virtual...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.network_connector.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new network_connector.
        ...
        try:
            ...
            raise F5XCValidationError("network_connector", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing network_connector.
        ...
        try:
            ...
            raise F5XCValidationError("network_connector", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[NetworkConnectorListItem]:
        """List network_connector resources in a namespace.
        ...
        try:
            return [NetworkConnectorListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("network_connector", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a network_connector by name.
        ...
        try:
            ...
            raise F5XCValidationError("network_connector", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a network_connector.

        Delete the specified network_connector
