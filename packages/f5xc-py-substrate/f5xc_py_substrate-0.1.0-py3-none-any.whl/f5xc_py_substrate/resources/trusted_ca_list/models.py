"""Pydantic models for trusted_ca_list."""
...
class TrustedCaListListItem(F5XCBaseModel):
    """List item for trusted_ca_list resources."""
...
class ListResponseItem(F5XCBaseModel):
    """By default a summary of trusted_ca_list is returned in 'List'. By..."""
