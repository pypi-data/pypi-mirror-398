"""Pydantic models for global_log_receiver."""
...
class GlobalLogReceiverListItem(F5XCBaseModel):
    """List item for global_log_receiver resources."""
...
class BatchOptionType(F5XCBaseModel):
    ...
    timeout_seconds_default: Optional[Any] = None


class CompressionType(F5XCBaseModel):
    """Compression Type"""

    compression_default: Optional[Any] = None
    compression_gzip: Optional[Any] = None
    compression_none: Optional[Any] = None


class AWSCloudwatchConfig(F5XCBaseModel):
...
class FilenameOptionsType(F5XCBaseModel):
    """Filename Options allow customization of filename and folder paths used..."""

    custom_folder: Optional[str] = None
    log_type_folder: Optional[Any] = None
    no_folder: Optional[Any] = None
...
class AzureBlobConfig(F5XCBaseModel):
    ...
    filename_options: Optional[FilenameOptionsType] = None


class AzureEventHubsConfig(F5XCBaseModel):
...
class KafkaConfig(F5XCBaseModel):
...
class NewRelicConfig(F5XCBaseModel):
    """Configuration for NewRelic endpoint"""

    api_key: Optional[SecretType] = None
    eu: Optional[Any] = None
    us: Optional[Any] = None


class NSList(F5XCBaseModel):
    """Namespace List"""

    namespaces: Optional[list[str]] = None


class QRadarConfig(F5XCBaseModel):
...
class SumoLogicConfig(F5XCBaseModel):
...
class CreateSpecType(F5XCBaseModel):
    ...
    audit_logs: Optional[Any] = None
    aws_cloud_watch_receiver: Optional[AWSCloudwatchConfig] = None
    azure_event_hubs_receiver: Optional[AzureEventHubsConfig] = None
    azure_receiver: Optional[AzureBlobConfig] = None
    datadog_receiver: Optional[DatadogConfig] = None
    dns_logs: Optional[Any] = None
    gcp_bucket_receiver: Optional[GCPBucketConfig] = None
    http_receiver: Optional[HTTPConfig] = None
    kafka_receiver: Optional[KafkaConfig] = None
    new_relic_receiver: Optional[NewRelicConfig] = None
    ns_all: Optional[Any] = None
    ns_current: Optional[Any] = None
    ns_list: Optional[NSList] = None
    qradar_receiver: Optional[QRadarConfig] = None
    request_logs: Optional[Any] = None
    s3_receiver: Optional[S3Config] = None
    security_events: Optional[Any] = None
    splunk_receiver: Optional[SplunkConfig] = None
    sumo_logic_receiver: Optional[SumoLogicConfig] = None
...
class StatusValue(F5XCBaseModel):
    """Status data contains timestamp and status."""

    status: Optional[Literal['STATUS_UNKNOWN', 'STATUS_UP', 'STATUS_DOWN', 'STATUS_DEGRADED']] = None
    timestamp: Optional[float] = None


class StatusData(F5XCBaseModel):
    """GlobalLogReceiverStatusData wraps all the response data for a global log..."""

    labels: Optional[dict[str, Any]] = None
    values: Optional[list[StatusValue]] = None


class LabelFilter(F5XCBaseModel):
    """Metrics used in the global log receiver are tagged with labels listed in..."""

    label: Optional[Literal['LABEL_NONE', 'LABEL_GLR_NAME']] = None
    op: Optional[Literal['EQ', 'NEQ']] = None
    value: Optional[str] = None


class StatusRequest(F5XCBaseModel):
    """Request to get the global log receiver."""

    end_time: Optional[str] = None
    group_by: Optional[list[Literal['LABEL_NONE', 'LABEL_GLR_NAME']]] = None
...
class StatusResponse(F5XCBaseModel):
    ...
    glr_status: Optional[list[StatusData]] = None
    step: Optional[str] = None
...
class ListResponseItem(F5XCBaseModel):
    """By default a summary of global_log_receiver is returned in 'List'. By..."""
...
class TestGlobalLogReceiverRequest(F5XCBaseModel):
...
class TestGlobalLogReceiverResponse(F5XCBaseModel):
    """Response for the Global Log Receiver test request; empty because the..."""
