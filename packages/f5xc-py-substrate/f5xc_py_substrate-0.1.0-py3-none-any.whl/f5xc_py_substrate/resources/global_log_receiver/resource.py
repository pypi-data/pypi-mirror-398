"""GlobalLogReceiver resource API."""
...
class GlobalLogReceiverResource:
    """API methods for global_log_receiver.

    Global Log Receiver is used to specify a receiver (s3 bucket, etc.)...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.global_log_receiver.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new global_log_receiver.
        ...
        try:
            ...
            raise F5XCValidationError("global_log_receiver", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing global_log_receiver.
        ...
        try:
            ...
            raise F5XCValidationError("global_log_receiver", "replace", e, response) from e

    def global_log_receiver_status(
        self,
        namespace: str,
        body: dict[str, Any] | None = None,
    ) -> StatusResponse:
        """Global Log Receiver Status for global_log_receiver.
        ...
        try:
            ...
            raise F5XCValidationError("global_log_receiver", "global_log_receiver_status", e, response) from e
    ...
    def list(
    ...
    ) -> list[GlobalLogReceiverListItem]:
        """List global_log_receiver resources in a namespace.
        ...
        try:
            return [GlobalLogReceiverListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("global_log_receiver", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a global_log_receiver by name.
        ...
        try:
            ...
            raise F5XCValidationError("global_log_receiver", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a global_log_receiver.

        Delete the specified global_log_receiver
    ...
    def test_global_log_receiver(
        self,
        namespace: str,
        name: str,
        body: dict[str, Any] | None = None,
    ) -> TestGlobalLogReceiverResponse:
        """Test Global Log Receiver for global_log_receiver.
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return TestGlobalLogReceiverResponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("global_log_receiver", "test_global_log_receiver", e, response) from e
