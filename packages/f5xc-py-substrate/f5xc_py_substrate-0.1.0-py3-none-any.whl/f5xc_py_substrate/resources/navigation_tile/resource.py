...
class NavigationTileResource:
    """API methods for navigation_tile.

    
Starting point of access to addon service from VoltConsole home...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.navigation_tile.CreateSpecType(...)
    ...
    def list(
    ...
    ) -> list[NavigationTileListItem]:
        """List navigation_tile resources in a namespace.
        ...
        try:
            return [NavigationTileListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("navigation_tile", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a navigation_tile by name.

        Get navigation_tile reads a given object from storage backend for...
        ...
        try:
            ...
            raise F5XCValidationError("navigation_tile", "get", e, response) from e
