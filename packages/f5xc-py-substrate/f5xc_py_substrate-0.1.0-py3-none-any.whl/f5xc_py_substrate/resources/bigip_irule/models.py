"""Pydantic models for bigip_irule."""
...
class BigipIruleListItem(F5XCBaseModel):
    """List item for bigip_irule resources."""
...
class ListResponseItem(F5XCBaseModel):
    """By default a summary of bigip_irule is returned in 'List'. By setting..."""
