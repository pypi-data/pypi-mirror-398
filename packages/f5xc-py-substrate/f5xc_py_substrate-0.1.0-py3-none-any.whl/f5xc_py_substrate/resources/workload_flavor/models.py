"""Pydantic models for workload_flavor."""
...
class WorkloadFlavorListItem(F5XCBaseModel):
    """List item for workload_flavor resources."""
...
class ListResponseItem(F5XCBaseModel):
    """By default a summary of workload_flavor is returned in 'List'. By..."""
