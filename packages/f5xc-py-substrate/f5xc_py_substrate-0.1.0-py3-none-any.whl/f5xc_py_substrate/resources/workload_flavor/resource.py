...
class WorkloadFlavorResource:
    """API methods for workload_flavor.

    Workload flavor is used to assign CPU, memory, and storage resources...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.workload_flavor.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("workload_flavor", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing workload_flavor.
        ...
        try:
            ...
            raise F5XCValidationError("workload_flavor", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[WorkloadFlavorListItem]:
        """List workload_flavor resources in a namespace.
        ...
        try:
            return [WorkloadFlavorListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("workload_flavor", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("workload_flavor", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a workload_flavor.

        Delete the specified workload_flavor
