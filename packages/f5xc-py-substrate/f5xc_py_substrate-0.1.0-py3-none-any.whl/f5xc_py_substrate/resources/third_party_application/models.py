"""Pydantic models for third_party_application."""
...
class ThirdPartyApplicationListItem(F5XCBaseModel):
    """List item for third_party_application resources."""
...
class GenerateTokenResponse(F5XCBaseModel):
    """Response to the Generate Token Request token - a base64 encoding of..."""
...
class ThirdPartyApplicationList(F5XCBaseModel):
    third_party_applications: Optional[list[str]] = None


class GetSecurityConfigReq(F5XCBaseModel):
    """Request of GET Security Config Spec API"""

    all_third_party_applications: Optional[Any] = None
    namespace: Optional[str] = None
    third_party_applications_list: Optional[ThirdPartyApplicationList] = None


class ListResponseItem(F5XCBaseModel):
    """By default a summary of third_party_application is returned in 'List'...."""
