"""Pydantic models for virtual_site."""
...
class VirtualSiteListItem(F5XCBaseModel):
    """List item for virtual_site resources."""
...
class CreateSpecType(F5XCBaseModel):
    ...
    site_selector: Optional[LabelSelectorType] = None
...
class ListResponseItem(F5XCBaseModel):
    """By default a summary of virtual_site is returned in 'List'. By setting..."""
...
class SelecteeItemType(F5XCBaseModel):
...
class SelecteeResponse(F5XCBaseModel):
    """Response indicating the objects selected by a Virtual Site based on its..."""

    error: Optional[ErrorType] = None
    items: Optional[list[SelecteeItemType]] = None
