...
class UserGroupResource:
    """API methods for user_group.

    Represents group for a given tenant
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.user_group.CreateSpecType(...)
    ...
    def list(
        ...
        """List user_group resources in a namespace.

        List the set of user_group in a namespace
        ...
        try:
            return [UserGroupListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("user_group", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("user_group", "get", e, response) from e

    def custom_list(
        self,
    ) -> ListUserGroupsResponse:
        """Custom List for user_group.
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return ListUserGroupsResponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("user_group", "custom_list", e, response) from e
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("user_group", "create", e, response) from e

    def analyze_for_deletion(
        self,
        body: dict[str, Any] | None = None,
    ) -> AnalyzeForDeletionResponse:
        """Analyze For Deletion for user_group.

        AnalyzeForDeletion checks the references of the object to make sure...
        """
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return AnalyzeForDeletionResponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("user_group", "analyze_for_deletion", e, response) from e

    def custom_get(
        self,
        name: str,
    ) -> Response:
        """Custom Get for user_group.

        Get fetches all the details for a group, provided the group id and...
        """
        ...
        try:
            ...
            raise F5XCValidationError("user_group", "custom_get", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing user_group.

        Replace allows updating of the different user group fields like the...
        ...
        try:
            ...
            raise F5XCValidationError("user_group", "replace", e, response) from e
    ...
    def delete(
        ...
        Delete deletes the group, provided the group id and the users list...
    ...
    def assign_role(
        ...
        try:
            ...
            raise F5XCValidationError("user_group", "assign_role", e, response) from e
    ...
    def remove_role(
        ...
        try:
            ...
            raise F5XCValidationError("user_group", "remove_role", e, response) from e
