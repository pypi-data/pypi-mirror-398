...
class EndpointResource:
    """API methods for endpoint.

    Endpoint object represent the actual endpoint that provides the...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.endpoint.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("endpoint", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("endpoint", "replace", e, response) from e
    ...
    def list(
        ...
        """List endpoint resources in a namespace.

        List the set of endpoint in a namespace
        ...
        try:
            return [EndpointListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("endpoint", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        Get endpoint will get the object from the storage backend for...
        ...
        try:
            ...
            raise F5XCValidationError("endpoint", "get", e, response) from e
