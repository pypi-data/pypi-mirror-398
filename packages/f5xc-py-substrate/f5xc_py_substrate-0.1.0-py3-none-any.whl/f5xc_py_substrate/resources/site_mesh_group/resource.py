...
class SiteMeshGroupResource:
    """API methods for site_mesh_group.

    Site mesh group is a configuration tool to provide Site to...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.site_mesh_group.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("site_mesh_group", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing site_mesh_group.
        ...
        try:
            ...
            raise F5XCValidationError("site_mesh_group", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[SiteMeshGroupListItem]:
        """List site_mesh_group resources in a namespace.
        ...
        try:
            return [SiteMeshGroupListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("site_mesh_group", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("site_mesh_group", "get", e, response) from e
