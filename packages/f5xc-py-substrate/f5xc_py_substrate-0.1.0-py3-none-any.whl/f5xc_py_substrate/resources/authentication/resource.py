...
class AuthenticationResource:
    ...
    Authentication Object contains authentication specific config . This...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.authentication.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("authentication", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("authentication", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[AuthenticationListItem]:
        """List authentication resources in a namespace.
        ...
        try:
            return [AuthenticationListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("authentication", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("authentication", "get", e, response) from e
    ...
    def delete(
        ...
        Delete the specified authentication
