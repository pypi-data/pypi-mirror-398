"""Pydantic models for infraprotect_firewall_rule_group."""
...
class InfraprotectFirewallRuleGroupListItem(F5XCBaseModel):
    """List item for infraprotect_firewall_rule_group resources."""
...
class CreateSpecType(F5XCBaseModel):
    ...
    firewall_rule_group_name: Optional[str] = None
...
class GetSpecType(F5XCBaseModel):
    ...
    firewall_rule_group_name: Optional[str] = None
    firewall_ruleset: Optional[list[ObjectRefType]] = None
...
class ListResponseItem(F5XCBaseModel):
    """By default a summary of infraprotect_firewall_rule_group is returned in..."""
