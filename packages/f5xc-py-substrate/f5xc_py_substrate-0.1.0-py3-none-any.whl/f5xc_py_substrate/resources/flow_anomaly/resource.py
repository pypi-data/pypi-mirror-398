...
class FlowAnomalyResource:
    """API methods for flow_anomaly.

    Flow Anomaly.
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.flow_anomaly.CreateSpecType(...)
    ...
    def list(
    ...
    ) -> list[FlowAnomalyListItem]:
        """List flow_anomaly resources in a namespace.
        ...
        try:
            return [FlowAnomalyListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("flow_anomaly", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("flow_anomaly", "get", e, response) from e
