"""K8sClusterRoleBinding resource API."""
...
from f5xc_py_substrate.resources.k8s_cluster_role_binding.models import (
    K8sClusterRoleBindingListItem,
    ObjectRefType,
    ObjectCreateMetaType,
    ObjectRefType,
    K8sClusterRoleBindingserviceaccounttype,
    K8sClusterRoleBindingsubjecttype,
    K8sClusterRoleBindingcreatespectype,
    K8sClusterRoleBindingcreaterequest,
    ObjectGetMetaType,
    K8sClusterRoleBindinggetspectype,
    InitializerType,
    StatusType,
    InitializersType,
    ViewRefType,
    SystemObjectGetMetaType,
    K8sClusterRoleBindingcreateresponse,
    K8sClusterRoleBindingdeleterequest,
    ObjectReplaceMetaType,
    K8sClusterRoleBindingreplacespectype,
    K8sClusterRoleBindingreplacerequest,
    ConditionType,
    StatusMetaType,
    K8sClusterRoleBindingstatusobject,
    K8sClusterRoleBindinggetresponse,
    ProtobufAny,
    ErrorType,
    K8sClusterRoleBindinglistresponseitem,
    K8sClusterRoleBindinglistresponse,
    K8sClusterRoleBindingreplaceresponse,
)
...
class K8sClusterRoleBindingResource:
    """API methods for k8s_cluster_role_binding.

    Cluster role binding allows administrator to assign cluster wide...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.k8s_cluster_role_binding.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new k8s_cluster_role_binding.

        Create k8s_cluster_role_binding will create the object in the...
        ...
        try:
            return K8sClusterRoleBindingcreateresponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("k8s_cluster_role_binding", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing k8s_cluster_role_binding.

        Replacing an k8s_cluster_role_binding object will update the object...
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return K8sClusterRoleBindingreplaceresponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("k8s_cluster_role_binding", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[K8sClusterRoleBindingListItem]:
        """List k8s_cluster_role_binding resources in a namespace.
        ...
        try:
            return [K8sClusterRoleBindingListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("k8s_cluster_role_binding", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a k8s_cluster_role_binding by name.
        ...
        try:
            return K8sClusterRoleBindinggetresponse(**filtered_response)
        except ValidationError as e:
            raise F5XCValidationError("k8s_cluster_role_binding", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a k8s_cluster_role_binding.
