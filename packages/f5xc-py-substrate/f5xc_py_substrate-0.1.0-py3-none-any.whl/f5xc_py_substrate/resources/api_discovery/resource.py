...
from f5xc_py_substrate.resources.api_discovery.models import (
    ApiDiscoveryListItem,
...
class ApiDiscoveryResource:
    """API methods for api_discovery.

    The api_discovery contains settings for API discovery
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.api_discovery.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new api_discovery.

        Create api discovery creates a new object in the storage backend for...
        ...
        try:
            ...
            raise F5XCValidationError("api_discovery", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing api_discovery.

        Replace api_discovery replaces an existing object in the storage...
        ...
        try:
            ...
            raise F5XCValidationError("api_discovery", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[ApiDiscoveryListItem]:
        """List api_discovery resources in a namespace.
        ...
        try:
            return [ApiDiscoveryListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("api_discovery", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a api_discovery by name.

        Get api_discovery reads a given object from storage backend for...
        ...
        try:
            ...
            raise F5XCValidationError("api_discovery", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a api_discovery.

        Delete the specified api_discovery
