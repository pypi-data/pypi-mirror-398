...
class NetworkInterfaceResource:
    """API methods for network_interface.

    Network Interface object represents the configuration of a network...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.network_interface.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        Network interface represents configuration of a network device. It...
        ...
        try:
            ...
            raise F5XCValidationError("network_interface", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing network_interface.
        ...
        try:
            ...
            raise F5XCValidationError("network_interface", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[NetworkInterfaceListItem]:
        """List network_interface resources in a namespace.
        ...
        try:
            return [NetworkInterfaceListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("network_interface", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a network_interface by name.
        ...
        try:
            ...
            raise F5XCValidationError("network_interface", "get", e, response) from e
    ...
    def delete(
        ...
        Delete the specified network_interface
