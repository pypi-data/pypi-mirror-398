...
class NamespaceRoleResource:
    """API methods for namespace_role.

    Namespace role defines a user's role in a namespace.
Namespace role...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.namespace_role.CreateSpecType(...)
    ...
    def list(
    ...
    ) -> list[NamespaceRoleListItem]:
        """List namespace_role resources in a namespace.
        ...
        try:
            return [NamespaceRoleListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("namespace_role", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("namespace_role", "get", e, response) from e
