...
class CertificateResource:
    """API methods for certificate.

    Certificate represents a client or server certificate.
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.certificate.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("certificate", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("certificate", "replace", e, response) from e
    ...
    def list(
        ...
        """List certificate resources in a namespace.
        ...
        try:
            return [CertificateListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("certificate", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("certificate", "get", e, response) from e
