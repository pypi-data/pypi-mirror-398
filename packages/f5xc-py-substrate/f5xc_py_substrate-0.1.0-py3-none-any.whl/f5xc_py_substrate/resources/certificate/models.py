"""Pydantic models for certificate."""
...
class CertificateListItem(F5XCBaseModel):
    """List item for certificate resources."""
...
class CreateSpecType(F5XCBaseModel):
    ...
    certificate_chain: Optional[ObjectRefType] = None
...
class CertInfoType(F5XCBaseModel):
...
class GetSpecType(F5XCBaseModel):
    ...
    infos: Optional[list[CertInfoType]] = None
    private_key: Optional[SecretType] = None
    tcp_loadbalancers: Optional[list[ObjectRefType]] = None
    use_system_defaults: Optional[Any] = None
...
class ListResponseItem(F5XCBaseModel):
    """By default a summary of certificate is returned in 'List'. By setting..."""
