"""ChildTenantManager resource API."""
...
class ChildTenantManagerResource:
    """API methods for child_tenant_manager.

    
Child Tenant Manager uses Tenant Profile template to create child...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.child_tenant_manager.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new child_tenant_manager.

        Creates a child_tenant_manager config instance. Name of the object...
        ...
        try:
            ...
            raise F5XCValidationError("child_tenant_manager", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing child_tenant_manager.
        ...
        try:
            ...
            raise F5XCValidationError("child_tenant_manager", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[ChildTenantManagerListItem]:
        """List child_tenant_manager resources in a namespace.
        ...
        try:
            return [ChildTenantManagerListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("child_tenant_manager", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a child_tenant_manager by name.

        Get child_tenant_manager reads a given object from storage backend...
        ...
        try:
            ...
            raise F5XCValidationError("child_tenant_manager", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a child_tenant_manager.

        Delete the specified child_tenant_manager
    ...
    def list_child_tenants(
        ...
        """List Child Tenants for child_tenant_manager.
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return ListChildTenantsByCTMResp(**response)
        except ValidationError as e:
            raise F5XCValidationError("child_tenant_manager", "list_child_tenants", e, response) from e

    def migrate_ctm_child_tenants(
        self,
        name: str,
        body: dict[str, Any] | None = None,
    ) -> MigrateCTMChildTenantsResp:
        """Migrate Ctm Child Tenants for child_tenant_manager.
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return MigrateCTMChildTenantsResp(**response)
        except ValidationError as e:
            raise F5XCValidationError("child_tenant_manager", "migrate_ctm_child_tenants", e, response) from e
