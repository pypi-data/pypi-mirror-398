"""Pydantic models for api_definition."""
...
class ApiDefinitionListItem(F5XCBaseModel):
    """List item for api_definition resources."""
...
class APInventoryResp(F5XCBaseModel):
...
class ApiGroupSummary(F5XCBaseModel):
    """ApiGroupSummary"""
...
class CreateSpecType(F5XCBaseModel):
    ...
    api_inventory_exclusion_list: Optional[list[ApiOperation]] = None
    api_inventory_inclusion_list: Optional[list[ApiOperation]] = None
    mixed_schema_origin: Optional[Any] = None
    non_api_endpoints: Optional[list[ApiOperation]] = None
    strict_schema_origin: Optional[Any] = None
    swagger_specs: Optional[list[str]] = None
...
class GetSpecType(F5XCBaseModel):
    ...
    api_groups: Optional[list[ApiGroupSummary]] = None
    api_inventory_exclusion_list: Optional[list[ApiOperation]] = None
    api_inventory_inclusion_list: Optional[list[ApiOperation]] = None
    mixed_schema_origin: Optional[Any] = None
    non_api_endpoints: Optional[list[ApiOperation]] = None
...
class GetReferencingAllLoadbalancersResp(F5XCBaseModel):
    """Response shape for Get API Endpoints With Newly Discovered Schema"""

    loadbalancers: Optional[list[ObjectRefType]] = None


class GetReferencingLoadbalancersResp(F5XCBaseModel):
    """Response shape for Get API Endpoints With Newly Discovered Schema"""

    http_loadbalancers: Optional[list[ObjectRefType]] = None
...
class ListResponseItem(F5XCBaseModel):
    """By default a summary of api_definition is returned in 'List'. By setting..."""
