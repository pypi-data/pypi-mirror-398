"""SensitiveDataPolicy resource API."""
...
from f5xc_py_substrate.resources.sensitive_data_policy.models import (
    SensitiveDataPolicyListItem,
    ObjectRefType,
    ProtobufAny,
    ConditionType,
    ErrorType,
...
class SensitiveDataPolicyResource:
    """API methods for sensitive_data_policy.

    The sensitive_data_policy is a policy defined by the user to...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.sensitive_data_policy.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new sensitive_data_policy.

        Create sensitive_data_policy creates a new object in the storage...
        ...
        try:
            ...
            raise F5XCValidationError("sensitive_data_policy", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing sensitive_data_policy.

        Replace sensitive_data_policy replaces an existing object in the...
        ...
        try:
            ...
            raise F5XCValidationError("sensitive_data_policy", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[SensitiveDataPolicyListItem]:
        """List sensitive_data_policy resources in a namespace.
        ...
        try:
            return [SensitiveDataPolicyListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("sensitive_data_policy", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a sensitive_data_policy by name.

        Get sensitive_data_policy reads a given object from storage backend...
        ...
        try:
            ...
            raise F5XCValidationError("sensitive_data_policy", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a sensitive_data_policy.

        Delete the specified sensitive_data_policy
