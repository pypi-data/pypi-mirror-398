"""ContainerRegistry resource API."""
...
class ContainerRegistryResource:
    """API methods for container_registry.

    Container registry is the container or docker registry information
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.container_registry.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new container_registry.
        ...
        try:
            ...
            raise F5XCValidationError("container_registry", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing container_registry.
        ...
        try:
            ...
            raise F5XCValidationError("container_registry", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[ContainerRegistryListItem]:
        """List container_registry resources in a namespace.
        ...
        try:
            return [ContainerRegistryListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("container_registry", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a container_registry by name.
        ...
        try:
            ...
            raise F5XCValidationError("container_registry", "get", e, response) from e
