...
class SecuremeshSiteV2Resource:
    """API methods for securemesh_site_v2.

    Secure Mesh site defines a required parameters that can be used in...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.securemesh_site_v2.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new securemesh_site_v2.
        ...
        try:
            return SecuremeshSiteV2createresponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("securemesh_site_v2", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing securemesh_site_v2.
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return SecuremeshSiteV2replaceresponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("securemesh_site_v2", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[SecuremeshSiteV2ListItem]:
        """List securemesh_site_v2 resources in a namespace.
        ...
        try:
            return [SecuremeshSiteV2ListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("securemesh_site_v2", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a securemesh_site_v2 by name.
        ...
        try:
            return SecuremeshSiteV2getresponse(**filtered_response)
        except ValidationError as e:
            raise F5XCValidationError("securemesh_site_v2", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a securemesh_site_v2.

        Delete the specified securemesh_site_v2
