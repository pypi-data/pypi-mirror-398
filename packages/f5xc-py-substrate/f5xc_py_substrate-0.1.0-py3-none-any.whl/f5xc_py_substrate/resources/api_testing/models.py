"""Pydantic models for api_testing."""
...
class ApiTestingListItem(F5XCBaseModel):
    """List item for api_testing resources."""
...
class ListResponseItem(F5XCBaseModel):
    """By default a summary of api_testing is returned in 'List'. By setting..."""
