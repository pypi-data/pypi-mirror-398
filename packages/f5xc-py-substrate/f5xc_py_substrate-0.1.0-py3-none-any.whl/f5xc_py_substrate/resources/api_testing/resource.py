...
from f5xc_py_substrate.resources.api_testing.models import (
    ApiTestingListItem,
...
class ApiTestingResource:
    """API methods for api_testing.

    This is the api testing type
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.api_testing.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("api_testing", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing api_testing.
        ...
        try:
            ...
            raise F5XCValidationError("api_testing", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[ApiTestingListItem]:
        """List api_testing resources in a namespace.
        ...
        try:
            return [ApiTestingListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("api_testing", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("api_testing", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a api_testing.

        Delete the specified api_testing
