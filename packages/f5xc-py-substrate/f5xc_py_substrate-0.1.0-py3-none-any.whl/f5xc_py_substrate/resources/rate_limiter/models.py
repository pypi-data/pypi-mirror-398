"""Pydantic models for rate_limiter."""
...
class RateLimiterListItem(F5XCBaseModel):
    """List item for rate_limiter resources."""
...
class CreateSpecType(F5XCBaseModel):
    ...
    limits: Optional[list[RateLimitValue]] = None
...
class ReplaceSpecType(F5XCBaseModel):
    """Replace rate_limiter replaces an existing object in the storage backend..."""
...
class ListResponseItem(F5XCBaseModel):
    """By default a summary of rate_limiter is returned in 'List'. By setting..."""
