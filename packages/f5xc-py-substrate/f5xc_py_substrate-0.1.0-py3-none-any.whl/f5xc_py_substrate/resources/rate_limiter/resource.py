...
class RateLimiterResource:
    """API methods for rate_limiter.

    A rate_limiter specifies a list of rate limit unit periods and the...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.rate_limiter.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new rate_limiter.

        Create rate_limiter creates a new object in the storage backend for...
        ...
        try:
            ...
            raise F5XCValidationError("rate_limiter", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing rate_limiter.

        Replace rate_limiter replaces an existing object in the storage...
        ...
        try:
            ...
            raise F5XCValidationError("rate_limiter", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[RateLimiterListItem]:
        """List rate_limiter resources in a namespace.

        List the set of rate_limiter in a namespace
        ...
        try:
            return [RateLimiterListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("rate_limiter", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a rate_limiter by name.

        Get rate_limiter reads a given object from storage backend for...
        ...
        try:
            ...
            raise F5XCValidationError("rate_limiter", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a rate_limiter.

        Delete the specified rate_limiter
