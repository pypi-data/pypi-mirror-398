...
class AppApiGroupResource:
    """API methods for app_api_group.

    The app_api_group construct provides a mechanism to classify the...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.app_api_group.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("app_api_group", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing app_api_group.

        Replace app_api_group replaces an existing object in the storage...
        ...
        try:
            ...
            raise F5XCValidationError("app_api_group", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[AppApiGroupListItem]:
        """List app_api_group resources in a namespace.
        ...
        try:
            return [AppApiGroupListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("app_api_group", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("app_api_group", "get", e, response) from e
    ...
    def evaluate_api_group(
        self,
        namespace: str,
        body: dict[str, Any] | None = None,
    ) -> EvaluateApiGroupRsp:
        """Evaluate Api Group for app_api_group.

        Evaluate API Group Builder against all API endpoints associated with...
        """
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return EvaluateApiGroupRsp(**response)
        except ValidationError as e:
            raise F5XCValidationError("app_api_group", "evaluate_api_group", e, response) from e

    def get_api_groups_stats(
        self,
        namespace: str,
        body: dict[str, Any] | None = None,
    ) -> GetApiGroupsStatsRsp:
        """Get Api Groups Stats for app_api_group.

        Check if there are any changes happened to the API Groups, and...
        """
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return GetApiGroupsStatsRsp(**response)
        except ValidationError as e:
            raise F5XCValidationError("app_api_group", "get_api_groups_stats", e, response) from e
