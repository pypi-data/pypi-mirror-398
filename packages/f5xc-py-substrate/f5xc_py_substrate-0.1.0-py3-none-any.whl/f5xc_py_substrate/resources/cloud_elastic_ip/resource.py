...
class CloudElasticIpResource:
    """API methods for cloud_elastic_ip.

    Cloud Elastic IP object represents a cloud elastic IP address that...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.cloud_elastic_ip.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("cloud_elastic_ip", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing cloud_elastic_ip.
        ...
        try:
            ...
            raise F5XCValidationError("cloud_elastic_ip", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[CloudElasticIpListItem]:
        """List cloud_elastic_ip resources in a namespace.
        ...
        try:
            return [CloudElasticIpListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("cloud_elastic_ip", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a cloud_elastic_ip by name.

        Get cloud elastic ip will get the object from the storage backend...
        ...
        try:
            ...
            raise F5XCValidationError("cloud_elastic_ip", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a cloud_elastic_ip.

        Delete the specified cloud_elastic_ip
    ...
    def force_delete_cloud_elastic_ip(
        self,
        name: str,
        body: dict[str, Any] | None = None,
    ) -> ForceDeleteCloudElasticIPResponse:
        """Force Delete Cloud Elastic Ip for cloud_elastic_ip.
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return ForceDeleteCloudElasticIPResponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("cloud_elastic_ip", "force_delete_cloud_elastic_ip", e, response) from e
