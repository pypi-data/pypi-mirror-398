...
class BgpAsnSetResource:
    """API methods for bgp_asn_set.

    An unordered set of RFC 6793 defined 4-byte AS numbers that can be...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.bgp_asn_set.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new bgp_asn_set.

        Create bgp_asn_set creates a new object in the storage backend for...
        ...
        try:
            ...
            raise F5XCValidationError("bgp_asn_set", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing bgp_asn_set.

        Replace bgp_asn_set replaces an existing object in the storage...
        ...
        try:
            ...
            raise F5XCValidationError("bgp_asn_set", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[BgpAsnSetListItem]:
        """List bgp_asn_set resources in a namespace.
        ...
        try:
            return [BgpAsnSetListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("bgp_asn_set", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a bgp_asn_set by name.

        Get bgp_asn_set reads a given object from storage backend for...
        ...
        try:
            ...
            raise F5XCValidationError("bgp_asn_set", "get", e, response) from e
