...
class ClusterResource:
    """API methods for cluster.

    cluster object represent common set of endpoints (providers of...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.cluster.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("cluster", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("cluster", "replace", e, response) from e
    ...
    def list(
        ...
        """List cluster resources in a namespace.

        List the set of cluster in a namespace
        ...
        try:
            return [ClusterListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("cluster", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        Get cluster will get the object from the storage backend for...
        ...
        try:
            ...
            raise F5XCValidationError("cluster", "get", e, response) from e
