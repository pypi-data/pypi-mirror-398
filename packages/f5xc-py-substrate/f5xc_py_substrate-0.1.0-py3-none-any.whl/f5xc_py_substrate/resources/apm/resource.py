...
class ApmResource:
    ...
    BIG-IP APM Service handles the life-cycle management of BIG-IP...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.apm.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("apm", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("apm", "replace", e, response) from e
    ...
    def list(
        ...
        """List apm resources in a namespace.

        List the set of apm in a namespace
        ...
        try:
            return [ApmListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("apm", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("apm", "get", e, response) from e
    ...
    def metrics(
        ...
        try:
            ...
            raise F5XCValidationError("apm", "metrics", e, response) from e
