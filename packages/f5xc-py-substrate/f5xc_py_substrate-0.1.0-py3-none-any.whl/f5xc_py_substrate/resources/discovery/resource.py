...
Dynamic service...
    ...
    # Usage: client.discovery.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("discovery", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing discovery.

        API to replace discovery object for a site or virtual site in system...
        ...
        try:
            ...
            raise F5XCValidationError("discovery", "replace", e, response) from e
    ...
    def list(
        ...
        """List discovery resources in a namespace.

        List the set of discovery in a namespace
        ...
        try:
            return [DiscoveryListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("discovery", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("discovery", "get", e, response) from e
    ...
    def delete(
        ...
        Delete the specified discovery
    ...
    def download_certificates(
        ...
        """Download Certificates for discovery.

        Download the cerificates files for the Log Collerctor In order to...
        """
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return DownloadCertificatesResponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("discovery", "download_certificates", e, response) from e
