"""RateLimiterPolicy resource API."""
...
class RateLimiterPolicyResource:
    """API methods for rate_limiter_policy.

    Rate limiter policy defines parameters that can be used for...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.rate_limiter_policy.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new rate_limiter_policy.
        ...
        try:
            ...
            raise F5XCValidationError("rate_limiter_policy", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing rate_limiter_policy.
        ...
        try:
            ...
            raise F5XCValidationError("rate_limiter_policy", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[RateLimiterPolicyListItem]:
        """List rate_limiter_policy resources in a namespace.
        ...
        try:
            return [RateLimiterPolicyListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("rate_limiter_policy", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a rate_limiter_policy by name.
        ...
        try:
            ...
            raise F5XCValidationError("rate_limiter_policy", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a rate_limiter_policy.

        Delete the specified rate_limiter_policy
