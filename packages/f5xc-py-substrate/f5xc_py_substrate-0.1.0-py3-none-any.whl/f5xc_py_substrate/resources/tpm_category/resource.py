...
class TpmCategoryResource:
    """API methods for tpm_category.

    Category is a grouping of APIKeys, each category comes with its own...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.tpm_category.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new tpm_category.

        Create a Category object, which is a grouping of APIKeys used for...
        ...
        try:
            ...
            raise F5XCValidationError("tpm_category", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing tpm_category.
        ...
        try:
            ...
            raise F5XCValidationError("tpm_category", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[TpmCategoryListItem]:
        """List tpm_category resources in a namespace.

        List the set of tpm_category in a namespace
        ...
        try:
            return [TpmCategoryListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("tpm_category", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("tpm_category", "get", e, response) from e
