...
1. Encryption...
    ...
    # Usage: client.ike1.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            return Ike1CreateResponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("ike1", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return Ike1ReplaceResponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("ike1", "replace", e, response) from e
    ...
    def list(
        ...
        """List ike1 resources in a namespace.

        List the set of ike1 in a namespace
        ...
        try:
            return [Ike1ListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("ike1", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            return Ike1GetResponse(**filtered_response)
        except ValidationError as e:
            raise F5XCValidationError("ike1", "get", e, response) from e
