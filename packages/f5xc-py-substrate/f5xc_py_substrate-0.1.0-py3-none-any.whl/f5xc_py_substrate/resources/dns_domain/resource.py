...
class DnsDomainResource:
    """API methods for dns_domain.

    DNS Domain object is used for delegating DNS sub domain to volterra....
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.dns_domain.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new dns_domain.

        Create DNS Domain in a given namespace. If one already exist it will...
        ...
        try:
            ...
            raise F5XCValidationError("dns_domain", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing dns_domain.
        ...
        try:
            ...
            raise F5XCValidationError("dns_domain", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[DnsDomainListItem]:
        """List dns_domain resources in a namespace.

        List the set of dns_domain in a namespace
        ...
        try:
            return [DnsDomainListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("dns_domain", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("dns_domain", "get", e, response) from e
    ...
    def delete(
        ...
        Delete the specified dns_domain
    ...
    def verify_dns_domain(
        self,
        namespace: str,
        name: str,
        body: dict[str, Any] | None = None,
    ) -> VerifyDnsDomainResponse:
        """Verify Dns Domain for dns_domain.
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return VerifyDnsDomainResponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("dns_domain", "verify_dns_domain", e, response) from e
