"""Pydantic models for nginx_server."""
...
class NginxServerListItem(F5XCBaseModel):
    """List item for nginx_server resources."""
...
class DataplaneReference(F5XCBaseModel):
    nginx_csg: Optional[ObjectRefType] = None
    nginx_instance: Optional[ObjectRefType] = None
...
class GetSpecType(F5XCBaseModel):
    ...
    dataplane_ref: Optional[DataplaneReference] = None
    server_spec: Optional[Server] = None
...
class GetDataplaneServerResponse(F5XCBaseModel):
    metadata: Optional[ObjectGetMetaType] = None
    spec: Optional[GetSpecType] = None
    system_metadata: Optional[SystemObjectGetMetaType] = None


class GetDataplaneServersRequest(F5XCBaseModel):
...
class GetDataplaneServersResponse(F5XCBaseModel):
    """Get NGINX One Dataplane servers response"""

    items: Optional[list[GetDataplaneServerResponse]] = None
...
class ListResponseItem(F5XCBaseModel):
    """By default a summary of nginx_server is returned in 'List'. By setting..."""
