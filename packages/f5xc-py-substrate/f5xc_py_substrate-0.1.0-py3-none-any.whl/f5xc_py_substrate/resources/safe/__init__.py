...
if TYPE_CHECKING:
    ...
    from f5xc_py_substrate.resources.safe.resource import SafeResource
...
def __getattr__(name: str):
    ...
    if _models_module is None:
        _models_module = importlib.import_module(
            "f5xc_py_substrate.resources.safe.models"
        )
    ...
    raise AttributeError(f"module 'f5xc_py_substrate.resources.safe' has no attribute '{name}'")
