...
class AlertReceiverResource:
    """API methods for alert_receiver.

    Alert Receiver is used to specify a receiver (slack, pagerDuty,...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.alert_receiver.CreateSpecType(...)
    ...
    def create(
        ...
        namespace: str,
        name: str,
        spec: BlindfoldSecretInfoType | None = None,
        *,
        ...
        try:
            ...
            raise F5XCValidationError("alert_receiver", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing alert_receiver.
        ...
        try:
            ...
            raise F5XCValidationError("alert_receiver", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[AlertReceiverListItem]:
        """List alert_receiver resources in a namespace.
        ...
        try:
            return [AlertReceiverListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("alert_receiver", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("alert_receiver", "get", e, response) from e
    ...
    def confirm_alert_receiver(
        self,
        namespace: str,
        name: str,
        body: dict[str, Any] | None = None,
    ) -> ConfirmAlertReceiverResponse:
        """Confirm Alert Receiver for alert_receiver.
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return ConfirmAlertReceiverResponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("alert_receiver", "confirm_alert_receiver", e, response) from e
    ...
    def test_alert_receiver(
        ...
        """Test Alert Receiver for alert_receiver.
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return TestAlertReceiverResponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("alert_receiver", "test_alert_receiver", e, response) from e

    def verify_alert_receiver(
        self,
        namespace: str,
        name: str,
        body: dict[str, Any] | None = None,
    ) -> VerifyAlertReceiverResponse:
        """Verify Alert Receiver for alert_receiver.

        API to send request to verify Alert Receiver - applicable only for...
        """
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return VerifyAlertReceiverResponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("alert_receiver", "verify_alert_receiver", e, response) from e
