...
class ForwardingClassResource:
    """API methods for forwarding_class.

    In Policy Based Routing(forwarding) (PBR) PBR policy can select...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.forwarding_class.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("forwarding_class", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing forwarding_class.
        ...
        try:
            ...
            raise F5XCValidationError("forwarding_class", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[ForwardingClassListItem]:
        """List forwarding_class resources in a namespace.
        ...
        try:
            return [ForwardingClassListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("forwarding_class", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a forwarding_class by name.
        ...
        try:
            ...
            raise F5XCValidationError("forwarding_class", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a forwarding_class.

        Delete the specified forwarding_class
