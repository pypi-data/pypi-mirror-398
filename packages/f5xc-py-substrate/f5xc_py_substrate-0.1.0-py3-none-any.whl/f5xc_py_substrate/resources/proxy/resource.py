...
class ProxyResource:
    ...
    Proxy view defines a required parameters that can be used in CRUD,...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.proxy.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("proxy", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("proxy", "replace", e, response) from e
    ...
    def list(
        ...
        """List proxy resources in a namespace.
        ...
        try:
            return [ProxyListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("proxy", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("proxy", "get", e, response) from e
    ...
    def get_proxy_server_ca_cert(
        self,
        namespace: str,
        name: str,
    ) -> HttpBody:
        """Get Proxy Server Ca Cert for proxy.
        ...
        try:
            ...
            raise F5XCValidationError("proxy", "get_proxy_server_ca_cert", e, response) from e
