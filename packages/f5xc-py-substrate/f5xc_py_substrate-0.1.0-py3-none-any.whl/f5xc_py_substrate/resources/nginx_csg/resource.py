...
class NginxCsgResource:
    """API methods for nginx_csg.
...
NGINX One CSG configuration
    ...
    # Usage: client.nginx_csg.CreateSpecType(...)
    ...
    def list(
    ...
    ) -> list[NginxCsgListItem]:
        """List nginx_csg resources in a namespace.
        ...
        try:
            return [NginxCsgListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("nginx_csg", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("nginx_csg", "get", e, response) from e
