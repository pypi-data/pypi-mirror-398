...
class SubnetResource:
    """API methods for subnet.

    Subnet object is used to support VMs/pods with multiple...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.subnet.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("subnet", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("subnet", "replace", e, response) from e
    ...
    def list(
        ...
        """List subnet resources in a namespace.

        List the set of subnet in a namespace
        ...
        try:
            return [SubnetListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("subnet", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("subnet", "get", e, response) from e
