...
class RbacPolicyResource:
    """API methods for rbac_policy.

    A rbac_policy object consists of list of rbac policy rules that when...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.rbac_policy.CreateSpecType(...)
    ...
    def list(
    ...
    ) -> list[RbacPolicyListItem]:
        """List rbac_policy resources in a namespace.
        ...
        try:
            return [RbacPolicyListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("rbac_policy", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a rbac_policy by name.

        Get rbac_policy reads a given object from storage backend for...
        ...
        try:
            ...
            raise F5XCValidationError("rbac_policy", "get", e, response) from e
