...
class StaticComponentResource:
    """API methods for static_component.

    stores information about the UI Components in key-value pair
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.static_component.CreateSpecType(...)
    ...
    def list(
    ...
    ) -> list[StaticComponentListItem]:
        """List static_component resources in a namespace.
        ...
        try:
            return [StaticComponentListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("static_component", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a static_component by name.
        ...
        try:
            ...
            raise F5XCValidationError("static_component", "get", e, response) from e
