...
class OriginPoolResource:
    """API methods for origin_pool.

    Origin pool is a view to create cluster and endpoints that can be...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.origin_pool.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("origin_pool", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing origin_pool.
        ...
        try:
            ...
            raise F5XCValidationError("origin_pool", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[OriginPoolListItem]:
        """List origin_pool resources in a namespace.
        ...
        try:
            return [OriginPoolListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("origin_pool", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("origin_pool", "get", e, response) from e
