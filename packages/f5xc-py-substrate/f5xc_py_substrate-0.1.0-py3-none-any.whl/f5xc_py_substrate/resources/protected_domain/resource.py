...
class ProtectedDomainResource:
    """API methods for protected_domain.

    
Domain to Protect Object defines which domains will be protected by...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.protected_domain.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("protected_domain", "create", e, response) from e
    ...
    def list(
    ...
    ) -> list[ProtectedDomainListItem]:
        """List protected_domain resources in a namespace.
        ...
        try:
            return [ProtectedDomainListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("protected_domain", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a protected_domain by name.
        ...
        try:
            ...
            raise F5XCValidationError("protected_domain", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a protected_domain.

        Delete the specified protected_domain
