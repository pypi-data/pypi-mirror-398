"""CodeBaseIntegration resource API."""
...
class CodeBaseIntegrationResource:
    """API methods for code_base_integration.

    Code base integration
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.code_base_integration.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new code_base_integration.
        ...
        try:
            ...
            raise F5XCValidationError("code_base_integration", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing code_base_integration.
        ...
        try:
            ...
            raise F5XCValidationError("code_base_integration", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[CodeBaseIntegrationListItem]:
        """List code_base_integration resources in a namespace.
        ...
        try:
            return [CodeBaseIntegrationListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("code_base_integration", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a code_base_integration by name.
        ...
        try:
            ...
            raise F5XCValidationError("code_base_integration", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a code_base_integration.

        Delete the specified code_base_integration
