...
class IpPrefixSetResource:
    """API methods for ip_prefix_set.

    An ip prefix set contains an unordered list of IP prefixes. It can...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.ip_prefix_set.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new ip_prefix_set.

        Create ip_prefix_set creates a new object in the storage backend for...
        ...
        try:
            ...
            raise F5XCValidationError("ip_prefix_set", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing ip_prefix_set.

        Replace ip_prefix_set replaces an existing object in the storage...
        ...
        try:
            ...
            raise F5XCValidationError("ip_prefix_set", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[IpPrefixSetListItem]:
        """List ip_prefix_set resources in a namespace.
        ...
        try:
            return [IpPrefixSetListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("ip_prefix_set", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a ip_prefix_set by name.

        Get ip_prefix_set reads a given object from storage backend for...
        ...
        try:
            ...
            raise F5XCValidationError("ip_prefix_set", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a ip_prefix_set.

        Delete the specified ip_prefix_set
