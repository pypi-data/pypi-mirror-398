"""Pydantic models for network_firewall."""
...
class NetworkFirewallListItem(F5XCBaseModel):
    """List item for network_firewall resources."""
...
class ActiveFastACLsType(F5XCBaseModel):
    """List of Fast ACL(s)."""
...
class CreateSpecType(F5XCBaseModel):
    ...
    active_fast_acls: Optional[ActiveFastACLsType] = None
    ...
    disable_fast_acl: Optional[Any] = None
    disable_forward_proxy_policy: Optional[Any] = None
    disable_network_policy: Optional[Any] = None
...
class ListResponseItem(F5XCBaseModel):
    """By default a summary of network_firewall is returned in 'List'. By..."""
