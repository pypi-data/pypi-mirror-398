...
class K8sClusterResource:
    """API methods for k8s_cluster.

    K8s cluster represents the real physical K8s cluster on the site. It...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.k8s_cluster.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            return K8sClustercreateresponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("k8s_cluster", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing k8s_cluster.

        Replacing an k8s_cluster object will update the object by replacing...
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return K8sClusterreplaceresponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("k8s_cluster", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[K8sClusterListItem]:
        """List k8s_cluster resources in a namespace.

        List the set of k8s_cluster in a namespace
        ...
        try:
            return [K8sClusterListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("k8s_cluster", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            return K8sClustergetresponse(**filtered_response)
        except ValidationError as e:
            raise F5XCValidationError("k8s_cluster", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a k8s_cluster.

        Delete the specified k8s_cluster
