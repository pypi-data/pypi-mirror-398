"""WafExclusionPolicy resource API."""
...
class WafExclusionPolicyResource:
    """API methods for waf_exclusion_policy.

    WAF Exclusion Policy record
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.waf_exclusion_policy.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new waf_exclusion_policy.
        ...
        try:
            ...
            raise F5XCValidationError("waf_exclusion_policy", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing waf_exclusion_policy.
        ...
        try:
            ...
            raise F5XCValidationError("waf_exclusion_policy", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[WafExclusionPolicyListItem]:
        """List waf_exclusion_policy resources in a namespace.
        ...
        try:
            return [WafExclusionPolicyListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("waf_exclusion_policy", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a waf_exclusion_policy by name.
        ...
        try:
            ...
            raise F5XCValidationError("waf_exclusion_policy", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a waf_exclusion_policy.

        Delete the specified waf_exclusion_policy
