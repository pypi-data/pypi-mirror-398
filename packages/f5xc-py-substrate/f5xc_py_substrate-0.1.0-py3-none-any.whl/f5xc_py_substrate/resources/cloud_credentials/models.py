"""Pydantic models for cloud_credentials."""
...
class CloudCredentialsListItem(F5XCBaseModel):
    """List item for cloud_credentials resources."""
...
class AWSAssumeRoleType(F5XCBaseModel):
    """AWS Assume Role to Handle Delegated Access"""

    custom_external_id: Optional[str] = None
    duration_seconds: Optional[int] = None
    external_id_is_optional: Optional[Any] = None
    external_id_is_tenant_id: Optional[Any] = None
    role_arn: Optional[str] = None
    session_name: Optional[str] = None
    session_tags: Optional[dict[str, Any]] = None
...
class AWSSecretType(F5XCBaseModel):
    """AWS Programmatic Access Credentials type"""

    access_key: Optional[str] = None
    secret_key: Optional[SecretType] = None


class AzurePfxType(F5XCBaseModel):
...
class AzureSecretType(F5XCBaseModel):
    """Azure Credentials Client Secret type"""

    client_id: Optional[str] = None
    client_secret: Optional[SecretType] = None
    subscription_id: Optional[str] = None
    tenant_id: Optional[str] = None
...
class GCPCredFileType(F5XCBaseModel):
    """GCP Credentials type"""

    credential_file: Optional[SecretType] = None


class CreateSpecType(F5XCBaseModel):
    """API to create cloud_credentials object"""

    aws_assume_role: Optional[AWSAssumeRoleType] = None
    aws_secret_key: Optional[AWSSecretType] = None
    azure_client_secret: Optional[AzureSecretType] = None
    azure_pfx_certificate: Optional[AzurePfxType] = None
    gcp_cred_file: Optional[GCPCredFileType] = None
...
class ListResponseItem(F5XCBaseModel):
    """By default a summary of cloud_credentials is returned in 'List'. By..."""
