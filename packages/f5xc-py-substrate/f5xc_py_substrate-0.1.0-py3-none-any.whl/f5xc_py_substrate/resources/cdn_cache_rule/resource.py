...
class CdnCacheRuleResource:
    """API methods for cdn_cache_rule.

    CDN cache rule view defines a required parameters that can be used...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.cdn_cache_rule.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("cdn_cache_rule", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing cdn_cache_rule.
        ...
        try:
            ...
            raise F5XCValidationError("cdn_cache_rule", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[CdnCacheRuleListItem]:
        """List cdn_cache_rule resources in a namespace.
        ...
        try:
            return [CdnCacheRuleListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("cdn_cache_rule", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("cdn_cache_rule", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a cdn_cache_rule.

        Delete the specified cdn_cache_rule
