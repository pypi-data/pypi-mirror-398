"""Pydantic models for secret_policy_rule."""
...
class SecretPolicyRuleListItem(F5XCBaseModel):
    """List item for secret_policy_rule resources."""
...
class CreateSpecType(F5XCBaseModel):
    """Create secret_policy_rule creates a new object in storage backend for..."""
...
class ReplaceSpecType(F5XCBaseModel):
    """Replace secret_policy_rule creates a new object in storage backend for..."""
...
class StatusObject(F5XCBaseModel):
    """Most recent observed status of the object"""
...
class ListResponseItem(F5XCBaseModel):
    """By default a summary of secret_policy_rule is returned in 'List'. By..."""
