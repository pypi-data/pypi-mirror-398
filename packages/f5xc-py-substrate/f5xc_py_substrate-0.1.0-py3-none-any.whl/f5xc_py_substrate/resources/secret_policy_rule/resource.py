...
class SecretPolicyRuleResource:
    """API methods for secret_policy_rule.

    Secret Policy Rule defines a rule controlling access to a secret.
A...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.secret_policy_rule.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new secret_policy_rule.

        Create secret_policy_rule creates a new object in storage backend...
        ...
        try:
            ...
            raise F5XCValidationError("secret_policy_rule", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing secret_policy_rule.

        Replace secret_policy_rule creates a new object in storage backend...
        ...
        try:
            ...
            raise F5XCValidationError("secret_policy_rule", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[SecretPolicyRuleListItem]:
        """List secret_policy_rule resources in a namespace.
        ...
        try:
            return [SecretPolicyRuleListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("secret_policy_rule", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a secret_policy_rule by name.

        Get secret_policy_rule reads a given object from storage backend for...
        ...
        try:
            ...
            raise F5XCValidationError("secret_policy_rule", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a secret_policy_rule.

        Delete the specified secret_policy_rule
