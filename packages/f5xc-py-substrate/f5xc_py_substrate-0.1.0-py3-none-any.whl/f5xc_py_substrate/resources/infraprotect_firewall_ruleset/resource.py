"""InfraprotectFirewallRuleset resource API."""
...
from f5xc_py_substrate.resources.infraprotect_firewall_ruleset.models import (
    InfraprotectFirewallRulesetListItem,
    ObjectRefType,
    ObjectGetMetaType,
...
class InfraprotectFirewallRulesetResource:
    """API methods for infraprotect_firewall_ruleset.

    DDoS transit Firewall Ruleset
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.infraprotect_firewall_ruleset.CreateSpecType(...)
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing infraprotect_firewall_ruleset.
        ...
        try:
            ...
            raise F5XCValidationError("infraprotect_firewall_ruleset", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[InfraprotectFirewallRulesetListItem]:
        """List infraprotect_firewall_ruleset resources in a namespace.
        ...
        try:
            return [InfraprotectFirewallRulesetListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("infraprotect_firewall_ruleset", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a infraprotect_firewall_ruleset by name.
        ...
        try:
            ...
            raise F5XCValidationError("infraprotect_firewall_ruleset", "get", e, response) from e
