...
class TenantProfileResource:
    """API methods for tenant_profile.

    
Tenant profile objects are required for creating child tenant using...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.tenant_profile.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new tenant_profile.

        Creates a tenant_profile config instance. Name of the object is the...
        ...
        try:
            ...
            raise F5XCValidationError("tenant_profile", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing tenant_profile.
        ...
        try:
            ...
            raise F5XCValidationError("tenant_profile", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[TenantProfileListItem]:
        """List tenant_profile resources in a namespace.
        ...
        try:
            return [TenantProfileListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("tenant_profile", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a tenant_profile by name.

        Get tenant_profile reads a given object from storage backend for...
        ...
        try:
            ...
            raise F5XCValidationError("tenant_profile", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a tenant_profile.

        Delete the specified tenant_profile
