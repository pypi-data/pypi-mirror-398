...
class QuotaResource:
    """API methods for quota.

    Quota object is used to configure the limits on how many of a...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.quota.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("quota", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing quota.

        replace quota updates a given object from storage backend for...
        ...
        try:
            ...
            raise F5XCValidationError("quota", "replace", e, response) from e
    ...
    def list(
        ...
        """List quota resources in a namespace.

        List the set of quota in a namespace
        ...
        try:
            return [QuotaListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("quota", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("quota", "get", e, response) from e
    ...
    def custom_get_quota_limits(
        self,
        namespace: str,
    ) -> GetQuotaLimitsResponse:
        """Custom Get Quota Limits for quota.
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return GetQuotaLimitsResponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("quota", "custom_get_quota_limits", e, response) from e

    def get_quota_usage(
        self,
        namespace: str,
    ) -> GetResponseType:
        """Get Quota Usage for quota.
        ...
        try:
            ...
            raise F5XCValidationError("quota", "get_quota_usage", e, response) from e
