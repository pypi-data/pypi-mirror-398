...
class ServicePolicyResource:
    """API methods for service_policy.

    A service_policy object consists of an unordered list of predicates...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.service_policy.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new service_policy.

        Create service_policy creates a new object in the storage backend...
        ...
        try:
            ...
            raise F5XCValidationError("service_policy", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing service_policy.
        ...
        try:
            ...
            raise F5XCValidationError("service_policy", "replace", e, response) from e

    def service_policy_hits(
        self,
        namespace: str,
        body: dict[str, Any] | None = None,
    ) -> HitsResponse:
        """Service Policy Hits for service_policy.
        ...
        try:
            ...
            raise F5XCValidationError("service_policy", "service_policy_hits", e, response) from e

    def service_policy_hits_latency(
        self,
        namespace: str,
        body: dict[str, Any] | None = None,
    ) -> HitsResponse:
        """Service Policy Hits Latency for service_policy.
        ...
        try:
            ...
            raise F5XCValidationError("service_policy", "service_policy_hits_latency", e, response) from e
    ...
    def list(
    ...
    ) -> list[ServicePolicyListItem]:
        """List service_policy resources in a namespace.
        ...
        try:
            return [ServicePolicyListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("service_policy", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("service_policy", "get", e, response) from e
