...
class ProtocolPolicerResource:
    """API methods for protocol_policer.

    Protocol policer has set or network protocol fields and flags to be...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.protocol_policer.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new protocol_policer.

        Create a protocol_policer object, protocol_policer object contains...
        ...
        try:
            ...
            raise F5XCValidationError("protocol_policer", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing protocol_policer.

        Replace a protocol_policer object with new L4 protocol match...
        ...
        try:
            ...
            raise F5XCValidationError("protocol_policer", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[ProtocolPolicerListItem]:
        """List protocol_policer resources in a namespace.
        ...
        try:
            return [ProtocolPolicerListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("protocol_policer", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a protocol_policer by name.

        Get specification of a protocol_policer object with L4 protocol...
        ...
        try:
            ...
            raise F5XCValidationError("protocol_policer", "get", e, response) from e
