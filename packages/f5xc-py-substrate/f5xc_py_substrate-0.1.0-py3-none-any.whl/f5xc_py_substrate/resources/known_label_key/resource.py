...
class KnownLabelKeyResource:
    """API methods for known_label_key.

    Known label key serves two purposes

   It lets users declare label...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.known_label_key.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new known_label_key.

        Create creates a new label key in shared namespace. Any other...
        ...
        try:
            ...
            raise F5XCValidationError("known_label_key", "create", e, response) from e
    ...
    def delete(
        ...
        """Delete a known_label_key.

        Delete will delete a given label key label key from current tenants...
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("known_label_key", "get", e, response) from e
