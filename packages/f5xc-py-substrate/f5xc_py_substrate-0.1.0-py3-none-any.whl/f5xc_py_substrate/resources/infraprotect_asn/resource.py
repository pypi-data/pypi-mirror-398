...
class InfraprotectAsnResource:
    """API methods for infraprotect_asn.

    DDoS transit ASN information
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.infraprotect_asn.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("infraprotect_asn", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing infraprotect_asn.
        ...
        try:
            ...
            raise F5XCValidationError("infraprotect_asn", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[InfraprotectAsnListItem]:
        """List infraprotect_asn resources in a namespace.
        ...
        try:
            return [InfraprotectAsnListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("infraprotect_asn", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a infraprotect_asn by name.
        ...
        try:
            ...
            raise F5XCValidationError("infraprotect_asn", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a infraprotect_asn.

        Delete the specified infraprotect_asn
    ...
    def update_asn_review_status(
        self,
        namespace: str,
        body: dict[str, Any] | None = None,
    ) -> UpdateASNReviewStatusResponse:
        """Update Asn Review Status for infraprotect_asn.
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return UpdateASNReviewStatusResponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("infraprotect_asn", "update_asn_review_status", e, response) from e
