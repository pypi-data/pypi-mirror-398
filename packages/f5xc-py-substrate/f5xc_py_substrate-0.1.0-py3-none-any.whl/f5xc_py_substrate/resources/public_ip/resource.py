...
class PublicIpResource:
    """API methods for public_ip.

    public_ip object represents a public IP address that is available on...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.public_ip.CreateSpecType(...)
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing public_ip.

        Replacing an public_ip object will update the object by replacing...
        ...
        try:
            ...
            raise F5XCValidationError("public_ip", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[PublicIpListItem]:
        """List public_ip resources in a namespace.
        ...
        try:
            return [PublicIpListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("public_ip", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a public_ip by name.

        Get public_ip will get the object from the storage backend for...
        ...
        try:
            ...
            raise F5XCValidationError("public_ip", "get", e, response) from e
