...
class AlertPolicyResource:
    """API methods for alert_policy.

    Alert Policy is used to specify a set of routes to match the...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.alert_policy.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("alert_policy", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing alert_policy.
        ...
        try:
            ...
            raise F5XCValidationError("alert_policy", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[AlertPolicyListItem]:
        """List alert_policy resources in a namespace.

        List the set of alert_policy in a namespace
        ...
        try:
            return [AlertPolicyListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("alert_policy", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("alert_policy", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a alert_policy.

        Delete the specified alert_policy
    ...
    def get_alert_policy_match(
        self,
        namespace: str,
        body: dict[str, Any] | None = None,
    ) -> MatchResponse:
        """Get Alert Policy Match for alert_policy.
        ...
        try:
            ...
            raise F5XCValidationError("alert_policy", "get_alert_policy_match", e, response) from e
