...
class NetworkPolicyResource:
    """API methods for network_policy.

    Network Policy is applied to all IP packets to and from a given...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.network_policy.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new network_policy.

        Creates a new network policy with configured parameters in specified...
        ...
        try:
            ...
            raise F5XCValidationError("network_policy", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing network_policy.

        Replaces configured Network Policy with new set of parameters in...
        ...
        try:
            ...
            raise F5XCValidationError("network_policy", "replace", e, response) from e
    ...
    def network_policy_hits(
        ...
        """Network Policy Hits for network_policy.
        ...
        try:
            ...
            raise F5XCValidationError("network_policy", "network_policy_hits", e, response) from e
    ...
    def list(
    ...
    ) -> list[NetworkPolicyListItem]:
        """List network_policy resources in a namespace.
        ...
        try:
            return [NetworkPolicyListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("network_policy", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("network_policy", "get", e, response) from e
