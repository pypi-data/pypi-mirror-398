...
class AwsTgwSiteResource:
    """API methods for aws_tgw_site.

    AWS TGW site view defines a required parameters that can be used in...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.aws_tgw_site.CreateSpecType(...)
    ...
    def create(
        ...
        namespace: str,
        name: str,
        spec: AWSSubnetInfoType | None = None,
        *,
        ...
        try:
            ...
            raise F5XCValidationError("aws_tgw_site", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing aws_tgw_site.
        ...
        try:
            ...
            raise F5XCValidationError("aws_tgw_site", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[AwsTgwSiteListItem]:
        """List aws_tgw_site resources in a namespace.
        ...
        try:
            return [AwsTgwSiteListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("aws_tgw_site", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("aws_tgw_site", "get", e, response) from e
    ...
    def set_tgw_info(
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return SetTGWInfoResponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("aws_tgw_site", "set_tgw_info", e, response) from e
    ...
    def set_vip_info(
        ...
        try:
            ...
            raise F5XCValidationError("aws_tgw_site", "set_vip_info", e, response) from e

    def set_vpc_ip_prefixes(
        self,
        namespace: str,
        name: str,
        body: dict[str, Any] | None = None,
    ) -> SetVPCIpPrefixesResponse:
        """Set Vpc Ip Prefixes for aws_tgw_site.
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return SetVPCIpPrefixesResponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("aws_tgw_site", "set_vpc_ip_prefixes", e, response) from e
    ...
    def set_vpn_tunnels(
        ...
        """Set Vpn Tunnels for aws_tgw_site.
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return SetVPNTunnelsResponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("aws_tgw_site", "set_vpn_tunnels", e, response) from e
    ...
    def validate_config(
        ...
        """Validate Config for aws_tgw_site.
        ...
        try:
            ...
            raise F5XCValidationError("aws_tgw_site", "validate_config", e, response) from e
