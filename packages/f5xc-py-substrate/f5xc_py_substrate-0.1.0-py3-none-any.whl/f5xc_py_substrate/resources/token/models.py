...
class TokenListItem(F5XCBaseModel):
    """List item for token resources."""
...
class CreateSpecType(F5XCBaseModel):
    """Creates new token. token object is used to manage site admission. User..."""
...
class GetSpecType(F5XCBaseModel):
    ...
    state: Optional[Literal['UNKNOWN', 'VALID', 'EXPIRED']] = None
...
class GetCloudInitConfigResp(F5XCBaseModel):
...
class ReplaceSpecType(F5XCBaseModel):
    """Replaces token. token object is used to manage site admission. User must..."""
...
class ListResponseItem(F5XCBaseModel):
    """By default a summary of token is returned in 'List'. By setting..."""
...
class Object(F5XCBaseModel):
    """Token object store token specification and state"""
...
class StateReq(F5XCBaseModel):
    """Changes token state, only state is changing, namespace and name is used..."""
