...
from f5xc_py_substrate.resources.healthcheck.models import (
    HealthcheckListItem,
...
class HealthcheckResource:
    """API methods for healthcheck.

    Health check configuration for a given cluster.
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.healthcheck.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        Healthcheck object defines method to determine if the given Endpoint...
        ...
        try:
            ...
            raise F5XCValidationError("healthcheck", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing healthcheck.
        ...
        try:
            ...
            raise F5XCValidationError("healthcheck", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[HealthcheckListItem]:
        """List healthcheck resources in a namespace.

        List the set of healthcheck in a namespace
        ...
        try:
            return [HealthcheckListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("healthcheck", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("healthcheck", "get", e, response) from e
    ...
    def delete(
        ...
        Delete the specified healthcheck
