...
class CloudRegionResource:
    """API methods for cloud_region.

    Cloud Region contains tenant specific configuration
object. Users...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.cloud_region.CreateSpecType(...)
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing cloud_region.
        ...
        try:
            ...
            raise F5XCValidationError("cloud_region", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[CloudRegionListItem]:
        """List cloud_region resources in a namespace.
        ...
        try:
            return [CloudRegionListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("cloud_region", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("cloud_region", "get", e, response) from e
