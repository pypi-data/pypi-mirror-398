"""Pydantic models for cminstance."""
...
class CminstanceListItem(F5XCBaseModel):
    """List item for cminstance resources."""
...
class CreateSpecType(F5XCBaseModel):
    ...
    ip: Optional[Ipv4AddressType] = None
...
class ListResponseItem(F5XCBaseModel):
    """By default a summary of cminstance is returned in 'List'. By setting..."""
