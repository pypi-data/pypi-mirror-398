...
class V1HttpMonitorResource:
    """API methods for v1_http_monitor.
...
HTTP Monitor defines an HTTP synthetic monitor.
    ...
    # Usage: client.v1_http_monitor.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            return V1HttpMonitorcreateresponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("v1_http_monitor", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing v1_http_monitor.
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return V1HttpMonitorreplaceresponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("v1_http_monitor", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[V1HttpMonitorListItem]:
        """List v1_http_monitor resources in a namespace.
        ...
        try:
            return [V1HttpMonitorListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("v1_http_monitor", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            return V1HttpMonitorgetresponse(**filtered_response)
        except ValidationError as e:
            raise F5XCValidationError("v1_http_monitor", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a v1_http_monitor.

        Delete the specified v1_http_monitor
    ...
    def get_filtered_http_monitor_list(
        self,
        namespace: str,
        ...
        """Get Filtered Http Monitor List for v1_http_monitor.
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return V1HttpMonitorgetfilteredhttpmonitorlistresponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("v1_http_monitor", "get_filtered_http_monitor_list", e, response) from e
