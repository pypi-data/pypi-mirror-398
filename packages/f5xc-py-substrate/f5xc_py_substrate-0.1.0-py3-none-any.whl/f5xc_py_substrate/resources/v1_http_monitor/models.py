"""Pydantic models for v1_http_monitor."""
...
class V1HttpMonitorListItem(F5XCBaseModel):
    """List item for v1_http_monitor resources."""
...
class V1HttpMonitorrequestbody(F5XCBaseModel):
    request_body: Optional[str] = None


class V1HttpMonitorhttpmonitorheader(F5XCBaseModel):
    key: Optional[str] = None
    value: Optional[str] = None


class V1HttpMonitorcreatespectype(F5XCBaseModel):
    """Create HTTP Monitor"""

    delete: Optional[V1HttpMonitorrequestbody] = None
    external_sources: Optional[list[SourceExternal]] = None
    follow_redirects: Optional[bool] = None
    get: Optional[Any] = None
    ...
    patch: Optional[V1HttpMonitorrequestbody] = None
    post: Optional[V1HttpMonitorrequestbody] = None
    put: Optional[V1HttpMonitorrequestbody] = None
    receive: Optional[str] = None
    request_headers: Optional[list[V1HttpMonitorhttpmonitorheader]] = None
...
class V1HttpMonitorcreaterequest(F5XCBaseModel):
    """This is the input message of the 'Create' RPC"""

    metadata: Optional[ObjectCreateMetaType] = None
    spec: Optional[V1HttpMonitorcreatespectype] = None


class V1HttpMonitorgetspectype(F5XCBaseModel):
    """Get HTTP Monitor"""
...
class V1HttpMonitorcreateresponse(F5XCBaseModel):
    metadata: Optional[ObjectGetMetaType] = None
    spec: Optional[V1HttpMonitorgetspectype] = None
    system_metadata: Optional[SystemObjectGetMetaType] = None


class V1HttpMonitordeleterequest(F5XCBaseModel):
...
class V1HttpMonitorglobalspectype(F5XCBaseModel):
    """HTTP Monitor spec"""
...
class V1HttpMonitorspectype(F5XCBaseModel):
    """Shape of the v1_http_monitor specification"""

    gc_spec: Optional[V1HttpMonitorglobalspectype] = None


class V1HttpMonitorobject(F5XCBaseModel):
    """HTTP Monitor Object"""

    metadata: Optional[ObjectMetaType] = None
    spec: Optional[V1HttpMonitorspectype] = None
    system_metadata: Optional[SystemObjectMetaType] = None


class V1HttpMonitorgetfilteredhttpmonitorlistresponse(F5XCBaseModel):
    """Response body of GetFilteredHTTPMonitorList request"""

    errors: Optional[list[ErrorType]] = None
    items: Optional[list[V1HttpMonitorobject]] = None


class V1HttpMonitorreplacespectype(F5XCBaseModel):
    """Update HTTP Monitor"""
...
class V1HttpMonitorreplacerequest(F5XCBaseModel):
    """This is the input message of the 'Replace' RPC"""

    metadata: Optional[ObjectReplaceMetaType] = None
    spec: Optional[V1HttpMonitorreplacespectype] = None


class V1HttpMonitorstatusobject(F5XCBaseModel):
...
class V1HttpMonitorgetresponse(F5XCBaseModel):
    """This is the output message of the 'Get' RPC"""

    create_form: Optional[V1HttpMonitorcreaterequest] = None
    deleted_referred_objects: Optional[list[ObjectRefType]] = None
    disabled_referred_objects: Optional[list[ObjectRefType]] = None
    metadata: Optional[ObjectGetMetaType] = None
    referring_objects: Optional[list[ObjectRefType]] = None
    replace_form: Optional[V1HttpMonitorreplacerequest] = None
    spec: Optional[V1HttpMonitorgetspectype] = None
    status: Optional[list[V1HttpMonitorstatusobject]] = None
    system_metadata: Optional[SystemObjectGetMetaType] = None


class V1HttpMonitorlistresponseitem(F5XCBaseModel):
    """By default a summary of v1_http_monitor is returned in 'List'. By..."""

    annotations: Optional[dict[str, Any]] = None
    description: Optional[str] = None
    disabled: Optional[bool] = None
    get_spec: Optional[V1HttpMonitorgetspectype] = None
    labels: Optional[dict[str, Any]] = None
    metadata: Optional[ObjectGetMetaType] = None
    name: Optional[str] = None
    namespace: Optional[str] = None
    owner_view: Optional[ViewRefType] = None
    status_set: Optional[list[V1HttpMonitorstatusobject]] = None
    system_metadata: Optional[SystemObjectGetMetaType] = None
    tenant: Optional[str] = None
    uid: Optional[str] = None


class V1HttpMonitorlistresponse(F5XCBaseModel):
    """This is the output message of 'List' RPC."""

    errors: Optional[list[ErrorType]] = None
    items: Optional[list[V1HttpMonitorlistresponseitem]] = None


class V1HttpMonitorreplaceresponse(F5XCBaseModel):
    pass
