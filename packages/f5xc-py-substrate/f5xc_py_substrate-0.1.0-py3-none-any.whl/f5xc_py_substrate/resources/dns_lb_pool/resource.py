...
class DnsLbPoolResource:
    """API methods for dns_lb_pool.

    DNS Load Balancer Pool  object is used for configuring DNS Load Balancer Pool
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.dns_lb_pool.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new dns_lb_pool.

        Create DNS Load Balancer Pool in a given namespace. If one already...
        ...
        try:
            ...
            raise F5XCValidationError("dns_lb_pool", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing dns_lb_pool.
        ...
        try:
            ...
            raise F5XCValidationError("dns_lb_pool", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[DnsLbPoolListItem]:
        """List dns_lb_pool resources in a namespace.

        List the set of dns_lb_pool in a namespace
        ...
        try:
            return [DnsLbPoolListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("dns_lb_pool", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("dns_lb_pool", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a dns_lb_pool.

        Delete the specified dns_lb_pool
