...
class BotNetworkPolicyResource:
    """API methods for bot_network_policy.

    Configures Bot network Policy
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.bot_network_policy.CreateSpecType(...)
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing bot_network_policy.
        ...
        try:
            ...
            raise F5XCValidationError("bot_network_policy", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[BotNetworkPolicyListItem]:
        """List bot_network_policy resources in a namespace.
        ...
        try:
            return [BotNetworkPolicyListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("bot_network_policy", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a bot_network_policy by name.
        ...
        try:
            ...
            raise F5XCValidationError("bot_network_policy", "get", e, response) from e

    def get_network_policies_and_versions_list(
        self,
        namespace: str,
    ) -> GetPoliciesAndVersionsListResponse:
        """Get Network Policies And Versions List for bot_network_policy.
        ...
        try:
            ...
            raise F5XCValidationError("bot_network_policy", "get_network_policies_and_versions_list", e, response) from e
    ...
    def custom_replace(
        ...
        """Custom Replace for bot_network_policy.
        ...
        try:
            ...
            raise F5XCValidationError("bot_network_policy", "custom_replace", e, response) from e

    def get_network_policy_versions(
        self,
        namespace: str,
        name: str,
    ) -> PolicyVersionsResponse:
        """Get Network Policy Versions for bot_network_policy.
        ...
        try:
            ...
            raise F5XCValidationError("bot_network_policy", "get_network_policy_versions", e, response) from e
    ...
    def get_content(
        ...
        """Get Content for bot_network_policy.
        ...
        try:
            ...
            raise F5XCValidationError("bot_network_policy", "get_content", e, response) from e
