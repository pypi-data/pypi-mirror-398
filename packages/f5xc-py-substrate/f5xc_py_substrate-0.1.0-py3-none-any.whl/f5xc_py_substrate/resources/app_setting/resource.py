...
class AppSettingResource:
    """API methods for app_setting.

    "App Setting" controls advanced monitoring of applications defined...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.app_setting.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("app_setting", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing app_setting.

        Replacing an App setting will update the configuration by replacing...
        ...
        try:
            ...
            raise F5XCValidationError("app_setting", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[AppSettingListItem]:
        """List app_setting resources in a namespace.

        List the set of app_setting in a namespace
        ...
        try:
            return [AppSettingListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("app_setting", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("app_setting", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a app_setting.

        Delete the specified app_setting
    ...
    def suspicious_user_status(
        ...
        """Suspicious User Status for app_setting.
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return SuspiciousUserStatusRsp(**response)
        except ValidationError as e:
            raise F5XCValidationError("app_setting", "suspicious_user_status", e, response) from e
