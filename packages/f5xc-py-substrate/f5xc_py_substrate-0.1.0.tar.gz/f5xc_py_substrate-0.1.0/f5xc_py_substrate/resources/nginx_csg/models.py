...
class NginxCsgListItem(F5XCBaseModel):
    """List item for nginx_csg resources."""
...
class ListResponseItem(F5XCBaseModel):
    """By default a summary of nginx_csg is returned in 'List'. By setting..."""
