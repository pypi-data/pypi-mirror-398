...
class IkePhase2ProfileResource:
    """API methods for ike_phase2_profile.
...
1. Encryption...
    ...
    # Usage: client.ike_phase2_profile.CreateSpecType(...)
    ...
    def create(
        ...
        namespace: str,
        name: str,
        spec: IkePhase1Profileinputhours | None = None,
        *,
        ...
        """Create a new ike_phase2_profile.
        ...
        try:
            return IkePhase2Profilecreateresponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("ike_phase2_profile", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing ike_phase2_profile.
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return IkePhase2Profilereplaceresponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("ike_phase2_profile", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[IkePhase2ProfileListItem]:
        """List ike_phase2_profile resources in a namespace.
        ...
        try:
            return [IkePhase2ProfileListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("ike_phase2_profile", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a ike_phase2_profile by name.
        ...
        try:
            return IkePhase2Profilegetresponse(**filtered_response)
        except ValidationError as e:
            raise F5XCValidationError("ike_phase2_profile", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a ike_phase2_profile.

        Delete the specified ike_phase2_profile
