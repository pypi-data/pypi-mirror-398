...
class TunnelResource:
    """API methods for tunnel.

    Tunnel configuration allows user to specify parameters for...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.tunnel.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        Create tunnel in a given namespace. If one already exist it will...
        ...
        try:
            ...
            raise F5XCValidationError("tunnel", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("tunnel", "replace", e, response) from e
    ...
    def list(
        ...
        """List tunnel resources in a namespace.

        List the set of tunnel in a namespace
        ...
        try:
            return [TunnelListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("tunnel", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("tunnel", "get", e, response) from e
