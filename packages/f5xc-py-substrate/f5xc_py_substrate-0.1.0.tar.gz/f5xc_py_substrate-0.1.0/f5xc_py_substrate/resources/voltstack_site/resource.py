...
class VoltstackSiteResource:
    """API methods for voltstack_site.

    App Stack site defines a required parameters that can be used in...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.voltstack_site.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("voltstack_site", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing voltstack_site.
        ...
        try:
            ...
            raise F5XCValidationError("voltstack_site", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[VoltstackSiteListItem]:
        """List voltstack_site resources in a namespace.

        List the set of voltstack_site in a namespace
        ...
        try:
            return [VoltstackSiteListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("voltstack_site", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("voltstack_site", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a voltstack_site.

        Delete the specified voltstack_site
