"""ServicePolicyRule resource API."""
...
class ServicePolicyRuleResource:
    """API methods for service_policy_rule.

    A service_policy_rule object consists of an unordered list of...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.service_policy_rule.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new service_policy_rule.

        Create service_policy_rule creates a new object in the storage...
        ...
        try:
            ...
            raise F5XCValidationError("service_policy_rule", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing service_policy_rule.

        Replace service_policy_rule replaces an existing object in the...
        ...
        try:
            ...
            raise F5XCValidationError("service_policy_rule", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[ServicePolicyRuleListItem]:
        """List service_policy_rule resources in a namespace.
        ...
        try:
            return [ServicePolicyRuleListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("service_policy_rule", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a service_policy_rule by name.

        Get service_policy_rule reads a given object from storage backend...
        ...
        try:
            ...
            raise F5XCValidationError("service_policy_rule", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a service_policy_rule.

        Delete the specified service_policy_rule
