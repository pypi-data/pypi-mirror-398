...
class UdpLoadbalancerResource:
    """API methods for udp_loadbalancer.

    UDP load balancer view defines a required parameters that can be...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.udp_loadbalancer.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("udp_loadbalancer", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing udp_loadbalancer.
        ...
        try:
            ...
            raise F5XCValidationError("udp_loadbalancer", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[UdpLoadbalancerListItem]:
        """List udp_loadbalancer resources in a namespace.
        ...
        try:
            return [UdpLoadbalancerListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("udp_loadbalancer", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a udp_loadbalancer by name.
        ...
        try:
            ...
            raise F5XCValidationError("udp_loadbalancer", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a udp_loadbalancer.

        Delete the specified udp_loadbalancer
    ...
    def get_dns_info(
        ...
        """Get Dns Info for udp_loadbalancer.
        ...
        try:
            ...
            raise F5XCValidationError("udp_loadbalancer", "get_dns_info", e, response) from e
