...
class QuotaListItem(F5XCBaseModel):
    """List item for quota resources."""
...
class GetResponseType(F5XCBaseModel):
    """x-example: '{'user': {limit: {maximum: 10}, usage: {number: 8}},..."""
...
class ListResponseItem(F5XCBaseModel):
    """By default a summary of quota is returned in 'List'. By setting..."""
