...
class ApiGroupListItem(F5XCBaseModel):
    """List item for api_group resources."""
...
class GetSpecType(F5XCBaseModel):
    ...
    element_specs: Optional[list[GlobalSpecType]] = None
    elements: Optional[list[ObjectRefType]] = None
...
class ListResponseItem(F5XCBaseModel):
    """By default a summary of api_group is returned in 'List'. By setting..."""
