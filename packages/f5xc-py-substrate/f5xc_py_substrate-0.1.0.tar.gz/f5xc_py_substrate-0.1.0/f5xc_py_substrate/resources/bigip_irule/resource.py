...
from f5xc_py_substrate.resources.bigip_irule.models import (
    BigipIruleListItem,
...
class BigipIruleResource:
    """API methods for bigip_irule.

    BIG-IP iRule Service manages iRule Library for customers
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.bigip_irule.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("bigip_irule", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing bigip_irule.
        ...
        try:
            ...
            raise F5XCValidationError("bigip_irule", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[BigipIruleListItem]:
        """List bigip_irule resources in a namespace.
        ...
        try:
            return [BigipIruleListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("bigip_irule", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("bigip_irule", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a bigip_irule.

        Delete the specified bigip_irule
