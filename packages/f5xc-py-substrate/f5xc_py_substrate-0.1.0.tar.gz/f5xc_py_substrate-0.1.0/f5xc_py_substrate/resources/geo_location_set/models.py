"""Pydantic models for geo_location_set."""
...
class GeoLocationSetListItem(F5XCBaseModel):
    """List item for geo_location_set resources."""
...
class CreateSpecType(F5XCBaseModel):
    ...
    custom_geo_location_selector: Optional[LabelSelectorType] = None
    global_: Optional[Any] = Field(default=None, alias="global")
...
class ListResponseItem(F5XCBaseModel):
    """By default a summary of geo_location_set is returned in 'List'. By..."""
