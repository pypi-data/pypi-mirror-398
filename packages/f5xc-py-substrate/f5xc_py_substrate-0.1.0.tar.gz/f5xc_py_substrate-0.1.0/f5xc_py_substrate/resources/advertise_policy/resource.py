...
class AdvertisePolicyResource:
    """API methods for advertise_policy.

    advertise_policy object controls how and where a service represented...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.advertise_policy.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("advertise_policy", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing advertise_policy.
        ...
        try:
            ...
            raise F5XCValidationError("advertise_policy", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[AdvertisePolicyListItem]:
        """List advertise_policy resources in a namespace.
        ...
        try:
            return [AdvertisePolicyListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("advertise_policy", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a advertise_policy by name.
        ...
        try:
            ...
            raise F5XCValidationError("advertise_policy", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a advertise_policy.

        Delete the specified advertise_policy
