...
class DnsLbHealthCheckResource:
    """API methods for dns_lb_health_check.

    DNS Load Balancer Health Check object is used for configuring DNS...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.dns_lb_health_check.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new dns_lb_health_check.

        Create DNS Load Balancer Health Check in a given namespace. If one...
        ...
        try:
            ...
            raise F5XCValidationError("dns_lb_health_check", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing dns_lb_health_check.
        ...
        try:
            ...
            raise F5XCValidationError("dns_lb_health_check", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[DnsLbHealthCheckListItem]:
        """List dns_lb_health_check resources in a namespace.
        ...
        try:
            return [DnsLbHealthCheckListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("dns_lb_health_check", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a dns_lb_health_check by name.
        ...
        try:
            ...
            raise F5XCValidationError("dns_lb_health_check", "get", e, response) from e
