"""Pydantic models for site_mesh_group."""
...
class SiteMeshGroupListItem(F5XCBaseModel):
    """List item for site_mesh_group resources."""
...
class Status(F5XCBaseModel):
    """Status of the site mesh group (this will be used in site status object..."""

    other_connected_sites: Optional[list[str]] = None
...
class CreateSpecType(F5XCBaseModel):
    ...
    disable_re_fallback: Optional[Any] = None
    enable_re_fallback: Optional[Any] = None
...
class StatusObject(F5XCBaseModel):
    ...
    site_mesh_group_status: Optional[Status] = None
...
class ListResponseItem(F5XCBaseModel):
    """By default a summary of site_mesh_group is returned in 'List'. By..."""
