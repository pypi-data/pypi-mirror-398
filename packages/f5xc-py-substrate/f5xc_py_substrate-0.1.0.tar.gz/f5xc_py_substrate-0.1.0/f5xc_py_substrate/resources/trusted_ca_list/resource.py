...
class TrustedCaListResource:
    """API methods for trusted_ca_list.

    A Root CA Certificate represents list of trusted root CAs
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.trusted_ca_list.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("trusted_ca_list", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing trusted_ca_list.
        ...
        try:
            ...
            raise F5XCValidationError("trusted_ca_list", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[TrustedCaListListItem]:
        """List trusted_ca_list resources in a namespace.
        ...
        try:
            return [TrustedCaListListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("trusted_ca_list", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("trusted_ca_list", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a trusted_ca_list.

        Delete the specified trusted_ca_list
