...
class NetworkFirewallResource:
    """API methods for network_firewall.

    Network Firewall is applicable when referred to by a Fleet. The...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.network_firewall.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("network_firewall", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing network_firewall.
        ...
        try:
            ...
            raise F5XCValidationError("network_firewall", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[NetworkFirewallListItem]:
        """List network_firewall resources in a namespace.
        ...
        try:
            return [NetworkFirewallListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("network_firewall", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a network_firewall by name.
        ...
        try:
            ...
            raise F5XCValidationError("network_firewall", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a network_firewall.

        Delete the specified network_firewall
