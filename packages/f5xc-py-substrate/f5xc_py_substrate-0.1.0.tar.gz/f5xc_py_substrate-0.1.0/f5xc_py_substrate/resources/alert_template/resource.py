...
class AlertTemplateResource:
    """API methods for alert_template.
...
BRM Alerts Alert Template
    ...
    # Usage: client.alert_template.CreateSpecType(...)
    ...
    def create(
        ...
        namespace: str,
        name: str,
        spec: CloneTemplateRequest | None = None,
        *,
        ...
        try:
            ...
            raise F5XCValidationError("alert_template", "create", e, response) from e
    ...
    def list(
    ...
    ) -> list[AlertTemplateListItem]:
        """List alert_template resources in a namespace.
        ...
        try:
            return [AlertTemplateListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("alert_template", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("alert_template", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a alert_template.

        Delete the specified alert_template
    ...
    def clone(
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return CloneTemplateResponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("alert_template", "clone", e, response) from e
