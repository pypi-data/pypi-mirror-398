"""TenantConfiguration resource API."""
...
class TenantConfigurationResource:
    """API methods for tenant_configuration.

    Tenant configuration consists of three main parts:
- Basic...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.tenant_configuration.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new tenant_configuration.
        ...
        try:
            ...
            raise F5XCValidationError("tenant_configuration", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing tenant_configuration.
        ...
        try:
            ...
            raise F5XCValidationError("tenant_configuration", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[TenantConfigurationListItem]:
        """List tenant_configuration resources in a namespace.
        ...
        try:
            return [TenantConfigurationListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("tenant_configuration", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a tenant_configuration by name.
        ...
        try:
            ...
            raise F5XCValidationError("tenant_configuration", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a tenant_configuration.

        Delete the specified tenant_configuration
