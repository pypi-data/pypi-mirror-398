"""Pydantic models for secret_management_access."""
...
class SecretManagementAccessListItem(F5XCBaseModel):
    """List item for secret_management_access resources."""
...
class AppRoleAuthInfoType(F5XCBaseModel):
    """AppRoleAuthInfoType contains parameters for AppRole authentication in..."""

    role_id: Optional[str] = None
    secret_id: Optional[SecretType] = None


class AuthnTypeBasicAuth(F5XCBaseModel):
...
class AuthnTypeHeaders(F5XCBaseModel):
    """AuthnTypeHeaders is used for setting headers for authentication"""

    headers: Optional[dict[str, Any]] = None


class AuthnTypeQueryParams(F5XCBaseModel):
...
class RestAuthInfoType(F5XCBaseModel):
    """Authentication parameters for REST based hosts"""

    basic_auth: Optional[AuthnTypeBasicAuth] = None
    headers_auth: Optional[AuthnTypeHeaders] = None
    query_params_auth: Optional[AuthnTypeQueryParams] = None
...
class VaultAuthInfoType(F5XCBaseModel):
    """Authentication parameters for Hashicorp Vault hosts"""

    app_role_auth: Optional[AppRoleAuthInfoType] = None
    token: Optional[SecretType] = None


class HostAccessInfoType(F5XCBaseModel):
    """HostAccessInfoType contains the information about how to connect to the..."""

    rest_auth_info: Optional[RestAuthInfoType] = None
    scheme: Optional[Literal['HTTP', 'HTTPS']] = None
    server_endpoint: Optional[str] = None
    tls_config: Optional[UpstreamTlsParamsType] = None
    vault_auth_info: Optional[VaultAuthInfoType] = None
...
class CreateSpecType(F5XCBaseModel):
    """Create secret_management_access creates a new object in storage backend..."""

    access_info: Optional[HostAccessInfoType] = None
...
class GetSpecType(F5XCBaseModel):
    """Get secret_management_access reads a given object from storage backend..."""
...
class ReplaceSpecType(F5XCBaseModel):
    """Replace secret_management_access replaces an existing object in storage..."""
...
class ListResponseItem(F5XCBaseModel):
    """By default a summary of secret_management_access is returned in 'List'...."""
