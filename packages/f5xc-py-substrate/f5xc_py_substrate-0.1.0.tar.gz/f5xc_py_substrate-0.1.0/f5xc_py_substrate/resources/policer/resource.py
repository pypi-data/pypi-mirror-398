...
class PolicerResource:
    """API methods for policer.

    * Policer objects enforces traffic rate limits
* network_policy_rule...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.policer.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("policer", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("policer", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[PolicerListItem]:
        """List policer resources in a namespace.

        List the set of policer in a namespace
        ...
        try:
            return [PolicerListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("policer", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("policer", "get", e, response) from e
