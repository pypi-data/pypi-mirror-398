...
class PolicerListItem(F5XCBaseModel):
    """List item for policer resources."""
...
class CreateSpecType(F5XCBaseModel):
    ...
    committed_information_rate: Optional[int] = None
    policer_mode: Optional[Literal['POLICER_MODE_NOT_SHARED', 'POLICER_MODE_SHARED']] = None
    policer_type: Optional[Literal['POLICER_SINGLE_RATE_TWO_COLOR']] = None
...
class ListResponseItem(F5XCBaseModel):
    """By default a summary of policer is returned in 'List'. By setting..."""
