"""Pydantic models for managed_tenant."""
...
class ManagedTenantListItem(F5XCBaseModel):
    """List item for managed_tenant resources."""
...
class ListSupportTenantMTResp(F5XCBaseModel):
    """Response to get list of managed tenant access."""

    items: Optional[list[ListSupportTenantMTRespItem]] = None
    next_page: Optional[str] = None
    total_count: Optional[int] = None
    total_filtered_count: Optional[int] = None
...
class CreateSpecType(F5XCBaseModel):
    """Creates a managed_tenant config instance. Name of the object is name of..."""
