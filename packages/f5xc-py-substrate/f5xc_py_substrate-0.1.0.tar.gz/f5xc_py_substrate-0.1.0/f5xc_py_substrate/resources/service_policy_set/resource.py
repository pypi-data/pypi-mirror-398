...
from f5xc_py_substrate.resources.service_policy_set.models import (
    ServicePolicySetListItem,
    ObjectRefType,
    ProtobufAny,
    ConditionType,
    ErrorType,
...
class ServicePolicySetResource:
    """API methods for service_policy_set.

    A service_policy_set object consists of an ordered list of...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.service_policy_set.CreateSpecType(...)
    ...
    def list(
    ...
    ) -> list[ServicePolicySetListItem]:
        """List service_policy_set resources in a namespace.
        ...
        try:
            return [ServicePolicySetListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("service_policy_set", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a service_policy_set by name.

        Get service_policy_set reads a given object from storage backend for...
        ...
        try:
            ...
            raise F5XCValidationError("service_policy_set", "get", e, response) from e
