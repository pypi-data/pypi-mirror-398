...
class LmaRegionResource:
    """API methods for lma_region.

    LMA Region.
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.lma_region.CreateSpecType(...)
    ...
    def list(
    ...
    ) -> list[LmaRegionListItem]:
        """List lma_region resources in a namespace.
        ...
        try:
            return [LmaRegionListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("lma_region", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("lma_region", "get", e, response) from e
