"""Pydantic models for lma_region."""
...
class LmaRegionListItem(F5XCBaseModel):
    """List item for lma_region resources."""
...
class ClickhouseParams(F5XCBaseModel):
...
class ElasticParams(F5XCBaseModel):
    """Elastic parameters"""
...
class KafkaParams(F5XCBaseModel):
    """Kafka parameters"""
...
class GetSpecType(F5XCBaseModel):
    ...
    clickhouse_params: Optional[ClickhouseParams] = None
    elastic_params: Optional[ElasticParams] = None
    is_default: Optional[bool] = None
    kafka_params: Optional[KafkaParams] = None
...
class ListResponseItem(F5XCBaseModel):
    """By default a summary of lma_region is returned in 'List'. By setting..."""
