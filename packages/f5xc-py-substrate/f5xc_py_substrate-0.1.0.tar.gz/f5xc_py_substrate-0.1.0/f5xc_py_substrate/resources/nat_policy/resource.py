...
class NatPolicyResource:
    """API methods for nat_policy.

    NAT Policy object represents the configuration of Network Address...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.nat_policy.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("nat_policy", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing nat_policy.

        NAT Policy replaces specification condigures NAT Policy with...
        ...
        try:
            ...
            raise F5XCValidationError("nat_policy", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[NatPolicyListItem]:
        """List nat_policy resources in a namespace.

        List the set of nat_policy in a namespace
        ...
        try:
            return [NatPolicyListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("nat_policy", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a nat_policy by name.

        NAT Policy Get specification fetches the configuration from store...
        ...
        try:
            ...
            raise F5XCValidationError("nat_policy", "get", e, response) from e
    ...
    def delete(
        ...
        Delete the specified nat_policy
