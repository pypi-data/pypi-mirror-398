...
class BgpRoutingPolicyResource:
    """API methods for bgp_routing_policy.

    BGP Routing Policy is a list of rules, which contains match criteria...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.bgp_routing_policy.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new bgp_routing_policy.

        BGP Routing Policy is a list of rules containing match criteria and...
        ...
        try:
            ...
            raise F5XCValidationError("bgp_routing_policy", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing bgp_routing_policy.
        ...
        try:
            ...
            raise F5XCValidationError("bgp_routing_policy", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[BgpRoutingPolicyListItem]:
        """List bgp_routing_policy resources in a namespace.
        ...
        try:
            return [BgpRoutingPolicyListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("bgp_routing_policy", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a bgp_routing_policy by name.
        ...
        try:
            ...
            raise F5XCValidationError("bgp_routing_policy", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a bgp_routing_policy.

        Delete the specified bgp_routing_policy
