...
class ApiCrawlerResource:
    """API methods for api_crawler.

    This is the api crawler type
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.api_crawler.CreateSpecType(...)
    ...
    def create(
        ...
        namespace: str,
        name: str,
        spec: ApiCrawlingStatus | None = None,
        *,
        ...
        try:
            ...
            raise F5XCValidationError("api_crawler", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing api_crawler.
        ...
        try:
            ...
            raise F5XCValidationError("api_crawler", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[ApiCrawlerListItem]:
        """List api_crawler resources in a namespace.
        ...
        try:
            return [ApiCrawlerListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("api_crawler", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("api_crawler", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a api_crawler.

        Delete the specified api_crawler
