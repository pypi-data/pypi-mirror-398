"""ExternalConnector resource API."""
...
class ExternalConnectorResource:
    """API methods for external_connector.

    External Connector configuration mainly includes the following:
1....
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.external_connector.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new external_connector.
        ...
        try:
            ...
            raise F5XCValidationError("external_connector", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing external_connector.
        ...
        try:
            ...
            raise F5XCValidationError("external_connector", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[ExternalConnectorListItem]:
        """List external_connector resources in a namespace.
        ...
        try:
            return [ExternalConnectorListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("external_connector", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a external_connector by name.
        ...
        try:
            ...
            raise F5XCValidationError("external_connector", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a external_connector.

        Delete the specified external_connector
