"""MaliciousUserMitigation resource API."""
...
from f5xc_py_substrate.resources.malicious_user_mitigation.models import (
    MaliciousUserMitigationListItem,
    Empty,
...
class MaliciousUserMitigationResource:
    """API methods for malicious_user_mitigation.

    A malicious_user_mitigation object consists of settings that specify...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.malicious_user_mitigation.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new malicious_user_mitigation.

        Create malicious_user_mitigation creates a new object in the storage...
        ...
        try:
            ...
            raise F5XCValidationError("malicious_user_mitigation", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing malicious_user_mitigation.

        Replace malicious_user_mitigation replaces an existing object in the...
        ...
        try:
            ...
            raise F5XCValidationError("malicious_user_mitigation", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[MaliciousUserMitigationListItem]:
        """List malicious_user_mitigation resources in a namespace.
        ...
        try:
            return [MaliciousUserMitigationListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("malicious_user_mitigation", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a malicious_user_mitigation by name.

        Get malicious_user_mitigation reads a given object from storage...
        ...
        try:
            ...
            raise F5XCValidationError("malicious_user_mitigation", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a malicious_user_mitigation.
