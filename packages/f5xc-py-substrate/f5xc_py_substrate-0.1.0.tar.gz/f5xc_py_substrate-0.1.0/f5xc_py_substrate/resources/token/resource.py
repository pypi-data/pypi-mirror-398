...
class TokenResource:
    """API methods for token.

    token object is used to manage site admission. User must generate...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.token.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        Creates new token. token object is used to manage site admission....
        ...
        try:
            ...
            raise F5XCValidationError("token", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        Replaces token. token object is used to manage site admission. User...
        ...
        try:
            ...
            raise F5XCValidationError("token", "replace", e, response) from e
    ...
    def list(
        ...
        """List token resources in a namespace.
        ...
        try:
            return [TokenListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("token", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        Get token. token object is used to manage site admission. User must...
        ...
        try:
            ...
            raise F5XCValidationError("token", "get", e, response) from e
    ...
    def get_cloud_init_config(
        ...
        """Get Cloud Init Config for token.
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return GetCloudInitConfigResp(**response)
        except ValidationError as e:
            raise F5XCValidationError("token", "get_cloud_init_config", e, response) from e
    ...
    def token_state(
        ...
        try:
            ...
            raise F5XCValidationError("token", "token_state", e, response) from e
