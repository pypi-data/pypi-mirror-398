...
class TpmManagerResource:
    """API methods for tpm_manager.

    TPM Manager stores the required TPM management related data for the...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.tpm_manager.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("tpm_manager", "create", e, response) from e
    ...
    def list(
    ...
    ) -> list[TpmManagerListItem]:
        """List tpm_manager resources in a namespace.
        ...
        try:
            return [TpmManagerListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("tpm_manager", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a tpm_manager by name.

        Retrieve a TPM Manager object
        ...
        try:
            ...
            raise F5XCValidationError("tpm_manager", "get", e, response) from e
