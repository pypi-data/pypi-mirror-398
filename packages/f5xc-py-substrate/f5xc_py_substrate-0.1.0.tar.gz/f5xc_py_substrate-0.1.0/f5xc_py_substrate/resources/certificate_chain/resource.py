...
class CertificateChainResource:
    """API methods for certificate_chain.

    Certificate chain is list of certificates used to establish chain of...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.certificate_chain.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new certificate_chain.
        ...
        try:
            ...
            raise F5XCValidationError("certificate_chain", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing certificate_chain.
        ...
        try:
            ...
            raise F5XCValidationError("certificate_chain", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[CertificateChainListItem]:
        """List certificate_chain resources in a namespace.
        ...
        try:
            return [CertificateChainListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("certificate_chain", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a certificate_chain by name.
        ...
        try:
            ...
            raise F5XCValidationError("certificate_chain", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a certificate_chain.

        Delete the specified certificate_chain
