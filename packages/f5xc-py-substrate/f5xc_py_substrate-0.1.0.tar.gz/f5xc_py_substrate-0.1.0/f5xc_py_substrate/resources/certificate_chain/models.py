"""Pydantic models for certificate_chain."""
...
class CertificateChainListItem(F5XCBaseModel):
    """List item for certificate_chain resources."""
...
class ListResponseItem(F5XCBaseModel):
    """By default a summary of certificate_chain is returned in 'List'. By..."""
