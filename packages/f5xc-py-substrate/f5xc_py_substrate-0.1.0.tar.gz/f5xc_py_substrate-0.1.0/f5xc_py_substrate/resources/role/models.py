...
class RoleListItem(F5XCBaseModel):
    """List item for role resources."""
...
class GetSpecType(F5XCBaseModel):
    ...
    rbac_policy: Optional[list[ObjectRefType]] = None
...
class CustomCreateRequest(F5XCBaseModel):
...
class GlobalSpecType(F5XCBaseModel):
    """role internally uses name (like admin) and namespace (shared) and tenant..."""
...
class CustomGetResponse(F5XCBaseModel):
...
class CustomListResponse(F5XCBaseModel):
...
class ListResponseItem(F5XCBaseModel):
    """By default a summary of role is returned in 'List'. By setting..."""
