"""Pydantic models for network_policy_rule."""
...
class NetworkPolicyRuleListItem(F5XCBaseModel):
    """List item for network_policy_rule resources."""
...
class AdvancedAction(F5XCBaseModel):
...
class CreateSpecType(F5XCBaseModel):
    ...
    advanced_action: Optional[AdvancedAction] = None
    ...
    prefix_selector: Optional[LabelSelectorType] = None
...
class ListResponseItem(F5XCBaseModel):
    """By default a summary of network_policy_rule is returned in 'List'. By..."""
