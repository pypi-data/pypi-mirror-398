"""NetworkPolicyRule resource API."""
...
class NetworkPolicyRuleResource:
    """API methods for network_policy_rule.

    Network Policy Rule is applied to given remote endpoints to and from...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.network_policy_rule.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new network_policy_rule.
        ...
        try:
            ...
            raise F5XCValidationError("network_policy_rule", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing network_policy_rule.

        Replaces a network policy rule with configured parameters in...
        ...
        try:
            ...
            raise F5XCValidationError("network_policy_rule", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[NetworkPolicyRuleListItem]:
        """List network_policy_rule resources in a namespace.
        ...
        try:
            return [NetworkPolicyRuleListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("network_policy_rule", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a network_policy_rule by name.
        ...
        try:
            ...
            raise F5XCValidationError("network_policy_rule", "get", e, response) from e
