...
class Srv6NetworkSliceResource:
    """API methods for srv6_network_slice.

    An srv6_network_slice represents a network slice in an operator...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.srv6_network_slice.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new srv6_network_slice.

        Create srv6_network_slice creates a new object in the storage...
        ...
        try:
            return Srv6NetworkSlicecreateresponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("srv6_network_slice", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing srv6_network_slice.

        Replace srv6_network_slice replaces an existing object in the...
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return Srv6NetworkSlicereplaceresponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("srv6_network_slice", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[Srv6NetworkSliceListItem]:
        """List srv6_network_slice resources in a namespace.
        ...
        try:
            return [Srv6NetworkSliceListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("srv6_network_slice", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a srv6_network_slice by name.

        Get srv6_network_slice reads a given object from storage backend for...
        ...
        try:
            return Srv6NetworkSlicegetresponse(**filtered_response)
        except ValidationError as e:
            raise F5XCValidationError("srv6_network_slice", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a srv6_network_slice.

        Delete the specified srv6_network_slice
