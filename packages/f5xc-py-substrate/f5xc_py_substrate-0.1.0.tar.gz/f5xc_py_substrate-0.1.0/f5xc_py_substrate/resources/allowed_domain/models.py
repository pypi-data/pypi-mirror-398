"""Pydantic models for allowed_domain."""
...
class AllowedDomainListItem(F5XCBaseModel):
    """List item for allowed_domain resources."""
...
class ListResponseItem(F5XCBaseModel):
    """By default a summary of allowed_domain is returned in 'List'. By setting..."""
