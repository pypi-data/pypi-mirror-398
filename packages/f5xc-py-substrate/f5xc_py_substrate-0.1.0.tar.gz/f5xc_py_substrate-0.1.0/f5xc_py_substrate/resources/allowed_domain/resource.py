...
from f5xc_py_substrate.resources.allowed_domain.models import (
    AllowedDomainListItem,
...
class AllowedDomainResource:
    """API methods for allowed_domain.

    
Allowed Domain Object defines which domains will be allowed by...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.allowed_domain.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("allowed_domain", "create", e, response) from e
    ...
    def list(
    ...
    ) -> list[AllowedDomainListItem]:
        """List allowed_domain resources in a namespace.
        ...
        try:
            return [AllowedDomainListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("allowed_domain", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("allowed_domain", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a allowed_domain.

        Delete the specified allowed_domain
