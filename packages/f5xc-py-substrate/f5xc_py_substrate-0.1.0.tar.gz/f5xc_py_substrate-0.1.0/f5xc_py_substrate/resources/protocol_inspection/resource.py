"""ProtocolInspection resource API."""
...
class ProtocolInspectionResource:
    """API methods for protocol_inspection.

    Protocol Inspection view defines the required parameters that can be...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.protocol_inspection.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new protocol_inspection.

        Create Protocol Inspection Specification in a given namespace. If...
        ...
        try:
            ...
            raise F5XCValidationError("protocol_inspection", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing protocol_inspection.
        ...
        try:
            ...
            raise F5XCValidationError("protocol_inspection", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[ProtocolInspectionListItem]:
        """List protocol_inspection resources in a namespace.
        ...
        try:
            return [ProtocolInspectionListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("protocol_inspection", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a protocol_inspection by name.
        ...
        try:
            ...
            raise F5XCValidationError("protocol_inspection", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a protocol_inspection.

        Delete the specified protocol_inspection
