...
class AppFirewallResource:
    """API methods for app_firewall.

    WAF Configuration
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.app_firewall.CreateSpecType(...)
    ...
    def metrics_all_namespaces(
        self,
        body: dict[str, Any] | None = None,
    ) -> MetricsResponse:
        """Metrics All Namespaces for app_firewall.
        ...
        try:
            ...
            raise F5XCValidationError("app_firewall", "metrics_all_namespaces", e, response) from e

    def create(
        self,
        namespace: str,
        name: str,
        spec: AiRiskBasedBlocking | None = None,
        *,
        body: dict[str, Any] | None = None,
        ...
        try:
            ...
            raise F5XCValidationError("app_firewall", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing app_firewall.
        ...
        try:
            ...
            raise F5XCValidationError("app_firewall", "replace", e, response) from e
    ...
    def metrics(
        ...
        try:
            ...
            raise F5XCValidationError("app_firewall", "metrics", e, response) from e
    ...
    def list(
    ...
    ) -> list[AppFirewallListItem]:
        """List app_firewall resources in a namespace.
        ...
        try:
            return [AppFirewallListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("app_firewall", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("app_firewall", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a app_firewall.

        Delete the specified app_firewall
