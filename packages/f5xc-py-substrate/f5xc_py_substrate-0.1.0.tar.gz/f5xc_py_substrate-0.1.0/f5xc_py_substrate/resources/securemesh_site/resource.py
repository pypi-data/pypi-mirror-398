...
class SecuremeshSiteResource:
    """API methods for securemesh_site.

    Secure Mesh site defines a required parameters that can be used in...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.securemesh_site.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("securemesh_site", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing securemesh_site.
        ...
        try:
            ...
            raise F5XCValidationError("securemesh_site", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[SecuremeshSiteListItem]:
        """List securemesh_site resources in a namespace.
        ...
        try:
            return [SecuremeshSiteListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("securemesh_site", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("securemesh_site", "get", e, response) from e
