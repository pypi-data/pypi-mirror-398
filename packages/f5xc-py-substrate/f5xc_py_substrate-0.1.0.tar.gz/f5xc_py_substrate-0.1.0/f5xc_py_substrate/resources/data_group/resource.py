...
class DataGroupResource:
    """API methods for data_group.

    A data group is a group of related items - IP addresses/subnets,...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.data_group.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        Create data group in a given namespace. If one already exists it...
        ...
        try:
            ...
            raise F5XCValidationError("data_group", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing data_group.

        Replace Data Group in a given namespace.
        ...
        try:
            ...
            raise F5XCValidationError("data_group", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[DataGroupListItem]:
        """List data_group resources in a namespace.

        List the set of data_group in a namespace
        ...
        try:
            return [DataGroupListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("data_group", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("data_group", "get", e, response) from e
    ...
    def delete(
        ...
        Delete the specified data_group
