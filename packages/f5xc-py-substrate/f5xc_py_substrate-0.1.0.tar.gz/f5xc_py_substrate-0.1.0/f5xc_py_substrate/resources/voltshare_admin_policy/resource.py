"""VoltshareAdminPolicy resource API."""
...
class VoltshareAdminPolicyResource:
    """API methods for voltshare_admin_policy.

    VoltShare Admin Policy object is an admin level policy object that...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.voltshare_admin_policy.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new voltshare_admin_policy.
        ...
        try:
            ...
            raise F5XCValidationError("voltshare_admin_policy", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing voltshare_admin_policy.
        ...
        try:
            ...
            raise F5XCValidationError("voltshare_admin_policy", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[VoltshareAdminPolicyListItem]:
        """List voltshare_admin_policy resources in a namespace.
        ...
        try:
            return [VoltshareAdminPolicyListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("voltshare_admin_policy", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a voltshare_admin_policy by name.

        Get voltshare_admin_policy reads a given object from storage backend...
        ...
        try:
            ...
            raise F5XCValidationError("voltshare_admin_policy", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a voltshare_admin_policy.

        Delete the specified voltshare_admin_policy
