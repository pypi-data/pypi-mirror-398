...
class DcClusterGroupResource:
    """API methods for dc_cluster_group.

    A DC Cluster Group represents a collection of sites that
can...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.dc_cluster_group.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("dc_cluster_group", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing dc_cluster_group.
        ...
        try:
            ...
            raise F5XCValidationError("dc_cluster_group", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[DcClusterGroupListItem]:
        """List dc_cluster_group resources in a namespace.
        ...
        try:
            return [DcClusterGroupListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("dc_cluster_group", "list", e, response) from e
    ...
    def metrics(
        ...
        try:
            ...
            raise F5XCValidationError("dc_cluster_group", "metrics", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a dc_cluster_group by name.
        ...
        try:
            ...
            raise F5XCValidationError("dc_cluster_group", "get", e, response) from e
