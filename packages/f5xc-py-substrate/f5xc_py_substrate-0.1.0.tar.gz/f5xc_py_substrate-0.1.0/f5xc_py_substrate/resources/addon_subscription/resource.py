"""AddonSubscription resource API."""
...
class AddonSubscriptionResource:
    """API methods for addon_subscription.

    
Represents addon subscription 
Eywa will create the...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.addon_subscription.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new addon_subscription.
        ...
        try:
            ...
            raise F5XCValidationError("addon_subscription", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing addon_subscription.
        ...
        try:
            ...
            raise F5XCValidationError("addon_subscription", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[AddonSubscriptionListItem]:
        """List addon_subscription resources in a namespace.
        ...
        try:
            return [AddonSubscriptionListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("addon_subscription", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a addon_subscription by name.

        Get Addon Subsciption reads a given object from storage backend for...
        ...
        try:
            ...
            raise F5XCValidationError("addon_subscription", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a addon_subscription.

        Delete the specified addon_subscription
