"""Pydantic models for addon_subscription."""
...
class AddonSubscriptionListItem(F5XCBaseModel):
    """List item for addon_subscription resources."""
...
class SupportTicketId(F5XCBaseModel):
    """SupportTicketId gives the information about ticket created for managed..."""

    subscription_ticket_id: Optional[str] = None
    unsubscription_ticket_id: Optional[str] = None
...
class NotificationPreference(F5XCBaseModel):
    ...
    support_ticket_id: Optional[SupportTicketId] = None


class CreateSpecType(F5XCBaseModel):
    """Create a new Addon Subscription with Addon Subscription State"""

    addon_service: Optional[ObjectRefType] = None
    notification_preference: Optional[NotificationPreference] = None
    status: Optional[Literal['SUBSCRIPTION_PENDING', 'SUBSCRIPTION_ENABLED', 'SUBSCRIPTION_DISABLE_PENDING', 'SUBSCRIPTION_DISABLED']] = None
...
class ListResponseItem(F5XCBaseModel):
    """By default a summary of addon_subscription is returned in 'List'. By..."""
