...
class FleetResource:
    """API methods for fleet.

    
Fleet is used to configure infrastructure components (like nodes)...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.fleet.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("fleet", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("fleet", "replace", e, response) from e
    ...
    def list(
        ...
        """List fleet resources in a namespace.
        ...
        try:
            return [FleetListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("fleet", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("fleet", "get", e, response) from e
