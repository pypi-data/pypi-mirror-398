"""ShapeBotDefenseInstance resource API."""
...
from f5xc_py_substrate.resources.shape_bot_defense_instance.models import (
    ShapeBotDefenseInstanceListItem,
    ObjectRefType,
    ProtobufAny,
    ErrorType,
    InitializerType,
...
class ShapeBotDefenseInstanceResource:
    """API methods for shape_bot_defense_instance.

    Shape Bot Defense Instance is the main configuration for a Shape...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.shape_bot_defense_instance.CreateSpecType(...)
    ...
    def list(
    ...
    ) -> list[ShapeBotDefenseInstanceListItem]:
        """List shape_bot_defense_instance resources in a namespace.
        ...
        try:
            return [ShapeBotDefenseInstanceListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("shape_bot_defense_instance", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a shape_bot_defense_instance by name.
        ...
        try:
            ...
            raise F5XCValidationError("shape_bot_defense_instance", "get", e, response) from e
