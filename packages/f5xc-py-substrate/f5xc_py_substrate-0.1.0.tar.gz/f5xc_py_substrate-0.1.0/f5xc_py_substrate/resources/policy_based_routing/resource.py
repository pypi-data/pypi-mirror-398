"""PolicyBasedRouting resource API."""
...
class PolicyBasedRoutingResource:
    """API methods for policy_based_routing.

    Policy based routing is used to control how different classes of...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.policy_based_routing.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new policy_based_routing.
        ...
        try:
            ...
            raise F5XCValidationError("policy_based_routing", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing policy_based_routing.
        ...
        try:
            ...
            raise F5XCValidationError("policy_based_routing", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[PolicyBasedRoutingListItem]:
        """List policy_based_routing resources in a namespace.
        ...
        try:
            return [PolicyBasedRoutingListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("policy_based_routing", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a policy_based_routing by name.
        ...
        try:
            ...
            raise F5XCValidationError("policy_based_routing", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a policy_based_routing.

        Delete the specified policy_based_routing
