"""InfraprotectFirewallRuleGroup resource API."""
...
from f5xc_py_substrate.resources.infraprotect_firewall_rule_group.models import (
    InfraprotectFirewallRuleGroupListItem,
...
class InfraprotectFirewallRuleGroupResource:
    """API methods for infraprotect_firewall_rule_group.

    DDoS transit Firewall Rule Group
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.infraprotect_firewall_rule_group.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new infraprotect_firewall_rule_group.
        ...
        try:
            ...
            raise F5XCValidationError("infraprotect_firewall_rule_group", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing infraprotect_firewall_rule_group.
        ...
        try:
            ...
            raise F5XCValidationError("infraprotect_firewall_rule_group", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[InfraprotectFirewallRuleGroupListItem]:
        """List infraprotect_firewall_rule_group resources in a namespace.
        ...
        try:
            return [InfraprotectFirewallRuleGroupListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("infraprotect_firewall_rule_group", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a infraprotect_firewall_rule_group by name.
        ...
        try:
            ...
            raise F5XCValidationError("infraprotect_firewall_rule_group", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a infraprotect_firewall_rule_group.
