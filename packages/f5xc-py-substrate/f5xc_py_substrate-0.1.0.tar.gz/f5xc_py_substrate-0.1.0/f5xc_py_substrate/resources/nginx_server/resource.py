...
from f5xc_py_substrate.resources.nginx_server.models import (
    NginxServerListItem,
    Empty,
    ObjectRefType,
    APIDiscoverySpec,
    ...
    GetDataplaneServerResponse,
    GetDataplaneServersRequest,
    GetDataplaneServersResponse,
    ConditionType,
    StatusMetaType,
    StatusObject,
    GetResponse,
...
class NginxServerResource:
    """API methods for nginx_server.
...
NGINX One Server Object configuration
    ...
    # Usage: client.nginx_server.CreateSpecType(...)
    ...
    def list(
    ...
    ) -> list[NginxServerListItem]:
        """List nginx_server resources in a namespace.
        ...
        try:
            return [NginxServerListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("nginx_server", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("nginx_server", "get", e, response) from e

    def get_dataplane_servers(
        self,
        namespace: str,
        body: dict[str, Any] | None = None,
    ) -> GetDataplaneServersResponse:
        """Get Dataplane Servers for nginx_server.
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return GetDataplaneServersResponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("nginx_server", "get_dataplane_servers", e, response) from e
