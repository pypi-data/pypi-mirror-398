...
class ApiGroupElementResource:
    """API methods for api_group_element.

    A api_group_element object consists of an unordered list of HTTP...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.api_group_element.CreateSpecType(...)
    ...
    def list(
    ...
    ) -> list[ApiGroupElementListItem]:
        """List api_group_element resources in a namespace.
        ...
        try:
            return [ApiGroupElementListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("api_group_element", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a api_group_element by name.

        Get api_group_element reads a given object from storage backend for...
        ...
        try:
            ...
            raise F5XCValidationError("api_group_element", "get", e, response) from e
