...
class ReceiverResource:
    """API methods for receiver.

    Data Delivery is used to specify a receiver (s3 bucket, etc.) for...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.receiver.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("receiver", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("receiver", "replace", e, response) from e
    ...
    def list(
        ...
        """List receiver resources in a namespace.

        List the set of receiver in a namespace
        ...
        try:
            return [ReceiverListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("receiver", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("receiver", "get", e, response) from e
