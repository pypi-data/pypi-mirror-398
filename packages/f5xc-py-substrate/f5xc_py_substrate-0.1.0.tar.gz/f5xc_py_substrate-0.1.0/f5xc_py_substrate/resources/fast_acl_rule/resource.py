...
class FastAclRuleResource:
    """API methods for fast_acl_rule.
...
Rule consists of following:
  1. Protocol to match...
    ...
    # Usage: client.fast_acl_rule.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new fast_acl_rule.

        Create a new Fast ACL rule, `fast_acl_rule` has specification to...
        ...
        try:
            ...
            raise F5XCValidationError("fast_acl_rule", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing fast_acl_rule.

        Replace a given Fast ACL rule, `fast_acl_rule` has specification to...
        ...
        try:
            ...
            raise F5XCValidationError("fast_acl_rule", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[FastAclRuleListItem]:
        """List fast_acl_rule resources in a namespace.
        ...
        try:
            return [FastAclRuleListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("fast_acl_rule", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("fast_acl_rule", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a fast_acl_rule.

        Delete the specified fast_acl_rule
