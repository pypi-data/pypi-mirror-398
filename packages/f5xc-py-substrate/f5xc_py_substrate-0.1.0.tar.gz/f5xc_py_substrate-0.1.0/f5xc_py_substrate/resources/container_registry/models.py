"""Pydantic models for container_registry."""
...
class ContainerRegistryListItem(F5XCBaseModel):
    """List item for container_registry resources."""
...
class StatusObject(F5XCBaseModel):
    """Most recently observed status of the Container Registry"""
...
class ListResponseItem(F5XCBaseModel):
    """By default a summary of container_registry is returned in 'List'. By..."""
