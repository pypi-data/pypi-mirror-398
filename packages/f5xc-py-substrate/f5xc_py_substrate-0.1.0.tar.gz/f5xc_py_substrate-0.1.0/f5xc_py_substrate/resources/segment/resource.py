...
class SegmentResource:
    """API methods for segment.

    Network Segment.
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.segment.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("segment", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("segment", "replace", e, response) from e
    ...
    def list(
        ...
        """List segment resources in a namespace.
        ...
        try:
            return [SegmentListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("segment", "list", e, response) from e
    ...
    def segments_graph(
        ...
        """Segments Graph for segment.

        Request to get different network segments with given metrics . This...
        """
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return SegmentSegmentsResponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("segment", "segments_graph", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("segment", "get", e, response) from e
