"""NetworkPolicyView resource API."""
...
class NetworkPolicyViewResource:
    """API methods for network_policy_view.

    Network policy site view defines a required parameters that can be...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.network_policy_view.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new network_policy_view.
        ...
        try:
            ...
            raise F5XCValidationError("network_policy_view", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing network_policy_view.
        ...
        try:
            ...
            raise F5XCValidationError("network_policy_view", "replace", e, response) from e

    def network_policy_hits(
        self,
        namespace: str,
        body: dict[str, Any] | None = None,
    ) -> NetworkPolicyHitsResponse:
        """Network Policy Hits for network_policy_view.
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return NetworkPolicyHitsResponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("network_policy_view", "network_policy_hits", e, response) from e
    ...
    def list(
    ...
    ) -> list[NetworkPolicyViewListItem]:
        """List network_policy_view resources in a namespace.
        ...
        try:
            return [NetworkPolicyViewListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("network_policy_view", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a network_policy_view by name.
        ...
        try:
            ...
            raise F5XCValidationError("network_policy_view", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a network_policy_view.

        Delete the specified network_policy_view
