...
from f5xc_py_substrate.resources.cloud_credentials.models import (
    CloudCredentialsListItem,
    Empty,
    AWSAssumeRoleType,
...
class CloudCredentialsResource:
    """API methods for cloud_credentials.

    
Cloud Credentials object is used to give user cloud credentials to...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.cloud_credentials.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new cloud_credentials.
        ...
        try:
            ...
            raise F5XCValidationError("cloud_credentials", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing cloud_credentials.
        ...
        try:
            ...
            raise F5XCValidationError("cloud_credentials", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[CloudCredentialsListItem]:
        """List cloud_credentials resources in a namespace.
        ...
        try:
            return [CloudCredentialsListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("cloud_credentials", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a cloud_credentials by name.
        ...
        try:
            ...
            raise F5XCValidationError("cloud_credentials", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a cloud_credentials.

        Delete the specified cloud_credentials
