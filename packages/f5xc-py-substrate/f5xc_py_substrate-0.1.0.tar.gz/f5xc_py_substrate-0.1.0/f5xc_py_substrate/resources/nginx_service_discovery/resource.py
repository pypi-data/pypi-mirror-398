"""NginxServiceDiscovery resource API."""
...
class NginxServiceDiscoveryResource:
    """API methods for nginx_service_discovery.

    NGINX Service discovery in F5XC
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.nginx_service_discovery.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new nginx_service_discovery.

        API to create NGINX Service Discovery object for a site or virtual...
        ...
        try:
            ...
            raise F5XCValidationError("nginx_service_discovery", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing nginx_service_discovery.

        API to replace NGINX Service Discovery object for a site or virtual...
        ...
        try:
            ...
            raise F5XCValidationError("nginx_service_discovery", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[NginxServiceDiscoveryListItem]:
        """List nginx_service_discovery resources in a namespace.
        ...
        try:
            return [NginxServiceDiscoveryListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("nginx_service_discovery", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a nginx_service_discovery by name.

        API to Get NGINX Service Discovery object for a site or virtual site...
        ...
        try:
            ...
            raise F5XCValidationError("nginx_service_discovery", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a nginx_service_discovery.
