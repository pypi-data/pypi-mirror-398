"""InfraprotectTunnel resource API."""
...
class InfraprotectTunnelResource:
    """API methods for infraprotect_tunnel.

    DDoS transit tunnel information
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.infraprotect_tunnel.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new infraprotect_tunnel.
        ...
        try:
            ...
            raise F5XCValidationError("infraprotect_tunnel", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing infraprotect_tunnel.
        ...
        try:
            ...
            raise F5XCValidationError("infraprotect_tunnel", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[InfraprotectTunnelListItem]:
        """List infraprotect_tunnel resources in a namespace.
        ...
        try:
            return [InfraprotectTunnelListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("infraprotect_tunnel", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a infraprotect_tunnel by name.
        ...
        try:
            ...
            raise F5XCValidationError("infraprotect_tunnel", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a infraprotect_tunnel.

        Delete the specified infraprotect_tunnel
    ...
    def update_tunnel_status(
        ...
        """Update Tunnel Status for infraprotect_tunnel.
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return UpdateTunnelStatusResponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("infraprotect_tunnel", "update_tunnel_status", e, response) from e
