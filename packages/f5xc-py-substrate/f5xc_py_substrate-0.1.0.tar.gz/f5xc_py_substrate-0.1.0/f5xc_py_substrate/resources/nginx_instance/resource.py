...
class NginxInstanceResource:
    """API methods for nginx_instance.
...
NGINX One Instance configuration
    ...
    # Usage: client.nginx_instance.CreateSpecType(...)
    ...
    def list(
    ...
    ) -> list[NginxInstanceListItem]:
        """List nginx_instance resources in a namespace.
        ...
        try:
            return [NginxInstanceListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("nginx_instance", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("nginx_instance", "get", e, response) from e
