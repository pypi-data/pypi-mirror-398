"""UserIdentification resource API."""
...
class UserIdentificationResource:
    """API methods for user_identification.

    A user_identification object consists of an ordered list of rules....
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.user_identification.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new user_identification.

        Create user_identification creates a new object in the storage...
        ...
        try:
            ...
            raise F5XCValidationError("user_identification", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing user_identification.

        Replace user_identification replaces an existing object in the...
        ...
        try:
            ...
            raise F5XCValidationError("user_identification", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[UserIdentificationListItem]:
        """List user_identification resources in a namespace.
        ...
        try:
            return [UserIdentificationListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("user_identification", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a user_identification by name.

        Get user_identification reads a given object from storage backend...
        ...
        try:
            ...
            raise F5XCValidationError("user_identification", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a user_identification.

        Delete the specified user_identification
