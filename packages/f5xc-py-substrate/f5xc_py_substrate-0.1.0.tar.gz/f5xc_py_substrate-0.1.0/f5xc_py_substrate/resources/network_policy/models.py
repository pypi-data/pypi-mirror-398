"""Pydantic models for network_policy."""
...
class NetworkPolicyListItem(F5XCBaseModel):
    """List item for network_policy resources."""
...
class RuleAdvancedAction(F5XCBaseModel):
...
class RuleType(F5XCBaseModel):
    ...
    adv_action: Optional[RuleAdvancedAction] = None
...
class RuleChoice(F5XCBaseModel):
    """Shape of Rule Choice"""

    egress_rules: Optional[list[RuleType]] = None
    ingress_rules: Optional[list[RuleType]] = None
...
class CreateSpecType(F5XCBaseModel):
    ...
    rules: Optional[RuleChoice] = None
...
class LegacyNetworkPolicyRuleChoice(F5XCBaseModel):
    """Shape of Legacy Rule Choice"""

    egress_rules: Optional[list[ObjectRefType]] = None
    ingress_rules: Optional[list[ObjectRefType]] = None
...
class GetSpecType(F5XCBaseModel):
    ...
    endpoint: Optional[EndpointChoiceType] = None
    legacy_rules: Optional[LegacyNetworkPolicyRuleChoice] = None
    rules: Optional[RuleChoice] = None
...
class MetricLabelFilter(F5XCBaseModel):
    ...
    label: Optional[Literal['NAMESPACE', 'POLICY', 'POLICY_SET', 'POLICY_RULE', 'ACTION', 'SITE']] = None
...
class HitsRequest(F5XCBaseModel):
    ...
    group_by: Optional[list[Literal['NAMESPACE', 'POLICY', 'POLICY_SET', 'POLICY_RULE', 'ACTION', 'SITE']]] = None
