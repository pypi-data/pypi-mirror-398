"""BotDefenseAppInfrastructure resource API."""
...
from f5xc_py_substrate.resources.bot_defense_app_infrastructure.models import (
    BotDefenseAppInfrastructureListItem,
...
class BotDefenseAppInfrastructureResource:
    """API methods for bot_defense_app_infrastructure.

    Bot Defense App Infrastructure is the main configuration for a Bot...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.bot_defense_app_infrastructure.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new bot_defense_app_infrastructure.
        ...
        try:
            ...
            raise F5XCValidationError("bot_defense_app_infrastructure", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing bot_defense_app_infrastructure.
        ...
        try:
            ...
            raise F5XCValidationError("bot_defense_app_infrastructure", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[BotDefenseAppInfrastructureListItem]:
        """List bot_defense_app_infrastructure resources in a namespace.
        ...
        try:
            return [BotDefenseAppInfrastructureListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("bot_defense_app_infrastructure", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a bot_defense_app_infrastructure by name.
        ...
        try:
            ...
            raise F5XCValidationError("bot_defense_app_infrastructure", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a bot_defense_app_infrastructure.
