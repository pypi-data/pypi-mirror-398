...
class MitigatedDomainResource:
    """API methods for mitigated_domain.

    
Mitigated Domain Object defines which domains will be mitigated by...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.mitigated_domain.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("mitigated_domain", "create", e, response) from e
    ...
    def list(
    ...
    ) -> list[MitigatedDomainListItem]:
        """List mitigated_domain resources in a namespace.
        ...
        try:
            return [MitigatedDomainListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("mitigated_domain", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a mitigated_domain by name.
        ...
        try:
            ...
            raise F5XCValidationError("mitigated_domain", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a mitigated_domain.

        Delete the specified mitigated_domain
