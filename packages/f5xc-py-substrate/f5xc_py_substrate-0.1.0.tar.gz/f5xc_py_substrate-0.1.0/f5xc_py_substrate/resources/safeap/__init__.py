...
if TYPE_CHECKING:
    ...
    from f5xc_py_substrate.resources.safeap.resource import SafeapResource
...
def __getattr__(name: str):
    ...
    if name == "SafeapResource":
        from f5xc_py_substrate.resources.safeap.resource import SafeapResource
        return SafeapResource

    # Load models module once and cache it
    if _models_module is None:
        _models_module = importlib.import_module(
            "f5xc_py_substrate.resources.safeap.models"
        )
    ...
    raise AttributeError(f"module 'f5xc_py_substrate.resources.safeap' has no attribute '{name}'")
