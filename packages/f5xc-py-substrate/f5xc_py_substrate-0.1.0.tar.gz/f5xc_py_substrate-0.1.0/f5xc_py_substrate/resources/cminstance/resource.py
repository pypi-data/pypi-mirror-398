...
class CminstanceResource:
    """API methods for cminstance.

    cminsatnce object can be used to enable connectivity between ce site...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.cminstance.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("cminstance", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing cminstance.
        ...
        try:
            ...
            raise F5XCValidationError("cminstance", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[CminstanceListItem]:
        """List cminstance resources in a namespace.

        List the set of cminstance in a namespace
        ...
        try:
            return [CminstanceListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("cminstance", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("cminstance", "get", e, response) from e
    ...
    def delete(
        ...
        Delete the specified cminstance
