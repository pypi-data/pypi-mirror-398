"""BigipVirtualServer resource API."""
...
class BigipVirtualServerResource:
    """API methods for bigip_virtual_server.

    BIG-IP virtual server view repesents the internal virtual host...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.bigip_virtual_server.CreateSpecType(...)
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing bigip_virtual_server.
        ...
        try:
            ...
            raise F5XCValidationError("bigip_virtual_server", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[BigipVirtualServerListItem]:
        """List bigip_virtual_server resources in a namespace.
        ...
        try:
            return [BigipVirtualServerListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("bigip_virtual_server", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a bigip_virtual_server by name.
        ...
        try:
            ...
            raise F5XCValidationError("bigip_virtual_server", "get", e, response) from e
    ...
    def get_security_config(
        ...
        """Get Security Config for bigip_virtual_server.
        ...
        try:
            ...
            raise F5XCValidationError("bigip_virtual_server", "get_security_config", e, response) from e
