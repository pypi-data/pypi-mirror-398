"""SegmentConnection resource API."""
...
class SegmentConnectionResource:
    """API methods for segment_connection.

    Configure a Segment Connector to allow network traffic between Segments
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.segment_connection.CreateSpecType(...)
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing segment_connection.
        ...
        try:
            ...
            raise F5XCValidationError("segment_connection", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[SegmentConnectionListItem]:
        """List segment_connection resources in a namespace.
        ...
        try:
            return [SegmentConnectionListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("segment_connection", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a segment_connection by name.
        ...
        try:
            ...
            raise F5XCValidationError("segment_connection", "get", e, response) from e
