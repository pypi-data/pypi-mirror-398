...
class VirtualNetworkResource:
    """API methods for virtual_network.

    Virtual network is an isolated L3 network. A virtual network can...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.virtual_network.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("virtual_network", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing virtual_network.
        ...
        try:
            ...
            raise F5XCValidationError("virtual_network", "replace", e, response) from e
    ...
    def sid_counters(
        ...
        """Sid Counters for virtual_network.
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return SIDCounterResponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("virtual_network", "sid_counters", e, response) from e
    ...
    def list(
    ...
    ) -> list[VirtualNetworkListItem]:
        """List virtual_network resources in a namespace.
        ...
        try:
            return [VirtualNetworkListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("virtual_network", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("virtual_network", "get", e, response) from e
