"""BotAllowlistPolicy resource API."""
...
from f5xc_py_substrate.resources.bot_allowlist_policy.models import (
    BotAllowlistPolicyListItem,
    IPDetail,
    IPPrefixDetail,
    IPAllowlistDetail,
    IPRangeAllowlistDetail,
    IPAllowlists,
    ReplaceSpecType,
...
class BotAllowlistPolicyResource:
    """API methods for bot_allowlist_policy.

    Configures Bot allowlist Policy
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.bot_allowlist_policy.CreateSpecType(...)
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing bot_allowlist_policy.
        ...
        try:
            ...
            raise F5XCValidationError("bot_allowlist_policy", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[BotAllowlistPolicyListItem]:
        """List bot_allowlist_policy resources in a namespace.
        ...
        try:
            return [BotAllowlistPolicyListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("bot_allowlist_policy", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a bot_allowlist_policy by name.
        ...
        try:
            ...
            raise F5XCValidationError("bot_allowlist_policy", "get", e, response) from e

    def get_allowlist_policies_and_versions_list(
        self,
        namespace: str,
    ) -> GetPoliciesAndVersionsListResponse:
        """Get Allowlist Policies And Versions List for bot_allowlist_policy.
        ...
        try:
            ...
            raise F5XCValidationError("bot_allowlist_policy", "get_allowlist_policies_and_versions_list", e, response) from e
    ...
    def custom_replace(
        ...
        """Custom Replace for bot_allowlist_policy.
        ...
        try:
            ...
            raise F5XCValidationError("bot_allowlist_policy", "custom_replace", e, response) from e

    def get_allowlist_policy_versions(
        self,
        namespace: str,
        name: str,
    ) -> PolicyVersionsResponse:
        """Get Allowlist Policy Versions for bot_allowlist_policy.
        ...
        try:
            ...
            raise F5XCValidationError("bot_allowlist_policy", "get_allowlist_policy_versions", e, response) from e
    ...
    def get_content(
        ...
        """Get Content for bot_allowlist_policy.
        ...
        try:
            ...
            raise F5XCValidationError("bot_allowlist_policy", "get_content", e, response) from e
