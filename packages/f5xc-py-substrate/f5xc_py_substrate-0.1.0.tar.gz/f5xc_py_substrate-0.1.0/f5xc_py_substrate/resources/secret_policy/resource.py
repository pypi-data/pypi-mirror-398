...
class SecretPolicyResource:
    """API methods for secret_policy.
...
A secret_policy...
    ...
    # Usage: client.secret_policy.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("secret_policy", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing secret_policy.

        Replace secret_policy replaces an existing object in the storage...
        ...
        try:
            ...
            raise F5XCValidationError("secret_policy", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[SecretPolicyListItem]:
        """List secret_policy resources in a namespace.
        ...
        try:
            return [SecretPolicyListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("secret_policy", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("secret_policy", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a secret_policy.

        Delete the specified secret_policy
    ...
    def list_policy(
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return ListPolicyResponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("secret_policy", "list_policy", e, response) from e
    ...
    def recover_policy(
        ...
        """Recover Policy for secret_policy.
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return RecoverResponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("secret_policy", "recover_policy", e, response) from e
    ...
    def delete_policy(
        ...
        """Delete Policy for secret_policy.
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return SoftDeleteResponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("secret_policy", "delete_policy", e, response) from e
