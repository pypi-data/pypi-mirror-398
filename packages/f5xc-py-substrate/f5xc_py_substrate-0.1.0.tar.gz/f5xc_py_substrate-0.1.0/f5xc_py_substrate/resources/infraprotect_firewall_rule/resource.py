"""InfraprotectFirewallRule resource API."""
...
from f5xc_py_substrate.resources.infraprotect_firewall_rule.models import (
    InfraprotectFirewallRuleListItem,
...
class InfraprotectFirewallRuleResource:
    """API methods for infraprotect_firewall_rule.

    DDoS transit Firewall Rule
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.infraprotect_firewall_rule.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new infraprotect_firewall_rule.
        ...
        try:
            ...
            raise F5XCValidationError("infraprotect_firewall_rule", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing infraprotect_firewall_rule.
        ...
        try:
            ...
            raise F5XCValidationError("infraprotect_firewall_rule", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[InfraprotectFirewallRuleListItem]:
        """List infraprotect_firewall_rule resources in a namespace.
        ...
        try:
            return [InfraprotectFirewallRuleListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("infraprotect_firewall_rule", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a infraprotect_firewall_rule by name.
        ...
        try:
            ...
            raise F5XCValidationError("infraprotect_firewall_rule", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a infraprotect_firewall_rule.
