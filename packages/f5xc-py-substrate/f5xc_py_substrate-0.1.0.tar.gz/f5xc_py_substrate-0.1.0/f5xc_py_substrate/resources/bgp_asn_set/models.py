"""Pydantic models for bgp_asn_set."""
...
class BgpAsnSetListItem(F5XCBaseModel):
    """List item for bgp_asn_set resources."""
...
class ReplaceSpecType(F5XCBaseModel):
    """Replace bgp_asn_set replaces an existing object in the storage backend..."""
...
class ListResponseItem(F5XCBaseModel):
    """By default a summary of bgp_asn_set is returned in 'List'. By setting..."""
