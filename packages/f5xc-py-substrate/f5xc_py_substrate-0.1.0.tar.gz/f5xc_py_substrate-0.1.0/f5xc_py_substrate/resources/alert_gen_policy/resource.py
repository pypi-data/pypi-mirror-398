...
from f5xc_py_substrate.resources.alert_gen_policy.models import (
    AlertGenPolicyListItem,
...
class AlertGenPolicyResource:
    """API methods for alert_gen_policy.
...
BRM Alerts Alert Generation Policy
    ...
    # Usage: client.alert_gen_policy.CreateSpecType(...)
    ...
    def create(
        ...
        namespace: str,
        name: str,
        spec: ChangeAlertStatusRequest | None = None,
        *,
        ...
        """Create a new alert_gen_policy.

        Create Alert Generation Policy
        ...
        try:
            ...
            raise F5XCValidationError("alert_gen_policy", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing alert_gen_policy.
        ...
        try:
            ...
            raise F5XCValidationError("alert_gen_policy", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[AlertGenPolicyListItem]:
        """List alert_gen_policy resources in a namespace.
        ...
        try:
            return [AlertGenPolicyListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("alert_gen_policy", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a alert_gen_policy by name.

        Get Alert Generation Policy
        ...
        try:
            ...
            raise F5XCValidationError("alert_gen_policy", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a alert_gen_policy.

        Delete the specified alert_gen_policy
    ...
    def change_status(
        ...
        """Change Status for alert_gen_policy.
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return ChangeAlertStatusResponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("alert_gen_policy", "change_status", e, response) from e
