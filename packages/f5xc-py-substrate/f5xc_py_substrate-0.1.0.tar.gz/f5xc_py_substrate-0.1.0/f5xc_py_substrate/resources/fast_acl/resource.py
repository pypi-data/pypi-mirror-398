...
class FastAclResource:
    """API methods for fast_acl.

    Fast ACL provides destination and specifies rules to protect the...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.fast_acl.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new fast_acl.

        Create a `fast_acl` object, `fast_acl` object contains rules to...
        ...
        try:
            ...
            raise F5XCValidationError("fast_acl", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing fast_acl.

        Replace a `fast_acl` object, `fast_acl` object contains rules to...
        ...
        try:
            ...
            raise F5XCValidationError("fast_acl", "replace", e, response) from e
    ...
    def fast_acl_hits(
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return FastACLHitsResponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("fast_acl", "fast_acl_hits", e, response) from e
    ...
    def list(
    ...
    ) -> list[FastAclListItem]:
        """List fast_acl resources in a namespace.

        List the set of fast_acl in a namespace
        ...
        try:
            return [FastAclListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("fast_acl", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("fast_acl", "get", e, response) from e
