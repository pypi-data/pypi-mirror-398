"""TicketTrackingSystem resource API."""
...
class TicketTrackingSystemResource:
    """API methods for ticket_tracking_system.

    Public Custom APIs for Ticket Tracking System related operations
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.ticket_tracking_system.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new ticket_tracking_system.
        ...
        try:
            ...
            raise F5XCValidationError("ticket_tracking_system", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing ticket_tracking_system.
        ...
        try:
            ...
            raise F5XCValidationError("ticket_tracking_system", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[TicketTrackingSystemListItem]:
        """List ticket_tracking_system resources in a namespace.
        ...
        try:
            return [TicketTrackingSystemListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("ticket_tracking_system", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a ticket_tracking_system by name.
        ...
        try:
            ...
            raise F5XCValidationError("ticket_tracking_system", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a ticket_tracking_system.

        Delete the specified ticket_tracking_system
    ...
    def jira_projects_issue_types(
        self,
        body: dict[str, Any] | None = None,
    ) -> JiraProjectsIssueTypesResponse:
        """Jira Projects Issue Types for ticket_tracking_system.

        Returns the available projects and issue types that are available...
        """
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return JiraProjectsIssueTypesResponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("ticket_tracking_system", "jira_projects_issue_types", e, response) from e

    def validate_ticket_tracking_system(
        self,
        body: dict[str, Any] | None = None,
    ) -> ValidateTicketTrackingSystemResponse:
        """Validate Ticket Tracking System for ticket_tracking_system.

        Validate input for the ticket tracking system like the credentials +...
        """
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return ValidateTicketTrackingSystemResponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("ticket_tracking_system", "validate_ticket_tracking_system", e, response) from e
