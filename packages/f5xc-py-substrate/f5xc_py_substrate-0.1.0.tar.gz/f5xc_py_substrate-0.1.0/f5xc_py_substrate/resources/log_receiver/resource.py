...
class LogReceiverResource:
    """API methods for log_receiver.

    Log Receiver is used to specify a receiver (syslog, splunk, datadog...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.log_receiver.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("log_receiver", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing log_receiver.
        ...
        try:
            ...
            raise F5XCValidationError("log_receiver", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[LogReceiverListItem]:
        """List log_receiver resources in a namespace.

        List the set of log_receiver in a namespace
        ...
        try:
            return [LogReceiverListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("log_receiver", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        try:
            ...
            raise F5XCValidationError("log_receiver", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a log_receiver.

        Delete the specified log_receiver
    ...
    def test_log_receiver(
        self,
        namespace: str,
        name: str,
        body: dict[str, Any] | None = None,
    ) -> TestLogReceiverResponse:
        """Test Log Receiver for log_receiver.
        ...
        try:
            ...
            raise type(e)(e.status_code, e.message, e.body) from None
        try:
            return TestLogReceiverResponse(**response)
        except ValidationError as e:
            raise F5XCValidationError("log_receiver", "test_log_receiver", e, response) from e
