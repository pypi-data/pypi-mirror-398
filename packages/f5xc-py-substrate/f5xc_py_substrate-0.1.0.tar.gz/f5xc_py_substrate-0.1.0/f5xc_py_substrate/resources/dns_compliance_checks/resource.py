"""DnsComplianceChecks resource API."""
...
class DnsComplianceChecksResource:
    """API methods for dns_compliance_checks.

    DNS Compliance Checks view defines the required parameters that can...
    """

    # Expose commonly-used models as class attributes for convenient access
    # Usage: client.dns_compliance_checks.CreateSpecType(...)
    ...
    def create(
        ...
        *,
        ...
        """Create a new dns_compliance_checks.

        Create DNS Compliance Checks Specification in a given namespace. If...
        ...
        try:
            ...
            raise F5XCValidationError("dns_compliance_checks", "create", e, response) from e
    ...
    def replace(
        ...
        *,
        ...
        """Replace an existing dns_compliance_checks.
        ...
        try:
            ...
            raise F5XCValidationError("dns_compliance_checks", "replace", e, response) from e
    ...
    def list(
    ...
    ) -> list[DnsComplianceChecksListItem]:
        """List dns_compliance_checks resources in a namespace.
        ...
        try:
            return [DnsComplianceChecksListItem(**item) for item in items]
        except ValidationError as e:
            raise F5XCValidationError("dns_compliance_checks", "list", e, response) from e
    ...
    def get(
        ...
        *,
        ...
        """Get a dns_compliance_checks by name.
        ...
        try:
            ...
            raise F5XCValidationError("dns_compliance_checks", "get", e, response) from e
    ...
    def delete(
        ...
        """Delete a dns_compliance_checks.

        Delete the specified dns_compliance_checks
