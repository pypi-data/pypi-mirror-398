...
from pype.__config__ import PYPE_CONDA, PYPE_DOCKER, PYPE_SINGULARITY_CACHE, PYPE_TMP
...
class Command:
    ...
    def run(self, local_script: bool = False, capture_stderr: bool = False) -> None:
        ...
        try:
            if hasattr(self, "namespace") and self.namespace.type == "docker":
                ...
                self.conda_run(capture_stderr=capture_stderr)
            else:
    ...
    def conda_run(self, capture_stderr: bool = False) -> None:
