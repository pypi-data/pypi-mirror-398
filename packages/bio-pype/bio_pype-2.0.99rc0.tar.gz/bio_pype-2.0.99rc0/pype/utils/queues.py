...
def snippet_module_description(snippet_module: Any) -> str:
    """description from a snippet module.

    Args:
        snippet_module: A snippet module

    Returns:
        Description string or empty string
    """
    snippet_name = snippet_module.module_name
...
def get_snippet_description(command: str, snippet_modules: Any) -> str:
    ...
    return snippet_module_description(snippet_module)
