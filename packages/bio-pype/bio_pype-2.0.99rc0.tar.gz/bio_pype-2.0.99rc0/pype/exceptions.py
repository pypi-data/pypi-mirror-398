...
class InvalidTemplateVariableMixError(ArgumentError):
    """Raised when template variables are mixed with static text in pipeline arguments."""

    def __init__(self, message: str, argument_key: Optional[str] = None, **kwargs):
        context = {"argument_key": argument_key, **kwargs}
        super().__init__(message, argument_key, **context)
