...
class ValidationResult:
    ...
    Attributes:
        ...
        available_snippets: Dict mapping snippets names to their descriptions (for pipelines)
    ...
    available_snippets: Dict[str, str] = field(default_factory=dict)
    profile_files: Dict[str, str] = field(default_factory=dict)
    profile_programs: Dict[str, str] = field(default_factory=dict)
    parsed_pipeline_arguments: Dict[str, str] = field(default_factory=dict)
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "available_snippets": self.available_snippets,
        }
