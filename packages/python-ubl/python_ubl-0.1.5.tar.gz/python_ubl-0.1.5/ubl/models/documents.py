...
class BaseDocument(BaseElement, AutoCastDataclassMixin):
    ...
    Attributes:
        ...
        notes: List of textual notes for the document
    ...
    buyer_reference: BuyerReference | None = None  # Required in PEPPOL mode (auto-created in __post_init__)
    ...
    # Order matters! Must match UBL 2.1 XSD sequence
    _base_class_name_to_attr: ClassVar[dict[str, str]] = {
        ...
        'BuyerReference': 'buyer_reference',  # Must come after LineCountNumeric per UBL 2.1 XSD
    ...
    def __post_init__(self):
        ...
        # PEPPOL mode: Ensure buyer_reference is present (BR-16)
        if is_peppol_mode() and self.buyer_reference is None:
            self.buyer_reference = BuyerReference()  # Defaults to 'N/A'
