/**
 * Cloudflare Pages Function for /api/quality/scores/[tableName]/columns endpoint
 * Handles GET /api/quality/scores/{table_name}/columns - Get column quality scores
 */
...
export async function onRequestGet(context: any): Promise<Response> {
  try {
    ...
    // Extract table name from URL path: /api/quality/scores/{tableName}/columns
    ...
    const scores = service.getColumnQualityScores(tableName, schema, days);
    ...
    console.error('Error in /api/quality/scores/[tableName]/columns:', error);
