...
class MediaQueryList(aspose.svg.dom.EventTarget):
    ...
    def add_event_listener(self, type : str, listener : aspose.svg.dom.events.IEventListener):
        ...
        It works by adding a function, or an object that implements :py:class:`aspose.svg.dom.events.IEventListener`,
        to the list of event listeners for the specified event type on the :py:class:`aspose.svg.dom.EventTarget` on which it's called.
    ...
    def dispatch_event(self, event : aspose.svg.dom.events.Event) -> bool:
        '''Dispatches an Event at the specified :py:class:`aspose.svg.dom.events.IEventTarget`, (synchronously) invoking
        the affected EventListeners in the appropriate order.
        The normal event processing rules (including the capturing and optional bubbling phase) also apply to events
        dispatched manually with :py:func:`aspose.svg.dom.events.IEventTarget.dispatch_event`.
