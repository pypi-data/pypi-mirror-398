...
class FileProtocolMessageHandler(aspose.svg.net.MessageHandler):
...
class FtpProtocolMessageHandler(aspose.svg.net.MessageHandler):
...
class HttpProtocolMessageHandler(aspose.svg.net.MessageHandler):
