...
from onnx_ocr.db_postprocess import DBPostProcess
from onnx_ocr.imaug import create_operators, transform
from onnx_ocr.predict_base import PredictBase
...
class TextDetector(PredictBase):
    def __init__(self, args):
        ...
        # 初始化模型
        self.det_onnx_session = self.get_onnx_session(
            args.det_model_dir, args.use_gpu, gpu_id=args.gpu_id
        )
