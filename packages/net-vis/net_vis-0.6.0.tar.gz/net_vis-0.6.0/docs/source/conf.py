...
# -*- coding: utf-8 -*-
#
# net_vis documentation build configuration file
#
...
_version_py = os.path.join(repo, 'net_vis', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'net_vis.tex', 'net_vis Documentation',
     'Manabu TERADA', 'manual'),
]
