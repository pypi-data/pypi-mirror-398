...
class FunctionABIBuilder:
    ...
    def add_bytes32(self, arg_name: str) -> FunctionABIBuilder:
        self.abi.inputs.append({"name": arg_name, "type": "bytes32"})
        return self
...
class _ABIBuilder:
    ...
    def _v4_pool_key_struct_builder() -> FunctionABIBuilder:
        ...
        builder.add_address("currency_0").add_address("currency_1").add_address(
            "hooks"
        ).add_address("pool_manager").add_uint24("fee").add_bytes32("parameters")
        return builder
