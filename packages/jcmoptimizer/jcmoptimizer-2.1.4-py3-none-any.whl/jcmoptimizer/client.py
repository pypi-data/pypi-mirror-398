...
class Client:
    ...
    Args:
      ...
      token: API access token. This is required for cloud servers.
          ...
          `JCMoptimizer Cloud <https://optimizer.jcmwave.com/dashboard/tokens/list>`_
    ...
    def __init__(
        ...
        verbose: bool = True,
        check: bool = True,
        cloud_endpoint: str = "https://optimizer.jcmwave.com/dashboard/api/",
    ) -> None:
    ...
    def create_study(
        ...
        **kwargs: Any,
        ...
        Args:
          ...
          clear_storage: If true, any stored data (study configuration, observations etc.)
            from previous runs of the study is cleared before creating the study.
        """
        ...
        if answer["dashboard_path"]:
            inform(
                f"The dashboard is accessible via {self.requestor.endpoint}{answer['dashboard_path']}"
            )
