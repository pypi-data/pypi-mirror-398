"""
PROOFNEST P2P Node Network (EXPERIMENTAL)
==========================================

WARNING: This module is EXPERIMENTAL and not part of the stable API.
It uses unencrypted TCP connections and should NOT be used in production
until TLS/Noise transport encryption is implemented.
...
Security Status:
- Transport: UNENCRYPTED (TLS/Noise pending)
- Authentication: HMAC-based (upgrade to mutual TLS pending)
- Production Ready: NO
