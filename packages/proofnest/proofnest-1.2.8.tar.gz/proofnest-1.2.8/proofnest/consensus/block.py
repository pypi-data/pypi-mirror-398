"""
ProofNest - Block Structure (EXPERIMENTAL)

WARNING: This module is experimental and not part of the stable API.

Minimal block structure for PoS + BFT consensus:
- Header: version, height, timestamp, prev_hash
- State: state_root, tx_root, receipt_root
- Consensus: proposer, proposer_signature, commit_signatures
- Randomness: vrf_output, vrf_proof
"""
