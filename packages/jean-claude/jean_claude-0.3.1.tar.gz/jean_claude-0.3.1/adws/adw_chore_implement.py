...
# ]
# ///
# ABOUTME: Compound workflow script that runs /chore planning followed by /implement execution.
# ABOUTME: Provides two-phase development workflow with comprehensive progress tracking and reporting.
