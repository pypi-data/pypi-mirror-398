...
# ]
# ///
# ABOUTME: Execute Claude Code slash commands programmatically from command line.
# ABOUTME: Provides rich output formatting and comprehensive logging for slash command execution.
