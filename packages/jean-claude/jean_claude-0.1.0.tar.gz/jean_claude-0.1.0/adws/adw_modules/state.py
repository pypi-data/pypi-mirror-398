"""ABOUTME: State management for ADW composable architecture.
ABOUTME: Provides persistent file storage and transient stdin/stdout state passing between scripts."""
