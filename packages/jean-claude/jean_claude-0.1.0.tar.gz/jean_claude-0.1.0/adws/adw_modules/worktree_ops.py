"""ABOUTME: Git worktree management for isolated ADW workflow execution in trees/<adw_id>/.
ABOUTME: Provides port allocation and worktree lifecycle management for parallel workflow instances."""
...
def create_worktree(adw_id: str, branch_name: str, logger: logging.Logger, base_dir: Optional[str] = None) -> Tuple[str, Optional[str]]:
    ...
    Args:
        ...
        base_dir: Base directory for the project (default: auto-detect)
...
def get_worktree_path(adw_id: str, base_dir: Optional[str] = None) -> str:
...
def remove_worktree(adw_id: str, logger: logging.Logger, base_dir: Optional[str] = None) -> Tuple[bool, Optional[str]]:
    ...
    """
    worktree_path = get_worktree_path(adw_id, base_dir)
