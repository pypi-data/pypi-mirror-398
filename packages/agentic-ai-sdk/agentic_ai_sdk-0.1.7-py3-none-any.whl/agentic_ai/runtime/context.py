...
# Fallback for threads/tasks that do not inherit ContextVars.
_runtime_context_fallback: RuntimeContext | None = None
...
def set_runtime_context(ctx: RuntimeContext) -> Token[RuntimeContext | None]:
    ...
    """
    global _runtime_context_fallback
    _runtime_context_fallback = ctx
...
def try_get_runtime_context() -> RuntimeContext | None:
    ...
    if ctx is not None:
        return ctx
    return _runtime_context_fallback
