...
def test_us_format_date_only():
    ...
    assert dt.hour == 0 or dt.hour is None or hasattr(dt, 'time')  # May be date or datetime
...
def test_datetime_multiple_formats():
    ...
    result = parse("{dt1:ti} {dt2:te}", "2023-12-25T10:30:00 Mon, 25 Dec 2023 10:30:00 +0000")
    assert result is not None
