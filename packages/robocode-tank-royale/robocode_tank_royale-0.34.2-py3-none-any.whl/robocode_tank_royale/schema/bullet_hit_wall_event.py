...
class BulletHitWallEvent(Event):
    """Event occurring when a bullet has hit a wall. Inherits the required 1-based turnNumber from event.schema.yaml. The bullet is a snapshot at the moment of impact."""
