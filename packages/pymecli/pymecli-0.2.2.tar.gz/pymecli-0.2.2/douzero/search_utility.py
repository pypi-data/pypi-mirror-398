                ...
                if len(move_selector.filter_type_n(mtype, other_moves, move)) == 0:
                    if rival_move is not None:
                        ...
                        if mtype != 5:
                            if (
                                "rank" in move_info
                                and "rank" in rival_move_info
                                and move_info["rank"] <= rival_move_info["rank"]
                            ):
                                continue
                            if (
                                "len" in move_info
                                and move_info["len"] != rival_move_info["len"]
                            ):
                                continue
                    ...
                    actions = search_actions(
                        new_cards, other_cards, path_list, prev_moves=new_prev
                    )
                    del new_prev
                    del new_cards
