...
class SnapshotStateUpdatedPostRequestData(BaseModel):
    ...
    old_state: Optional[StrictStr] = Field(default=None, serialization_alias="oldState")
    new_state: Optional[StrictStr] = Field(default=None, serialization_alias="newState")
