...
# Load contributed indicators and studies (must be at end to avoid circular imports)
from . import indicators as _  # noqa: ensure indicators module is loaded
from . import studies as _  # noqa: ensure studies module is loaded
