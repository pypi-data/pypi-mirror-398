...
class RunCoordinatorClient:
    ...
    def submit_graph_patch(self, request: RunCoordinatorSubmitGraphPatchRequest) -> GraphPatchSubmitResponse:
        resp = submit_graph_patch.sync_detailed(client=self._client, body=request.body)
        return _unwrap(resp)
