"""
File system tools for copying directories into other directories.
"""
...
def copy_dir_into(
    ...
    """
    Copy a directory and all its contents into another directory.

    The source directory will be copied inside the destination directory.
    ...
    try:
        ...
        # Copy source directory inside destination directory
        ...
        return {
            ...
            "source_path": source_path,
            "destination_path": None,
            "error": f"Error copying directory: {str(e)}",
        }
