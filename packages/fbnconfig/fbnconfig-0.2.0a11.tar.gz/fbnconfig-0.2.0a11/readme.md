...
`fbnconfig` is a configuration management tool designed to help deploy and manage configurations for
various resources within the LUSID ecosystem. It ensures that an environment aligns with the desired
configuration by managing resources, tracking state changes, and handling dependencies effectively.
