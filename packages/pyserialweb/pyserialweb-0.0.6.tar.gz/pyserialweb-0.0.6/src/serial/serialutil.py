...
def to_bytes(seq) -> bytes:
    ...
    if isinstance(seq, bytes):
        ...
        return seq.tobytes()  # type: ignore
...
class Timeout(object):
    ...
    def time_left(self) -> float | None:
        ...
        if self.is_non_blocking:
            return 0
        elif self.is_infinite or not self.target_time or not self.duration:
            return None
        else:
...
class SerialBase(io.RawIOBase):
    ...
    def open(self):
        raise NotImplementedError("SerialBase#open not implemented")

    def _reconfigure_port(self):
        raise NotImplementedError(
            "SerialBase#_reconfigure_port not implemented"
        )

    def _update_rts_state(self):
        raise NotImplementedError(
            "SerialBase#_update_rts_state not implemented"
        )

    def _update_dtr_state(self):
        raise NotImplementedError(
            "SerialBase#_update_dtr_state not implemented"
        )

    def _update_break_state(self):
        raise NotImplementedError(
            "SerialBase#_update_break_state not implemented"
        )

    def reset_input_buffer(self):
        raise NotImplementedError(
            "SerialBase#reset_input_buffer not implemented"
        )

    def reset_output_buffer(self):
        raise NotImplementedError(
            "SerialBase#reset_output_buffer not implemented"
        )
    ...
    def timeout(self, timeout):
        ...
        if timeout is not None:
            try:
                timeout + 1  # type: ignore # test if it's a number, will throw a TypeError if not...
            except TypeError:
    ...
    def inter_byte_timeout(self, ic_timeout):
        ...
        if ic_timeout is not None:
            ...
            try:
                ic_timeout + 1  # type: ignore # test if it's a number, will throw a TypeError if not...
            except TypeError:
                raise ValueError(
                    "Not a valid timeout: {!r}".format(ic_timeout)
                )
