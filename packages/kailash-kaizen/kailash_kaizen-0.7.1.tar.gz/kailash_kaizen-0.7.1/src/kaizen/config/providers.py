...
def auto_detect_provider(preferred: Optional[ProviderType] = None) -> ProviderConfig:
    ...
    detection_order = ["openai", "azure", "anthropic", "ollama", "docker"]
    ...
    raise ConfigurationError(
        ...
        "  4. Start Ollama (https://ollama.ai)\n"
        "  5. Enable Docker Model Runner (docker desktop enable model-runner --tcp 12434)"
    )
