...
from py4swiss.engines.dubov.criteria.color import E1, E2, E3, E4, E5
from py4swiss.engines.dubov.criteria.quality import C5, C6, C7, C8, C9, C10

ABSOLUTE_CRITERIA = (C1, C2, C3)
COLOR_CRITERIA = (E1, E2, E3, E4, E5)
QUALITY_CRITERIA = (C5, C6, C7, C8, C9, C10)
