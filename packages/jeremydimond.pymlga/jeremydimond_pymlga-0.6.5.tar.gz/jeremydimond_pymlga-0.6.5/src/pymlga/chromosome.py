...
def _get_target_length(
    ...
    target_length = initial_length + lengthening - shortening
    assert min_length <= target_length <= max_length, (f'invalid target_length={target_length}'
                                                       f', min_length={min_length}'
                                                       f', max_length={max_length}'
                                                       f', shortening_rate={shortening_rate}'
                                                       f', lengthening_rate={lengthening_rate}'
                                                       f', throttling_factor={throttling_factor}')
