...
class ModelVersion:
    ...
    Attributes:
        ...
        deployed (Union[Unset, bool]): True if any Deployments have an associated DeploymentModelConfig that associates
            with this model.
        error_summary (Union[None, Unset, str]): Contains a human readable error summary if status is Error. See
            model.upload_log() for more.
        id (Union[Unset, int]):
    ...
    error_summary: Union[None, Unset, str] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        error_summary: Union[None, Unset, str]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_error_summary(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
