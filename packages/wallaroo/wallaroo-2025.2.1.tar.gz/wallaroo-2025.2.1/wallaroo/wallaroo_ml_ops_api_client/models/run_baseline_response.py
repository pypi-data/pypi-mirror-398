...
T = TypeVar("T", bound="RunBaselineResponse")


@_attrs_define
class RunBaselineResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        run_baseline_response.additional_properties = additional_properties
        return run_baseline_response
