...
from ..models.assays_get_assay_by_id_response_200_baseline_type_1_static_aggregation import (
    AssaysGetAssayByIdResponse200BaselineType1StaticAggregation,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="AssaysGetAssayByIdResponse200BaselineType1Static")


@_attrs_define
class AssaysGetAssayByIdResponse200BaselineType1Static:
    ...
    Attributes:
        ...
        aggregation (AssaysGetAssayByIdResponse200BaselineType1StaticAggregation):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assays_get_assay_by_id_response_200_baseline_type_1_static = cls(
            count=count,
            min_=min_,
            max_=max_,
            mean=mean,
        ...
        assays_get_assay_by_id_response_200_baseline_type_1_static.additional_properties = d
        return assays_get_assay_by_id_response_200_baseline_type_1_static
