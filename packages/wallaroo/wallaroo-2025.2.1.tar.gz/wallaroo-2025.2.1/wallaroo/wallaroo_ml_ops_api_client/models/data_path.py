...
class DataPath:
    ...
    Attributes:
        ...
        indexes (Union[None, Unset, list[int]]): The indexes of the field to monitor, if a list.
    ...
    field: str
    indexes: Union[None, Unset, list[int]] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        indexes: Union[None, Unset, list[int]]
        ...
        thresholds: Union[None, Unset, dict[str, Any]]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_indexes(data: object) -> Union[None, Unset, list[int]]:
            if data is None:
                return data
