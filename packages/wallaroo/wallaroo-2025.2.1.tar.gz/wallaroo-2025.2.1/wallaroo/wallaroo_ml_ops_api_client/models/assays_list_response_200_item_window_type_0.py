...
T = TypeVar("T", bound="AssaysListResponse200ItemWindowType0")


@_attrs_define
class AssaysListResponse200ItemWindowType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assays_list_response_200_item_window_type_0 = cls(
            path=path,
            pipeline_name=pipeline_name,
            width=width,
            workspace_id=workspace_id,
        ...
        assays_list_response_200_item_window_type_0.additional_properties = d
        return assays_list_response_200_item_window_type_0
