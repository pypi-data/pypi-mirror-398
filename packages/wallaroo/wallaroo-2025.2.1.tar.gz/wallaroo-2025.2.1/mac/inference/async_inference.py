"""This module features the AsyncInference interface, that can be used
as a blueprint to create concrete subclasses for performing asynchronous
...
class AsyncInference(ABC):
    """This class specifies the interface for creating concrete async inference classes,
    that can be used to calculate asynchronous inference on a model.
    ...
    def __init__(self) -> None:
        """Initializes the AsyncInference class."""
    ...
    async def predict(self, input_data: InferenceData) -> InferenceData:
        """Calculates the asynchronous inference on the given input data.
    ...
    @abstractmethod
    async def _predict(self, input_data: InferenceData) -> InferenceData:
        """Calculates the asynchronous inference on the given input data.
