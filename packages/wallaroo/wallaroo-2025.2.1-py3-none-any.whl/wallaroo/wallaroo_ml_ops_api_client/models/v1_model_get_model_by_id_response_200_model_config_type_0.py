...
if TYPE_CHECKING:
    from ..models.v1_model_get_model_by_id_response_200_model_config_type_0_tensor_fields_type_0 import (
        V1ModelGetModelByIdResponse200ModelConfigType0TensorFieldsType0,
    )


T = TypeVar("T", bound="V1ModelGetModelByIdResponse200ModelConfigType0")


@_attrs_define
class V1ModelGetModelByIdResponse200ModelConfigType0:
    ...
    Attributes:
        ...
        tensor_fields (Union['V1ModelGetModelByIdResponse200ModelConfigType0TensorFieldsType0', None, Unset]):  Optional
    ...
    runtime: str
    tensor_fields: Union[
        "V1ModelGetModelByIdResponse200ModelConfigType0TensorFieldsType0", None, Unset
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_tensor_fields(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                tensor_fields_type_0 = V1ModelGetModelByIdResponse200ModelConfigType0TensorFieldsType0.from_dict(
                    data
                )
        ...
        v1_model_get_model_by_id_response_200_model_config_type_0 = cls(
            id=id,
            runtime=runtime,
        ...
        v1_model_get_model_by_id_response_200_model_config_type_0.additional_properties = d
        return v1_model_get_model_by_id_response_200_model_config_type_0
