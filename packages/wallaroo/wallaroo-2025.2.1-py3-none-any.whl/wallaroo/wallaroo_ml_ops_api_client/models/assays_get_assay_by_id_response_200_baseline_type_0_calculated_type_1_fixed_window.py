...
T = TypeVar(
    "T", bound="AssaysGetAssayByIdResponse200BaselineType0CalculatedType1FixedWindow"
)


@_attrs_define
class AssaysGetAssayByIdResponse200BaselineType0CalculatedType1FixedWindow:
    """Assay window.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assays_get_assay_by_id_response_200_baseline_type_0_calculated_type_1_fixed_window = cls(
            path=path,
            pipeline_name=pipeline_name,
            width=width,
            workspace_id=workspace_id,
        ...
        assays_get_assay_by_id_response_200_baseline_type_0_calculated_type_1_fixed_window.additional_properties = d
        return assays_get_assay_by_id_response_200_baseline_type_0_calculated_type_1_fixed_window
