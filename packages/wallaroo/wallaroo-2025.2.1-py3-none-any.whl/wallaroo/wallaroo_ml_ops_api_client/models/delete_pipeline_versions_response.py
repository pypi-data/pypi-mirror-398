...
T = TypeVar("T", bound="DeletePipelineVersionsResponse")


@_attrs_define
class DeletePipelineVersionsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_pipeline_versions_response = cls(
            pipeline_versions=pipeline_versions,
        )

        delete_pipeline_versions_response.additional_properties = d
        return delete_pipeline_versions_response
