...
T = TypeVar("T", bound="AssaysCreateBodyWindow")


@_attrs_define
class AssaysCreateBodyWindow:
    """Assay window.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assays_create_body_window.additional_properties = d
        return assays_create_body_window
