...
T = TypeVar("T", bound="AssaysSummarizeBodyBaselineType2SlidingWindowWindow")


@_attrs_define
class AssaysSummarizeBodyBaselineType2SlidingWindowWindow:
    """Assay window.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assays_summarize_body_baseline_type_2_sliding_window_window = cls(
            path=path,
            pipeline_name=pipeline_name,
            width=width,
            workspace_id=workspace_id,
        ...
        assays_summarize_body_baseline_type_2_sliding_window_window.additional_properties = d
        return assays_summarize_body_baseline_type_2_sliding_window_window
