...
T = TypeVar("T", bound="ContinuousBatchingConfig")
...
class ContinuousBatchingConfig:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        continuous_batching_config = cls(
            max_concurrent_batch_size=max_concurrent_batch_size,
        )

        continuous_batching_config.additional_properties = d
        return continuous_batching_config
