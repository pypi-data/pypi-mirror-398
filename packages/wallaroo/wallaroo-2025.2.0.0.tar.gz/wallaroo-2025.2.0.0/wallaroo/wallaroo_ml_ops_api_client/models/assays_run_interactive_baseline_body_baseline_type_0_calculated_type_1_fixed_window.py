...
T = TypeVar(
    "T", bound="AssaysRunInteractiveBaselineBodyBaselineType0CalculatedType1FixedWindow"
)


@_attrs_define
class AssaysRunInteractiveBaselineBodyBaselineType0CalculatedType1FixedWindow:
    """Assay window.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assays_run_interactive_baseline_body_baseline_type_0_calculated_type_1_fixed_window = cls(
            path=path,
            pipeline_name=pipeline_name,
            width=width,
            workspace_id=workspace_id,
        ...
        assays_run_interactive_baseline_body_baseline_type_0_calculated_type_1_fixed_window.additional_properties = d
        return assays_run_interactive_baseline_body_baseline_type_0_calculated_type_1_fixed_window
