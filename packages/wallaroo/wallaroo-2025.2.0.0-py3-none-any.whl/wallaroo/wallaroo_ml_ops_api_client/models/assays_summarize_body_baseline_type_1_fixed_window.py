...
T = TypeVar("T", bound="AssaysSummarizeBodyBaselineType1FixedWindow")


@_attrs_define
class AssaysSummarizeBodyBaselineType1FixedWindow:
    """Assay window.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assays_summarize_body_baseline_type_1_fixed_window = cls(
            path=path,
            pipeline_name=pipeline_name,
            width=width,
            workspace_id=workspace_id,
        ...
        assays_summarize_body_baseline_type_1_fixed_window.additional_properties = d
        return assays_summarize_body_baseline_type_1_fixed_window
