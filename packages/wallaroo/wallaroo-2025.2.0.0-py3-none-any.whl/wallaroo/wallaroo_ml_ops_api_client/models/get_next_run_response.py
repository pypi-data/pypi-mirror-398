...
T = TypeVar("T", bound="GetNextRunResponse")


@_attrs_define
class GetNextRunResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_next_run_response = cls(
            last_run=last_run,
            next_run=next_run,
        )

        get_next_run_response.additional_properties = d
        return get_next_run_response
