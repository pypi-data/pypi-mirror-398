...
T = TypeVar(
    "T", bound="AssaysRunInteractiveBodyBaselineType0CalculatedType1FixedWindow"
)


@_attrs_define
class AssaysRunInteractiveBodyBaselineType0CalculatedType1FixedWindow:
    """Assay window.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assays_run_interactive_body_baseline_type_0_calculated_type_1_fixed_window = (
            cls(
                path=path,
                pipeline_name=pipeline_name,
                width=width,
        ...
        assays_run_interactive_body_baseline_type_0_calculated_type_1_fixed_window.additional_properties = d
        return (
            assays_run_interactive_body_baseline_type_0_calculated_type_1_fixed_window
        )
