...
T = TypeVar("T", bound="AssaysGetAssayByIdResponse200WindowType0")


@_attrs_define
class AssaysGetAssayByIdResponse200WindowType0:
    """Options describing the time range tested by the assay
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assays_get_assay_by_id_response_200_window_type_0 = cls(
            path=path,
            pipeline_name=pipeline_name,
            width=width,
            workspace_id=workspace_id,
        ...
        assays_get_assay_by_id_response_200_window_type_0.additional_properties = d
        return assays_get_assay_by_id_response_200_window_type_0
