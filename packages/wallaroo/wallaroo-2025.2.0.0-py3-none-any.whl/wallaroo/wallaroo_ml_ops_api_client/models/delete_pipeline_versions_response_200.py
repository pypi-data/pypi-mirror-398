...
T = TypeVar("T", bound="DeletePipelineVersionsResponse200")


@_attrs_define
class DeletePipelineVersionsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_pipeline_versions_response_200 = cls(
            pipeline_versions=pipeline_versions,
        )

        delete_pipeline_versions_response_200.additional_properties = d
        return delete_pipeline_versions_response_200
