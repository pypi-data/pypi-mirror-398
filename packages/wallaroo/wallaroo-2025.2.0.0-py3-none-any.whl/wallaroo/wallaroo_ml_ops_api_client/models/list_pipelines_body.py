...
T = TypeVar("T", bound="ListPipelinesBody")


@_attrs_define
class ListPipelinesBody:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_pipelines_body = cls(
            workspace_id=workspace_id,
            workspace_name=workspace_name,
        )

        list_pipelines_body.additional_properties = d
        return list_pipelines_body
