...
if TYPE_CHECKING:
    from ..models.pause_response_202_input_data import PauseResponse202InputData
    from ..models.task_run import TaskRun


T = TypeVar("T", bound="PauseResponse202")


@_attrs_define
class PauseResponse202:
    """
    Attributes:
        created_at (datetime.datetime):
        id (UUID):
        input_data (PauseResponse202InputData):
        killed (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        input_data = PauseResponse202InputData.from_dict(d.pop("input_data"))
        ...
        pause_response_202.additional_properties = d
        return pause_response_202
