...
Use HtmlGraph directly in Claude Code with automatic session tracking and workflow analytics:
...
/plugin marketplace add Shakes-tzd/htmlgraph

# 3. Install the plugin
/plugin install htmlgraph@htmlgraph
...
- **Automatic session tracking** - Every Claude Code session is tracked
- **Smart recommendations** - AI-powered next work suggestions
- **Slash commands** - `/init`, `/status`, `/start`, `/end`, `/feature-add`, and more
- **Dashboard analytics** - View workflow patterns and bottlenecks
- **Git hooks** - Automatic activity linking and validation

See [MARKETPLACE.md](MARKETPLACE.md) for complete plugin documentation.
