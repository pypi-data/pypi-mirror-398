...
class MatriceDeployServer:
    ...
    def __init__(
        ...
        Args:
            ...
            async_predict: Function to make asynchronous predictions. Defaults to None.
        ...
        try:
            ...
            self._validate_init_parameters(
                load_model, predict, action_id, external_port, preprocess_fn, postprocess_fn, async_predict, async_load_model
            )
    ...
    def _validate_init_parameters(self, load_model, predict, action_id, external_port, preprocess_fn, postprocess_fn, async_predict, async_load_model):
        ...
        Args:
            ...
            async_predict: Asynchronous prediction function
    ...
    def _initialize_streaming_pipeline(self):
        ...
        try:
            ...
            if not app_deployment_id:
                ...
                # DISABLED: Skip initial camera fetch to avoid Redis auth issues and performance problems
                ...
                # This prevents:
                # - Large API calls at startup that can timeout
                # - Redis connection failures when no cameras exist yet
                # - Slow initialization with thousands of cameras
                camera_configs = {}
                logging.info(
