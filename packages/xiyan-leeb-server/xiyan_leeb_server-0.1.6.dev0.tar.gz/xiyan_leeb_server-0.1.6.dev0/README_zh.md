...
<br />
<a href="https://github.com/XGenerationLab/xiyan_leeb_server">英文</a> | <a href="https://github.com/XGenerationLab/xiyan_leeb_server/blob/main/README_zh.md">中文</a> | <a href="https://github.com/XGenerationLab/xiyan_leeb_server/blob/main/README_ja.md">日本語</a><br />
<a href="https://github.com/XGenerationLab/xiyan_leeb_server/blob/main/imgs/dinggroup_out.png">钉钉群</a> | 
...
```bash
python -m xiyan_leeb_server
```
但在您完成以下配置之前，它不会提供任何功能。
您将获得一个 yml 文件。然后您可以通过以下方式运行服务器：
```yaml
env YML=path/to/yml python -m xiyan_leeb_server
```

### 从 Smithery.ai 安装
请参见 [@XGenerationLab/xiyan_leeb_server](https://smithery.ai/server/@XGenerationLab/xiyan_leeb_server)
...
要在本地模式下运行 xiyan_leeb_server，您需要： 
...
步骤 3：下载脚本并运行服务器。文件 src/xiyan_leeb_server/local_xiyan_server.py
...
步骤 4：准备配置并运行 xiyan_leeb_server
config.yml 应如下所示：
```yml
model:
...
## 启动
### Claude Desktop
在您的 Claude Desktop 配置文件中添加以下内容，参考 <a href="https://github.com/XGenerationLab/xiyan_leeb_server/blob/main/imgs/claude_desktop.jpg">Claude Desktop 配置示例</a>
```json
{
    "mcpServers": {
        "xiyan-leeb-server": {
...
### Goose
在配置中添加以下命令，参考 <a href="https://github.com/XGenerationLab/xiyan_leeb_server/blob/main/imgs/goose.jpg">Goose 配置示例</a>
...
参考 <a href="https://github.com/XGenerationLab/xiyan_leeb_server/blob/main/imgs/witsy.jpg">Witsy 配置示例</a>
