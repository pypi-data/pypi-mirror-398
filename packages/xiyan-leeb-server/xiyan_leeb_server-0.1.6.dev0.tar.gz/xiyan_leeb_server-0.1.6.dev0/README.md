...
<p align="center">
💻 <a href="https://github.com/XGenerationLab/xiyan_leeb_server" >xiyan-leeb-server</a> | 
...
<a href="https://pepy.tech/projects/xiyan-leeb-server"><img src="https://static.pepy.tech/badge/xiyan-leeb-server" alt="PyPI Downloads"></a>
  <a href="https://smithery.ai/server/@XGenerationLab/xiyan_leeb_server"><img alt="Smithery Installs" src="https://smithery.ai/badge/@XGenerationLab/xiyan_leeb_server" height="20"/></a>
<a href="https://github.com/XGenerationLab/xiyan_leeb_server" target="_blank">
    <img src="https://img.shields.io/github/stars/XGenerationLab/xiyan_leeb_server?style=social" alt="GitHub stars" />
</a>
<br />
<a href="https://github.com/XGenerationLab/xiyan_leeb_server" >English</a> | <a href="https://github.com/XGenerationLab/xiyan_leeb_server/blob/main/README_zh.md"> 中文 </a> | <a href="https://github.com/XGenerationLab/xiyan_leeb_server/blob/main/README_ja.md"> 日本語 </a><br />
<a href="https://github.com/XGenerationLab/xiyan_leeb_server/blob/main/imgs/dinggroup_out.png">Ding Group钉钉群</a>｜ 
...
```shell
pip install xiyan-leeb-server
```

If you want to install the development version from source, you can install from source code on github:
```shell
pip install git+https://github.com/XGenerationLab/xiyan_leeb_server.git
```

### Installing from Smithery.ai
See [@XGenerationLab/xiyan_leeb_server](https://smithery.ai/server/@XGenerationLab/xiyan_leeb_server)
...
See [Local Model](src/xiyan_leeb_server/local_model/README.md) for more details.
...
```shell
YML=path/to/yml python -m xiyan_leeb_server
```
...
#### Claude Desktop
Add this in your Claude Desktop config file, ref <a href="https://github.com/XGenerationLab/xiyan_leeb_server/blob/main/imgs/claude_desktop.jpg">Claude Desktop config example</a>
```json
{
    "mcpServers": {
        "xiyan-leeb-server": {
...
#### Goose
If you use `stdio`, add following command in the config, ref <a href="https://github.com/XGenerationLab/xiyan_leeb_server/blob/main/imgs/goose.jpg">Goose config example</a>
```shell
env YML=path/to/yml /xxx/python -m xiyan_leeb_server
```
...
```shell
/xxx/python -m xiyan_leeb_server
```
Add an env: key is YML and value is the path to your yml file.
Ref <a href="https://github.com/XGenerationLab/xiyan_leeb_server/blob/main/imgs/witsy.jpg">Witsy config example</a>
...
[![MseeP.ai Security Assessment Badge](https://mseep.net/pr/xgenerationlab-xiyan-leeb-server-badge.png)](https://mseep.ai/app/xgenerationlab-xiyan-leeb-server)
