...
> API 경로: `/uapi/domestic-bond/v1/trading/sell`

---

# REST장내채권 매도주문 [국내주식-123]

**장내채권 매도주문 [국내주식-123] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | POST | URL | /uapi/domestic-bond/v1/trading/sell  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | TTTC0958U | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
