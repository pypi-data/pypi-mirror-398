...
> API 경로: `/uapi/domestic-bond/v1/quotations/inquire-daily-itemchartprice`

---

# REST장내채권 기간별시세(일) [국내주식-159]

**장내채권 기간별시세(일) [국내주식-159] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-bond/v1/quotations/inquire-daily-itemchartprice  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | FHKBJ773701C0 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
