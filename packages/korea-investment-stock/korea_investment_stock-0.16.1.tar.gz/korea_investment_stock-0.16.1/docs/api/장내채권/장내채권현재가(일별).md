...
> API 경로: `/uapi/domestic-bond/v1/quotations/inquire-daily-price`

---

# REST장내채권현재가(일별) [국내주식-202]

**장내채권현재가(일별) [국내주식-202] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-bond/v1/quotations/inquire-daily-price  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | FHKBJ773404C0 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
