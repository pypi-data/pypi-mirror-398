...
> API 경로: `/uapi/domestic-bond/v1/trading/order-rvsecncl`

---

# REST장내채권 정정취소주문 [국내주식-125]

**장내채권 정정취소주문 [국내주식-125] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | POST | URL | /uapi/domestic-bond/v1/trading/order-rvsecncl  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | TTTC0953U | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
