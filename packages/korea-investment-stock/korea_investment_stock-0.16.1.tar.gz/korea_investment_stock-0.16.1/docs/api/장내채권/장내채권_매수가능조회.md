...
> API 경로: `/uapi/domestic-bond/v1/trading/inquire-psbl-order`

---

# REST장내채권 매수가능조회 [국내주식-199]

**장내채권 매수가능조회 [국내주식-199] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-bond/v1/trading/inquire-psbl-order  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | TTTC8910R | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
...
### Data Class (Python)
    ...
    class ResponseBodyoutput:
        ...
        bond_ord_unpr2: str    #채권주문단가2
        buy_psbl_amt: str    #매수가능금액
        buy_psbl_qty: str    #매수가능수량
