...
> API 경로: `/uapi/domestic-bond/v1/quotations/inquire-price`

---

# REST장내채권현재가(시세) [국내주식-200]

**장내채권현재가(시세) [국내주식-200] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-bond/v1/quotations/inquire-price  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | FHKBJ773400C0 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
...
### Data Class (Python)
    ...
    class ResponseBodyoutput:
        ...
        bond_prdy_vrss: str    #채권전일대비
        prdy_ctrt: str    #전일대비율
        acml_vol: str    #누적거래량
        bond_prdy_clpr: str    #채권전일종가
        bond_oprc: str    #채권시가2
        bond_hgpr: str    #채권고가
        bond_lwpr: str    #채권저가
        ernn_rate: str    #수익비율
