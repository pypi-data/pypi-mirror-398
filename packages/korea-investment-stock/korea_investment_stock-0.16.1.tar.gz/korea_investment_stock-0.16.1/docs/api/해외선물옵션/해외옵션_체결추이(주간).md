...
> API 경로: `/uapi/overseas-futureoption/v1/quotations/opt-weekly-ccnl`

---

# REST해외옵션 체결추이(주간) [해외선물-036]

**해외옵션 체결추이(주간) [해외선물-036] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/overseas-futureoption/v1/quotations/opt-weekly-ccnl  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | HHDFO55020000 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
