...
> API 경로: `/uapi/overseas-futureoption/v1/quotations/search-opt-detail`

---

# REST해외옵션 상품기본정보 [해외선물-041]

**해외옵션 상품기본정보 [해외선물-041] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/overseas-futureoption/v1/quotations/search-opt-detail  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | HHDFO55200000 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
...
SRS_CD_01 | 종목코드1 | String | Y | 32 | SRS_CD_01부터 차례로 입력(ex ) OESU24 C5500  
최대 30개 까지 가능  
...
sttl_price  | 정산가 | String | Y | 15 | 정산가  
