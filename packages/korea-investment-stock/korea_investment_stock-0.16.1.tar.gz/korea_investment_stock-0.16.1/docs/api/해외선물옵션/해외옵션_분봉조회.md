...
> API 경로: `/uapi/overseas-futureoption/v1/quotations/inquire-time-optchartprice`

---

# REST해외옵션 분봉조회 [해외선물-040]

**해외옵션 분봉조회 [해외선물-040] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/overseas-futureoption/v1/quotations/inquire-time-optchartprice  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | HHDFO55020400 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
