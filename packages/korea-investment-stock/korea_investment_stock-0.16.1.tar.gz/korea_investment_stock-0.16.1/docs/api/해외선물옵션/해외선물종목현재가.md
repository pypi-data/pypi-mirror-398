...
> API 경로: `/uapi/overseas-futureoption/v1/quotations/inquire-price`

---

# REST해외선물종목현재가 [v1_해외선물-009]

**해외선물종목현재가 [v1_해외선물-009] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/overseas-futureoption/v1/quotations/inquire-price  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | HHDFC55010000 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
