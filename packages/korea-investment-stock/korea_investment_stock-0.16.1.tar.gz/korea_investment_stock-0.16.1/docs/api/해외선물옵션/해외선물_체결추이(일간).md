...
> API 경로: `/uapi/overseas-futureoption/v1/quotations/daily-ccnl`

---

# REST해외선물 체결추이(일간)[해외선물-018]

**해외선물 체결추이(일간)[해외선물-018] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/overseas-futureoption/v1/quotations/daily-ccnl  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | HHDFC55020100 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
