...
> API 경로: `/uapi/domestic-stock/v1/trading/pension/inquire-deposit`

---

# REST퇴직연금 예수금조회[v1_국내주식-035]

**퇴직연금 예수금조회[v1_국내주식-035] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-stock/v1/trading/pension/inquire-deposit  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | TTTC0506R | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
...
### Data Class (Python)
    ...
    class ResponseBodyoutput:
        dnca_tota: str    #예수금총액
        nxdy_excc_amt: str    #익일정산액
        nxdy_sttl_amt: str    #익일결제금액
        nx2_day_sttl_amt: str    #2익일결제금액
