...
> API 경로: `/uapi/domestic-stock/v1/ranking/profit-asset-index`

---

# REST국내주식 수익자산지표 순위[v1_국내주식-090]

**국내주식 수익자산지표 순위[v1_국내주식-090] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-stock/v1/ranking/profit-asset-index  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | FHPST01730000 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
