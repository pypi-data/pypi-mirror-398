...
> API 경로: `/uapi/domestic-stock/v1/trading/order-resv-ccnl`

---

# REST주식예약주문조회[v1_국내주식-020]

**주식예약주문조회[v1_국내주식-020] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-stock/v1/trading/order-resv-ccnl  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | CTSC0004R | 모의 TR ID | 모의투자 미지원  
...
PRCS_DVSN_CD | 처리구분코드 | String | Y | 2 | 0: 전체  
1: 처리내역  
2: 미처리내역  
...
### Data Class (Python)
    ...
    class RequestQueryParam:
        ...
        TMNL_MDIA_KIND_CD: str    #단말매체종류코드
        CANO: str    #종합계좌번호
        ACNT_PRDT_CD: str    #계좌상품코드
        PRCS_DVSN_CD: str    #처리구분코드
        CNCL_YN: str    #취소여부
        PDNO: str    #상품번호
