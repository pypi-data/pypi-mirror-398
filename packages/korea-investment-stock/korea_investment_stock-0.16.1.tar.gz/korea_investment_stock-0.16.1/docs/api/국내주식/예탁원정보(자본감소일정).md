...
> API 경로: `/uapi/domestic-stock/v1/ksdinfo/cap-dcrs`

---

# REST예탁원정보(자본감소일정)[국내주식-149]

**예탁원정보(자본감소일정)[국내주식-149] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-stock/v1/ksdinfo/cap-dcrs  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 미지원  
실전 TR ID  | HHKDB669106C0 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
...
### Data Class (Python)
    ...
    class ResponseBodyoutput1:
        ...
        isin_name: str    #종목명
        stk_kind: str    #주식종류
        reduce_cap_type: str    #감자구분
        reduce_cap_rate: str    #감자배정율
        comp_way: str    #계산방법
