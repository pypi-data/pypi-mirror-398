...
> API 경로: `/uapi/domestic-stock/v1/ksdinfo/dividend`

---

# REST예탁원정보(배당일정)[국내주식-145]

**예탁원정보(배당일정)[국내주식-145] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-stock/v1/ksdinfo/dividend  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 미지원  
실전 TR ID  | HHKDB669102C0 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
