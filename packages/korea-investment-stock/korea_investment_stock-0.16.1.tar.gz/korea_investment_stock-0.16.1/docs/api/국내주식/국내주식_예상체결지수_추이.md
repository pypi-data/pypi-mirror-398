...
> API 경로: `/uapi/domestic-stock/v1/quotations/exp-index-trend`

---

# REST국내주식 예상체결지수 추이[국내주식-121]

**국내주식 예상체결지수 추이[국내주식-121] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-stock/v1/quotations/exp-index-trend  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 미지원  
실전 TR ID  | FHPST01840000 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
...
### Data Class (Python)
    ...
    class ResponseBodyoutput:
        stck_cntg_hour: str    #주식 단축 종목코드
        bstp_nmix_prpr: str    #HTS 한글 종목명
        prdy_vrss_sign: str    #주식 현재가
        bstp_nmix_prdy_vrss: str    #전일 대비
        prdy_ctrt: str    #전일 대비 부호
        acml_vol: str    #전일 대비율
        acml_tr_pbmn: str    #기준가 대비 현재가
