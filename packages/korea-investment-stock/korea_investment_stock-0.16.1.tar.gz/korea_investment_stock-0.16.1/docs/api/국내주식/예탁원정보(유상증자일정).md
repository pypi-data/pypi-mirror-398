...
> API 경로: `/uapi/domestic-stock/v1/ksdinfo/paidin-capin`

---

# REST예탁원정보(유상증자일정) [국내주식-143]

**예탁원정보(유상증자일정) [국내주식-143] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-stock/v1/ksdinfo/paidin-capin  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | HHKDB669100C0 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
