...
> API 경로: `/uapi/domestic-stock/v1/quotations/program-trade-by-stock-daily`

---

# REST종목별 프로그램매매추이(일별) [국내주식-113]

**종목별 프로그램매매추이(일별) [국내주식-113] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-stock/v1/quotations/program-trade-by-stock-daily  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 미지원  
실전 TR ID  | FHPPG04650201 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
