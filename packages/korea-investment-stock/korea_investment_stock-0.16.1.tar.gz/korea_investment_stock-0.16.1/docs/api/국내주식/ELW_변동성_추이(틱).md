...
> API 경로: `/uapi/elw/v1/quotations/volatility-trend-tick`

---

# RESTELW 변동성 추이(틱) [국내주식-180]

**ELW 변동성 추이(틱) [국내주식-180] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/elw/v1/quotations/volatility-trend-tick  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 미지원  
실전 TR ID  | FHPEW02840400 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
...
### Data Class (Python)
    ...
    class ResponseBodyoutput:
        bsop_date: str    #주식영업일자
        stck_cntg_hour: str    #ELW현재가
        elw_prpr: str    #전일대비
        hts_ints_vltl: str    #전일대비부호
