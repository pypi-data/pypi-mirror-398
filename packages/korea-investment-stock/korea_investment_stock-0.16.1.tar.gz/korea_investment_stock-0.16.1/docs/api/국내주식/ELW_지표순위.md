...
> API 경로: `/uapi/elw/v1/ranking/indicator`

---

# RESTELW 지표순위[국내주식-169]

**ELW 지표순위[국내주식-169] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/elw/v1/ranking/indicator  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | FHPEW02790000 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
