...
# REST종목별 외국계 순매수추이 [국내주식-164]

**종목별 외국계 순매수추이 [국내주식-164] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-stock/v1/quotations/frgnmem-pchs-trend  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 미지원  
실전 TR ID  | FHKST644400C0 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
...
### Data Class (Python)
    ...
    class RequestQueryParam:
        FID_INPUT_ISCD: str    #조건시장분류코드
        FID_INPUT_ISCD_2: str    #조건화면분류코드
        FID_COND_MRKT_DIV_CODE: str    #시장구분코드
...
### Data Class (Python)
    ...
    class ResponseBodyoutput:
        ...
        prdy_ctrt: str    #전일대비율
        acml_vol: str    #누적거래량
        frgn_seln_vol: str    #외국인매도거래량
        frgn_shnu_vol: str    #외국인매수2거래량
