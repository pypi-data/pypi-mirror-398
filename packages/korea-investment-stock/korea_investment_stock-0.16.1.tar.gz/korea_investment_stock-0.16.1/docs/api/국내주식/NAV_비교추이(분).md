...
> API 경로: `/uapi/etfetn/v1/quotations/nav-comparison-time-trend`

---

# RESTNAV 비교추이(분)[v1_국내주식-070]

**NAV 비교추이(분)[v1_국내주식-070] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/etfetn/v1/quotations/nav-comparison-time-trend  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | FHPST02440100 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
