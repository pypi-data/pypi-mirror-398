...
> API 경로: `/uapi/domestic-stock/v1/ranking/bulk-trans-num`

---

# REST국내주식 대량체결건수 상위[국내주식-107]

**국내주식 대량체결건수 상위[국내주식-107] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-stock/v1/ranking/bulk-trans-num  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | FHKST190900C0 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
