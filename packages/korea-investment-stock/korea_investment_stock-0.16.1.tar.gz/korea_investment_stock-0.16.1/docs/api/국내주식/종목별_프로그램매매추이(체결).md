...
> API 경로: `/uapi/domestic-stock/v1/quotations/program-trade-by-stock`

---

# REST종목별 프로그램매매추이(체결)[v1_국내주식-044]

**종목별 프로그램매매추이(체결)[v1_국내주식-044] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-stock/v1/quotations/program-trade-by-stock  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | FHPPG04650101 | 모의 TR ID | 모의투자 미지원  
Format | JSON | Content-Type | application/octet-stream  
