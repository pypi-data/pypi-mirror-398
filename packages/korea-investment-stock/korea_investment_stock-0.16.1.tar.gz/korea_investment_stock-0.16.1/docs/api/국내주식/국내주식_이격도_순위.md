...
> API 경로: `/uapi/domestic-stock/v1/ranking/disparity`

---

# REST국내주식 이격도 순위[v1_국내주식-095]

**국내주식 이격도 순위[v1_국내주식-095] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-stock/v1/ranking/disparity  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | FHPST01780000 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
...
### Data Class (Python)
    ...
    class ResponseBodyoutput:
        ...
        acml_vol: str    #누적 거래량
        d5_dsrt: str    #5일 이격도
        d10_dsrt: str    #10일 이격도
        d20_dsrt: str    #20일 이격도
        d60_dsrt: str    #60일 이격도
        d120_dsrt: str    #120일 이격도
