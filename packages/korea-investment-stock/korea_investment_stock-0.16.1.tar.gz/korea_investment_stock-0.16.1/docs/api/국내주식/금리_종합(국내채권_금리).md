...
> API 경로: `/uapi/domestic-stock/v1/quotations/comp-interest`

---

# REST금리 종합(국내채권/금리) [국내주식-155]

**금리 종합(국내채권/금리) [국내주식-155] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-stock/v1/quotations/comp-interest  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | FHPST07020000 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
...
### Data Class (Python)
    ...
    class ResponseBodyoutput1:
        ...
        bond_mnrt_prdy_vrss: str    #채권금리전일대비
        prdy_ctrt: str    #전일대비율
    ...
    class ResponseBodyoutput2:
        ...
        prdy_vrss_sign: str    #전일대비부호
        bond_mnrt_prdy_vrss: str    #채권금리전일대비
        bstp_nmix_prdy_ctrt: str    #업종지수전일대비율
        stck_bsop_date: str    #주식영업일자
