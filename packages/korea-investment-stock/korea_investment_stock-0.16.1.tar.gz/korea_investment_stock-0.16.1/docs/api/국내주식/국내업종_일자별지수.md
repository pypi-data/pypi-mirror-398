...
> API 경로: `/uapi/domestic-stock/v1/quotations/inquire-index-daily-price`

---

# REST국내업종 일자별지수[v1_국내주식-065]

**국내업종 일자별지수[v1_국내주식-065] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-stock/v1/quotations/inquire-index-daily-price  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | FHPUP02120000 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
