...
> API 경로: `/uapi/domestic-stock/v1/quotations/exp-closing-price`

---

# REST국내주식 장마감 예상체결가[국내주식-120]

**국내주식 장마감 예상체결가[국내주식-120] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-stock/v1/quotations/exp-closing-price  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 미지원  
실전 TR ID  | FHKST117300C0 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
...
### Data Class (Python)
    ...
    class ResponseBodyoutput1:
        ...
        sdpr_vrss_prpr: str    #기준가 대비 현재가
        sdpr_vrss_prpr_rate: str    #기준가 대비 현재가 비율
        cntg_vol: str    #체결 거래량
