...
> API 경로: `/uapi/domestic-stock/v1/quotations/inquire-index-tickprice`

---

# REST국내업종 시간별지수(초)[국내주식-064]

**국내업종 시간별지수(초)[국내주식-064] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-stock/v1/quotations/inquire-index-tickprice  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 미지원  
실전 TR ID  | FHPUP02110100 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
