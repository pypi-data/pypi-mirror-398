...
> API 경로: `/uapi/domestic-stock/v1/ksdinfo/purreq`

---

# REST예탁원정보(주식매수청구일정)[국내주식-146]

**예탁원정보(주식매수청구일정)[국내주식-146] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-stock/v1/ksdinfo/purreq  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 미지원  
실전 TR ID  | HHKDB669103C0 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
...
### Data Class (Python)
    ...
    class ResponseBodyoutput1:
        ...
        isin_name: str    #종목명
        stk_kind: str    #주식종류
        opp_opi_rcpt_term: str    #반대의사접수시한
        buy_req_rcpt_term: str    #매수청구접수시한
        buy_req_price: str    # 매수청구가격
        buy_amt_pay_dt: str    #매수대금지급일
        get_meet_dt: str    #주총일
