...
# REST국내주식 시가총액 상위[v1_국내주식-091]

**국내주식 시가총액 상위[v1_국내주식-091] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-stock/v1/ranking/market-cap  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | FHPST01740000 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
...
### Data Class (Python)
    ...
    class ResponseBodyoutput:
        ...
        lstn_stcn: str    #상장 주수
        stck_avls: str    #시가 총액
        mrkt_whol_avls_rlim: str    #시장 전체 시가총액 비중
