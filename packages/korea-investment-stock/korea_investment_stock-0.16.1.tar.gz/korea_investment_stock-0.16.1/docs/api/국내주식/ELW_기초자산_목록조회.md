...
> API 경로: `/uapi/elw/v1/quotations/udrl-asset-list`

---

# RESTELW 기초자산 목록조회 [국내주식-185]

**ELW 기초자산 목록조회 [국내주식-185] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/elw/v1/quotations/udrl-asset-list  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | FHKEW154100C0 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
