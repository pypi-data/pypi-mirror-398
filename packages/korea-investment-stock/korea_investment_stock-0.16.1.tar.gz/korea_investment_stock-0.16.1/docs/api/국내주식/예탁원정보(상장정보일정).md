...
> API 경로: `/uapi/domestic-stock/v1/ksdinfo/list-info`

---

# REST예탁원정보(상장정보일정)[국내주식-150]

**예탁원정보(상장정보일정)[국내주식-150] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-stock/v1/ksdinfo/list-info  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 미지원  
실전 TR ID  | HHKDB669107C0 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
...
### Data Class (Python)
    ...
    class ResponseBodyoutput1:
        ...
        stk_kind: str    #주식종류
        issue_type: str    #사유
        issue_stk_qty: str    #상장주식수
        tot_issue_stk_qty: str    #총발행주식수
        issue_price: str    #발행가
