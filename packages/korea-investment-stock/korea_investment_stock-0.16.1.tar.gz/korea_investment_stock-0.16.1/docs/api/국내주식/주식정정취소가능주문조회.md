...
> API 경로: `/uapi/domestic-stock/v1/trading/inquire-psbl-rvsecncl`

---

# REST주식정정취소가능주문조회[v1_국내주식-004]

**주식정정취소가능주문조회[v1_국내주식-004] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-stock/v1/trading/inquire-psbl-rvsecncl  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | TTTC0084R | 모의 TR ID | 모의투자 미지원  
...
INQR_DVSN_1 | 조회구분1 | String | Y | 1 | '0 주문  
1 종목'  
INQR_DVSN_2 | 조회구분2 | String | Y | 1 | '0 전체  
1 매도  
2 매수'  
...
ord_dvsn_cd  | 주문구분코드 | String | Y | 6 | [KRX]  
00 : 지정가  
01 : 시장가  
02 : 조건부지정가  
03 : 최유리지정가  
