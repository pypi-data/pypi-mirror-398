...
> API 경로: `/uapi/domestic-stock/v1/quotations/inquire-ccnl`

---

# REST주식현재가 체결[v1_국내주식-009]

**주식현재가 체결[v1_국내주식-009] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-stock/v1/quotations/inquire-ccnl  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | https://openapivts.koreainvestment.com:29443  
실전 TR ID  | FHKST01010300 | 모의 TR ID | FHKST01010300  
Format |  | Content-Type |   
