...
> API 경로: `/uapi/domestic-stock/v1/quotations/inquire-time-itemconclusion`

---

# REST주식현재가 당일시간대별체결[v1_국내주식-023]

**주식현재가 당일시간대별체결[v1_국내주식-023] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-stock/v1/quotations/inquire-time-itemconclusion  
---|---|---|---  
