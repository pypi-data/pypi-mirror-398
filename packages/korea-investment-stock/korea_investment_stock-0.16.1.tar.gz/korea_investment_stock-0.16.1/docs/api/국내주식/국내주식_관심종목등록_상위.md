...
> API 경로: `/uapi/domestic-stock/v1/ranking/top-interest-stock`

---

# REST국내주식 관심종목등록 상위[v1_국내주식-102]

**국내주식 관심종목등록 상위[v1_국내주식-102] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-stock/v1/ranking/top-interest-stock  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | FHPST01800000 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
...
### Data Class (Python)
    ...
    class RequestQueryParam:
        fid_input_iscd_2: str    #입력 필수값2
        fid_cond_mrkt_div_code: str    #조건 시장 분류 코드
        fid_cond_scr_div_code: str    #조건 화면 분류 코드
        fid_input_iscd: str    #업종 코드
...
### Data Class (Python)
    ...
    class ResponseBodyoutput:
        mrkt_div_cls_name: str    #시장 분류 구분 명
        ...
        inter_issu_reg_csnu: str    #관심 종목 등록 건수
