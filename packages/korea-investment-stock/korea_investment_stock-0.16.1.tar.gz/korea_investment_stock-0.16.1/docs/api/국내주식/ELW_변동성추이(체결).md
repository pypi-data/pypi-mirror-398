...
> API 경로: `/uapi/elw/v1/quotations/volatility-trend-ccnl`

---

# RESTELW 변동성추이(체결) [국내주식-177]

**ELW 변동성추이(체결) [국내주식-177] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/elw/v1/quotations/volatility-trend-ccnl  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | FHPEW02840100 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
