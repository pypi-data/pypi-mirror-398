...
> API 경로: `/uapi/domestic-stock/v1/trading/inquire-psbl-sell`

---

# REST매도가능수량조회 [국내주식-165]

**매도가능수량조회 [국내주식-165] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-stock/v1/trading/inquire-psbl-sell  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | TTTC8408R | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
