...
> API 경로: `/uapi/domestic-stock/v1/ranking/overtime-volume`

---

# REST국내주식 시간외거래량순위 [국내주식-139]

**국내주식 시간외거래량순위 [국내주식-139] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-stock/v1/ranking/overtime-volume  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | FHPST02350000 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
