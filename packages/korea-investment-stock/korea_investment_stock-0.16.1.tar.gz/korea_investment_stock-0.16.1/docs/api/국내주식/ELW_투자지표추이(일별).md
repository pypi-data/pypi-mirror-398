...
> API 경로: `/uapi/elw/v1/quotations/indicator-trend-daily`

---

# RESTELW 투자지표추이(일별) [국내주식-173]

**ELW 투자지표추이(일별) [국내주식-173] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/elw/v1/quotations/indicator-trend-daily  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 미지원  
실전 TR ID  | FHPEW02740200 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
...
### Data Class (Python)
    ...
    class RequestQueryParam:
        FID_COND_MRKT_DIV_CODE: str    #시장분류코드
        FID_INPUT_ISCD: str    #종콕코드
