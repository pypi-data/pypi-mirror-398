...
> API 경로: `/uapi/elw/v1/quotations/compare-stocks`

---

# RESTELW 비교대상종목조회 [국내주식-183]

**ELW 비교대상종목조회 [국내주식-183] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/elw/v1/quotations/compare-stocks  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 미지원  
실전 TR ID  | FHKEW151701C0 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
