...
> API 경로: `/uapi/elw/v1/quotations/volatility-trend-daily`

---

# RESTELW 변동성 추이(일별) [국내주식-178]

**ELW 변동성 추이(일별) [국내주식-178] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/elw/v1/quotations/volatility-trend-daily  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 미지원  
실전 TR ID  | FHPEW02840200 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
...
### Data Class (Python)
    ...
    class ResponseBodyoutput:
        ...
        acml_vol: str    #누적 거래량
        d10_hist_vltl: str    #10일 역사적 변동성
        d20_hist_vltl: str    #20일 역사적 변동성
        d30_hist_vltl: str    #30일 역사적 변동성
        d60_hist_vltl: str    #60일 역사적 변동성
        d90_hist_vltl: str    #90일 역사적 변동성
