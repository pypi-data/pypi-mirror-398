...
> API 경로: `/uapi/domestic-stock/v1/quotations/mktfunds`

---

# REST국내 증시자금 종합 [국내주식-193]

**국내 증시자금 종합 [국내주식-193] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-stock/v1/quotations/mktfunds  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 미지원  
실전 TR ID  | FHKST649100C0 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
...
### Data Class (Python)
    ...
    class ResponseBodyoutput:
        bsop_date: str    #영업일자
        bstp_nmix_prpr: str    #업종지수현재가
        bstp_nmix_prdy_vrss: str    #업종지수전일대비
        prdy_vrss_sign: str    #전일대비부호
        prdy_ctrt: str    #전일대비율
        hts_avls: str    #HTS시가총액
        cust_dpmn_amt: str    #고객예탁금금액
        cust_dpmn_amt_prdy_vrss: str    #고객예탁금금액전일대비
        amt_tnrt: str    #금액회전율
        uncl_amt: str    #미수금액
        crdt_loan_rmnd: str    #신용융자잔고
        futs_tfam_amt: str    #선물예수금금액
        sttp_amt: str    #주식형금액
        mxtp_amt: str    #혼합형금액
        bntp_amt: str    #채권형금액
        mmf_amt: str    #MMF금액
        secu_lend_amt: str    #담보대출잔고금액
