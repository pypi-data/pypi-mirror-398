...
> API 경로: `/uapi/domestic-stock/v1/finance/stability-ratio`

---

# REST국내주식 안정성비율[v1_국내주식-083]

**국내주식 안정성비율[v1_국내주식-083] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-stock/v1/finance/stability-ratio  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | FHKST66430600 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
