...
> API 경로: `/uapi/domestic-stock/v1/ksdinfo/mand-deposit`

---

# REST예탁원정보(의무예치일정)[국내주식-153]

**예탁원정보(의무예치일정)[국내주식-153] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-stock/v1/ksdinfo/mand-deposit  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 미지원  
실전 TR ID  | HHKDB669110C0 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
...
### Data Class (Python)
    ...
    class ResponseBodyoutput1:
        ...
        depo_date: str    #예치일
        depo_reason: str    #사유
        tot_issue_qty_per_rate: str    #총발행주식수대비비율(%)
