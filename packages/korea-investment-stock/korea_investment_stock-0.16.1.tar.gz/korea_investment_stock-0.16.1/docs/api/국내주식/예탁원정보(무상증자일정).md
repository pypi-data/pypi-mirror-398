...
> API 경로: `/uapi/domestic-stock/v1/ksdinfo/bonus-issue`

---

# REST예탁원정보(무상증자일정) [국내주식-144]

**예탁원정보(무상증자일정) [국내주식-144] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-stock/v1/ksdinfo/bonus-issue  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | HHKDB669101C0 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
...
### Data Class (Python)
    ...
    class ResponseBodyoutput1:
        ...
        isin_name: str    #종목명
        fix_rate: str    #확정배정율
        odd_rec_price: str    #단주기준가
        right_dt: str    #권리락일
        odd_pay_dt: str    #단주대금지급일
        list_date: str    #상장/등록일
