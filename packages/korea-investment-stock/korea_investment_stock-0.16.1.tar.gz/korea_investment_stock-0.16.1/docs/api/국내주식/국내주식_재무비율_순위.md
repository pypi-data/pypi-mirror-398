...
> API 경로: `/uapi/domestic-stock/v1/ranking/finance-ratio`

---

# REST국내주식 재무비율 순위[v1_국내주식-092]

**국내주식 재무비율 순위[v1_국내주식-092] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-stock/v1/ranking/finance-ratio  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | FHPST01750000 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
...
### Data Class (Python)
    ...
    class ResponseBodyoutput:
        ...
        rsrv_rate: str    #유보 비율
        grs: str    #매출액 증가율
        op_prfi_inrt: str    #경상 이익 증가율
        bsop_prfi_inrt: str    #영업 이익 증가율
        ntin_inrt: str    #순이익 증가율
        equt_inrt: str    #자기자본 증가율
        cptl_tnrt: str    #총자본회전율
        sale_bond_tnrt: str    #매출 채권 회전율
