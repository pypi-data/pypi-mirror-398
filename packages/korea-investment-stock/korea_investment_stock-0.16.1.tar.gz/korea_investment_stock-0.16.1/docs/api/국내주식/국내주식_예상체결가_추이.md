...
> API 경로: `/uapi/domestic-stock/v1/quotations/exp-price-trend`

---

# REST국내주식 예상체결가 추이[국내주식-118]

**국내주식 예상체결가 추이[국내주식-118] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-stock/v1/quotations/exp-price-trend  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | FHPST01810000 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
