...
> API 경로: `/uapi/domestic-stock/v1/ksdinfo/forfeit`

---

# REST예탁원정보(실권주일정)[국내주식-152]

**예탁원정보(실권주일정)[국내주식-152] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-stock/v1/ksdinfo/forfeit  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 미지원  
실전 TR ID  | HHKDB669109C0 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
...
### Data Class (Python)
    ...
    class ResponseBodyoutput1:
        ...
        isin_name: str    #종목명
        subscr_dt: str    #청약일
        subscr_price: str    #공모가
        subscr_stk_qty: str    #공모주식수
        refund_dt: str    #환불일
        list_dt: str    #상장/등록일
        lead_mgr: str    #주간사
