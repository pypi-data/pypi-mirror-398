...
> API 경로: `/tryitout/H0UNPGM0`

---

# WEBSOCKET국내주식 실시간프로그램매매 (통합)

**국내주식 실시간프로그램매매 (통합) 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | POST | URL | /tryitout/H0UNPGM0  
---|---|---|---  
실전 Domain  | ws://ops.koreainvestment.com:21000 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | H0UNPGM0 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
