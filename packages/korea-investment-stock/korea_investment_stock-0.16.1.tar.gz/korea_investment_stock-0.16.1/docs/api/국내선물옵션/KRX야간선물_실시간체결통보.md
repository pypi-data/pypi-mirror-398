...
> API 경로: `/tryitout/H0MFCNI0`

---

# WEBSOCKETKRX야간선물 실시간체결통보 [실시간-066]

**KRX야간선물 실시간체결통보 [실시간-066] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | POST | URL | /tryitout/H0MFCNI0  
---|---|---|---  
