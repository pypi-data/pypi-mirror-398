...
> API 경로: `/tryitout/H0ZOANC0`

---

# WEBSOCKET주식옵션 실시간예상체결 [실시간-046]

**주식옵션 실시간예상체결 [실시간-046] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | POST | URL | /tryitout/H0ZOANC0  
---|---|---|---  
실전 Domain  | ws://ops.koreainvestment.com:21000 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | H0ZOANC0 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
