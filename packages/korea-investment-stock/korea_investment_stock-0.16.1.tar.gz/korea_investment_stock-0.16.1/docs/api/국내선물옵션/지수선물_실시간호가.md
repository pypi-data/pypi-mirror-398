...
> API 경로: `/tryitout/H0IFASP0`

---

# WEBSOCKET지수선물 실시간호가[실시간-011]

**지수선물 실시간호가[실시간-011] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | POST | URL | /tryitout/H0IFASP0  
---|---|---|---  
실전 Domain  | ws://ops.koreainvestment.com:21000 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | H0IFASP0 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
