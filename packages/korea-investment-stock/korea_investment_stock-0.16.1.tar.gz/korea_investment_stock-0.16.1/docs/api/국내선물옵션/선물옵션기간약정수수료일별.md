...
> API 경로: `/uapi/domestic-futureoption/v1/trading/inquire-daily-amount-fee`

---

# REST선물옵션기간약정수수료일별[v1_국내선물-017]

**선물옵션기간약정수수료일별[v1_국내선물-017] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/domestic-futureoption/v1/trading/inquire-daily-amount-fee  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | CTFO6119R | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
...
### Data Class (Python)
    ...
    class RequestQueryParam:
        ...
        INQR_STRT_DAY: str    #조회시작일
        INQR_END_DAY: str    #조회종료일
...
### Data Class (Python)
    ...
    class ResponseBodyoutput1:
        ...
        pdno: str    #상품번호
        item_name: str    #종목명
        sll_agrm_amt: str    #매도약정금액
        sll_fee: str    #매도수수료
        buy_agrm_amt: str    #매수약정금액
        buy_fee: str    #매수수수료
        tot_fee_smtl: str    #총수수료합계
        trad_pfls: str    #매매손익
    
    @dataclass
    class ResponseBodyoutput2:
        futr_agrm: str    #선물약정
        futr_agrm_amt: str    #선물약정금액
        futr_agrm_amt_smtl: str    #선물약정금액합계
        futr_sll_fee_smtl: str    #선물매도수수료합계
        futr_buy_fee_smtl: str    #선물매수수수료합계
        futr_fee_smtl: str    #선물수수료합계
        opt_agrm: str    #옵션약정
        opt_agrm_amt: str    #옵션약정금액
        opt_agrm_amt_smtl: str    #옵션약정금액합계
        opt_sll_fee_smtl: str    #옵션매도수수료합계
        opt_buy_fee_smtl: str    #옵션매수수수료합계
        opt_fee_smtl: str    #옵션수수료합계
        prdt_futr_agrm: str    #상품선물약정
        prdt_fuop: str    #상품선물옵션
        prdt_futr_evlu_amt: str    #상품선물평가금액
        futr_fee: str    #선물수수료
        opt_fee: str    #옵션수수료
        fee: str    #수수료
        sll_agrm_amt: str    #매도약정금액
        buy_agrm_amt: str    #매수약정금액
        agrm_amt_smtl: str    #약정금액합계
        sll_fee: str    #매도수수료
        buy_fee: str    #매수수수료
        fee_smtl: str    #수수료합계
