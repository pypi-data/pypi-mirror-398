...
> API 경로: `/tryitout/H0CFASP0`

---

# WEBSOCKET상품선물 실시간호가[실시간-023]

**상품선물 실시간호가[실시간-023] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | POST | URL | /tryitout/H0CFASP0  
---|---|---|---  
실전 Domain  | ws://ops.koreainvestment.com:21000 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | H0CFASP0 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
