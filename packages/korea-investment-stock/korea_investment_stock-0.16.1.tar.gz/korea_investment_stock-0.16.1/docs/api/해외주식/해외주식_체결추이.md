...
> API 경로: `/uapi/overseas-price/v1/quotations/inquire-ccnl`

---

# REST해외주식 체결추이[해외주식-037]

**해외주식 체결추이[해외주식-037] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/overseas-price/v1/quotations/inquire-ccnl  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 모의투자 미지원  
실전 TR ID  | HHDFS76200300 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
...
**주식주문(현금[V1_국내주식-001]) 정보** **Element, 한글명, Type, Rquired, Length, Description** Element | 한글명 | Type | Required | Length | Description  
---|---|---|---|---|---  
EXCD | 거래소명 | String | Y | 4 | 'NYS : 뉴욕, NAS : 나스닥, AMS : 아멕스   
