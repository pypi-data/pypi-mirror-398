...
> API 경로: `/uapi/overseas-stock/v1/ranking/new-highlow`

---

# REST해외주식 신고/신저가[해외주식-042]

**해외주식 신고/신저가[해외주식-042] 정보** **Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type** Method | GET | URL | /uapi/overseas-stock/v1/ranking/new-highlow  
---|---|---|---  
실전 Domain  | https://openapi.koreainvestment.com:9443 | 모의 Domain | 미지원  
실전 TR ID  | HHDFS76300000 | 모의 TR ID | 모의투자 미지원  
Format |  | Content-Type |   
