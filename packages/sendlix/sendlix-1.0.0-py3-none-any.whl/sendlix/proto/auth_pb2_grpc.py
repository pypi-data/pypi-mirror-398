...
class AuthStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.GetJwtToken = channel.unary_unary(
                '/sendlix.api.v1.Auth/GetJwtToken',
...
class AuthServicer(object):
    ...
    def GetJwtToken(self, request, context):
        """Missing associated documentation comment in .proto file."""
...
def add_AuthServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetJwtToken': grpc.unary_unary_rpc_method_handler(
                    servicer.GetJwtToken,
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'sendlix.api.v1.Auth', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('sendlix.api.v1.Auth', rpc_method_handlers)
