...
Hover over any translated string to see it highlighted. Click to edit inline. Changes are saved to your `.po` files and messages are recompiled automatically.
