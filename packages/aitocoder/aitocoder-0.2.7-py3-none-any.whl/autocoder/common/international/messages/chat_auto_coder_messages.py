...
Использование файла правил:
  ...
  Система автоматически отслеживает изменения в этом каталоге и обновляет правила.
    ...
    "wait_system_processing": {
        "en": "\u26A0  System is processing, please wait... (max wait time: {{timeout}} seconds)",
        "zh": "\u26A0  系统正在处理中，请稍等... (最多等待 {{timeout}} 秒)",
        "ja": "\u26A0  システムが処理中です、お待ちください... (最大待機時間: {{timeout}} 秒)",
        "ar": "\u26A0  النظام قيد المعالجة، يرجى الانتظار... (الحد الأقصى لوقت الانتظار: {{timeout}} ثانية)",
        "ru": "\u26A0  Система обрабатывает, пожалуйста, подождите... (максимальное время ожидания: {{timeout}} секунд)"
    },
