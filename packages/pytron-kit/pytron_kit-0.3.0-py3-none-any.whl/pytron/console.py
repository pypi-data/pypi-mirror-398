...
__all__ = ['console', 'log', 'get_progress', 'print_rule', 'run_command_with_output', 'Rule', 'set_log_file']
...
def run_command_with_output(cmd, env=None, cwd=None, style="dim", title=None, shell=False):
