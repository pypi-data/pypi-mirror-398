...
if IS_ANDROID:
    ...
    class AndroidBridge:
        ...
        def webview_create(self, debug, window): return 1
        def webview_navigate(self, w, url): self._send("navigate", {"url": url.decode('utf-8')})
        def webview_eval(self, w, js): self._send("eval", {"code": js.decode('utf-8')})
        def webview_destroy(self, w): pass
        def webview_run(self, w): pass
        def webview_set_title(self, w, t): pass
        def webview_set_size(self, w, width, height, hints): pass
