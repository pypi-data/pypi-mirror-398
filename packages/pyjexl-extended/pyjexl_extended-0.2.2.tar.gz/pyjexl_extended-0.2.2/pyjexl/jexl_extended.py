...
class JexlExtended(JEXL):
    def __init__(self, context=None):
        ...
        super().add_function("sort", self._extended_grammar.array_sort)
        super().add_function("$sort", self._extended_grammar.array_sort)
        super().add_transform("sort", self._extended_grammar.array_sort)
        super().add_function("order", self._extended_grammar.array_sort)
        super().add_function("$order", self._extended_grammar.array_sort)
        super().add_transform("order", self._extended_grammar.array_sort)
