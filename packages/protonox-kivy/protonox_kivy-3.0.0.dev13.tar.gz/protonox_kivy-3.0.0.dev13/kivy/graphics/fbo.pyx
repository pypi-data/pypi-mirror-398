...
# Define OpenGL ES constants for Android compatibility
DEF GL_FRAMEBUFFER_INCOMPLETE_DIMENSIONS = 0x8CD9
DEF GL_FRAMEBUFFER_UNDEFINED_OES = 0x8219
DEF GL_DEPTH24_STENCIL8_OES = 0x88F0

from libc.stdlib cimport malloc, free

def py_glReadPixels(GLint x, GLint y, GLsizei width, GLsizei height, GLenum format,
                    GLenum type):
...
# Export constants as Python attributes
