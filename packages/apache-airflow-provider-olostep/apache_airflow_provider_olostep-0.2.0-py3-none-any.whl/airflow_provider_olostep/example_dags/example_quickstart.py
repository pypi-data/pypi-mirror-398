...
with DAG(
    ...
    3. **Web Search** - Get AI-powered answers from web search
    ...
    # Task 3: AI-powered web search
    web_search = OlostepAnswerOperator(
        task_id="web_search",
        task="What are the top trending stories on Hacker News today?",
        doc_md="Use AI to search the web and find trending stories.",
    )
    ...
    def process_results(**context):
        ...
        search_result = ti.xcom_pull(task_ids="web_search")
        ...
        result_data = search_result.get("result", {}) if search_result else {}
        answer = result_data.get("markdown_content", "No answer")
        ...
        print(f"AI Web Search Answer: {answer[:200]}...")
        print("=" * 60)
    ...
    [scrape_homepage, create_sitemap, web_search] >> summarize
