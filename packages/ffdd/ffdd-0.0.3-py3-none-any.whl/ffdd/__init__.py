...
__doc__ = f'''list Files or Directories - an alternative to ls find tree du grep wc nl ...
 ...
 │  n  │ int  │ file's nesting = number of {sep!r} in path minus one       │
 ...
 │  z  │ str  │ last level of directory (no {sep!r})                       │
 │  d  │ str  │ abs path of directory (ending with {sep!r})                │
 │  f  │ str  │ filename                                               │
 ...
 │  n  │ int  │ dir's nesting = number of {sep!r} in path minus one        │
 ...
 │  e  │ str  │ ''                                                     │
 │  f  │ str  │ ''                                                     │
 │  p  │ str  │ abs path of directory (ending with {sep!r})                │
 │  q  │ str  │ ''                                                     │
 │  r  │ str  │ ''                                                     │
