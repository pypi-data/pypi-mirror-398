...
class SchemaStateManager:
    ...
    def _fetch_fresh_schema(self) -> DatabaseSchema:
        ...
        try:
            ...
            # ✅ FIX: Always use LocalRuntime for schema queries to avoid async context issues
            # Schema fetching is a simple query that doesn't benefit from async execution
            from kailash.runtime.local import LocalRuntime

            runtime = LocalRuntime()
            logger.debug("_fetch_fresh_schema: Using LocalRuntime for schema query")
