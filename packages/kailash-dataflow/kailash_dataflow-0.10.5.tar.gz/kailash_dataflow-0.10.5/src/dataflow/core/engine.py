...
class DataFlow:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Format: {database_type: (node, event_loop_id)} for event loop tracking (v0.9.8+)
    ...
    def _ensure_migration_tables(self, database_type: str = None):
        ...
        try:
            ...
            try:
                ...
                is_async = True
                logger.debug(
                    "_ensure_migration_tables: Detected async context, using AsyncLocalRuntime"
                )
            except RuntimeError:
                ...
                is_async = False
                logger.debug(
                    "_ensure_migration_tables: Detected sync context, using LocalRuntime"
                )
    ...
    def clear_async_sql_node_cache(self) -> None:
        ...
        Note: The event loop tracking mechanism (v0.9.8+) automatically detects
