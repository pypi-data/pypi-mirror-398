...
def create(
    ...
    :param skip_thumbnail: If True, skip thumbnail generation (e.g. in pyodide).
    ...
    # Create thumbnail if the file is a figure and generation is not skipped
    if is_figure and not skip_thumbnail:
        ...
        thumb_file.seek(0)
    elif is_figure and skip_thumbnail:
        # Still need metadata for it to be recognized as a figure
        data["metadata"] = json.dumps(
            {
                "svgedit": {},
            }
