...
if TYPE_CHECKING:
    from ..models.soa_enrollment_customer_account import SOAEnrollmentCustomerAccount


T = TypeVar("T", bound="SOAEnrollmentCustomerAccountIReadOnlyListApiResult")


@_attrs_define
class SOAEnrollmentCustomerAccountIReadOnlyListApiResult:
    """
    Attributes:
        ...
        data (Union[None, Unset, list['SOAEnrollmentCustomerAccount']]):
    """
    ...
    data: Union[None, Unset, list["SOAEnrollmentCustomerAccount"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> Union[None, Unset, list["SOAEnrollmentCustomerAccount"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for data_type_0_item_data in _data_type_0:
                    data_type_0_item = SOAEnrollmentCustomerAccount.from_dict(data_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list["SOAEnrollmentCustomerAccount"]], data)

        data = _parse_data(d.pop("data", UNSET))

        soa_enrollment_customer_account_i_read_only_list_api_result = cls(
        ...
        return soa_enrollment_customer_account_i_read_only_list_api_result
