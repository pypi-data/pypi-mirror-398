...
if TYPE_CHECKING:
    from ..models.reward_account_details import RewardAccountDetails


T = TypeVar("T", bound="RewardAccountDetailsIEnumerableApiResult")


@_attrs_define
class RewardAccountDetailsIEnumerableApiResult:
    """
    Attributes:
        ...
        data (Union[None, Unset, list['RewardAccountDetails']]):
    """
    ...
    data: Union[None, Unset, list["RewardAccountDetails"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> Union[None, Unset, list["RewardAccountDetails"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for data_type_0_item_data in _data_type_0:
                    data_type_0_item = RewardAccountDetails.from_dict(data_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list["RewardAccountDetails"]], data)

        data = _parse_data(d.pop("data", UNSET))

        reward_account_details_i_enumerable_api_result = cls(
        ...
        return reward_account_details_i_enumerable_api_result
