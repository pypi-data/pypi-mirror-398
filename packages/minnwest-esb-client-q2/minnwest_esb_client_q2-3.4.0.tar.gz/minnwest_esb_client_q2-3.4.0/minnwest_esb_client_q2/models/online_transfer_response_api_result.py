...
if TYPE_CHECKING:
    from ..models.online_transfer_response import OnlineTransferResponse


T = TypeVar("T", bound="OnlineTransferResponseApiResult")


@_attrs_define
class OnlineTransferResponseApiResult:
    """
    Attributes:
        ...
        data (Union[Unset, OnlineTransferResponse]):
    """
    ...
    data: Union[Unset, "OnlineTransferResponse"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = OnlineTransferResponse.from_dict(_data)

        online_transfer_response_api_result = cls(
        ...
        return online_transfer_response_api_result
