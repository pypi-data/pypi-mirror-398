...
T = TypeVar("T", bound="UpdateEmailResponseApiResult")


@_attrs_define
class UpdateEmailResponseApiResult:
    """
    Attributes:
        ...
        data (Union[Unset, UpdateEmailResponse]):
    """
    ...
    data: Union[Unset, "UpdateEmailResponse"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = UpdateEmailResponse.from_dict(_data)

        update_email_response_api_result = cls(
        ...
        return update_email_response_api_result
