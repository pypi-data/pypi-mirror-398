...
if TYPE_CHECKING:
    from ..models.get_name_response import GetNameResponse


T = TypeVar("T", bound="GetNameResponseApiResult")


@_attrs_define
class GetNameResponseApiResult:
    """
    Attributes:
        ...
        data (Union[Unset, GetNameResponse]):
    """
    ...
    data: Union[Unset, "GetNameResponse"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = GetNameResponse.from_dict(_data)

        get_name_response_api_result = cls(
        ...
        return get_name_response_api_result
