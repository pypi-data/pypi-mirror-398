...
T = TypeVar("T", bound="SoaAccountApiResult")


@_attrs_define
class SoaAccountApiResult:
    """
    Attributes:
    ...
    data: Union[Unset, "SoaAccount"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = SoaAccount.from_dict(_data)

        soa_account_api_result = cls(
