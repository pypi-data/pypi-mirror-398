...
if TYPE_CHECKING:
    from ..models.application_dto import ApplicationDto


T = TypeVar("T", bound="ApplicationDtoApiResult")


@_attrs_define
class ApplicationDtoApiResult:
    """
    Attributes:
        ...
        data (Union[Unset, ApplicationDto]):
    """
    ...
    data: Union[Unset, "ApplicationDto"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = ApplicationDto.from_dict(_data)

        application_dto_api_result = cls(
        ...
        return application_dto_api_result
