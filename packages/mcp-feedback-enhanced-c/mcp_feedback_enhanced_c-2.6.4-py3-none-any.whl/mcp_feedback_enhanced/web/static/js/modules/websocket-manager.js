...
(function() {
     ...
     * 設置 conversation ID
     */
    WebSocketManager.prototype.setConversationId = function(conversationId) {
        this.conversationId = conversationId;
        console.log('🔗 設置 conversation ID:', conversationId);
    };

    /**
     * 獲取 conversation ID
     */
    WebSocketManager.prototype.getConversationId = function() {
    ...
    WebSocketManager.prototype.connect = function() {
        ...
        // 添加 conversation_id 參數（如果有）
        if (this.conversationId) {
            params.append('c', this.conversationId);
            console.log('🔗 WebSocket 連接使用 conversation_id:', this.conversationId);
        }
    ...
    WebSocketManager.prototype.processMessage = function(data) {
        ...
        switch (data.type) {
            case 'connection_established':
                ...
                // 保存服務器返回的 conversation_id
                if (data.conversation_id) {
                    this.conversationId = data.conversation_id;
                    console.log('🔗 從服務器獲取 conversation_id:', data.conversation_id);
                }
