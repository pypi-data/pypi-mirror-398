...
(function() {
    ...
    SettingsManager.prototype.applyImageSettings = function() {
        ...
        // 更新所有圖片壓縮比例選擇器（包括設定頁籤中的）
        const compressionQualitySelects = document.querySelectorAll('[id$="ImageCompressionQuality"]');
        compressionQualitySelects.forEach(function(select) {
            select.value = this.currentSettings.imageCompressionQuality.toString();
        }.bind(this));
        ...
        console.log('圖片設定已應用到 UI:', {
            ...
            imageCompressionQuality: this.currentSettings.imageCompressionQuality
        });
    };
    ...
    SettingsManager.prototype.setupEventListeners = function() {
        ...
        // 圖片設定 - 壓縮比例選擇器
        const settingsImageCompressionQuality = Utils.safeQuerySelector('#settingsImageCompressionQuality');
        if (settingsImageCompressionQuality) {
            settingsImageCompressionQuality.addEventListener('change', function(e) {
                const value = parseFloat(e.target.value);
                self.set('imageCompressionQuality', value);
                console.log('圖片壓縮比例已更新:', value);
            });
        }
