...
(function() {
    ...
    function ImageHandler(options) {
        ...
        const initialCompressionQuality = parseFloat(options.imageCompressionQuality);
        if (Number.isFinite(initialCompressionQuality) && initialCompressionQuality > 0) {
            this.imageCompressionQuality = Math.min(1, initialCompressionQuality);
        } else {
            this.imageCompressionQuality = 1;
        }
        ...
        this.imageCompressionQualitySelect = null;
        ...
        this.fileUploadManager = new window.MCPFeedback.FileUploadManager({
            ...
            compressionQuality: this.imageCompressionQuality,
    ...
    ImageHandler.prototype.initImageSettingsElements = function() {
        ...
        this.imageCompressionQualitySelect = Utils.safeQuerySelector('#settingsImageCompressionQuality');
    ...
    ImageHandler.prototype.removeImageSettingsListeners = function() {
        ...
        if (this.imageCompressionQualitySelect && this.imageCompressionQualityChangeHandler) {
            this.imageCompressionQualitySelect.removeEventListener('change', this.imageCompressionQualityChangeHandler);
            this.imageCompressionQualityChangeHandler = null;
        }
    };
    ...
    ImageHandler.prototype.initImageSettings = function() {
        ...
        if (this.imageCompressionQualitySelect) {
            this.imageCompressionQualityChangeHandler = function(e) {
                const value = parseFloat(e.target.value);
                if (Number.isFinite(value) && value > 0) {
                    self.imageCompressionQuality = Math.min(1, value);
                } else {
            ...
            this.imageCompressionQualitySelect.addEventListener('change', this.imageCompressionQualityChangeHandler);
        }
    };
    ...
    ImageHandler.prototype.updateSettings = function(settings) {
        ...
        const compressionQuality = parseFloat(settings.imageCompressionQuality);
        if (Number.isFinite(compressionQuality) && compressionQuality > 0) {
            this.imageCompressionQuality = Math.min(1, compressionQuality);
        } else {
            this.imageCompressionQuality = 1;
        }
        ...
        if (this.imageCompressionQualitySelect) {
            this.imageCompressionQualitySelect.value = this.imageCompressionQuality.toString();
        }
    };
