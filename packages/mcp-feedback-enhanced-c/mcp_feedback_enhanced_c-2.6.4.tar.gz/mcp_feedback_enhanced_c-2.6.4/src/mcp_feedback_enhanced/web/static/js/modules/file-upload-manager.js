...
(function() {
    ...
    function FileUploadManager(options) {
        ...
        this.compressionQuality = this.normalizeCompressionQuality(options.compressionQuality);
    ...
    FileUploadManager.prototype.addFiles = function(files) {
        ...
        Promise.all(promises)
            .then(function(base64Results) {
                base64Results.forEach(function(result, index) {
                    const processedFile = result.file || files[index];
                    const fileData = {
                    ...
                    console.log('✅ 檔案已添加:', processedFile.name);
    ...
    FileUploadManager.prototype.fileToBase64 = function(file) {
        ...
        return this.compressImageFile(file)
            ...
            .catch(function(error) {
                console.warn('⚠️ 圖片壓縮失敗，使用原始檔案:', file.name, error);
                return new Promise(function(resolve, reject) {
                    const reader = new FileReader();
                    reader.onload = function() {
                        resolve({
     ...
     * 判斷是否需要壓縮
     */
    FileUploadManager.prototype.shouldCompressImage = function(file) {
     ...
     * 壓縮圖片檔案
     */
    FileUploadManager.prototype.compressImageFile = function(file) {
        const self = this;
            ...
            reader.onload = function() {
                ...
                img.onload = function() {
                    ...
                    canvas.toBlob(function(blob) {
                        ...
                        console.log('🗜️ 圖片已壓縮:', file.name, '品質', self.compressionQuality);
                        resolve(compressedFile);
                    }, outputType, self.compressionQuality);
                };
    ...
    FileUploadManager.prototype.updateSettings = function(settings) {
        ...
        this.compressionQuality = this.normalizeCompressionQuality(settings.imageCompressionQuality);
     ...
     * 正規化壓縮品質設定
     */
    FileUploadManager.prototype.normalizeCompressionQuality = function(value) {
