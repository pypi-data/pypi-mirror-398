"""Directory Manager Module for funcy_bear."""
...
from funcy_bear.constants import PATH_TO_CONFIG, PATH_TO_DOCUMENTS, PATH_TO_DOWNLOADS, PATH_TO_HOME, PATH_TO_PICTURES
