...
[`ci.yml`]: https://github.com/runsascoded/mdcmd/blob/v0.7.4/.github/workflows/ci.yml
[`bmd`]: #bmd
[`bmdf`]: #bmdf
[`bmdff`]: #bmdff
[`bmdfff`]: #bmdfff
...
[toc.py]: https://github.com/runsascoded/mdcmd/blob/v0.7.4/src/bmdf/toc.py
<!-- `scripts/gh-url.py print-table.py test/print-table.py` -->
[print-table.py]: https://github.com/runsascoded/mdcmd/blob/v0.7.4/test/print-table.py
<!-- `scripts/gh-url.py 'in CI' .github/workflows/ci.yml#L28-L31` -->
[in CI]: https://github.com/runsascoded/mdcmd/blob/v0.7.4/.github/workflows/ci.yml#L28-L31
<!-- `scripts/raw-readme-link.py mdcmd` -->
[raw-mdcmd]: https://github.com/runsascoded/mdcmd/blob/v0.7.4/README.md?plain=1#L5-L11
<!-- `scripts/raw-readme-link.py toc` -->
[raw-toc]: https://github.com/runsascoded/mdcmd/blob/v0.7.4/README.md?plain=1#L18-L32
