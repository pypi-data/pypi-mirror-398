...
class MiniRpaSapAutomation:
    ...
    def click_radio_checkbox(self, radio_checkbox_title, radio_checkbox_index=1):
        ...
        while wait_time > 0:
            try:
                radio_checkbox_element = self.web_rpa.find_radio_checkbox_element_by_css_selector(f"span[title='{radio_checkbox_title}']", radio_checkbox_index)
                if radio_checkbox_element is not None:
                    self.web_rpa.click_or_input_by_element(radio_checkbox_element, 'click')
                    return
            except NoSuchElementException:
                try:
                    radio_checkbox_element = self.web_rpa.find_radio_checkbox_element_by_css_selector(f"span[aria-label='{radio_checkbox_title}']", radio_checkbox_index)
                    if radio_checkbox_element is not None:
                        self.web_rpa.click_or_input_by_element(radio_checkbox_element, 'click')
                        return
                except NoSuchElementException:
    ...
    def click_radio_checkbox_by_mouse(self, radio_checkbox_title, radio_checkbox_index=1):
        ...
        while wait_time > 0:
            try:
                radio_checkbox_element = self.web_rpa.find_radio_checkbox_element_by_css_selector(f"span[title='{radio_checkbox_title}']", radio_checkbox_index)
                if radio_checkbox_element is not None:
                    self.web_rpa.move_to_and_click_element("", radio_checkbox_element)
                    return
            except NoSuchElementException:
                try:
                    radio_checkbox_element = self.web_rpa.find_radio_checkbox_element_by_css_selector(f"span[aria-label='{radio_checkbox_title}']", radio_checkbox_index)
