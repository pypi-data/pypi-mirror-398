...
class QueryExecutor:
    ...
    def _load_metadata(self):
        ...
        try:
            ...
            for table_info in stored_tables:
                ...
                self.schema.register_table(table)
    ...
    def execute_select(self, parsed: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        # Handle system table selection
        # Handle system table selection (treated as normal tables now)
        # if SystemTables.is_system_table(table_name):
        #      return self._select_system_table(table_name, parsed)
