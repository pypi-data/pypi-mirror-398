...
Use this tool online at **[DevTools.at](https://devtools.at/tools/json-minifier)** - Free, fast, and no registration required!

## Installation

```bash
pip install devtools_json_minifier
```

## Usage

```python
from devtools_json_minifier import process, encode, decode
...
**[https://devtools.at/tools/json-minifier](https://devtools.at/tools/json-minifier)**
