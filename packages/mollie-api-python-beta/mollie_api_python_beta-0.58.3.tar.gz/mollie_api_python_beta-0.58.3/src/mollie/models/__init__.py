...
if TYPE_CHECKING:
    ...
    from .entity_method_all import (
        ...
        EntityMethodAllMaximumAmountTypedDict,
        EntityMethodAllMinimumAmount,
        EntityMethodAllMinimumAmountTypedDict,
...
_dynamic_imports: dict[str, str] = {
    ...
    "AvailableAmount": ".entity_balance",
    "AvailableAmountTypedDict": ".entity_balance",
    "Currency": ".entity_balance",
    ...
    "PendingAmount": ".entity_balance",
    "PendingAmountTypedDict": ".entity_balance",
    "TransferDestination": ".entity_balance",
    "TransferDestinationTypedDict": ".entity_balance",
    "TransferFrequency": ".entity_balance",
    "TransferThreshold": ".entity_balance",
    "TransferThresholdTypedDict": ".entity_balance",
    ...
    "GrossAmount": ".entity_invoice",
    "GrossAmountTypedDict": ".entity_invoice",
    "NetAmount": ".entity_invoice",
    "NetAmountTypedDict": ".entity_invoice",
    "VatAmount": ".entity_invoice",
    "VatAmountTypedDict": ".entity_invoice",
    ...
    "EntityMethodAllID": ".entity_method_all",
    ...
    "EntityMethodAllMaximumAmount": ".entity_method_all",
    "EntityMethodAllMaximumAmountTypedDict": ".entity_method_all",
    "EntityMethodAllMinimumAmount": ".entity_method_all",
    "EntityMethodAllMinimumAmountTypedDict": ".entity_method_all",
    ...
    "AmountCaptured": ".payment_response",
    "AmountCapturedTypedDict": ".payment_response",
    "AmountChargedBack": ".payment_response",
    "AmountChargedBackTypedDict": ".payment_response",
    "AmountRefunded": ".payment_response",
    "AmountRefundedTypedDict": ".payment_response",
    "AmountRemaining": ".payment_response",
    "AmountRemainingTypedDict": ".payment_response",
    ...
    "AmountDue": ".sales_invoice_response",
    "AmountDueTypedDict": ".sales_invoice_response",
    "DiscountedSubtotalAmount": ".sales_invoice_response",
    "DiscountedSubtotalAmountTypedDict": ".sales_invoice_response",
    ...
    "SubtotalAmount": ".sales_invoice_response",
    "SubtotalAmountTypedDict": ".sales_invoice_response",
    "TotalAmount": ".sales_invoice_response",
    "TotalAmountTypedDict": ".sales_invoice_response",
    "TotalVatAmount": ".sales_invoice_response",
    "TotalVatAmountTypedDict": ".sales_invoice_response",
