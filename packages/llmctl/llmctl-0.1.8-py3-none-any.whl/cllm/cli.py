...
MODEL_PRICING = {
    ...
    # Anthropic models - Claude 3.5 (may require special API access)
    "claude-3-5-sonnet-20241022": {"input": 3.00, "output": 15.00},
    "claude-3-5-haiku-20241022": {"input": 0.80, "output": 4.00},

    # Anthropic models - Claude 3 (stable, widely available)
...
class AnthropicProvider(LLMProvider):
    ...
    def __init__(self, api_key, model="claude-3-sonnet-20240229"):
        ...
        model_map = {
            # Claude 3.5 models (if available - may require special access)
            "sonnet-3.5": "claude-3-5-sonnet-20241022",
            "haiku-3.5": "claude-3-5-haiku-20241022",
            # Claude 3 models (stable and widely available)
            "sonnet-4": "claude-3-sonnet-20240229",
            "sonnet": "claude-3-sonnet-20240229",
            "haiku-4": "claude-3-haiku-20240307",
...
class CLLM:
    ...
    def interactive(self, session_name="default"):
        ...
        print_colored("  🚀 CLLM - Interactive LLM Session", Fore.CYAN, Style.BRIGHT)
