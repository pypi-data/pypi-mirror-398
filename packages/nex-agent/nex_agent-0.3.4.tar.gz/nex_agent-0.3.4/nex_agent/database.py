...
class Database:
    ...
    def update_model(self, model_key: str, new_key: str = None, model_id: str = None, display_name: str = None, thinking_model_id: str = None, clear_thinking: bool = False) -> bool:
        """更新模型"""
        with self.get_conn() as conn:
            updates = []
            params = []
