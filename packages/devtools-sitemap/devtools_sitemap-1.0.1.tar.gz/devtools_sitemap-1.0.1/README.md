...
Use this tool online at **[DevTools.at](https://devtools.at/tools/sitemap-generator)** - Free, fast, and no registration required!

## Installation

```bash
pip install devtools_sitemap
```

## Usage

```python
from devtools_sitemap import process, encode, decode
...
**[https://devtools.at/tools/sitemap-generator](https://devtools.at/tools/sitemap-generator)**
