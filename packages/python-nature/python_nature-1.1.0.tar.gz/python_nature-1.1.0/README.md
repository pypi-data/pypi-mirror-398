...
```bash
pip install python-nature
```

Then import as:

```python
from nature import Species, evolve, Evaluator, Incubator
...
**All dependencies are installed automatically**, including:
...
- And more (see [pyproject.toml](pyproject.toml) for full list)

**For Development**:

```bash
# Clone the repository
git clone https://github.com/dgabriele/nature.git
cd nature
