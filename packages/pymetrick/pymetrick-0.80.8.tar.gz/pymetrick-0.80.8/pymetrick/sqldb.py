            ...
            if sql:
                ...
                if parameters is not None:
                    ...
                    if len(sql_list)>2 or sql[0:4].upper() in ('CALL',):
                        ...
                        return request
                    elif sql[0:14].upper() in ('WITH RECURSIVE',):
...
if __name__ == "__main__":
    ...
    try:
        ...
        __db__ = SQLdb(host='universofiesta.es',database='universofiesta',username='root',password='headcracker_sql',driver='mariadb',port='4306')
        print(type(__db__))
        ...
        sql = " \
                    SELECT \
                        o.id, o.order_serial, o.year, o.next_code, o.name, o.date_updated, o.flow, o.veri_factu FROM orders_type AS o \
                    WHERE \
                        o.dealer_id = 1 AND o.action = 'output' AND o.order_serial = 'AL' \
                        AND o.entity_type_id = 5 \
                    ORDER BY o.dealer_id, o.entity_type_id, o.action, o.order_serial DESC \
                    LIMIT 1 FOR UPDATE;"
        n = __db__.execute(sql)
        print(n)
    except Exception as e:
        tb = sys.exc_info()[2]
        LOG.error("{0} in line {1} !!!".format(repr(e),tb.tb_lineno))
