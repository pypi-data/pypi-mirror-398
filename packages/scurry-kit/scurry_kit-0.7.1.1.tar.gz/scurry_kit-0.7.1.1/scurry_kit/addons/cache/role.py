...
class RoleCacheAddon(Addon):
    ...
    def __init__(self, client: Client):
        ...
        client.add_event_listener('ROLE_CREATE', self.on_role_create)
        client.add_event_listener('ROLE_UPDATE', self.on_role_update)
        client.add_event_listener('ROLE_DELETE', self.on_role_delete)
