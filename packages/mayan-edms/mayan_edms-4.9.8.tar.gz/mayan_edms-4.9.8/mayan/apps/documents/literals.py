...
# Tasks
DEFAULT_DOCUMENTS_STUBS_DELETE_TASK_INTERVAL = 60 * 30  # 30 minutes
DEFAULT_DOCUMENTS_TRASHED_DELETE_PERIODS_CHECK_TASK_INTERVAL = 60 * 30  # 30 minutes
DEFAULT_DOCUMENTS_TRASH_PERIOD_CHECK_TASK_INTERVAL = 60 * 30  # 30 minutes
