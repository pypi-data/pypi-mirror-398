...
setup(
    ...
    version="1.0.3",  # ⚠️ Update version for each release
    author="Your Company Name",  # ⚠️ CHANGE THIS
    author_email="your.email@example.com",  # ⚠️ CHANGE THIS
    description="A powerful Python package for text formatting and validation. Includes utilities for text transformation (title case, snake case, reverse, etc.) and data validation (email, phone, password strength). Perfect for data processing, form validation, and text manipulation tasks.",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/yourusername/textformatter-plus",  # ⚠️ Optional: Change if you have a GitHub repo
    packages=find_packages(include=["textformatter_plus", "textformatter_plus.*"]),
    classifiers=[
