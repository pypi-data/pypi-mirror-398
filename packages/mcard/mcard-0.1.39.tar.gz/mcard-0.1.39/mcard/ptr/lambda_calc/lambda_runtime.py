...
class LambdaRuntime:
    ...
    def _numeric_op(self, operation: str, context: Dict[str, Any]) -> LambdaRuntimeResult:
        ...
        try:
            ...
            if operation == 'num-add': result = val_a + val_b
            elif operation == 'num-sub': result = val_a - val_b
            elif operation == 'num-mul': result = val_a * val_b
            elif operation == 'num-div': 
                if val_b == 0: return LambdaRuntimeResult(success=False, error="Division by zero")
                result = val_a / val_b
            else:
