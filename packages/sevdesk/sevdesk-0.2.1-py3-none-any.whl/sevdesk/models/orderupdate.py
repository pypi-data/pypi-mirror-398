...
class OrderUpdate(BaseModel):
    ...
    status: Optional[int] = Field(default=None, description="Please have a look in <a href='#tag/Order/Types-and-status-of-orders'>status of orders</a> to see what the different status codes mean")
    ...
    version: Optional[int] = Field(default=None, description="Version of the order.<br> Can be used if you have multiple drafts for the same order.<br> Should start with 0")
    ...
    sumNet: Optional[float] = Field(default=None, description="Net sum of the order")
    sumTax: Optional[float] = Field(default=None, description="Tax sum of the order")
    sumGross: Optional[float] = Field(default=None, description="Gross sum of the order")
    sumDiscounts: Optional[float] = Field(default=None, description="Sum of all discounts in the order")
    sumNetForeignCurrency: Optional[float] = Field(default=None, description="Net sum of the order in the foreign currency")
    sumTaxForeignCurrency: Optional[float] = Field(default=None, description="Tax sum of the order in the foreign currency")
    sumGrossForeignCurrency: Optional[float] = Field(default=None, description="Gross sum of the order in the foreign currency")
    sumDiscountsForeignCurrency: Optional[float] = Field(default=None, description="Discounts sum of the order in the foreign currency")
