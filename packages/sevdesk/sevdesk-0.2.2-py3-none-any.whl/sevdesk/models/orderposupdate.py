...
class OrderPosUpdate(BaseModel):
    ...
    quantity: Optional[float] = Field(default=None, description="Quantity of the article/part")
    ...
    taxRate: Optional[float] = Field(default=None, description="Tax rate of the position.")
