...
def cmd_init(name: str) -> None:
    ...
    try:
        ...
        shutil.copy(
            templates_dir / "faq_example.md",
            project_dir / "faqs" / "it_support_faq.md"
        )
...
"""
        ...
        print(f"  ├── faqs/it_support_faq.md")
        print(f"  ├── .env.example")
        print(f"  ├── .gitignore")
        print(f"  └── README.md")
        print(f"\n🚀 Next steps:")
        ...
        print(f"  #   TELEGRAM_TOKEN=your_token")
        print(f"  #   GIGACHAT_KEY=your_key")
        print(f"  #   YANDEX_API_KEY=your_key")
        print(f"  telegram-bot run")
...
def main() -> None:
    ...
    init_parser = subparsers.add_parser(
        "init",
        help="Create new bot project from template"
    )
    ...
    subparsers.add_parser(
        "run",
        help="Run bot from current directory"
    )
    
    # rebuild command
    rebuild_parser = subparsers.add_parser(
        "rebuild",
        help="Rebuild FAQ index for mode"
    )
    ...
    subparsers.add_parser(
        "version",
        help="Show version and project information"
    )
