...
def setup_structured_logging(log_format: str = "text", level: int = logging.INFO) -> None:
    """
    ...
    logger.info(f"✅ Structured logging initialized (format: {log_format}, level: {logging.getLevelName(level)})")
