...
class ScalarDistributionMixin:
    ...
    def plot(
        ...
        Args:
            ...
            variable_name: the name of the variable described by this distribution.
        ...
        if file_extension == "html":
            ...
            fig.update_layout(
                title=f"Probability distribution of {variable_name}",
            )
            if save:
                directory_path = (
                    Path().cwd() if directory_path == "" else Path(directory_path)
                )
                file_name = f"pdf_{variable_name}" if file_name == "" else file_name
