...
class OTWeibullDistribution(OTDistribution):
    ...
    _STANDARD_PARAMETER_NAMES = ("location", "scale", "shape")

    _REMAPPING_PARAMETER_NAMES = {
        BaseDistribution._LOCATION: "location",
        BaseDistribution._SCALE: "scale",
        BaseDistribution._SHAPE: "shape",
    }
