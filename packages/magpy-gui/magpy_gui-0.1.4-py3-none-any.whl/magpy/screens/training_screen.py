"""
Training Screen - Model training and evaluation interface.

Provides UI for training ML models for bioacoustic classification
and detection tasks.
"""
...
class TrainingScreen(BaseScreen):
    ...
    def _setup_ui(self):
        ...
        description = QLabel(
            "Train and evaluate ML models for bioacoustics.\n\n"
            "- Select and split datasets\n"
            "- Configure hyperparameters\n"
            "- Visualize training progress\n"
            "- Integrate with TensorBoard/MLflow\n"
