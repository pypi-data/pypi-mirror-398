...
from .registry import log_action_registry, LogActionResult
...
def log_action(
    ...
    title=None,
    data=None,
    result: LogActionResult = LogActionResult.NOTSET,
    **kwargs
):
    ...
    Parameters:
        ...
        result (optional): The result of the action (like SUCCESS,WARNING etc,),
                if needed. Defaults to LogActionResult.NOTSET.
