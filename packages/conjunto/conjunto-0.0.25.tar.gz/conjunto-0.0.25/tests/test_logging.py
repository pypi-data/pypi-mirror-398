...
from conjunto.audit_log.registry import LogActionRegistry, LogActionResult
...
def test_log_with_explicit_user_and_uuid(mocker):
    ...
    test_instance = TestModel2()
    test_user = mocker.Mock()
    test_uuid = uuid.uuid4()

    # Register the model with the registry
    registry.register_model(TestModel2, TestLogEntryModel)
