...
.. |badge1| image:: https://git.gfz.de/EnMAP/GFZ_Tools_EnMAP_BOX/enfrosp/badges/main/pipeline.svg
    :target: https://git.gfz.de/EnMAP/GFZ_Tools_EnMAP_BOX/enfrosp/pipelines
    :alt: Pipelines

.. |badge2| image:: https://git.gfz.de/EnMAP/GFZ_Tools_EnMAP_BOX/enfrosp/badges/main/coverage.svg
...
.. |badge6| image:: https://img.shields.io/pypi/l/enfrosp.svg
    :target: https://git.gfz.de/EnMAP/GFZ_Tools_EnMAP_BOX/enfrosp/-/blob/main/LICENSE
...
`here <https://git.gfz.de/EnMAP/GFZ_Tools_EnMAP_BOX/enfrosp/-/blob/main/HISTORY.rst>`__.
