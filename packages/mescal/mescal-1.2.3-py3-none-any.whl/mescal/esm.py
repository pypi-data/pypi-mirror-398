...
class PathwayESM(ESM):
    ...
    dataframes, .dat files, etc. corresponding to all time steps of a pathway ESM. You can also use this class to
    generate several ESM databases simultaneously, even for the same time step, e.g., with different background
    databases.
    """
    ...
    def __init__(
        ...
        :param time_steps: List of dictionaries, each containing parameters for a time step in the pathway ESM.
            ...
            'main_database_name', 'model' and 'lifetime'. If you aim to generate ESM databases for the same year, but
            with different assumptions, e.g., different background databases, you might rather use the 'year' entry
            as an identifier.
