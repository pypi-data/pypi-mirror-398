...
ListOfFindingUpdates = list[FindingUpdate]
OptListOfFindingUpdates = ListOfFindingUpdates | None


class FindingUpdatesMixin(BaseModel):
    finding_updates: Annotated[
        OptListOfFindingUpdates,
        Field(None, description="Finding updates", min_length=1),
    ] = None
