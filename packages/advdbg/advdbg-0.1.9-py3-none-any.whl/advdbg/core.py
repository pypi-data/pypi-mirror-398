	...
	def info(self, text):
			...
			if self.activated:
				if self.legacy:
					...
					print(f' Info - {self.title} ({datetime.now().strftime("%D, %H:%M:%S")}) | {text}')
				if self.logging:
	...
	def warn(self, text):
			...
			if self.activated:
				if self.legacy:
					...
					print(f' Warn - {self.title} ({datetime.now().strftime("%D, %H:%M:%S")}) | {text}')
				if self.logging:
	...
	def error(self, text):
			...
			if self.activated:
				if self.legacy:
					...
					print(f' Error - {self.title} ({datetime.now().strftime("%D, %H:%M:%S")}) | {text}')
				if self.logging:
