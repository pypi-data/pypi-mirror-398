...
def main():
    ...
    parser.add_argument("length", metavar="length", type=str, help="Box length in U (1U = 42 mm)")
    parser.add_argument("width", metavar="width", type=str, help="Box width in U (1U = 42 mm)")
    parser.add_argument("height", metavar="height", type=str, help="Box height in U (1U = 7 mm)")
    parser.add_argument(
        "+l",
        "--label",
        action="store_true",
    ...
    if box.lid_window:
        print("  Lid window dimensions: %.2f x %.2f mm, %.2f mm thickness" % (*box.lid_window_size(), box.window_th))
    ...
    if argsd["genlatch"]:
        ...
        g = True
    if argsd["genwindow"]:
        print("Rendering lid window (%.2f x %.2f mm, %.2f mm thickness)..." % (*box.lid_window_size(), box.window_th))
