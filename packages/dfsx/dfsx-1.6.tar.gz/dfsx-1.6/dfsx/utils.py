...
def run_app_supercore() -> Tuple[int, str]:
    ...
    try:
        ...
        # Prompt for process name after supercore command
        process_name = get_user_input("Enter process name for the app")
        
        # Wait 2.5 seconds after user enters process name
        time.sleep(2.5)
