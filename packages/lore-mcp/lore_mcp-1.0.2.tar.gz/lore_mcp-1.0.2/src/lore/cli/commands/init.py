    ...
    "PostToolUse": [
        {
            ...
            "hooks": [
                {
                    "type": "command",
                    "command": "uvx lore-mcp python -m lore.hooks.post_tool_use",
                }
            ],
        }
    ],
    "Stop": [
        {
            ...
            "hooks": [
                {
                    "type": "command",
                    "command": "uvx lore-mcp python -m lore.hooks.on_stop",
                }
            ],
        }
    ],
...
def init_command(
    ...
    if api_key:
        ...
        console.print("  [dim]# Get your key at: https://lore-dashboard.jadecon2655.workers.dev/api-keys[/dim]\n")
