...
Upload any file to a document via `/api/method/upload_file`:
...
# Local file path
client.upload_file(
    file="Deep Purple.jpg",
    doctype="Work Item",
    docname="067d50f8-f0e7-4fb4-a560-560308742f81",
    file_name="Deep Purple.jpg",
    is_private=False,
)

# Bytes (e.g., downloaded from Jira)
# content = requests.get(jira_url, timeout=30).content
# client.upload_file(content, "Work Item", work_item_hash, file_name="image.png")

# Remote URL (no binary upload, avoids gateway size limits)
client.upload_file(
    file_url="https://raw.githubusercontent.com/github/explore/main/topics/python/python.png",
    doctype="Work Item",
    docname="067d50f8-f0e7-4fb4-a560-560308742f81",
