...
Returns:
    QuotaAlert: Alert details"""
        response = await self._client.request("GET", f"/quotas/{quota_id}/alerts/{alert_id}")
        return QuotaAlert(**response)
...
Returns:
    QuotaAlert: Alert updated successfully"""
        response = await self._client.request("PUT", f"/quotas/{quota_id}/alerts/{alert_id}", json=request.model_dump(mode='json', exclude_none=True))
        return QuotaAlert(**response)
...
Returns:
    QuotaAlertsDeleteResponse: Alert deleted successfully"""
        response = await self._client.request("DELETE", f"/quotas/{quota_id}/alerts/{alert_id}")
...
View a log of triggered alerts for a quota.
...
Returns:
    PaginatedResponse[QuotaAlertLog]: Alert history"""
        ...
        params = {k: v for k, v in params.items() if v is not None}
        response = await self._client.request("GET", f"/quotas/{quota_id}/alerts/history", params=params)
        return PaginatedResponse(
