...
binary_mask = jnp.zeros((256, 256), dtype=jnp.float32)
# binary_mask[100:150, 100:150] = 1
binary_mask = binary_mask.at[100:150, 100:150].set(1)

binart_mask2 = jnp.zeros((348, 348), dtype=jnp.float32)
binart_mask2 = binart_mask2.at[100:200, 100:200].set(1)

vizy.save("binary_mask.png", [binary_mask, binart_mask2])
