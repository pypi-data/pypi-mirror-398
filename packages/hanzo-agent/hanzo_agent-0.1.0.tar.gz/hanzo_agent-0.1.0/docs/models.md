...
```python
from agents import Agent, Runner, AsyncHanzo AI, Hanzo AIChatCompletionsModel
import asyncio
...
2. Use [`Hanzo AIChatCompletionsModel`][agents.models.openai_chatcompletions.Hanzo AIChatCompletionsModel]. There are examples [here](https://github.com/openai/openai-agents-python/tree/main/examples/model_providers/).
