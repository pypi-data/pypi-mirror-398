...
class TestText:
    ...
    def test_slugify_unicode(self):
        ...
        assert slugify("Café") == "cafe"  # Without unicode - é becomes e
        assert slugify("Café", allow_unicode=True) == "café"  # With unicode
    ...
    def test_truncate_chars(self):
        ...
        assert truncate_chars("Hello World Test", 10) == "Hello W..."  # 7 chars + ...
