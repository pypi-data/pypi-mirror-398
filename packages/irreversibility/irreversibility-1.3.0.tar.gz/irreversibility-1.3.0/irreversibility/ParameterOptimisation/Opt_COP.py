...
"""
Optimisation of the parameters of the Continuous Ordinal Patterns test
...
def Optimisation( tsSet, paramSet = None, target = 'p-value', criterion = np.median, numProcesses = -1, **kwargs ):
    ...
    """
    Optimise the parameters for the Continuous Ordinal Patterns test.
    ...
    for pSet in p1Set:
        ...
        if numProcesses == -1:
            ...
            for k in range( len( tsSet ) ):
                pV[ k ] = GetPValue( tsSet[ k ], pSize = pSet, **kwargs )[ nTarget ]
