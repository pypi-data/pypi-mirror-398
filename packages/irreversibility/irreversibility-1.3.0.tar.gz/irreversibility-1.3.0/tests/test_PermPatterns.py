...
def test_GetPValue( length ):
    ...
    with pytest.raises(ValueError):
        irr.Metrics.PermPatterns.GetPValue( TS, pSize = 1. )
    with pytest.raises(ValueError):
        irr.Metrics.PermPatterns.GetPValue( TS, pSize = -1 )
...
def test_GetStatistic( length ):
    ...
    result = irr.Metrics.PermPatterns.GetStatistic( TS )
...
def test_Optimisation():
    ...
    from irreversibility.ParameterOptimisation.Opt_PermPatterns import Optimisation
