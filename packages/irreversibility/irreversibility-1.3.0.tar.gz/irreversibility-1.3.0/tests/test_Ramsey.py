...
def test_GetPValue( length ):
    ...
    with pytest.raises(ValueError):
        irr.Metrics.Ramsey.GetPValue( TS, kappa = 1. )
    with pytest.raises(ValueError):
        irr.Metrics.Ramsey.GetPValue( TS, kappa = -1 )
...
def test_GetStatistic( length ):
    ...
    result = irr.Metrics.Ramsey.GetStatistic( TS )
...
def test_Optimisation():
    ...
    from irreversibility.ParameterOptimisation.Opt_Ramsey import Optimisation
