...
class WebSapCommonFunctions:
    ...
    def find_radio_checkbox_element_by_title(self, radio_checkbox_title: str, radio_checkbox_index):
        """This function is used to find input element by title
        ...
        """
        target_element = None
        target_elements = self.browser.find_elements(By.CSS_SELECTOR, f"span[title='{radio_checkbox_title}']")
