...
A Python implementation of outlier detection in multi-dimensional data using vector cosine similarity
...
Author: Z Shen
Code optimized with assistance from Grok (xAI)

Copyright (c) 2024-2025 Z Shen
