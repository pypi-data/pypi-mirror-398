...
from android_use.tools.registry.views import (
    ActionModel,
    ActionRegistry,
    RegisteredAction,
)
...
class Registry(Generic[Context]):
    ...
    def _create_param_model(self, function: Callable) -> Type[BaseModel]:
        ...
        params = {
            ...
            if name != 'android' and name != 'page_extraction_llm' and name != 'available_file_paths'
        }
    ...
    async def execute_action(
            ...
            action_name: str,
            params: dict,
            android: Optional[AndroidContext] = None,
        ...
        try:
            ...
            # Check if the action requires android
            if 'android' in parameter_names and not android:
                raise ValueError(f'Action {action_name} requires android but none provided.')
            ...
            if 'android' in parameter_names:
                extra_args['android'] = android
