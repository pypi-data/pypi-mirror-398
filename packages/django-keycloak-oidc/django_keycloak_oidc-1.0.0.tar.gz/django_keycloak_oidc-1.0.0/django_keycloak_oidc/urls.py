...
from django_keycloak_oidc.utils import import_from_settings

DEFAULT_CALLBACK_CLASS = "django_keycloak_oidc.views.OIDCAuthenticationCallbackView"
...
DEFAULT_AUTHENTICATE_CLASS = "django_keycloak_oidc.views.OIDCAuthenticationRequestView"
