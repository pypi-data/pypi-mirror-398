...
from django_keycloak_oidc.middleware import SessionRefresh
from django_keycloak_oidc.urls import urlpatterns as orig_urlpatterns
...
@patch("django_keycloak_oidc.middleware.get_random_string")
