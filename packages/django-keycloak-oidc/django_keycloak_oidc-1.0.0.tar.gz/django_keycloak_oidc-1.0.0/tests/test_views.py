...
from django_keycloak_oidc import views
...
class OIDCAuthorizationCallbackViewTestCase(TestCase):
    ...
    def test_get_auth_success(self):
        ...
        with patch("django_keycloak_oidc.views.auth.authenticate") as mock_auth:
            with patch("django_keycloak_oidc.views.auth.login") as mock_login:
    ...
    def test_get_auth_error(self):
        ...
        with patch("django_keycloak_oidc.views.auth.logout") as mock_logout:
...
class OIDCAuthorizationRequestViewTestCase(TestCase):
    ...
    @patch("django_keycloak_oidc.views.get_random_string")
    ...
    @override_settings(OIDC_USE_PKCE=True)
    @patch("django_keycloak_oidc.views.get_random_string")
    @patch("django_keycloak_oidc.views.OIDCAuthenticationRequestView.get_extra_params")
