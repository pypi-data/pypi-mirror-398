...
.. py:attribute:: OIDC_EXEMPT_URLS
   ...
   Django view names. This plus the django-keycloak-oidc urls are exempted from
...
.. py:attribute:: OIDC_CALLBACK_CLASS
   ...
   :default: ``django_keycloak_oidc.views.OIDCAuthenticationCallbackView``
...
.. py:attribute:: OIDC_AUTHENTICATE_CLASS
   ...
   :default: ``django_keycloak_oidc.views.OIDCAuthenticationRequestView``
...
.. py:attribute:: OIDC_RP_SCOPES
   ...
   .. warning::
      ...
      since the default one only works for the default ``django-keycloak-oidc`` configuration.
