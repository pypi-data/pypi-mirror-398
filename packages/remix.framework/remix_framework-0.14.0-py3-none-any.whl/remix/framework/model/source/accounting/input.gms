...
set pc_accounting_converterUnits
    ...
    /;
table accounting_converterUnitsIn(indicator,accNodesData,accYears,converter_techs,vintage,pc_accounting_converterUnits)
$onDelim
...
set pc_accounting_converterActivity
    ...
    /;
table accounting_converterActivityIn(indicator,accNodesData,accYears,converter_techs,vintage,activity,pc_accounting_converterActivity)
$onDelim
...
set pc_accounting_converterStartup
    ...
    /;
table accounting_converterStartupIn(indicator,accNodesData,accYears,converter_techs,vintage,pc_accounting_converterStartup)
$onDelim
...
set pc_accounting_storageUnits
    ...
    interest            "Interest | (Only required for annuity) The interest rate used for the calculation of the annuity factors | needs:['useAnnuity'] | number | {none} | OEO_00240021:discount rate"
    /;
table accounting_storageUnitsIn(indicator,accNodesData,accYears,storage_techs,vintage,pc_accounting_storageUnits)
$onDelim
...
set pc_accounting_transferLinks
    ...
    interest            "Interest | (Only required for annuity) The interest rate used for the calculation of the annuity factors | needs:['useAnnuity'] | number | {none} | OEO_00240021:discount rate"
    /;
table accounting_transferLinksIn(indicator,accLinksData,accYears,transfer_techs,vintage,pc_accounting_transferLinks)
$onDelim
...
set pc_accounting_transferPerLength
    ...
    interest            "Interest | (Only required for annuity) The interest rate used for the calculation of the annuity factors | needs:['useAnnuity'] | number | {none} | OEO_00240021:discount rate"
    /;
table accounting_transferPerLengthIn(indicator,accLinksData,accYears,transfer_techs,vintage,link_types,pc_accounting_transferPerLength)
$onDelim
...
set pc_accounting_sourcesinkFlow
    ...
    /;
table accounting_sourcesinkFlowIn(indicator,accNodesData,accYears,sourcesink_techs,commodity,pc_accounting_sourcesinkFlow)
$onDelim
...
set pc_accounting_indicatorBounds
    ...
    integral            "Integral | Weighting of indicators according to 'endyear'; derived by multiplying annual indicator with length of the intervals between years | | boolean | {none} | OEO_00000339:program parameter"
    endyear             "Endyear | (Only required for integral indicators) Interval length of last model year; the number of years used for the last year slice or 'perpetuity' | | integer | {none} | OEO_00000339:program parameter"
...
$batinclude %aggregateAccountingMean% accounting_sourcesinkFlow indicator nodes sourcesink_techs,commodity 0
...
accounting_indicatorBounds(accNodesModel,accYears,indicator,pc_accounting_indicatorBounds)
    $(sum (nodesModelToCalc$sameas(accNodesModel,nodesModelToCalc), 1) > 0)
    = sum ((accNodesData,nodesDataToCalc,nodesModelToCalc)
            $(aggregateNodesModel(nodesDataToCalc,nodesModelToCalc) and sameas(accNodesModel,nodesModelToCalc) and sameas(accNodesData,nodesDataToCalc)),
        accounting_indicatorBoundsIn(accNodesData,accYears,indicator,pc_accounting_indicatorBounds));
...
accounting_perIndicatorAgg(indicator,indicator_a,nodesModelToCalc,accYears,pc_accounting_perIndicator)
    $sum((nodesDataToCalc,accnodesData)
            $(aggregatenodesModel(nodesDataToCalc,nodesModelToCalc) and sameas(nodesDataToCalc,accnodesData)
...
accounting_perIndicator(indicator,indicator_a,accNodesModel,accYears,pc_accounting_perIndicator)
    $sum(nodesModelToCalc$(accounting_perIndicatorAgg(indicator,indicator_a,nodesModelToCalc,"horizon",pc_accounting_perIndicator)
        and sameas(accNodesModel,nodesModelToCalc)), 1)
    = sum(nodesModelToCalc$sameas(accNodesModel,nodesModelToCalc),
        accounting_perIndicatorAgg(indicator,indicator_a,nodesModelToCalc,"horizon",pc_accounting_perIndicator));

accounting_perIndicator(indicator,indicator_a,accNodesModel,accYears,pc_accounting_perIndicator)
    $sum(nodesModelToCalc$(accounting_perIndicatorAgg(indicator,indicator_a,nodesModelToCalc,accYears,pc_accounting_perIndicator)
        and sameas(accNodesModel,nodesModelToCalc) and not sameas(accYears, "horizon")), 1)
    = sum(nodesModelToCalc$sameas(accNodesModel,nodesModelToCalc),
        accounting_perIndicatorAgg(indicator,indicator_a,nodesModelToCalc,accYears,pc_accounting_perIndicator));
...
* Clear other dependencies and only add self mapping for variable and qp indicators
accounting_perIndicator(indicator,indicator_a,accNodesModel,accYears,"perIndicator")
    $(variableIndicators(accNodesModel,accYears,indicator))
    = 0;
accounting_perIndicator(indicator,indicator,accNodesModel,accYears,"perIndicator")
    $(variableIndicators(accNodesModel,accYears,indicator))
    = 1;
...
* Add self mapping for variable and qp indicators
yearFactor(accNodesModel,accYears,indicator,accYears)
    $(variableIndicators(accNodesModel,accYears,indicator))
    = 1;
...
compoundIndicatorsExt(accNodesModel,accYears,indicator,accNodesModel_a,accYears_a,indicator_a,accNodesModel_aa,accYears_aa,indicator_a)
    $(compoundIndicators_act(accNodesModel,accYears,indicator)
        and compoundIndicators(accNodesModel,accYears,indicator,accNodesModel_a,accYears_a,indicator_a)
        and not variableIndicators(accNodesModel_a,accYears_a,indicator_a)
        and map_accYears(accYears_aa,accYears_a)
        and map_accNodes(accNodesModel_aa,accNodesModel_a))
    = compoundIndicators(accNodesModel,accYears,indicator,accNodesModel_a,accYears_a,indicator_a)
...
compoundIndicatorsExt(accNodesModel,accYears,indicator,accNodesModel_a,accYears_a,indicator_a,accNodesModel_aa,accYears_aa,indicator_aa)
    $(compoundIndicatorsExt(accNodesModel,accYears,indicator,accNodesModel_a,accYears_a,indicator_a,accNodesModel_aa,accYears_aa,indicator_aa)
        and not variableIndicators(accNodesModel_aa,accYears_aa,indicator_aa)
...
compoundIndicatorsExt(accNodesModel,accYears,indicator,accNodesModel_a,accYears_a,indicator_a,accNodesModel_aa,accYears_aa,indicator_aa)
    $(compoundIndicatorsExt(accNodesModel,accYears,indicator,accNodesModel_a,accYears_a,indicator_a,accNodesModel_aa,accYears_aa,indicator_aa)
        and (sum((accNodesModel_aaa,accYears_aaa)$variableIndicators(accNodesModel_aaa,accYears_aaa,indicator_a), 1)
                or sum((accNodesModel_aaa,accYears_aaa)$variableIndicators(accNodesModel_aaa,accYears_aaa,indicator_aa), 1))
        and not variableIndicators(accNodesModel_aa,accYears_aa,indicator_aa))
    = 0;
...
compoundIndicators(accNodesModel,accYears,indicator,accNodesModel_aa,accYears_aa,indicator_aa)
    $(compoundIndicators(accNodesModel,accYears,indicator,accNodesModel_aa,accYears_aa,indicator_aa)
        and sum((accNodesModel_aaa,accYears_aaa)$variableIndicators(accNodesModel_aaa,accYears_aaa,indicator_aa), 1)
        and not variableIndicators(accNodesModel_aa,accYears_aa,indicator_aa))
    = 0;
...
compoundIndicatorsFull(accNodesModel,accYears,indicator,accNodesModel,accYears,indicator)
    $(activeIndicators(accNodesModel,accYears,indicator)
        or variableIndicators(accNodesModel,accYears,indicator))
    = 1;
