...
$iftheni.fcfgdx %fixedcapsfromgdx%==None
  $(years.val < smin(yearsToCalc,yearsToCalc.val))
$endif.fcfgdx
...
* Technologies have to be decommissioned in the interval of first avail + lifetime to last avail + lifetime
...
converter_decomTech(nodesModel,years,converter_techs,vintage)
  $(sum(years_a$(converter_usedTech(nodesModel,years_a,converter_techs,vintage)
...
* decommission also when the first of yearsToCalc is further away than the end of the tech's lifeTime
converter_decomTech(nodesModel,years,converter_techs,vintage)
  $(sum(years_a$(converter_usedTech(nodesModel,years_a,converter_techs,vintage)), 1)
    and sum(yearsToCalc
      $(sameas(years, yearsToCalc)
        and (vintage.val + converter_techParam(converter_techs,vintage,"lifeTime")) < smin(yearsToCalc_a, yearsToCalc_a.val)), 1))
  = yes;

* Extend the decom frame to the model year after the last model year of usedTech
...
converter_useRampPos(nodesModelToCalc,yearsToCalc,converter_techs,vintage)
  $(sum(indicator$accounting_converterStartup(indicator,nodesModelToCalc,yearsToCalc,converter_techs,vintage,"perRamp"), 1)
    or sum(indicator$accounting_converterStartup(indicator,nodesModelToCalc,yearsToCalc,converter_techs,vintage,"perRampPos"), 1))
  = 1;
...
converter_useRampNeg(nodesModelToCalc,yearsToCalc,converter_techs,vintage)
  $(sum(indicator$accounting_converterStartup(indicator,nodesModelToCalc,yearsToCalc,converter_techs,vintage,"perRamp"), 1)
    or sum(indicator$accounting_converterStartup(indicator,nodesModelToCalc,yearsToCalc,converter_techs,vintage,"perRampNeg"), 1))
  = 1;
...
converter_activity_hasProfile(nodesModelToCalc,yearsToCalc,converter_techs,pc_converter_activityProfile)
    = sum(nodesDataToCalc$aggregateNodesModel(nodesDataToCalc,nodesModelToCalc),
            converter_activity_hasProfileIn(nodesDataToCalc,yearsToCalc,converter_techs,pc_converter_activityProfile));
...
converter_coefficient_hasProfile(nodesModelToCalc,yearsToCalc,converter_techs,vintage,activity,commodity)
    = sum(nodesDataToCalc$aggregateNodesModel(nodesDataToCalc,nodesModelToCalc),
            converter_coefficient_hasProfileIn(nodesDataToCalc,yearsToCalc,converter_techs,vintage,activity,commodity));
...
converter_activityProfileIn_aggTime(timeModelToCalc,nodesDataToCalc,yearsToCalc,converter_techs,pc_converter_activityProfile)
  $converter_activity_hasProfileIn(nodesDataToCalc,yearsToCalc,converter_techs,pc_converter_activityProfile)
  = sum(timeData$timeMapping_t(timeModelToCalc,timeData),
          converter_activityProfileIn(timeData,nodesDataToCalc,yearsToCalc,converter_techs,pc_converter_activityProfile)
...
converter_finiteUnitLimit(nodesModelToCalc,yearsToCalc,converter_techs)
    = sum(nodesDataToCalc$aggregateNodesModel(nodesDataToCalc,nodesModelToCalc), converter_capacityParamIn(nodesDataToCalc,yearsToCalc,converter_techs,"unitsUpperLimit")) > 0
        and sum(nodesDataToCalc$aggregateNodesModel(nodesDataToCalc,nodesModelToCalc), converter_capacityParamIn(nodesDataToCalc,yearsToCalc,converter_techs,"unitsUpperLimit")) < inf;
...
converter_infiniteUnitLimit(nodesModelToCalc,yearsToCalc,converter_techs)
    = sum(nodesDataToCalc$aggregateNodesModel(nodesDataToCalc,nodesModelToCalc), converter_capacityParamIn(nodesDataToCalc,yearsToCalc,converter_techs,"unitsUpperLimit")) = inf;
...
converter_activityProfile(timeModelToCalc,converter_usedTech(nodesModelToCalc,yearsToCalc,converter_techs,vintage),pc_converter_activityProfile)
    ...
    = sum(nodesDataToCalc$(aggregateNodesModel(nodesDataToCalc,nodesModelToCalc)
                and converter_capacityParamIn(nodesDataToCalc,yearsToCalc,converter_techs,"unitsUpperLimit") < inf ),
              converter_activityProfileIn_aggTime(timeModelToCalc,nodesDataToCalc,yearsToCalc,converter_techs,pc_converter_activityProfile)
              * converter_capacityParamIn(nodesDataToCalc,yearsToCalc,converter_techs,"unitsUpperLimit"))
    / sum(nodesDataToCalc$aggregateNodesModel(nodesDataToCalc,nodesModelToCalc),
            converter_capacityParamIn(nodesDataToCalc,yearsToCalc,converter_techs,"unitsUpperLimit"));
...
converter_activityProfile(timeModelToCalc,converter_usedTech(nodesModelToCalc,yearsToCalc,converter_techs,vintage),pc_converter_activityProfile)
  = round(converter_activityProfile(timeModelToCalc,nodesModelToCalc,yearsToCalc,converter_techs,vintage,pc_converter_activityProfile), %roundcoefsdigits%);
converter_activityProfile(timeModelToCalc,converter_usedTech(nodesModelToCalc,yearsToCalc,converter_techs,vintage),pc_converter_activityProfile)
  $(converter_activityProfile(timeModelToCalc,nodesModelToCalc,yearsToCalc,converter_techs,vintage,pc_converter_activityProfile) < 1e-%roundcoefsdigits%)
  = 0;
$endif.roundcoefs
$offVerbatim
...
converter_coefficientProfile(timeModelToCalc,converter_usedTechAct(nodesModelToCalc,yearsToCalc,converter_techs,vintage,activity),commodity)
    ...
    = sum(nodesDataToCalc$aggregateNodesModel(nodesDataToCalc,nodesModelToCalc),
          sum(timeData$timeMapping(timeData,timeModelToCalc),
                  converter_coefficientProfileIn(timeData,nodesDataToCalc,yearsToCalc,converter_techs,vintage,activity,commodity))
              / timeLength(timeModelToCalc)
            * converter_capacityParamIn(nodesDataToCalc,yearsToCalc,converter_techs,"unitsUpperLimit") )
    / sum(nodesDataToCalc$aggregateNodesModel(nodesDataToCalc,nodesModelToCalc),
            converter_capacityParamIn(nodesDataToCalc,yearsToCalc,converter_techs,"unitsUpperLimit"));
...
converter_coefficientProfile(timeModelToCalc,converter_usedTechAct(nodesModelToCalc,yearsToCalc,converter_techs,vintage,activity),commodity)
    ...
    = sum(nodesDataToCalc$(aggregateNodesModel(nodesDataToCalc,nodesModelToCalc)
          ...
          sum(timeData$timeMapping(timeData,timeModelToCalc),
              ...
              / timeLength(timeModelToCalc))
    / sum(nodesDataToCalc$(aggregateNodesModel(nodesDataToCalc,nodesModelToCalc)
                    and converter_capacityParamIn(nodesDataToCalc,yearsToCalc,converter_techs,"unitsUpperLimit") = inf ), 1);

$onVerbatim
$ifthene.roundcoefs %roundcoefs%=1
converter_coefficientProfile(timeModelToCalc,converter_usedTechAct(nodesModelToCalc,yearsToCalc,converter_techs,vintage,activity),commodity)
  = round(converter_coefficientProfile(timeModelToCalc,nodesModelToCalc,yearsToCalc,converter_techs,vintage,activity,commodity), %roundcoefsdigits%);
converter_coefficientProfile(timeModelToCalc,converter_usedTechAct(nodesModelToCalc,yearsToCalc,converter_techs,vintage,activity),commodity)
  $(converter_coefficientProfile(timeModelToCalc,nodesModelToCalc,yearsToCalc,converter_techs,vintage,activity,commodity) < 1e-%roundcoefsdigits%
        and converter_coefficientProfile(timeModelToCalc,nodesModelToCalc,yearsToCalc,converter_techs,vintage,activity,commodity) > -1e-%roundcoefsdigits%)
  = 0;
$endif.roundcoefs
...
converter_unitsTotal_MIP.up(nodesModelToCalc,years,converter_techs,vintage)
...
converter_unitsOnline_MIP.up(timeModelToCalc,nodesModelToCalc,years,converter_techs,vintage)
    $(converter_usedTech(nodesModelToCalc,years,converter_techs,vintage)
      and converter_techParam(converter_techs,vintage,"mipDispatch") = 1)
    = converter_capacityParam(nodesModelToCalc,years,converter_techs,"unitsUpperLimit");
converter_unitsUsingActivity_MIP.up(timeModelToCalc,nodesModelToCalc,years,converter_techs,vintage,activity)
    $(converter_usedTech(nodesModelToCalc,years,converter_techs,vintage)
...
$iftheni.fcfgdx %fixedcapsfromgdx%==None
  $(years.val < smin(yearsToCalc,yearsToCalc.val))
$endif.fcfgdx
  = sum((accNodesModel,accYears)
         $(sameas(accNodesModel,nodesModel) and sameas(accYears,years)),
        converter_units(accNodesModel,accYears,converter_techs,vintage,"decom"));
$endif.cfgdx
...
converter_unitBoundsFixed(nodesModel,years,converter_techs)
  $(not sum(vintage$converter_usedTech(nodesModel,years,converter_techs,vintage),
        converter_techParam(converter_techs,vintage,"freeDecom"))
...
* Fix activities of upper limit if upper limit is zero
converter_activity.fx(timeModelToCalc,nodesModelToCalc,yearsToCalc,converter_techs,vintage,activity)
  $(converter_usedTech(nodesModelToCalc,yearsToCalc,converter_techs,vintage)
    and not converter_activityProfile(timeModelToCalc,nodesModelToCalc,yearsToCalc,converter_techs,vintage,"upper"))
    = 0;
...
equations
  ...
  Eq_converter_unitsBalanceFreeDecom(nodesModel,years,converter_techs,vintage
    ) "Ensures the units balance over the planning period."
...
Eq_converter_unitsBalance(nodesModelSel,yearsSel,converter_techs,vintage)
    ...
    sum ((years_a)
            $(converter_availTech(nodesModelSel,years_a,converter_techs,vintage)
                ...
                and years_a.val + converter_techParam(converter_techs,vintage,'lifeTime') > yearsSel.val
    ...
    + sum ((yearsToCalc)
            $(converter_availTech(nodesModelSel,yearsToCalc,converter_techs,vintage)
                ...
                and yearsToCalc.val + converter_techParam(converter_techs,vintage,'lifeTime') > yearsSel.val
                and yearsToCalc.val <= yearsSel.val ),
          converter_unitsBuild(nodesModelSel,yearsToCalc,converter_techs,vintage));

* Equation using build and decom
Eq_converter_unitsBalanceFreeDecom(nodesModelSel,yearsSel,converter_techs,vintage)
    $((converter_usedTech(nodesModelSel,yearsSel,converter_techs,vintage)
          or sum(years$sameas(years,yearsSel), converter_usedTech(nodesModelSel,years-1,converter_techs,vintage)))
        and not converter_unitBoundsFixed(nodesModelSel,yearsSel,converter_techs)
        and converter_techParam(converter_techs,vintage,"freeDecom") = 1)
...
/
  Eq_converter_unitsBalance
  Eq_converter_unitsBalanceFreeDecom
  Eq_converter_unitsFreeDecom
  Eq_converter_unitsUpperLimit
  Eq_converter_unitsLowerLimit
