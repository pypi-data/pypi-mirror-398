...
parameter indicator_accounting_ref(%scenidx%accNodesModel,accYears,indicator) "Indicator accounting reference" ;
* //
** // OUTPUT: indicator_accounting_var | OEO_00000350:quantity value
* // ### indicator_accounting_var
* // Title: Accounting indicators variable states
parameter indicator_accounting_var(%scenidx%accNodesModel,accYears,indicator) "Indicator accounting variable levels" ;
* //
