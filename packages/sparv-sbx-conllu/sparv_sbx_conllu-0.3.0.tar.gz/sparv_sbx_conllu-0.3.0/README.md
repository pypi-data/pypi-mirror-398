...
[![PyPI version](https://img.shields.io/pypi/v/sparv-sbx-conllu/0.3.0.svg)](https://pypi.org/project/sparv-sbx-conllu/)
[![PyPI license](https://img.shields.io/pypi/l/sparv-sbx-conllu/0.3.0.svg)](https://pypi.org/project/sparv-sbx-conllu/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/sparv-sbx-conllu/0.3.0.svg)](https://pypi.org/project/sparv-sbx-conllu)

[![Maturity badge - level 2](https://img.shields.io/badge/Maturity-Level%202%20--%20First%20Release-yellowgreen.svg)](https://github.com/spraakbanken/getting-started/blob/main/scorecard.md)
[![Stage](https://img.shields.io/pypi/status/sparv-sbx-conllu/0.3.0.svg)](https://pypi.org/project/sparv-sbx-conllu/)
...
- When importing CoNLL-U data, tokens inside multiword tokens are merged, see [Multiword](https://github.com/spraakbanken/sparv-sbx-conllu/blob/0.3.0/docs/multiword.md).
...
This project keeps a [changelog](https://github.com/spraakbanken/sparv-sbx-conllu/blob/0.3.0/CHANGELOG.md).

## License

This repository is licensed under the [MIT](https://github.com/spraakbanken/sparv-sbx-conllu/blob/0.3.0/LICENSE) license.
...
- Push `main` and tags to GitHub: `git push main --tags` or `make publish`
  - [GitHub Actions workflow](https://github.com/spraakbanken/sparv-sbx-conllu/blob/0.3.0/.github/workflows/release.yaml) will build, test and publish the package to [PyPi](https://pypi.prg).
