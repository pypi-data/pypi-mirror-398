...
[![](https://img.shields.io/badge/Singularity-GalaxyProject-blue)](https://depot.galaxyproject.org/singularity/biobb_cmip:5.2.0--pyhdfd78af_0)
...
* Installation:
        ...
        conda install -c bioconda "biobb_cmip>=5.2.0"
...
* Installation:
        ...
        docker pull quay.io/biocontainers/biobb_cmip:5.2.0--pyhdfd78af_0


* Usage:


        docker run quay.io/biocontainers/biobb_cmip:5.2.0--pyhdfd78af_0 <command>
...
* Installation:
        ...
        singularity pull --name biobb_cmip.sif https://depot.galaxyproject.org/singularity/biobb_cmip:5.2.0--pyhdfd78af_0
