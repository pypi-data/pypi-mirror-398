...
from kyutil.reg_exp import is_unicode_escape
...
def gen_tags_filter(tags: str):
    if is_unicode_escape(tags):
        return tags, tags.encode('ascii').decode('unicode_escape')
    else:
        return tags, tags.encode('unicode_escape').decode('ascii')
