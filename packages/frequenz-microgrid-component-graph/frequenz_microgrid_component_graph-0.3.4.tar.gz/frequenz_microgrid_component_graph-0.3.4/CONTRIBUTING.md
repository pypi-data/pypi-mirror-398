# Contributing to Frequenz Microgrid Component Graph Library
...
5. A GitHub action will test the tag and if all goes well it will create
   a [GitHub
   Release](https://github.com/frequenz-floss/frequenz-microgrid-component-graph-python/releases),
   and upload a new package to
   [PyPI](https://pypi.org/project/frequenz-microgrid-component-graph/)
   automatically.
