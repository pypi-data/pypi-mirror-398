...
build_time_vars = {
    ...
    'BASECPPFLAGS': '',
    'BASEMODLIBS': '',
    'BINDIR': '/opt/_internal/cpython-3.13.9-nogil/bin',
    'BINLIBDEST': '/opt/_internal/cpython-3.13.9-nogil/lib/python3.13t',
    ...
    'CONFIG_ARGS': "'CC=gcc' 'CXX=g++' 'CFLAGS_NODIST=-g -O2 -Wall -fdebug-prefix-map=/=. -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2' 'LDFLAGS_NODIST=-Wl,-Bsymbolic-functions -Wl,-z,relro -Wl,-z,now ' '--prefix=/opt/_internal/cpython-3.13.9-nogil' '--disable-shared' '--with-ensurepip=no' '--disable-gil' '--with-openssl=/opt/_internal/openssl-3.5' '--with-openssl-rpath=auto' 'PKG_CONFIG_PATH=/usr/local/lib/pkgconfig' 'TCLTK_LIBS=-L/usr/local/lib -ltk8.6 -ltcl8.6'",
    'CONFINCLUDEDIR': '/opt/_internal/cpython-3.13.9-nogil/include',
    'CONFINCLUDEPY': '/opt/_internal/cpython-3.13.9-nogil/include/python3.13t',
    'COREPYTHONPATH': '',
    ...
    'CXX': 'g++ -pthread',
    'DESTDIRS': '/opt/_internal/cpython-3.13.9-nogil /opt/_internal/cpython-3.13.9-nogil/lib /opt/_internal/cpython-3.13.9-nogil/lib/python3.13t /opt/_internal/cpython-3.13.9-nogil/lib/python3.13t/lib-dynload',
    'DESTLIB': '/opt/_internal/cpython-3.13.9-nogil/lib/python3.13t',
    'DESTPATH': '',
    'DESTSHARED': '/opt/_internal/cpython-3.13.9-nogil/lib/python3.13t/lib-dynload',
    'DFLAGS': '',
    'DIRMODE': 755,
    ...
    'EXE': '',
    'EXEMODE': 755,
    'EXENAME': '/opt/_internal/cpython-3.13.9-nogil/bin/python3.13t',
    'EXPORTSFROM': '',
    'EXPORTSYMS': '',
    'EXTRATESTOPTS': '',
    'EXTRA_CFLAGS': '',
    'EXT_SUFFIX': '.cpython-313t-aarch64-linux-gnu.so',
    'FILEMODE': 644,
    ...
    'INCLDIRSTOMAKE': '/opt/_internal/cpython-3.13.9-nogil/include /opt/_internal/cpython-3.13.9-nogil/include /opt/_internal/cpython-3.13.9-nogil/include/python3.13t /opt/_internal/cpython-3.13.9-nogil/include/python3.13t',
    'INCLUDEDIR': '/opt/_internal/cpython-3.13.9-nogil/include',
    'INCLUDEPY': '/opt/_internal/cpython-3.13.9-nogil/include/python3.13t',
    ...
    'LDVERSION': '3.13t',
    'LIBC': '',
    'LIBDEST': '/opt/_internal/cpython-3.13.9-nogil/lib/python3.13t',
    'LIBDIR': '/opt/_internal/cpython-3.13.9-nogil/lib',
    ...
    'LIBOBJDIR': 'Python/',
    'LIBOBJS': '',
    'LIBPC': '/opt/_internal/cpython-3.13.9-nogil/lib/pkgconfig',
    'LIBPL': '/opt/_internal/cpython-3.13.9-nogil/lib/python3.13t/config-3.13t-aarch64-linux-gnu',
    'LIBPYTHON': '',
    ...
    'MACHDEP': 'linux',
    'MACHDEP_OBJS': '',
    'MACHDESTLIB': '/opt/_internal/cpython-3.13.9-nogil/lib/python3.13t',
    'MACOSX_DEPLOYMENT_TARGET': '',
    'MAJOR_IN_MKDEV': 0,
    'MAJOR_IN_SYSMACROS': 1,
    'MAKESETUP': './Modules/makesetup',
    'MANDIR': '/opt/_internal/cpython-3.13.9-nogil/share/man',
    'MIMALLOC_HEADERS': '\\',
    ...
    'RETSIGTYPE': 'void',
    'RUNSHARED': '',
    'SCRIPTDIR': '/opt/_internal/cpython-3.13.9-nogil/lib',
    'SCRIPT_IDLE': 'build/scripts-3.13/idle3.13',
    'SCRIPT_PYDOC': 'build/scripts-3.13/pydoc3.13',
    'SETPGRP_HAVE_ARG': 0,
    'SHAREDMODS': 'Modules/array.cpython-313t-aarch64-linux-gnu.so Modules/_asyncio.cpython-313t-aarch64-linux-gnu.so Modules/_bisect.cpython-313t-aarch64-linux-gnu.so Modules/_contextvars.cpython-313t-aarch64-linux-gnu.so Modules/_csv.cpython-313t-aarch64-linux-gnu.so Modules/_heapq.cpython-313t-aarch64-linux-gnu.so Modules/_json.cpython-313t-aarch64-linux-gnu.so Modules/_lsprof.cpython-313t-aarch64-linux-gnu.so Modules/_opcode.cpython-313t-aarch64-linux-gnu.so Modules/_pickle.cpython-313t-aarch64-linux-gnu.so Modules/_queue.cpython-313t-aarch64-linux-gnu.so Modules/_random.cpython-313t-aarch64-linux-gnu.so Modules/_struct.cpython-313t-aarch64-linux-gnu.so Modules/_interpreters.cpython-313t-aarch64-linux-gnu.so Modules/_interpchannels.cpython-313t-aarch64-linux-gnu.so Modules/_interpqueues.cpython-313t-aarch64-linux-gnu.so Modules/_zoneinfo.cpython-313t-aarch64-linux-gnu.so Modules/math.cpython-313t-aarch64-linux-gnu.so Modules/cmath.cpython-313t-aarch64-linux-gnu.so Modules/_statistics.cpython-313t-aarch64-linux-gnu.so Modules/_datetime.cpython-313t-aarch64-linux-gnu.so Modules/_decimal.cpython-313t-aarch64-linux-gnu.so Modules/binascii.cpython-313t-aarch64-linux-gnu.so Modules/_bz2.cpython-313t-aarch64-linux-gnu.so Modules/_lzma.cpython-313t-aarch64-linux-gnu.so Modules/zlib.cpython-313t-aarch64-linux-gnu.so Modules/_dbm.cpython-313t-aarch64-linux-gnu.so Modules/_gdbm.cpython-313t-aarch64-linux-gnu.so Modules/readline.cpython-313t-aarch64-linux-gnu.so Modules/_md5.cpython-313t-aarch64-linux-gnu.so Modules/_sha1.cpython-313t-aarch64-linux-gnu.so Modules/_sha2.cpython-313t-aarch64-linux-gnu.so Modules/_sha3.cpython-313t-aarch64-linux-gnu.so Modules/_blake2.cpython-313t-aarch64-linux-gnu.so Modules/pyexpat.cpython-313t-aarch64-linux-gnu.so Modules/_elementtree.cpython-313t-aarch64-linux-gnu.so Modules/_codecs_cn.cpython-313t-aarch64-linux-gnu.so Modules/_codecs_hk.cpython-313t-aarch64-linux-gnu.so Modules/_codecs_iso2022.cpython-313t-aarch64-linux-gnu.so Modules/_codecs_jp.cpython-313t-aarch64-linux-gnu.so Modules/_codecs_kr.cpython-313t-aarch64-linux-gnu.so Modules/_codecs_tw.cpython-313t-aarch64-linux-gnu.so Modules/_multibytecodec.cpython-313t-aarch64-linux-gnu.so Modules/unicodedata.cpython-313t-aarch64-linux-gnu.so Modules/fcntl.cpython-313t-aarch64-linux-gnu.so Modules/grp.cpython-313t-aarch64-linux-gnu.so Modules/mmap.cpython-313t-aarch64-linux-gnu.so Modules/_posixsubprocess.cpython-313t-aarch64-linux-gnu.so Modules/resource.cpython-313t-aarch64-linux-gnu.so Modules/select.cpython-313t-aarch64-linux-gnu.so Modules/_socket.cpython-313t-aarch64-linux-gnu.so Modules/syslog.cpython-313t-aarch64-linux-gnu.so Modules/termios.cpython-313t-aarch64-linux-gnu.so Modules/_posixshmem.cpython-313t-aarch64-linux-gnu.so Modules/_multiprocessing.cpython-313t-aarch64-linux-gnu.so Modules/_ctypes.cpython-313t-aarch64-linux-gnu.so Modules/_curses.cpython-313t-aarch64-linux-gnu.so Modules/_curses_panel.cpython-313t-aarch64-linux-gnu.so Modules/_sqlite3.cpython-313t-aarch64-linux-gnu.so Modules/_ssl.cpython-313t-aarch64-linux-gnu.so Modules/_hashlib.cpython-313t-aarch64-linux-gnu.so Modules/_uuid.cpython-313t-aarch64-linux-gnu.so Modules/_tkinter.cpython-313t-aarch64-linux-gnu.so Modules/xxsubtype.cpython-313t-aarch64-linux-gnu.so Modules/_xxtestfuzz.cpython-313t-aarch64-linux-gnu.so Modules/_testbuffer.cpython-313t-aarch64-linux-gnu.so Modules/_testinternalcapi.cpython-313t-aarch64-linux-gnu.so Modules/_testcapi.cpython-313t-aarch64-linux-gnu.so Modules/_testlimitedcapi.cpython-313t-aarch64-linux-gnu.so Modules/_testclinic.cpython-313t-aarch64-linux-gnu.so Modules/_testclinic_limited.cpython-313t-aarch64-linux-gnu.so Modules/_testimportmultiple.cpython-313t-aarch64-linux-gnu.so Modules/_testmultiphase.cpython-313t-aarch64-linux-gnu.so Modules/_testsinglephase.cpython-313t-aarch64-linux-gnu.so Modules/_testexternalinspection.cpython-313t-aarch64-linux-gnu.so Modules/_ctypes_test.cpython-313t-aarch64-linux-gnu.so Modules/xxlimited.cpython-313t-aarch64-linux-gnu.so Modules/xxlimited_35.cpython-313t-aarch64-linux-gnu.so',
    'SHELL': '/bin/sh -e',
    ...
    'SIZEOF_WCHAR_T': 4,
    'SIZEOF__BOOL': 1,
    'SOABI': 'cpython-313t-aarch64-linux-gnu',
    ...
    'VERSION': '3.13',
    'WASM_ASSETS_DIR': './opt/_internal/cpython-3.13.9-nogil',
    'WASM_STDLIB': './opt/_internal/cpython-3.13.9-nogil/lib/python3.13/os.py',
    'WHEEL_PKG_DIR': '',
    'WINDOW_HAS_FLAGS': 1,
    ...
    'datarootdir': '/opt/_internal/cpython-3.13.9-nogil/share',
    'exec_prefix': '/opt/_internal/cpython-3.13.9-nogil',
    'prefix': '/opt/_internal/cpython-3.13.9-nogil',
    'srcdir': '.',
}
