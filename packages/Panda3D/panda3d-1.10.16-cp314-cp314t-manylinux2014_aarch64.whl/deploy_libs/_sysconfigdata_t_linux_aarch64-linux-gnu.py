...
build_time_vars = {
    ...
    'BASECPPFLAGS': '',
    'BASEMODLIBS': '',
    'BINDIR': '/opt/_internal/cpython-3.14.0-nogil/bin',
    'BINLIBDEST': '/opt/_internal/cpython-3.14.0-nogil/lib/python3.14t',
    'BLDLIBRARY': 'libpython3.14t.a',
    ...
    'CONFIG_ARGS': "'CC=gcc' 'CXX=g++' 'CFLAGS_NODIST=-g -O2 -Wall -fdebug-prefix-map=/=. -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2' 'LDFLAGS_NODIST=-Wl,-Bsymbolic-functions -Wl,-z,relro -Wl,-z,now ' '--prefix=/opt/_internal/cpython-3.14.0-nogil' '--disable-shared' '--with-ensurepip=no' '--disable-gil' '--with-openssl=/opt/_internal/openssl-3.5' '--with-openssl-rpath=auto' 'PKG_CONFIG_PATH=/usr/local/lib/pkgconfig' 'TCLTK_LIBS=-L/usr/local/lib -ltk8.6 -ltcl8.6'",
    'CONFINCLUDEDIR': '/opt/_internal/cpython-3.14.0-nogil/include',
    'CONFINCLUDEPY': '/opt/_internal/cpython-3.14.0-nogil/include/python3.14t',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/Python-3.14.0/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/Python-3.14.0/lcov-report',
    'COVERAGE_REPORT_OPTIONS': '--rc lcov_branch_coverage=1 --branch-coverage --title "CPython 3.14 LCOV report [commit $(shell )]"',
    'CPPFLAGS': '-I. -I./Include',
    'CXX': 'g++ -pthread',
    'DESTDIRS': '/opt/_internal/cpython-3.14.0-nogil /opt/_internal/cpython-3.14.0-nogil/lib /opt/_internal/cpython-3.14.0-nogil/lib/python3.14t /opt/_internal/cpython-3.14.0-nogil/lib/python3.14t/lib-dynload',
    'DESTLIB': '/opt/_internal/cpython-3.14.0-nogil/lib/python3.14t',
    'DESTPATH': '',
    'DESTSHARED': '/opt/_internal/cpython-3.14.0-nogil/lib/python3.14t/lib-dynload',
    'DFLAGS': '',
    'DIRMODE': 755,
    ...
    'EXE': '',
    'EXEMODE': 755,
    'EXENAME': '/opt/_internal/cpython-3.14.0-nogil/bin/python3.14t',
    'EXPORTSFROM': '',
    'EXPORTSYMS': '',
    'EXTRATESTOPTS': '',
    'EXTRA_CFLAGS': '',
    'EXT_SUFFIX': '.cpython-314t-aarch64-linux-gnu.so',
    'FILEMODE': 644,
    ...
    'INCLDIRSTOMAKE': '/opt/_internal/cpython-3.14.0-nogil/include /opt/_internal/cpython-3.14.0-nogil/include /opt/_internal/cpython-3.14.0-nogil/include/python3.14t /opt/_internal/cpython-3.14.0-nogil/include/python3.14t',
    'INCLUDEDIR': '/opt/_internal/cpython-3.14.0-nogil/include',
    'INCLUDEPY': '/opt/_internal/cpython-3.14.0-nogil/include/python3.14t',
    ...
    'LDFLAGS': '',
    'LDFLAGS_NODIST': '',
    'LDLIBRARY': 'libpython3.14t.a',
    'LDLIBRARYDIR': '',
    'LDSHARED': 'gcc -pthread -shared',
    'LDVERSION': '3.14t',
    'LIBC': '',
    'LIBDEST': '/opt/_internal/cpython-3.14.0-nogil/lib/python3.14t',
    'LIBDIR': '/opt/_internal/cpython-3.14.0-nogil/lib',
    ...
    'LIBOBJDIR': 'Python/',
    'LIBOBJS': '',
    'LIBPC': '/opt/_internal/cpython-3.14.0-nogil/lib/pkgconfig',
    'LIBPL': '/opt/_internal/cpython-3.14.0-nogil/lib/python3.14t/config-3.14t-aarch64-linux-gnu',
    'LIBPYTHON': '',
    'LIBRARY': 'libpython3.14t.a',
    'LIBRARY_DEPS': 'libpython3.14t.a',
    'LIBRARY_OBJS': '\\',
    ...
    'LINK_PYTHON_DEPS': 'libpython3.14t.a',
    'LINK_PYTHON_OBJS': '\\',
    'LIPO_32BIT_FLAGS': '',
    'LIPO_INTEL64_FLAGS': '',
    'LLVM_PROF_ERR': 'no',
    ...
    'MACHDEP': 'linux',
    'MACHDEP_OBJS': '',
    'MACHDESTLIB': '/opt/_internal/cpython-3.14.0-nogil/lib/python3.14t',
    'MACOSX_DEPLOYMENT_TARGET': '',
    'MAJOR_IN_MKDEV': 0,
    'MAJOR_IN_SYSMACROS': 1,
    'MAKESETUP': './Modules/makesetup',
    'MANDIR': '/opt/_internal/cpython-3.14.0-nogil/share/man',
    'MIMALLOC_HEADERS': '\\',
    ...
    'MODULE__ZSTD_CFLAGS': '-pthread -I/opt/_internal/zstd-1/include',
    'MODULE__ZSTD_DEPS': './Modules/_zstd/_zstdmodule.h ./Modules/_zstd/buffer.h ./Modules/_zstd/zstddict.h',
    'MODULE__ZSTD_LDFLAGS': '-Wl,--enable-new-dtags,-rpath=/opt/_internal/zstd-1/lib -pthread -L/opt/_internal/zstd-1/lib -lzstd',
    ...
    'RETSIGTYPE': 'void',
    'RUNSHARED': '',
    'SCRIPTDIR': '/opt/_internal/cpython-3.14.0-nogil/lib',
    'SCRIPT_IDLE': 'build/scripts-3.14/idle3.14',
    'SCRIPT_PYDOC': 'build/scripts-3.14/pydoc3.14',
    'SETPGRP_HAVE_ARG': 0,
    'SHAREDMODS': 'Modules/array.cpython-314t-aarch64-linux-gnu.so Modules/_asyncio.cpython-314t-aarch64-linux-gnu.so Modules/_bisect.cpython-314t-aarch64-linux-gnu.so Modules/_csv.cpython-314t-aarch64-linux-gnu.so Modules/_heapq.cpython-314t-aarch64-linux-gnu.so Modules/_json.cpython-314t-aarch64-linux-gnu.so Modules/_lsprof.cpython-314t-aarch64-linux-gnu.so Modules/_pickle.cpython-314t-aarch64-linux-gnu.so Modules/_queue.cpython-314t-aarch64-linux-gnu.so Modules/_random.cpython-314t-aarch64-linux-gnu.so Modules/_remote_debugging.cpython-314t-aarch64-linux-gnu.so Modules/_struct.cpython-314t-aarch64-linux-gnu.so Modules/_interpreters.cpython-314t-aarch64-linux-gnu.so Modules/_interpchannels.cpython-314t-aarch64-linux-gnu.so Modules/_interpqueues.cpython-314t-aarch64-linux-gnu.so Modules/_zoneinfo.cpython-314t-aarch64-linux-gnu.so Modules/math.cpython-314t-aarch64-linux-gnu.so Modules/cmath.cpython-314t-aarch64-linux-gnu.so Modules/_statistics.cpython-314t-aarch64-linux-gnu.so Modules/_decimal.cpython-314t-aarch64-linux-gnu.so Modules/binascii.cpython-314t-aarch64-linux-gnu.so Modules/_bz2.cpython-314t-aarch64-linux-gnu.so Modules/_lzma.cpython-314t-aarch64-linux-gnu.so Modules/_zstd.cpython-314t-aarch64-linux-gnu.so Modules/zlib.cpython-314t-aarch64-linux-gnu.so Modules/_dbm.cpython-314t-aarch64-linux-gnu.so Modules/_gdbm.cpython-314t-aarch64-linux-gnu.so Modules/readline.cpython-314t-aarch64-linux-gnu.so Modules/_md5.cpython-314t-aarch64-linux-gnu.so Modules/_sha1.cpython-314t-aarch64-linux-gnu.so Modules/_sha2.cpython-314t-aarch64-linux-gnu.so Modules/_sha3.cpython-314t-aarch64-linux-gnu.so Modules/_blake2.cpython-314t-aarch64-linux-gnu.so Modules/_hmac.cpython-314t-aarch64-linux-gnu.so Modules/pyexpat.cpython-314t-aarch64-linux-gnu.so Modules/_elementtree.cpython-314t-aarch64-linux-gnu.so Modules/_codecs_cn.cpython-314t-aarch64-linux-gnu.so Modules/_codecs_hk.cpython-314t-aarch64-linux-gnu.so Modules/_codecs_iso2022.cpython-314t-aarch64-linux-gnu.so Modules/_codecs_jp.cpython-314t-aarch64-linux-gnu.so Modules/_codecs_kr.cpython-314t-aarch64-linux-gnu.so Modules/_codecs_tw.cpython-314t-aarch64-linux-gnu.so Modules/_multibytecodec.cpython-314t-aarch64-linux-gnu.so Modules/unicodedata.cpython-314t-aarch64-linux-gnu.so Modules/fcntl.cpython-314t-aarch64-linux-gnu.so Modules/grp.cpython-314t-aarch64-linux-gnu.so Modules/mmap.cpython-314t-aarch64-linux-gnu.so Modules/_posixsubprocess.cpython-314t-aarch64-linux-gnu.so Modules/resource.cpython-314t-aarch64-linux-gnu.so Modules/select.cpython-314t-aarch64-linux-gnu.so Modules/_socket.cpython-314t-aarch64-linux-gnu.so Modules/syslog.cpython-314t-aarch64-linux-gnu.so Modules/termios.cpython-314t-aarch64-linux-gnu.so Modules/_posixshmem.cpython-314t-aarch64-linux-gnu.so Modules/_multiprocessing.cpython-314t-aarch64-linux-gnu.so Modules/_ctypes.cpython-314t-aarch64-linux-gnu.so Modules/_curses.cpython-314t-aarch64-linux-gnu.so Modules/_curses_panel.cpython-314t-aarch64-linux-gnu.so Modules/_sqlite3.cpython-314t-aarch64-linux-gnu.so Modules/_ssl.cpython-314t-aarch64-linux-gnu.so Modules/_hashlib.cpython-314t-aarch64-linux-gnu.so Modules/_uuid.cpython-314t-aarch64-linux-gnu.so Modules/_tkinter.cpython-314t-aarch64-linux-gnu.so Modules/xxsubtype.cpython-314t-aarch64-linux-gnu.so Modules/_xxtestfuzz.cpython-314t-aarch64-linux-gnu.so Modules/_testbuffer.cpython-314t-aarch64-linux-gnu.so Modules/_testinternalcapi.cpython-314t-aarch64-linux-gnu.so Modules/_testcapi.cpython-314t-aarch64-linux-gnu.so Modules/_testlimitedcapi.cpython-314t-aarch64-linux-gnu.so Modules/_testclinic.cpython-314t-aarch64-linux-gnu.so Modules/_testclinic_limited.cpython-314t-aarch64-linux-gnu.so Modules/_testimportmultiple.cpython-314t-aarch64-linux-gnu.so Modules/_testmultiphase.cpython-314t-aarch64-linux-gnu.so Modules/_testsinglephase.cpython-314t-aarch64-linux-gnu.so Modules/_ctypes_test.cpython-314t-aarch64-linux-gnu.so Modules/xxlimited.cpython-314t-aarch64-linux-gnu.so Modules/xxlimited_35.cpython-314t-aarch64-linux-gnu.so',
    'SHELL': '/bin/sh -e',
    ...
    'SIZEOF_WCHAR_T': 4,
    'SIZEOF__BOOL': 1,
    'SOABI': 'cpython-314t-aarch64-linux-gnu',
    ...
    'ZIP_STDLIB': 'python3.14t.zip',
    'abs_builddir': '/Python-3.14.0',
    'abs_srcdir': '/Python-3.14.0',
    'datarootdir': '/opt/_internal/cpython-3.14.0-nogil/share',
    'exec_prefix': '/opt/_internal/cpython-3.14.0-nogil',
    'host_exec_prefix': '/opt/_internal/cpython-3.14.0-nogil',
    'host_prefix': '/opt/_internal/cpython-3.14.0-nogil',
    'prefix': '/opt/_internal/cpython-3.14.0-nogil',
    'srcdir': '.',
}
