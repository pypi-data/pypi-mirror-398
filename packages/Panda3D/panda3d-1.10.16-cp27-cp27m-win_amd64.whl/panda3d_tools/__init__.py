...
egg2maya2014 = lambda: _exec_tool(u'egg2maya2014.exe')
egg2maya2015 = lambda: _exec_tool(u'egg2maya2015.exe')
egg2maya2016 = lambda: _exec_tool(u'egg2maya2016.exe')
egg2maya20165 = lambda: _exec_tool(u'egg2maya20165.exe')
egg2maya2017 = lambda: _exec_tool(u'egg2maya2017.exe')
egg2maya2018 = lambda: _exec_tool(u'egg2maya2018.exe')
egg2maya2019 = lambda: _exec_tool(u'egg2maya2019.exe')
egg2maya2020 = lambda: _exec_tool(u'egg2maya2020.exe')
egg2maya2022 = lambda: _exec_tool(u'egg2maya2022.exe')
...
maya2egg2014 = lambda: _exec_tool(u'maya2egg2014.exe')
maya2egg2015 = lambda: _exec_tool(u'maya2egg2015.exe')
maya2egg2016 = lambda: _exec_tool(u'maya2egg2016.exe')
maya2egg20165 = lambda: _exec_tool(u'maya2egg20165.exe')
maya2egg2017 = lambda: _exec_tool(u'maya2egg2017.exe')
maya2egg2018 = lambda: _exec_tool(u'maya2egg2018.exe')
maya2egg2019 = lambda: _exec_tool(u'maya2egg2019.exe')
maya2egg2020 = lambda: _exec_tool(u'maya2egg2020.exe')
maya2egg2022 = lambda: _exec_tool(u'maya2egg2022.exe')
...
mayacopy2014 = lambda: _exec_tool(u'mayacopy2014.exe')
mayacopy2015 = lambda: _exec_tool(u'mayacopy2015.exe')
mayacopy2016 = lambda: _exec_tool(u'mayacopy2016.exe')
mayacopy20165 = lambda: _exec_tool(u'mayacopy20165.exe')
mayacopy2017 = lambda: _exec_tool(u'mayacopy2017.exe')
mayacopy2018 = lambda: _exec_tool(u'mayacopy2018.exe')
mayacopy2019 = lambda: _exec_tool(u'mayacopy2019.exe')
mayacopy2020 = lambda: _exec_tool(u'mayacopy2020.exe')
mayacopy2022 = lambda: _exec_tool(u'mayacopy2022.exe')
