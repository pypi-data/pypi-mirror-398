...
class CollectorS3AuthenticationMethod5(str, Enum, metaclass=utils.OpenEnumMeta):
...
class CollectorS3SignatureVersion5(str, Enum, metaclass=utils.OpenEnumMeta):
...
class CollectorS3S35TypedDict(TypedDict):
    ...
    aws_authentication_method: NotRequired[CollectorS3AuthenticationMethod5]
    r"""AWS authentication method. Choose Auto to use IAM roles."""
    ...
    signature_version: NotRequired[CollectorS3SignatureVersion5]
    r"""Signature version to use for signing S3 requests"""
...
class CollectorS3S35(BaseModel):
    ...
    aws_authentication_method: Annotated[
        Annotated[
            Optional[CollectorS3AuthenticationMethod5],
            PlainValidator(validate_open_enum(False)),
        ],
        pydantic.Field(alias="awsAuthenticationMethod"),
    ] = CollectorS3AuthenticationMethod5.AUTO
    r"""AWS authentication method. Choose Auto to use IAM roles."""
    ...
    signature_version: Annotated[
        Annotated[
            Optional[CollectorS3SignatureVersion5],
            PlainValidator(validate_open_enum(False)),
        ],
        pydantic.Field(alias="signatureVersion"),
    ] = CollectorS3SignatureVersion5.V4
    r"""Signature version to use for signing S3 requests"""
    ...
    def serialize_aws_authentication_method(self, value):
        if isinstance(value, str):
            try:
                return models.CollectorS3AuthenticationMethod5(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_signature_version(self, value):
        if isinstance(value, str):
            try:
                return models.CollectorS3SignatureVersion5(value)
            except ValueError:
                return value
        return value


class CollectorS3AuthenticationMethod4(str, Enum, metaclass=utils.OpenEnumMeta):
    r"""AWS authentication method. Choose Auto to use IAM roles."""
...
class CollectorS3SignatureVersion4(str, Enum, metaclass=utils.OpenEnumMeta):
    r"""Signature version to use for signing S3 requests"""
...
class CollectorS3S34TypedDict(TypedDict):
    ...
    bucket: str
    r"""S3 Bucket from which to collect data"""
    aws_authentication_method: NotRequired[CollectorS3AuthenticationMethod4]
    r"""AWS authentication method. Choose Auto to use IAM roles."""
    aws_api_key: NotRequired[str]
    r"""Access key. If not present, will fall back to env.AWS_ACCESS_KEY_ID, or to the metadata endpoint for IAM creds. Optional when running on AWS. This value can be a constant or a JavaScript expression."""
    aws_secret_key: NotRequired[str]
    ...
    endpoint: NotRequired[str]
    r"""Must point to an S3-compatible endpoint. If empty, defaults to an AWS region-specific endpoint."""
    signature_version: NotRequired[CollectorS3SignatureVersion4]
    r"""Signature version to use for signing S3 requests"""
    enable_assume_role: NotRequired[bool]
    r"""Use AssumeRole credentials"""
    assume_role_arn: NotRequired[str]
...
class CollectorS3S34(BaseModel):
    ...
    aws_authentication_method: Annotated[
        Annotated[
            Optional[CollectorS3AuthenticationMethod4],
            PlainValidator(validate_open_enum(False)),
        ],
        pydantic.Field(alias="awsAuthenticationMethod"),
    ] = CollectorS3AuthenticationMethod4.AUTO
    r"""AWS authentication method. Choose Auto to use IAM roles."""
    ...
    signature_version: Annotated[
        Annotated[
            Optional[CollectorS3SignatureVersion4],
            PlainValidator(validate_open_enum(False)),
        ],
        pydantic.Field(alias="signatureVersion"),
    ] = CollectorS3SignatureVersion4.V4
    r"""Signature version to use for signing S3 requests"""
    ...
    def serialize_aws_authentication_method(self, value):
        if isinstance(value, str):
            try:
                return models.CollectorS3AuthenticationMethod4(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_signature_version(self, value):
        if isinstance(value, str):
            try:
                return models.CollectorS3SignatureVersion4(value)
            except ValueError:
                return value
        return value


class CollectorS3AuthenticationMethod3(str, Enum, metaclass=utils.OpenEnumMeta):
    r"""AWS authentication method. Choose Auto to use IAM roles."""
...
class CollectorS3SignatureVersion3(str, Enum, metaclass=utils.OpenEnumMeta):
    r"""Signature version to use for signing S3 requests"""
...
class CollectorS3S33TypedDict(TypedDict):
    ...
    bucket: str
    r"""S3 Bucket from which to collect data"""
    aws_authentication_method: NotRequired[CollectorS3AuthenticationMethod3]
    r"""AWS authentication method. Choose Auto to use IAM roles."""
    output_name: NotRequired[str]
    r"""Name of the predefined Destination that will be used to auto-populate Collector settings"""
    parquet_chunk_size_mb: NotRequired[float]
    ...
    endpoint: NotRequired[str]
    r"""Must point to an S3-compatible endpoint. If empty, defaults to an AWS region-specific endpoint."""
    signature_version: NotRequired[CollectorS3SignatureVersion3]
    r"""Signature version to use for signing S3 requests"""
    enable_assume_role: NotRequired[bool]
    r"""Use AssumeRole credentials"""
    assume_role_arn: NotRequired[str]
...
class CollectorS3S33(BaseModel):
    ...
    aws_authentication_method: Annotated[
        Annotated[
            Optional[CollectorS3AuthenticationMethod3],
            PlainValidator(validate_open_enum(False)),
        ],
        pydantic.Field(alias="awsAuthenticationMethod"),
    ] = CollectorS3AuthenticationMethod3.AUTO
    r"""AWS authentication method. Choose Auto to use IAM roles."""
    ...
    signature_version: Annotated[
        Annotated[
            Optional[CollectorS3SignatureVersion3],
            PlainValidator(validate_open_enum(False)),
        ],
        pydantic.Field(alias="signatureVersion"),
    ] = CollectorS3SignatureVersion3.V4
    r"""Signature version to use for signing S3 requests"""
    ...
    def serialize_aws_authentication_method(self, value):
        if isinstance(value, str):
            try:
                return models.CollectorS3AuthenticationMethod3(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_signature_version(self, value):
        if isinstance(value, str):
            try:
                return models.CollectorS3SignatureVersion3(value)
            except ValueError:
                return value
        return value
...
class CollectorS3AuthenticationMethod2(str, Enum, metaclass=utils.OpenEnumMeta):
    r"""AWS authentication method. Choose Auto to use IAM roles."""
...
class CollectorS3SignatureVersion2(str, Enum, metaclass=utils.OpenEnumMeta):
    r"""Signature version to use for signing S3 requests"""
...
class CollectorS3S32TypedDict(TypedDict):
    ...
    r"""Allows using template tokens as context for expressions that enrich discovery results. For example, given a template /path/${epoch}, an extractor under key \"epoch\" with an expression {date: new Date(+value*1000)}, will enrich discovery results with a human readable \"date\" field."""
    aws_authentication_method: NotRequired[CollectorS3AuthenticationMethod2]
    r"""AWS authentication method. Choose Auto to use IAM roles."""
    endpoint: NotRequired[str]
    r"""Must point to an S3-compatible endpoint. If empty, defaults to an AWS region-specific endpoint."""
    signature_version: NotRequired[CollectorS3SignatureVersion2]
    r"""Signature version to use for signing S3 requests"""
    enable_assume_role: NotRequired[bool]
    r"""Use AssumeRole credentials"""
    assume_role_arn: NotRequired[str]
...
class CollectorS3S32(BaseModel):
    ...
    aws_authentication_method: Annotated[
        Annotated[
            Optional[CollectorS3AuthenticationMethod2],
            PlainValidator(validate_open_enum(False)),
        ],
        pydantic.Field(alias="awsAuthenticationMethod"),
    ] = CollectorS3AuthenticationMethod2.AUTO
    r"""AWS authentication method. Choose Auto to use IAM roles."""
    ...
    signature_version: Annotated[
        Annotated[
            Optional[CollectorS3SignatureVersion2],
            PlainValidator(validate_open_enum(False)),
        ],
        pydantic.Field(alias="signatureVersion"),
    ] = CollectorS3SignatureVersion2.V4
    r"""Signature version to use for signing S3 requests"""
    ...
    def serialize_aws_authentication_method(self, value):
        if isinstance(value, str):
            try:
                return models.CollectorS3AuthenticationMethod2(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_signature_version(self, value):
        if isinstance(value, str):
            try:
                return models.CollectorS3SignatureVersion2(value)
            except ValueError:
                return value
        return value
...
class CollectorS3AuthenticationMethod1(str, Enum, metaclass=utils.OpenEnumMeta):
    r"""AWS authentication method. Choose Auto to use IAM roles."""
...
class CollectorS3SignatureVersion1(str, Enum, metaclass=utils.OpenEnumMeta):
    r"""Signature version to use for signing S3 requests"""
...
class CollectorS3S31TypedDict(TypedDict):
    ...
    r"""Allows using template tokens as context for expressions that enrich discovery results. For example, given a template /path/${epoch}, an extractor under key \"epoch\" with an expression {date: new Date(+value*1000)}, will enrich discovery results with a human readable \"date\" field."""
    aws_authentication_method: NotRequired[CollectorS3AuthenticationMethod1]
    r"""AWS authentication method. Choose Auto to use IAM roles."""
    endpoint: NotRequired[str]
    r"""Must point to an S3-compatible endpoint. If empty, defaults to an AWS region-specific endpoint."""
    signature_version: NotRequired[CollectorS3SignatureVersion1]
    r"""Signature version to use for signing S3 requests"""
    enable_assume_role: NotRequired[bool]
    r"""Use AssumeRole credentials"""
    assume_role_arn: NotRequired[str]
...
class CollectorS3S31(BaseModel):
    ...
    aws_authentication_method: Annotated[
        Annotated[
            Optional[CollectorS3AuthenticationMethod1],
            PlainValidator(validate_open_enum(False)),
        ],
        pydantic.Field(alias="awsAuthenticationMethod"),
    ] = CollectorS3AuthenticationMethod1.AUTO
    r"""AWS authentication method. Choose Auto to use IAM roles."""
    ...
    signature_version: Annotated[
        Annotated[
            Optional[CollectorS3SignatureVersion1],
            PlainValidator(validate_open_enum(False)),
        ],
        pydantic.Field(alias="signatureVersion"),
    ] = CollectorS3SignatureVersion1.V4
    r"""Signature version to use for signing S3 requests"""
    ...
    def serialize_aws_authentication_method(self, value):
        if isinstance(value, str):
            try:
                return models.CollectorS3AuthenticationMethod1(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_signature_version(self, value):
        if isinstance(value, str):
            try:
                return models.CollectorS3SignatureVersion1(value)
            except ValueError:
                return value
        return value
