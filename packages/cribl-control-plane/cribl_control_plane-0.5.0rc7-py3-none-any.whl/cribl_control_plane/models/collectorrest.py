...
class CollectorRestRest12TypedDict(TypedDict):
    ...
    collect_request_params: NotRequired[List[ItemsTypeCollectRequestParams1TypedDict]]
    ...
    collect_request_headers: NotRequired[List[ItemsTypeCollectRequestParams1TypedDict]]
    ...
    auth_request_headers: NotRequired[List[ItemsTypeCollectRequestParams1TypedDict]]
    ...
    auth_request_params: NotRequired[List[ItemsTypeCollectRequestParams1TypedDict]]
...
class CollectorRestRest12(BaseModel):
    ...
    collect_request_params: Annotated[
        Optional[List[ItemsTypeCollectRequestParams1]],
...
class AuthenticationRest(str, Enum, metaclass=utils.OpenEnumMeta):
    r"""Authentication method for Discover and Collect REST calls. You can specify API key–based authentication by adding the appropriate Collect headers."""
...
class DiscoverTypeRest(str, Enum, metaclass=utils.OpenEnumMeta):
    r"""Defines how task discovery will be performed. Each entry returned by the Discover operation will result in a Collect task."""
...
class DiscoveryRestTypedDict(TypedDict):
    discover_type: NotRequired[DiscoverTypeRest]
    r"""Defines how task discovery will be performed. Each entry returned by the Discover operation will result in a Collect task."""


class DiscoveryRest(BaseModel):
    discover_type: Annotated[
        Annotated[
            Optional[DiscoverTypeRest], PlainValidator(validate_open_enum(False))
        ],
        pydantic.Field(alias="discoverType"),
    ] = DiscoverTypeRest.NONE
    r"""Defines how task discovery will be performed. Each entry returned by the Discover operation will result in a Collect task."""
    ...
    def serialize_discover_type(self, value):
        if isinstance(value, str):
            try:
                return models.DiscoverTypeRest(value)
            except ValueError:
                return value
        return value


class CollectMethodRest(str, Enum, metaclass=utils.OpenEnumMeta):
    # GET
    GET = "get"
    # POST
    POST = "post"
...
class PaginationRestEnum(str, Enum, metaclass=utils.OpenEnumMeta):
    # None
    NONE = "none"
    # Response Body Attribute
    RESPONSE_BODY = "response_body"
...
class PaginationRestTypedDict(TypedDict):
    type: NotRequired[PaginationRestEnum]


class PaginationRest(BaseModel):
    type: Annotated[
        Optional[PaginationRestEnum], PlainValidator(validate_open_enum(False))
    ] = PaginationRestEnum.NONE

    @field_serializer("type")
    def serialize_type(self, value):
        if isinstance(value, str):
            try:
                return models.PaginationRestEnum(value)
            except ValueError:
                return value
        return value


class RetryRulesRestTypedDict(TypedDict):
    type: NotRequired[RetryTypeOptionsRetryRules]
    r"""The algorithm to use when performing HTTP retries"""
    interval: NotRequired[Any]
    limit: NotRequired[Any]
...
class RetryRulesRest(BaseModel):
    type: Annotated[
        Optional[RetryTypeOptionsRetryRules], PlainValidator(validate_open_enum(False))
    ] = RetryTypeOptionsRetryRules.BACKOFF
    r"""The algorithm to use when performing HTTP retries"""
...
class StateTrackingRestTypedDict(TypedDict):
    enabled: NotRequired[bool]
    r"""Track collection progress between consecutive scheduled executions"""


class StateTrackingRest(BaseModel):
    enabled: Optional[bool] = None
    r"""Track collection progress between consecutive scheduled executions"""


class SchedulingRestTypedDict(TypedDict):
    state_tracking: NotRequired[StateTrackingRestTypedDict]


class SchedulingRest(BaseModel):
    state_tracking: Annotated[
        Optional[StateTrackingRest], pydantic.Field(alias="stateTracking")
    ] = None


class CollectorRestCollectorHealthCheckPart2TypeTypedDict(TypedDict):
    credentials_secret: str
    r"""Select or create a stored secret that references your login credentials"""
    ...
    collect_url: str
    r"""URL (constant or JavaScript expression) to use for the Collect operation"""
    authentication: NotRequired[AuthenticationRest]
    r"""Authentication method for Discover and Collect REST calls. You can specify API key–based authentication by adding the appropriate Collect headers."""
    discovery: NotRequired[DiscoveryRestTypedDict]
    collect_method: NotRequired[CollectMethodRest]
    collect_verb: NotRequired[str]
    r"""Custom HTTP method to use for the Collect operation"""
    collect_request_params: NotRequired[List[ItemsTypeCollectRequestParams1TypedDict]]
    collect_body: NotRequired[str]
    r"""Template for body to send with the Collect request. Reference global variables, functions, or parameters from the Discover response using template parameters: `${C.vars.myVar}`, or `${Date.now()}`, `${param}`"""
    collect_request_headers: NotRequired[List[ItemsTypeCollectRequestParams1TypedDict]]
    pagination: NotRequired[PaginationRestTypedDict]
    timeout: NotRequired[float]
    r"""HTTP request inactivity timeout. Use 0 to disable."""
    use_round_robin_dns: NotRequired[bool]
    r"""Use round-robin DNS lookup. Suitable when DNS server returns multiple addresses in sort order."""
    ...
    safe_headers: NotRequired[List[str]]
    r"""List of headers that are safe to log in plain text"""
    retry_rules: NotRequired[RetryRulesRestTypedDict]
    scheduling: NotRequired[SchedulingRestTypedDict]
    username: NotRequired[str]
    password: NotRequired[str]
    login_url: NotRequired[str]
    r"""URL to use for the OAuth API call. This call is expected to be a POST."""
...
class CollectorRestCollectorHealthCheckPart2Type(BaseModel):
    credentials_secret: Annotated[str, pydantic.Field(alias="credentialsSecret")]
    r"""Select or create a stored secret that references your login credentials"""
    ...
    authentication: Annotated[
        Optional[AuthenticationRest], PlainValidator(validate_open_enum(False))
    ] = AuthenticationRest.NONE
    r"""Authentication method for Discover and Collect REST calls. You can specify API key–based authentication by adding the appropriate Collect headers."""

    discovery: Optional[DiscoveryRest] = None

    collect_method: Annotated[
        Annotated[
            Optional[CollectMethodRest], PlainValidator(validate_open_enum(False))
        ],
        pydantic.Field(alias="collectMethod"),
    ] = CollectMethodRest.GET
    ...
    pagination: Optional[PaginationRest] = None
    ...
    retry_rules: Annotated[
        Optional[RetryRulesRest], pydantic.Field(alias="retryRules")
    ] = None

    scheduling: Annotated[
        Optional[SchedulingRest], pydantic.Field(alias="__scheduling")
    ] = None
    ...
    def serialize_authentication(self, value):
        if isinstance(value, str):
            try:
                return models.AuthenticationRest(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_collect_method(self, value):
        if isinstance(value, str):
            try:
                return models.CollectMethodRest(value)
            except ValueError:
                return value
        return value
...
class CollectorRestCollectorHealthCheckPart0TypeTypedDict(TypedDict):
    type: CollectorRestType5
    r"""Collector type: rest"""
    collect_url: str
    r"""URL (constant or JavaScript expression) to use for the Collect operation"""
...
class CollectorRestCollectorHealthCheckPart0Type(BaseModel):
    type: CollectorRestType5
    r"""Collector type: rest"""
