...
class OutputMinioTypedDict(TypedDict):
    ...
    signature_version: NotRequired[SignatureVersionOptions6]
...
class OutputMinio(BaseModel):
    ...
    signature_version: Annotated[
        Annotated[
            Optional[SignatureVersionOptions6],
            PlainValidator(validate_open_enum(False)),
        ],
        pydantic.Field(alias="signatureVersion"),
    ] = SignatureVersionOptions6.V4
    r"""Signature version to use for signing MinIO requests"""
    ...
    def serialize_signature_version(self, value):
        if isinstance(value, str):
            try:
                return models.SignatureVersionOptions6(value)
            except ValueError:
                return value
        return value
