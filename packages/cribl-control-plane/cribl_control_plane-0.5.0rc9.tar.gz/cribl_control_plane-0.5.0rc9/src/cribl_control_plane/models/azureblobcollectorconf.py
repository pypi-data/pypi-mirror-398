...
class AzureBlobAuthTypeClientCertCertificateTypedDict(TypedDict):
    certificate_name: str
    r"""The certificate you registered as credentials for your app in the Azure portal"""


class AzureBlobAuthTypeClientCertCertificate(BaseModel):
...
class AzureBlobAuthTypeClientCertTypedDict(TypedDict):
    ...
    certificate: AzureBlobAuthTypeClientCertCertificateTypedDict
    container_name: str
