...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["no_content_change_since", "pulp_labels", "name", "pulp_href", "base_path", "pulp_created", "base_url", "hidden", "content_guard", "pulp_last_updated", "prn"]
