...
[[nodiscard]] std::optional<ignite::end_point> parse_address_with_error_handling(const py_string &item_str) noexcept {
    try {
        return ignite::detail::parse_single_address(item_str.get_data(), ignite::protocol::protocol_context::DEFAULT_TCP_PORT);
...
PyObject* pygridgain_dbapi_connect(PyObject*, PyObject* args, PyObject* kwargs) {
    static char *kwlist[] = {
