...
class ChessUI(Bindings):
    ...
    def __init__(self, panel, statusbar=None, uci=None, toolbarframe=None):
        ...
        # used to view the detail of games, repertoires, and CQL queries.
        ...
        # These display the lists of games, repertoires, CQL queries, and
        # game selection rules, on the database.
        self.base_games = self._create_tag_roster_grid()
        self.base_repertoires = RepertoireGrid(self)
        self.base_partials = self._create_cql_grid()
        self.base_selections = QueryGrid(self)

        # These display the lists of games, repertoires, and CQL queries,
        # which match the current position of the active displayed item.
        self.game_games = self._create_game_position_games_grid()
        self.repertoire_games = RepertoirePositionGames(self)
        self.partial_games = self._create_partial_position_games_grid()
        ...
        # The visibility of the repertoire and CQL query lists when a
        ...
        # The game, repertoire, CQL query, and selection rule, widgets in their
        # own Toplevel.
    ...
    def configure_partial_grid(self):
        """Adjust CQL query grid row sizes after navigate add or delete."""
        ...
        # else:
        #    active_weight = 1
        # Back to original code when repertoire and CQL query fully
        # separated.
    ...
    def _hide_partial_position_games(self):
        """Hide widgets containing selected CQL queries and games."""
    ...
    def _hide_base_partials(self):
        """Hide widget containing list of CQL queries in database."""
    ...
    def _set_partial_change_notifications(self, widget, callback=None):
        """Set or unset CQL query update notifications to widget."""
        self.set_data_change_notifications(
    ...
    def _set_partial_position_data_source(self):
        """Attach database to widget displaying games for CQL query."""
        if self.database is not None:
        ...
        # Seems to be wrong always if CQL query item is asked for first.
    ...
    def show_game_grid(self, database):
        ...
        if self.partial_items.count_items_in_stack():
            self._set_partial_position_data_source()
            sourceobject = self.partial_items.active_item.sourceobject
    ...
    def _show_partial_position_games(self):
        """List games with a position fitting the active CQL query."""
    ...
    def _create_partial_position_datasource(self, database):
        """Create a new DataSource for list of CQL queries."""
    ...
    def _show_base_partials(self):
        """Show widget containing list of CQL queries in database."""
