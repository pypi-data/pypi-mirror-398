...
(function() {
    ...
    const StatusUtils = {
         ...
         */
        STATUS_COLOR_MAP: {
            'waiting': '#a855f7', // Purple 500
            'waiting_for_feedback': '#a855f7',
            'active': '#3b82f6', // Blue 500
            'feedback_submitted': '#10b981', // Emerald 500
            'completed': '#10b981',
        ...
        CONNECTION_QUALITY_LEVELS: {
            'excellent': { threshold: 50, color: '#10b981' }, // Emerald 500
            'good': { threshold: 100, color: '#84cc16' }, // Lime 500
            'fair': { threshold: 200, color: '#f59e0b' }, // Amber 500
            'poor': { threshold: Infinity, color: '#ef4444' } // Red 500
        },
        ...
        getStatusDescription: function(status) {
            const descriptions = {
                'waiting': '系统正在等待用户提供反馈',
                'waiting_for_feedback': '系统正在等待用户提供反馈',
                'active': '会话正在进行中',
                'processing': '系统正在处理用户的反馈',
                'feedback_submitted': '用户已提交反馈',
                'completed': '会话已成功完成',
                'timeout': '会话因超时而结束',
                'error': '会话遇到错误',
                'expired': '会话已过期',
