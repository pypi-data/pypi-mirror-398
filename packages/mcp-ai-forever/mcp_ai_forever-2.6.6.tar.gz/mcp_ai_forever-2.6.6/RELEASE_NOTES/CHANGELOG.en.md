...
## [v2.6.6] - 2025-12-25 - UI Simplification & Workflow Cleanup

### 🌟 Version Highlights
Removed the command and session management tabs to streamline the UI and reduce unused controls.

### 🚀 Improvements
- 🧹 **UI Simplification**: Removed Command and Session Management tabs from the web interface
- 🔌 **Event Cleanup**: Dropped related frontend event wiring for removed features
