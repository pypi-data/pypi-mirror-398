...
class EventbridgeToLambda(
    ...
    def __init__(
        ...
        *,
        ...
        :param lambda_function_props: Optional - user provided props to override the default props for the Lambda function. Providing both this and ``existingLambdaObj`` is an error. Default: - Default props are used
...
class EventbridgeToLambdaProps:
    ...
    def existing_event_bus_interface(
        ...
        '''Optional - user provided custom event bus for this construct to use.

        Providing both this and ``eventBusProps`` is
        an error.
