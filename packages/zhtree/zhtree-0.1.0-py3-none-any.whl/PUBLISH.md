...
本指南将详细说明如何将 `zhtree` 打包并发布到 PyPI。
...
这将创建：
- `dist/zhtree-0.1.0.tar.gz` (源码分发包)
- `dist/zhtree-0.1.0-py3-none-any.whl` (wheel 分发包)
...
```bash
# 从 TestPyPI 安装测试
pip install --index-url https://test.pypi.org/simple/ zhtree
