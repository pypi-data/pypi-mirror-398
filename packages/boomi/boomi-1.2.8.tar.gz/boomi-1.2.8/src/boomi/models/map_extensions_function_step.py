...
class MapExtensionsFunctionStepCacheType(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                MapExtensionsFunctionStepCacheType._member_map_.values(),
            )
        )


class MapExtensionsFunctionStepType(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        """
        return list(
            map(lambda x: x.value, MapExtensionsFunctionStepType._member_map_.values())
        )
...
class MapExtensionsFunctionStep(BaseModel):
    ...
    :type cache_type: MapExtensionsFunctionStepCacheType, optional
    :param id_: id_, defaults to None
    :type id_: str, optional
    :param position: position, defaults to None
    :type position: int, optional
    :param type_: type_, defaults to None
    :type type_: MapExtensionsFunctionStepType, optional
    """
    ...
    def __init__(
        ...
        cache_type: MapExtensionsFunctionStepCacheType = SENTINEL,
        id_: str = SENTINEL,
        position: int = SENTINEL,
        type_: MapExtensionsFunctionStepType = SENTINEL,
        **kwargs,
    ):
        """MapExtensionsFunctionStep
        ...
        if cache_type is not SENTINEL:
            self.cache_type = self._enum_matching(
                cache_type, MapExtensionsFunctionStepCacheType.list(), "cache_type"
            )
        ...
        if type_ is not SENTINEL:
            self.type_ = self._enum_matching(
                type_, MapExtensionsFunctionStepType.list(), "type_"
            )
        self._kwargs = kwargs
