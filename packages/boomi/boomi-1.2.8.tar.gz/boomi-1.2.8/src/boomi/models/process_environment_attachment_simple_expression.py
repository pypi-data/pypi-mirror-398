...
class ProcessEnvironmentAttachmentSimpleExpressionOperator(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                ProcessEnvironmentAttachmentSimpleExpressionOperator._member_map_.values(),
            )
        )


class ProcessEnvironmentAttachmentSimpleExpressionProperty(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                ProcessEnvironmentAttachmentSimpleExpressionProperty._member_map_.values(),
            )
        )


@JsonMap({})
class ProcessEnvironmentAttachmentSimpleExpression(BaseModel):
    """ProcessEnvironmentAttachmentSimpleExpression

    :param argument: argument, defaults to None
    :type argument: List[str], optional
    :param operator: operator
    :type operator: ProcessEnvironmentAttachmentSimpleExpressionOperator
    :param property: property
    :type property: ProcessEnvironmentAttachmentSimpleExpressionProperty
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.operator = self._enum_matching(
            operator,
            ProcessEnvironmentAttachmentSimpleExpressionOperator.list(),
            "operator",
        )
        self.property = self._enum_matching(
            property,
            ProcessEnvironmentAttachmentSimpleExpressionProperty.list(),
            "property",
        )
        self._kwargs = kwargs
