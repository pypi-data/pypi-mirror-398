...
class AccountGroupUserRoleSimpleExpressionOperator(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                AccountGroupUserRoleSimpleExpressionOperator._member_map_.values(),
            )
        )


class AccountGroupUserRoleSimpleExpressionProperty(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                AccountGroupUserRoleSimpleExpressionProperty._member_map_.values(),
            )
        )


@JsonMap({})
class AccountGroupUserRoleSimpleExpression(BaseModel):
    """AccountGroupUserRoleSimpleExpression

    :param argument: argument, defaults to None
    :type argument: List[str], optional
    :param operator: operator
    :type operator: AccountGroupUserRoleSimpleExpressionOperator
    :param property: property
    :type property: AccountGroupUserRoleSimpleExpressionProperty
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.operator = self._enum_matching(
            operator, AccountGroupUserRoleSimpleExpressionOperator.list(), "operator"
        )
        self.property = self._enum_matching(
            property, AccountGroupUserRoleSimpleExpressionProperty.list(), "property"
        )
        self._kwargs = kwargs
