...
class EdiCustomConnectorRecordSimpleExpressionOperator(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                EdiCustomConnectorRecordSimpleExpressionOperator._member_map_.values(),
            )
        )


@JsonMap({})
class EdiCustomConnectorRecordSimpleExpression(BaseModel):
    """EdiCustomConnectorRecordSimpleExpression

    :param argument: argument, defaults to None
    :type argument: List[str], optional
    :param operator: operator
    :type operator: EdiCustomConnectorRecordSimpleExpressionOperator
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.operator = self._enum_matching(
            operator,
            EdiCustomConnectorRecordSimpleExpressionOperator.list(),
            "operator",
        )
