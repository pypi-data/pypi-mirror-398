...
class TradingPartnerProcessingGroupQueryResponse(BaseModel):
    ...
    :type result: List[TradingPartnerProcessingGroup], optional
    """
    ...
    def __init__(
        ...
        result: List[TradingPartnerProcessingGroup] = SENTINEL,
        **kwargs,
    ):
        """TradingPartnerProcessingGroupQueryResponse
        ...
        if result is not SENTINEL:
            self.result = self._define_list(result, TradingPartnerProcessingGroup)
        self._kwargs = kwargs
