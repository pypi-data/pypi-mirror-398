...
class CloudSimpleExpressionOperator(Enum):
    ...
    def list():
        ...
        """
        return list(
            map(lambda x: x.value, CloudSimpleExpressionOperator._member_map_.values())
        )


class CloudSimpleExpressionProperty(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        """
        return list(
            map(lambda x: x.value, CloudSimpleExpressionProperty._member_map_.values())
        )


@JsonMap({})
class CloudSimpleExpression(BaseModel):
    """CloudSimpleExpression

    :param argument: argument, defaults to None
    :type argument: List[str], optional
    :param operator: operator
    :type operator: CloudSimpleExpressionOperator
    :param property: property
    :type property: CloudSimpleExpressionProperty
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.operator = self._enum_matching(
            operator, CloudSimpleExpressionOperator.list(), "operator"
        )
        self.property = self._enum_matching(
            property, CloudSimpleExpressionProperty.list(), "property"
        )
        self._kwargs = kwargs
