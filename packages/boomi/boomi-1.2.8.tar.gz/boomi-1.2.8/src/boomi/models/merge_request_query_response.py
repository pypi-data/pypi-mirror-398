...
class MergeRequestQueryResponse(BaseModel):
    ...
    :type result: List[MergeRequest], optional
    """
    ...
    def __init__(
        ...
        result: List[MergeRequest] = SENTINEL,
        **kwargs,
    ):
        """MergeRequestQueryResponse
        ...
        if result is not SENTINEL:
            self.result = self._define_list(result, MergeRequest)
        self._kwargs = kwargs
