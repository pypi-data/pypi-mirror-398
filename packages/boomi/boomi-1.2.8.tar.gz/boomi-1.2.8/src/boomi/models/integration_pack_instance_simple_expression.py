...
class IntegrationPackInstanceSimpleExpressionOperator(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                IntegrationPackInstanceSimpleExpressionOperator._member_map_.values(),
            )
        )


class IntegrationPackInstanceSimpleExpressionProperty(Enum):
    """An enumeration representing different categories.

    :cvar INTEGRATIONPACKOVERRIDENAME: "integrationPackOverrideName"
    :vartype INTEGRATIONPACKOVERRIDENAME: str
    :cvar INTEGRATIONPACKNAME: "integrationPackName"
    :vartype INTEGRATIONPACKNAME: str
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                IntegrationPackInstanceSimpleExpressionProperty._member_map_.values(),
            )
        )


@JsonMap({})
class IntegrationPackInstanceSimpleExpression(BaseModel):
    """IntegrationPackInstanceSimpleExpression

    :param argument: argument, defaults to None
    :type argument: List[str], optional
    :param operator: operator
    :type operator: IntegrationPackInstanceSimpleExpressionOperator
    :param property: property
    :type property: IntegrationPackInstanceSimpleExpressionProperty
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.operator = self._enum_matching(
            operator, IntegrationPackInstanceSimpleExpressionOperator.list(), "operator"
        )
        self.property = self._enum_matching(
            property, IntegrationPackInstanceSimpleExpressionProperty.list(), "property"
        )
        self._kwargs = kwargs
