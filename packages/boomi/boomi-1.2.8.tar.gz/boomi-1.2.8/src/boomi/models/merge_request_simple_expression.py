...
class MergeRequestSimpleExpressionOperator(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                MergeRequestSimpleExpressionOperator._member_map_.values(),
            )
        )


@JsonMap({})
class MergeRequestSimpleExpression(BaseModel):
    """MergeRequestSimpleExpression

    :param argument: argument, defaults to None
    :type argument: List[str], optional
    :param operator: operator
    :type operator: MergeRequestSimpleExpressionOperator
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.operator = self._enum_matching(
            operator, MergeRequestSimpleExpressionOperator.list(), "operator"
        )
