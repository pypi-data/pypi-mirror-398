...
class GenericConnectorRecordQueryResponse(BaseModel):
    ...
    :type result: List[GenericConnectorRecord], optional
    """
    ...
    def __init__(
        ...
        result: List[GenericConnectorRecord] = SENTINEL,
        **kwargs,
    ):
        """GenericConnectorRecordQueryResponse
        ...
        if result is not SENTINEL:
            self.result = self._define_list(result, GenericConnectorRecord)
        self._kwargs = kwargs
