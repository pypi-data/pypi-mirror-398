...
class RoleSimpleExpressionOperator(Enum):
    ...
    def list():
        ...
        """
        return list(
            map(lambda x: x.value, RoleSimpleExpressionOperator._member_map_.values())
        )


class RoleSimpleExpressionProperty(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        """
        return list(
            map(lambda x: x.value, RoleSimpleExpressionProperty._member_map_.values())
        )


@JsonMap({})
class RoleSimpleExpression(BaseModel):
    """RoleSimpleExpression

    :param argument: argument, defaults to None
    :type argument: List[str], optional
    :param operator: operator
    :type operator: RoleSimpleExpressionOperator
    :param property: property
    :type property: RoleSimpleExpressionProperty
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.operator = self._enum_matching(
            operator, RoleSimpleExpressionOperator.list(), "operator"
        )
        self.property = self._enum_matching(
            property, RoleSimpleExpressionProperty.list(), "property"
        )
        self._kwargs = kwargs
