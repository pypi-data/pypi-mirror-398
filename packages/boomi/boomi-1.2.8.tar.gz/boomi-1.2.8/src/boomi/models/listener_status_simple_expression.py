...
class ListenerStatusSimpleExpressionOperator(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                ListenerStatusSimpleExpressionOperator._member_map_.values(),
            )
        )


class ListenerStatusSimpleExpressionProperty(Enum):
    """An enumeration representing different categories.

    :cvar LISTENERID: "listenerId"
    :vartype LISTENERID: str
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                ListenerStatusSimpleExpressionProperty._member_map_.values(),
            )
        )


@JsonMap({})
class ListenerStatusSimpleExpression(BaseModel):
    """ListenerStatusSimpleExpression

    :param argument: argument, defaults to None
    :type argument: List[str], optional
    :param operator: operator
    :type operator: ListenerStatusSimpleExpressionOperator
    :param property: property
    :type property: ListenerStatusSimpleExpressionProperty
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.operator = self._enum_matching(
            operator, ListenerStatusSimpleExpressionOperator.list(), "operator"
        )
        self.property = self._enum_matching(
            property, ListenerStatusSimpleExpressionProperty.list(), "property"
        )
        self._kwargs = kwargs
