...
class TradingPartnerComponentQueryResponse(BaseModel):
    ...
    :type result: List[TradingPartnerComponent], optional
    """
    ...
    def __init__(
        ...
        result: List[TradingPartnerComponent] = SENTINEL,
        **kwargs,
    ):
        """TradingPartnerComponentQueryResponse
        ...
        if result is not SENTINEL:
            self.result = self._define_list(result, TradingPartnerComponent)
        self._kwargs = kwargs
