...
class PackagedComponentSimpleExpressionOperator(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                PackagedComponentSimpleExpressionOperator._member_map_.values(),
            )
        )


@JsonMap({})
class PackagedComponentSimpleExpression(BaseModel):
    """PackagedComponentSimpleExpression

    :param argument: argument, defaults to None
    :type argument: List[str], optional
    :param operator: operator
    :type operator: PackagedComponentSimpleExpressionOperator
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.operator = self._enum_matching(
            operator, PackagedComponentSimpleExpressionOperator.list(), "operator"
        )
