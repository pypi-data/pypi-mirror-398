...
class EnvironmentMapExtensionsSummarySimpleExpressionOperator(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                EnvironmentMapExtensionsSummarySimpleExpressionOperator._member_map_.values(),
            )
        )


class EnvironmentMapExtensionsSummarySimpleExpressionProperty(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                EnvironmentMapExtensionsSummarySimpleExpressionProperty._member_map_.values(),
            )
        )


@JsonMap({})
class EnvironmentMapExtensionsSummarySimpleExpression(BaseModel):
    ...
    :type operator: EnvironmentMapExtensionsSummarySimpleExpressionOperator
    :param property: property
    :type property: EnvironmentMapExtensionsSummarySimpleExpressionProperty
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.operator = self._enum_matching(
            operator,
            EnvironmentMapExtensionsSummarySimpleExpressionOperator.list(),
            "operator",
        )
        self.property = self._enum_matching(
            property,
            EnvironmentMapExtensionsSummarySimpleExpressionProperty.list(),
            "property",
        )
        self._kwargs = kwargs
