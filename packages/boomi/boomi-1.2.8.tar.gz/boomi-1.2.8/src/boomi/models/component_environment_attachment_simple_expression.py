...
class ComponentEnvironmentAttachmentSimpleExpressionOperator(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                ComponentEnvironmentAttachmentSimpleExpressionOperator._member_map_.values(),
            )
        )


class ComponentEnvironmentAttachmentSimpleExpressionProperty(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                ComponentEnvironmentAttachmentSimpleExpressionProperty._member_map_.values(),
            )
        )


@JsonMap({})
class ComponentEnvironmentAttachmentSimpleExpression(BaseModel):
    ...
    :type operator: ComponentEnvironmentAttachmentSimpleExpressionOperator
    :param property: property
    :type property: ComponentEnvironmentAttachmentSimpleExpressionProperty
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.operator = self._enum_matching(
            operator,
            ComponentEnvironmentAttachmentSimpleExpressionOperator.list(),
            "operator",
        )
        self.property = self._enum_matching(
            property,
            ComponentEnvironmentAttachmentSimpleExpressionProperty.list(),
            "property",
        )
        self._kwargs = kwargs
