...
class DocumentCountAccountSimpleExpressionOperator(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                DocumentCountAccountSimpleExpressionOperator._member_map_.values(),
            )
        )


class DocumentCountAccountSimpleExpressionProperty(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                DocumentCountAccountSimpleExpressionProperty._member_map_.values(),
            )
        )


@JsonMap({})
class DocumentCountAccountSimpleExpression(BaseModel):
    ...
    :type operator: DocumentCountAccountSimpleExpressionOperator
    :param property: property
    :type property: DocumentCountAccountSimpleExpressionProperty
    """

    def __init__(
        self,
        operator: DocumentCountAccountSimpleExpressionOperator,
        ...
        **kwargs
        ...
        self.operator = self._enum_matching(
            operator, DocumentCountAccountSimpleExpressionOperator.list(), "operator"
        )
        self.property = self._enum_matching(
            property, DocumentCountAccountSimpleExpressionProperty.list(), "property"
        )
        self._kwargs = kwargs
