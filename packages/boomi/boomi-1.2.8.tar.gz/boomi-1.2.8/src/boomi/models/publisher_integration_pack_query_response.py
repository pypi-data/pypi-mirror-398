...
class PublisherIntegrationPackQueryResponse(BaseModel):
    ...
    :type result: List[PublisherIntegrationPack], optional
    """
    ...
    def __init__(
        ...
        result: List[PublisherIntegrationPack] = SENTINEL,
        **kwargs,
    ):
        """PublisherIntegrationPackQueryResponse
        ...
        if result is not SENTINEL:
            self.result = self._define_list(result, PublisherIntegrationPack)
        self._kwargs = kwargs
