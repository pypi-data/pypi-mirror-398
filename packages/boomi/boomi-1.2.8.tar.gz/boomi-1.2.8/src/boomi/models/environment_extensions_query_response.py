...
class EnvironmentExtensionsQueryResponse(BaseModel):
    ...
    :type result: List[EnvironmentExtensions], optional
    """
    ...
    def __init__(
        ...
        result: List[EnvironmentExtensions] = SENTINEL,
        **kwargs,
    ):
        """EnvironmentExtensionsQueryResponse
        ...
        if result is not SENTINEL:
            self.result = self._define_list(result, EnvironmentExtensions)
        self._kwargs = kwargs
