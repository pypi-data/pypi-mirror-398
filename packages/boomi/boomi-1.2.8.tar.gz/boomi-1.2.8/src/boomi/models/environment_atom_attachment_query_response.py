...
class EnvironmentAtomAttachmentQueryResponse(BaseModel):
    ...
    :type result: List[EnvironmentAtomAttachment], optional
    """
    ...
    def __init__(
        ...
        result: List[EnvironmentAtomAttachment] = SENTINEL,
        **kwargs,
    ):
        """EnvironmentAtomAttachmentQueryResponse
        ...
        if result is not SENTINEL:
            self.result = self._define_list(result, EnvironmentAtomAttachment)
        self._kwargs = kwargs
