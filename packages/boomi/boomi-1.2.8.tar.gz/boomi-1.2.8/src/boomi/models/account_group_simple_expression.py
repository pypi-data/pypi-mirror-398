...
class AccountGroupSimpleExpressionOperator(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                AccountGroupSimpleExpressionOperator._member_map_.values(),
            )
        )


class AccountGroupSimpleExpressionProperty(Enum):
    """An enumeration representing different categories.
    ...
    :cvar NAME: "name"
    :vartype NAME: str
    :cvar DEFAULTGROUP: "defaultGroup"
    :vartype DEFAULTGROUP: str
    :cvar AUTOSUBSCRIBEALERTLEVEL: "autoSubscribeAlertLevel"
    :vartype AUTOSUBSCRIBEALERTLEVEL: str
    """
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                AccountGroupSimpleExpressionProperty._member_map_.values(),
            )
        )


@JsonMap({})
class AccountGroupSimpleExpression(BaseModel):
    """AccountGroupSimpleExpression

    :param argument: argument, defaults to None
    :type argument: List[str], optional
    :param operator: operator
    :type operator: AccountGroupSimpleExpressionOperator
    :param property: property
    :type property: AccountGroupSimpleExpressionProperty
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.operator = self._enum_matching(
            operator, AccountGroupSimpleExpressionOperator.list(), "operator"
        )
        self.property = self._enum_matching(
            property, AccountGroupSimpleExpressionProperty.list(), "property"
        )
        self._kwargs = kwargs
