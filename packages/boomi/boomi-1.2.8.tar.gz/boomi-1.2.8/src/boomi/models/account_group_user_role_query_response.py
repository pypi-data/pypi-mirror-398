...
class AccountGroupUserRoleQueryResponse(BaseModel):
    ...
    :type result: List[AccountGroupUserRole], optional
    """
    ...
    def __init__(
        ...
        result: List[AccountGroupUserRole] = SENTINEL,
        **kwargs,
    ):
        """AccountGroupUserRoleQueryResponse
        ...
        if result is not SENTINEL:
            self.result = self._define_list(result, AccountGroupUserRole)
        self._kwargs = kwargs
