...
class AccountGroupIntegrationPackQueryResponse(BaseModel):
    ...
    :type result: List[AccountGroupIntegrationPack], optional
    """
    ...
    def __init__(
        ...
        result: List[AccountGroupIntegrationPack] = SENTINEL,
        **kwargs,
    ):
        """AccountGroupIntegrationPackQueryResponse
        ...
        if result is not SENTINEL:
            self.result = self._define_list(result, AccountGroupIntegrationPack)
        self._kwargs = kwargs
