...
class ProcessScheduleStatusQueryResponse(BaseModel):
    ...
    :type result: List[ProcessScheduleStatus], optional
    """
    ...
    def __init__(
        ...
        result: List[ProcessScheduleStatus] = SENTINEL,
        **kwargs,
    ):
        """ProcessScheduleStatusQueryResponse
        ...
        if result is not SENTINEL:
            self.result = self._define_list(result, ProcessScheduleStatus)
        self._kwargs = kwargs
