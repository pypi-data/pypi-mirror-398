...
class AccountGroupAccountQueryResponse(BaseModel):
    ...
    :type result: List[AccountGroupAccount], optional
    """
    ...
    def __init__(
        ...
        result: List[AccountGroupAccount] = SENTINEL,
        **kwargs,
    ):
        """AccountGroupAccountQueryResponse
        ...
        if result is not SENTINEL:
            self.result = self._define_list(result, AccountGroupAccount)
        self._kwargs = kwargs
