...
class BranchSimpleExpressionOperator(Enum):
    ...
    def list():
        ...
        """
        return list(
            map(lambda x: x.value, BranchSimpleExpressionOperator._member_map_.values())
        )


@JsonMap({})
class BranchSimpleExpression(BaseModel):
    """BranchSimpleExpression

    :param argument: argument, defaults to None
    :type argument: List[str], optional
    :param operator: operator
    :type operator: BranchSimpleExpressionOperator
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.operator = self._enum_matching(
            operator, BranchSimpleExpressionOperator.list(), "operator"
        )
