...
class IntegrationPackQueryResponse(BaseModel):
    ...
    :type result: List[IntegrationPack], optional
    """
    ...
    def __init__(
        ...
        result: List[IntegrationPack] = SENTINEL,
        **kwargs,
    ):
        """IntegrationPackQueryResponse
        ...
        if result is not SENTINEL:
            self.result = self._define_list(result, IntegrationPack)
        self._kwargs = kwargs
