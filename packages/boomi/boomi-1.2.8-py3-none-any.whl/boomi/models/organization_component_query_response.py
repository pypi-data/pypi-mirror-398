...
class OrganizationComponentQueryResponse(BaseModel):
    ...
    :type result: List[OrganizationComponent], optional
    """
    ...
    def __init__(
        ...
        result: List[OrganizationComponent] = SENTINEL,
        **kwargs,
    ):
        """OrganizationComponentQueryResponse
        ...
        if result is not SENTINEL:
            self.result = self._define_list(result, OrganizationComponent)
        self._kwargs = kwargs
