...
class ComponentAtomAttachmentQueryResponse(BaseModel):
    ...
    :type result: List[ComponentAtomAttachment], optional
    """
    ...
    def __init__(
        ...
        result: List[ComponentAtomAttachment] = SENTINEL,
        **kwargs,
    ):
        """ComponentAtomAttachmentQueryResponse
        ...
        if result is not SENTINEL:
            self.result = self._define_list(result, ComponentAtomAttachment)
        self._kwargs = kwargs
