...
class EnvironmentMapExtensionsSummaryQueryResponse(BaseModel):
    ...
    :type result: List[EnvironmentMapExtensionsSummary], optional
    """
    ...
    def __init__(
        ...
        result: List[EnvironmentMapExtensionsSummary] = SENTINEL,
        **kwargs,
    ):
        """EnvironmentMapExtensionsSummaryQueryResponse
        ...
        if result is not SENTINEL:
            self.result = self._define_list(result, EnvironmentMapExtensionsSummary)
        self._kwargs = kwargs
