...
class ExecutionSummaryRecordQueryResponse(BaseModel):
    ...
    :type result: List[ExecutionSummaryRecord], optional
    """
    ...
    def __init__(
        ...
        result: List[ExecutionSummaryRecord] = SENTINEL,
        **kwargs,
    ):
        """ExecutionSummaryRecordQueryResponse
        ...
        if result is not SENTINEL:
            self.result = self._define_list(result, ExecutionSummaryRecord)
        self._kwargs = kwargs
