...
class ProcessAtomAttachmentQueryResponse(BaseModel):
    ...
    :type result: List[ProcessAtomAttachment], optional
    """
    ...
    def __init__(
        ...
        result: List[ProcessAtomAttachment] = SENTINEL,
        **kwargs,
    ):
        """ProcessAtomAttachmentQueryResponse
        ...
        if result is not SENTINEL:
            self.result = self._define_list(result, ProcessAtomAttachment)
        self._kwargs = kwargs
