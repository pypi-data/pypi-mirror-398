...
class EnvironmentAtomAttachmentSimpleExpressionOperator(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                EnvironmentAtomAttachmentSimpleExpressionOperator._member_map_.values(),
            )
        )


class EnvironmentAtomAttachmentSimpleExpressionProperty(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                EnvironmentAtomAttachmentSimpleExpressionProperty._member_map_.values(),
            )
        )


@JsonMap({})
class EnvironmentAtomAttachmentSimpleExpression(BaseModel):
    """EnvironmentAtomAttachmentSimpleExpression

    :param argument: argument, defaults to None
    :type argument: List[str], optional
    :param operator: operator
    :type operator: EnvironmentAtomAttachmentSimpleExpressionOperator
    :param property: property
    :type property: EnvironmentAtomAttachmentSimpleExpressionProperty
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.operator = self._enum_matching(
            operator,
            EnvironmentAtomAttachmentSimpleExpressionOperator.list(),
            "operator",
        )
        self.property = self._enum_matching(
            property,
            EnvironmentAtomAttachmentSimpleExpressionProperty.list(),
            "property",
        )
        self._kwargs = kwargs
