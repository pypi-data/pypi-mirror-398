...
class ProcessScheduleStatusSimpleExpressionOperator(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                ProcessScheduleStatusSimpleExpressionOperator._member_map_.values(),
            )
        )


class ProcessScheduleStatusSimpleExpressionProperty(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                ProcessScheduleStatusSimpleExpressionProperty._member_map_.values(),
            )
        )


@JsonMap({})
class ProcessScheduleStatusSimpleExpression(BaseModel):
    """ProcessScheduleStatusSimpleExpression

    :param argument: argument, defaults to None
    :type argument: List[str], optional
    :param operator: operator
    :type operator: ProcessScheduleStatusSimpleExpressionOperator
    :param property: property
    :type property: ProcessScheduleStatusSimpleExpressionProperty
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.operator = self._enum_matching(
            operator, ProcessScheduleStatusSimpleExpressionOperator.list(), "operator"
        )
        self.property = self._enum_matching(
            property, ProcessScheduleStatusSimpleExpressionProperty.list(), "property"
        )
        self._kwargs = kwargs
