...
class ConnectorBulkResponseResponse(BaseModel):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :type error_message: str, optional
        """
        self.result = self._define_object(result, Connector)
...
@JsonMap({})
class ConnectorBulkResponse(BaseModel):
    """ConnectorBulkResponse

    :param response: response, defaults to None
    :type response: List[ConnectorBulkResponseResponse], optional
    """

    def __init__(
        self, response: List[ConnectorBulkResponseResponse] = SENTINEL, **kwargs
    ):
        """ConnectorBulkResponse
        ...
        if response is not SENTINEL:
            self.response = self._define_list(response, ConnectorBulkResponseResponse)
        self._kwargs = kwargs
