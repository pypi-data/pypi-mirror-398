...
class PackagedComponentQueryResponse(BaseModel):
    ...
    :type result: List[PackagedComponent], optional
    """
    ...
    def __init__(
        ...
        result: List[PackagedComponent] = SENTINEL,
        **kwargs,
    ):
        """PackagedComponentQueryResponse
        ...
        if result is not SENTINEL:
            self.result = self._define_list(result, PackagedComponent)
        self._kwargs = kwargs
