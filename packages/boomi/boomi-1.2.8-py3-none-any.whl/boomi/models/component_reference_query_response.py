...
class ComponentReferenceQueryResponse(BaseModel):
    ...
    :type result: List[ComponentReference], optional
    """
    ...
    def __init__(
        ...
        result: List[ComponentReference] = SENTINEL,
        **kwargs,
    ):
        """ComponentReferenceQueryResponse
        ...
        if result is not SENTINEL:
            self.result = self._define_list(result, ComponentReference)
        self._kwargs = kwargs
