...
class EnvironmentRoleQueryResponse(BaseModel):
    ...
    :type result: List[EnvironmentRole], optional
    """
    ...
    def __init__(
        ...
        result: List[EnvironmentRole] = SENTINEL,
        **kwargs,
    ):
        """EnvironmentRoleQueryResponse
        ...
        if result is not SENTINEL:
            self.result = self._define_list(result, EnvironmentRole)
        self._kwargs = kwargs
