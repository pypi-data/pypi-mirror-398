...
class EnvironmentRoleSimpleExpressionOperator(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                EnvironmentRoleSimpleExpressionOperator._member_map_.values(),
            )
        )


class EnvironmentRoleSimpleExpressionProperty(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                EnvironmentRoleSimpleExpressionProperty._member_map_.values(),
            )
        )


@JsonMap({})
class EnvironmentRoleSimpleExpression(BaseModel):
    """EnvironmentRoleSimpleExpression

    :param argument: argument, defaults to None
    :type argument: List[str], optional
    :param operator: operator
    :type operator: EnvironmentRoleSimpleExpressionOperator
    :param property: property
    :type property: EnvironmentRoleSimpleExpressionProperty
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.operator = self._enum_matching(
            operator, EnvironmentRoleSimpleExpressionOperator.list(), "operator"
        )
        self.property = self._enum_matching(
            property, EnvironmentRoleSimpleExpressionProperty.list(), "property"
        )
        self._kwargs = kwargs
