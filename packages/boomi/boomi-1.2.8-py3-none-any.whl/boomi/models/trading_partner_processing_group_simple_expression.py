...
class TradingPartnerProcessingGroupSimpleExpressionOperator(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                TradingPartnerProcessingGroupSimpleExpressionOperator._member_map_.values(),
            )
        )


@JsonMap({})
class TradingPartnerProcessingGroupSimpleExpression(BaseModel):
    """TradingPartnerProcessingGroupSimpleExpression

    :param argument: argument, defaults to None
    :type argument: List[str], optional
    :param operator: operator
    :type operator: TradingPartnerProcessingGroupSimpleExpressionOperator
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.operator = self._enum_matching(
            operator,
            TradingPartnerProcessingGroupSimpleExpressionOperator.list(),
            "operator",
        )
