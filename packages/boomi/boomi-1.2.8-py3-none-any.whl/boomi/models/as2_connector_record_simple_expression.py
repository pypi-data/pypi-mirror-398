...
class As2ConnectorRecordSimpleExpressionOperator(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                As2ConnectorRecordSimpleExpressionOperator._member_map_.values(),
            )
        )


@JsonMap({})
class As2ConnectorRecordSimpleExpression(BaseModel):
    """As2ConnectorRecordSimpleExpression

    :param argument: argument, defaults to None
    :type argument: List[str], optional
    :param operator: operator
    :type operator: As2ConnectorRecordSimpleExpressionOperator
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.operator = self._enum_matching(
            operator, As2ConnectorRecordSimpleExpressionOperator.list(), "operator"
        )
