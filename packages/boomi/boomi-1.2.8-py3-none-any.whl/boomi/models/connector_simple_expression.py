...
class ConnectorSimpleExpressionOperator(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                ConnectorSimpleExpressionOperator._member_map_.values(),
            )
        )


class ConnectorSimpleExpressionProperty(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                ConnectorSimpleExpressionProperty._member_map_.values(),
            )
        )


@JsonMap({})
class ConnectorSimpleExpression(BaseModel):
    """ConnectorSimpleExpression

    :param argument: argument, defaults to None
    :type argument: List[str], optional
    :param operator: operator
    :type operator: ConnectorSimpleExpressionOperator
    :param property: property
    :type property: ConnectorSimpleExpressionProperty
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.operator = self._enum_matching(
            operator, ConnectorSimpleExpressionOperator.list(), "operator"
        )
        self.property = self._enum_matching(
            property, ConnectorSimpleExpressionProperty.list(), "property"
        )
        self._kwargs = kwargs
