...
class ProcessSchedulesQueryResponse(BaseModel):
    ...
    :type result: List[ProcessSchedules], optional
    """
    ...
    def __init__(
        ...
        result: List[ProcessSchedules] = SENTINEL,
        **kwargs,
    ):
        """ProcessSchedulesQueryResponse
        ...
        if result is not SENTINEL:
            self.result = self._define_list(result, ProcessSchedules)
        self._kwargs = kwargs
