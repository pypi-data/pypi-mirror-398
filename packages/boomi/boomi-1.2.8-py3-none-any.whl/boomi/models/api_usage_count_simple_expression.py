...
class ApiUsageCountSimpleExpressionOperator(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                ApiUsageCountSimpleExpressionOperator._member_map_.values(),
            )
        )


class ApiUsageCountSimpleExpressionProperty(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                ApiUsageCountSimpleExpressionProperty._member_map_.values(),
            )
        )


@JsonMap({})
class ApiUsageCountSimpleExpression(BaseModel):
    """ApiUsageCountSimpleExpression

    :param argument: argument, defaults to None
    :type argument: List[str], optional
    :param operator: operator
    :type operator: ApiUsageCountSimpleExpressionOperator
    :param property: property
    :type property: ApiUsageCountSimpleExpressionProperty
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.operator = self._enum_matching(
            operator, ApiUsageCountSimpleExpressionOperator.list(), "operator"
        )
        self.property = self._enum_matching(
            property, ApiUsageCountSimpleExpressionProperty.list(), "property"
        )
        self._kwargs = kwargs
