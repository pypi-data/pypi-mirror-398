...
class AccountUserRoleQueryResponse(BaseModel):
    ...
    :type result: List[AccountUserRole], optional
    """
    ...
    def __init__(
        ...
        result: List[AccountUserRole] = SENTINEL,
        **kwargs,
    ):
        """AccountUserRoleQueryResponse
        ...
        if result is not SENTINEL:
            self.result = self._define_list(result, AccountUserRole)
        self._kwargs = kwargs
