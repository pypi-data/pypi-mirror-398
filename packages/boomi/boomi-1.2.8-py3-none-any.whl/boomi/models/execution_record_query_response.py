...
class ExecutionRecordQueryResponse(BaseModel):
    ...
    :type result: List[ExecutionRecord], optional
    """
    ...
    def __init__(
        ...
        result: List[ExecutionRecord] = SENTINEL,
        **kwargs,
    ):
        """ExecutionRecordQueryResponse
        ...
        if result is not SENTINEL:
            self.result = self._define_list(result, ExecutionRecord)
        self._kwargs = kwargs
