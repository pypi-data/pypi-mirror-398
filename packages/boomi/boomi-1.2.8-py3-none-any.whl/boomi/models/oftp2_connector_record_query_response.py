...
class Oftp2ConnectorRecordQueryResponse(BaseModel):
    ...
    :type result: List[Oftp2ConnectorRecord], optional
    """
    ...
    def __init__(
        ...
        result: List[Oftp2ConnectorRecord] = SENTINEL,
        **kwargs,
    ):
        """Oftp2ConnectorRecordQueryResponse
        ...
        if result is not SENTINEL:
            self.result = self._define_list(result, Oftp2ConnectorRecord)
        self._kwargs = kwargs
