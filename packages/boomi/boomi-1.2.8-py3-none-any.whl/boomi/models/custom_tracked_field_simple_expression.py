...
class CustomTrackedFieldSimpleExpressionOperator(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                CustomTrackedFieldSimpleExpressionOperator._member_map_.values(),
            )
        )


@JsonMap({})
class CustomTrackedFieldSimpleExpression(BaseModel):
    """CustomTrackedFieldSimpleExpression

    :param argument: argument, defaults to None
    :type argument: List[str], optional
    :param operator: operator
    :type operator: CustomTrackedFieldSimpleExpressionOperator
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.operator = self._enum_matching(
            operator, CustomTrackedFieldSimpleExpressionOperator.list(), "operator"
        )
