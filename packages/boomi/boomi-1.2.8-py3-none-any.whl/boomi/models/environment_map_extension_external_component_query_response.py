...
class EnvironmentMapExtensionExternalComponentQueryResponse(BaseModel):
    ...
    :type result: List[EnvironmentMapExtensionExternalComponent], optional
    """
    ...
    def __init__(
        ...
        result: List[EnvironmentMapExtensionExternalComponent] = SENTINEL,
        **kwargs,
    ):
        """EnvironmentMapExtensionExternalComponentQueryResponse
        ...
        if result is not SENTINEL:
            self.result = self._define_list(
                result, EnvironmentMapExtensionExternalComponent
            )
        self._kwargs = kwargs
