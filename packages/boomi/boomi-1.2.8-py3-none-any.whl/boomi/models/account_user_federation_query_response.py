...
class AccountUserFederationQueryResponse(BaseModel):
    ...
    :type result: List[AccountUserFederation], optional
    """
    ...
    def __init__(
        ...
        result: List[AccountUserFederation] = SENTINEL,
        **kwargs,
    ):
        """AccountUserFederationQueryResponse
        ...
        if result is not SENTINEL:
            self.result = self._define_list(result, AccountUserFederation)
        self._kwargs = kwargs
