...
class OrganizationComponentSimpleExpressionOperator(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                OrganizationComponentSimpleExpressionOperator._member_map_.values(),
            )
        )


class OrganizationComponentSimpleExpressionProperty(Enum):
    """An enumeration representing different categories.

    :cvar NAME: "name"
    :vartype NAME: str
    :cvar CONTACTNAME: "contactName"
    :vartype CONTACTNAME: str
    :cvar EMAIL: "email"
    :vartype EMAIL: str
    :cvar PHONE: "phone"
    :vartype PHONE: str
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                OrganizationComponentSimpleExpressionProperty._member_map_.values(),
            )
        )


@JsonMap({})
class OrganizationComponentSimpleExpression(BaseModel):
    """OrganizationComponentSimpleExpression

    :param argument: argument, defaults to None
    :type argument: List[str], optional
    :param operator: operator
    :type operator: OrganizationComponentSimpleExpressionOperator
    :param property: property
    :type property: OrganizationComponentSimpleExpressionProperty
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.operator = self._enum_matching(
            operator, OrganizationComponentSimpleExpressionOperator.list(), "operator"
        )
        self.property = self._enum_matching(
            property, OrganizationComponentSimpleExpressionProperty.list(), "property"
        )
        self._kwargs = kwargs
