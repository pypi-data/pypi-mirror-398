...
class AccountGroupQueryResponse(BaseModel):
    ...
    :type result: List[AccountGroup], optional
    """
    ...
    def __init__(
        ...
        result: List[AccountGroup] = SENTINEL,
        **kwargs,
    ):
        """AccountGroupQueryResponse
        ...
        if result is not SENTINEL:
            self.result = self._define_list(result, AccountGroup)
        self._kwargs = kwargs
