...
class DeployedExpiredCertificateQueryResponse(BaseModel):
    ...
    :type result: List[DeployedExpiredCertificate], optional
    """
    ...
    def __init__(
        ...
        result: List[DeployedExpiredCertificate] = SENTINEL,
        **kwargs,
    ):
        """DeployedExpiredCertificateQueryResponse
        ...
        if result is not SENTINEL:
            self.result = self._define_list(result, DeployedExpiredCertificate)
        self._kwargs = kwargs
