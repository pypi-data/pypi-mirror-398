...
class IntegrationPackAtomAttachmentSimpleExpressionOperator(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                IntegrationPackAtomAttachmentSimpleExpressionOperator._member_map_.values(),
            )
        )


class IntegrationPackAtomAttachmentSimpleExpressionProperty(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                IntegrationPackAtomAttachmentSimpleExpressionProperty._member_map_.values(),
            )
        )


@JsonMap({})
class IntegrationPackAtomAttachmentSimpleExpression(BaseModel):
    """IntegrationPackAtomAttachmentSimpleExpression

    :param argument: argument, defaults to None
    :type argument: List[str], optional
    :param operator: operator
    :type operator: IntegrationPackAtomAttachmentSimpleExpressionOperator
    :param property: property
    :type property: IntegrationPackAtomAttachmentSimpleExpressionProperty
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.operator = self._enum_matching(
            operator,
            IntegrationPackAtomAttachmentSimpleExpressionOperator.list(),
            "operator",
        )
        self.property = self._enum_matching(
            property,
            IntegrationPackAtomAttachmentSimpleExpressionProperty.list(),
            "property",
        )
        self._kwargs = kwargs
