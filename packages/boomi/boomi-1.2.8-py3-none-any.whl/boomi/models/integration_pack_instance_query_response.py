...
class IntegrationPackInstanceQueryResponse(BaseModel):
    ...
    :type result: List[IntegrationPackInstance], optional
    """
    ...
    def __init__(
        ...
        result: List[IntegrationPackInstance] = SENTINEL,
        **kwargs,
    ):
        """IntegrationPackInstanceQueryResponse
        ...
        if result is not SENTINEL:
            self.result = self._define_list(result, IntegrationPackInstance)
        self._kwargs = kwargs
