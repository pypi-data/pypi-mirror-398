...
"""
MedRxivSearcher - medRxiv 医学预印本搜索
...
class MedRxivSearcher(PaperSource):
    ...
    def search(self, query: str, max_results: int = 10, days: int = 30) -> List[Paper]:
        ...
        Args:
            query: 分类名称（如 "cardiovascular medicine", "infectious diseases"）
            max_results: 最大返回数量
            days: 搜索最近 N 天的论文
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print("Testing MedRxivSearcher...")
    print("=" * 60)
    
    papers = searcher.search("infectious diseases", max_results=2, days=7)
