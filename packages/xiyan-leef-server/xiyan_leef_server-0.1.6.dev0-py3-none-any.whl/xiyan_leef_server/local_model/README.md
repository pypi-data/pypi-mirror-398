...
To run xiyan_leef_server in local mode, you need 
...
Script is located at `src/xiyan_leef_server/local_model/local_xiyan_server.py`
...
### Step 4: prepare config and run xiyan_leef_server
