...
<br />
<a href="https://github.com/XGenerationLab/xiyan_leef_server">英語</a> | <a href="https://github.com/XGenerationLab/xiyan_leef_server/blob/main/README_zh.md">中国語</a><br />
<a href="https://github.com/XGenerationLab/xiyan_leef_server/blob/main/imgs/dinggroup_out.png">Ding Group</a> | 
...
[@XGenerationLab/xiyan_leef_server](https://smithery.ai/server/@XGenerationLab/xiyan_leef_server)を参照
...
ローカルモードでxiyan_leef_serverを実行するには、以下が必要です：
...
ステップ3：スクリプトをダウンロードしてサーバーを実行します。ファイルsrc/xiyan_leef_server/local_xiyan_server.py
...
ステップ4：設定を準備してxiyan_leef_serverを実行
...
## 起動
### Claude Desktop
Claude Desktopの設定ファイルに以下を追加します。<a href="https://github.com/XGenerationLab/xiyan_leef_server/blob/main/imgs/claude_desktop.jpg">Claude Desktop設定例</a>を参照
```json
{
    "mcpServers": {
        "xiyan-leef-server": {
...
### Goose
設定に以下のコマンドを追加します。<a href="https://github.com/XGenerationLab/xiyan_leef_server/blob/main/imgs/goose.jpg">Goose設定例</a>を参照
...
<a href="https://github.com/XGenerationLab/xiyan_leef_server/blob/main/imgs/witsy.jpg">Witsy設定例</a>を参照
