...
async def launch_wireshark(interface, target_ip, exclude_ips, url_file=None, output_file=None):
    """
    ...
    if url_file is None:
        ...
        url_file = os.path.join(relative_path, 'stealth_chopper', 'assets', 'url_file.txt')
...
async def main(target_ip, interface, default_gateway, exclude_ips):
    ...
    await asyncio.gather(
        ...
        launch_wireshark(interface, target_ip, exclude_ips, url_file)
    )
