...
change_basis (const IK::Vector_3 &origin_1, const IK::Vector_3 &x_axis_1, const IK::Vector_3 &y_axis_1, const IK::Vector_3 &z_axis_1, const IK::Vector_3 &origin_0, const IK::Vector_3 &x_axis_0,
              const IK::Vector_3 &y_axis_0, const IK::Vector_3 &z_axis_0)
{
...
CGAL::Aff_transformation_3<IK>
plane_to_plane (const IK::Vector_3 &origin_0, const IK::Vector_3 &x_axis_0, const IK::Vector_3 &y_axis_0, const IK::Vector_3 &z_axis_0, const IK::Vector_3 &origin_1, const IK::Vector_3 &x_axis_1,
                const IK::Vector_3 &y_axis_1, const IK::Vector_3 &z_axis_1)
{
    ...
    // Rotate ->
    CGAL::Aff_transformation_3<IK> f0 (_x_axis_0.x (), _x_axis_0.y (), _x_axis_0.z (), _y_axis_0.x (), _y_axis_0.y (), _y_axis_0.z (), _z_axis_0.x (), _z_axis_0.y (), _z_axis_0.z ());

    CGAL::Aff_transformation_3<IK> f1 (_x_axis_1.x (), _y_axis_1.x (), _z_axis_1.x (), _x_axis_1.y (), _y_axis_1.y (), _z_axis_1.y (), _x_axis_1.z (), _y_axis_1.z (), _z_axis_1.z ());
...
CGAL::Aff_transformation_3<IK>
plane_to_xy (const IK::Vector_3 &origin, const IK::Vector_3 &x_axis, const IK::Vector_3 &y_axis, const IK::Vector_3 &z_axis)
{
    // Vectors must be unitized, else the result is wrong
    ...
    // Rotate ->
    CGAL::Aff_transformation_3<IK> f (_x_axis.x (), _x_axis.y (), _x_axis.z (), _y_axis.x (), _y_axis.y (), _y_axis.z (), _z_axis.x (), _z_axis.y (), _z_axis.z ());

    return f * t;
}

CGAL::Aff_transformation_3<IK>
xy_to_plane (const IK::Vector_3 &origin, const IK::Plane_3 &plane)
{
    // Vectors must be unitized, else the result is wrong
    auto x_axis = plane.base1 ();
    auto y_axis = plane.base2 ();
    ...
    // transformation maps P0 to P1, P0+x_axis_0 to P1+x_axis_1, ...
    CGAL::Aff_transformation_3<IK> f (x_axis.x (), y_axis.x (), z_axis.x (), x_axis.y (), y_axis.y (), z_axis.y (), x_axis.z (), y_axis.z (), z_axis.z ());
...
CGAL::Aff_transformation_3<IK>
xy_to_plane (const IK::Vector_3 &origin, const IK::Vector_3 &x_axis, const IK::Vector_3 &y_axis, const IK::Vector_3 &z_axis)
{
    // Vectors must be unitized, else the result is wrong
    IK::Vector_3 _x_axis = x_axis;
    IK::Vector_3 _y_axis = y_axis;
    ...
    // transformation maps P0 to P1, P0+x_axis_0 to P1+x_axis_1, ...
    CGAL::Aff_transformation_3<IK> f (_x_axis.x (), _y_axis.x (), _z_axis.x (), _x_axis.y (), _y_axis.y (), _z_axis.y (), _x_axis.z (), _y_axis.z (), _z_axis.z ());
...
CGAL::Aff_transformation_3<IK>
scale (const double &scale_x, const double &scale_y, const double &scale_z)
{
    CGAL::Aff_transformation_3<IK> t (scale_x, 0, 0, 0, scale_y, 0, 0, 0, scale_z);
    return t;
}

CGAL::Aff_transformation_3<IK>
scale (const IK::Point_3 &origin, const double &scale_value)
{
...
CGAL::Aff_transformation_3<IK>
scale (const IK::Point_3 &origin, const double &scale_x, const double &scale_y, const double &scale_z)
{
    // Move to origin -> T0 translates point P0 to (0,0,0), scale, translate back
    CGAL::Aff_transformation_3<IK> t0 (CGAL::TRANSLATION, IK::Vector_3 (-origin.x (), -origin.y (), -origin.z ()));
...
CGAL::Aff_transformation_3<IK>
axis_rotation (const double &angle, const IK::Vector_3 &axis)
{
    // create matrix of the rotation
    IK::RT c = cos (angle), s = sin (angle), ux (axis.x ()), uy (axis.y ()), uz (axis.z ());

    IK::RT matrix[12] = { ux * ux * (1 - c) + c,      ux * uy * (1 - c) - uz * s, ux * uz * (1 - c) + uy * s, 0, ux * uy * (1 - c) + uz * s, uy * uy * (1 - c) + c, uy * uz * (1 - c) - ux * s, 0,
                          ux * uz * (1 - c) - uy * s, uy * uz * (1 - c) + ux * s, uz * uz * (1 - c) + c,      0 };

    return CGAL::Aff_transformation_3<IK> (matrix[0], matrix[1], matrix[2], matrix[3], matrix[4], matrix[5], matrix[6], matrix[7], matrix[8], matrix[9], matrix[10], matrix[11]);
}
} // namespace xform_util
} // namespace cgal