...
double
triangle_edge_by_angle (const double &edge_length, const double &angle_degrees)
{
    return edge_length * std::tan (angle_degrees * 3.14159265358979323846 / 180.0);
}

double
rad_to_deg (const double &radians)
{
    return radians * 180.0 / 3.14159265358979323846;
}

double
deg_to_rad (const double &degrees)
{
    return degrees * 3.14159265358979323846 / 180.0;
}

int
count_digits (const double &number)
{
...
uint64_t
unique_from_two_int (const int &number0, const int &number1)
{
    if (number1 > number0)
...
int
wrap (const int &index, const int &n)
{
    if (n == 0)
        return 0;
    return ((index % n) + n) % n;
