 ...
 *
 * @param [in] box Plane made as a C-style array of length 5: origin and x,y,z vectors, and one
 * vector for box size
 * @param [in] x_axis The first coordinate of the vector
 * @param [in] y_axis The second coordinate of the vector
 * @param [in] z_axis The third coordinate of the vector
 ...
 *
 * @param [in] box Plane made as a C-style array of length 5: origin and x,y,z vectors, and one
 * vector for box size, each vector is the length of the box edge lengths
 ...
 * @return return true If we find an axis that separates the both polygons, then the polygons cannot
 * overlap! This works only for convex polygons!
 */
