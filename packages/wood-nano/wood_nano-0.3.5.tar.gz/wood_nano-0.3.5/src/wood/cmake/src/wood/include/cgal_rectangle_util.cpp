...
float
ccw (const IK::Point_3 &a, const IK::Point_3 &b, const IK::Point_3 &c)
{
    return (b.x () - a.x ()) * (c.y () - a.y ()) - (b.y () - a.y ()) * (c.x () - a.x ());
}

bool
is_left_of (const IK::Point_3 &a, const IK::Point_3 &b)
{
    return (a.x () < b.x () || (a.x () == b.x () && a.y () < b.y ()));
}

float
len (const IK::Point_3 &a, const IK::Point_3 &b)
{
    return std::sqrt ((b.x () - a.x ()) * (b.x () - a.x ()) + (b.y () - a.y ()) * (b.y () - a.y ()));
}

float
dist (const IK::Point_3 &a, const IK::Point_3 &b, const IK::Point_3 &p)
{
    return std::fabs ((b.x () - a.x ()) * (a.y () - p.y ()) - (b.y () - a.y ()) * (a.x () - p.x ())) / len (a, b);
}

size_t
get_farthest (const IK::Point_3 &a, const IK::Point_3 &b, const std::vector<IK::Point_3> &v)
{
    size_t idxMax = 0;
...
void
quick_hull (const std::vector<IK::Point_3> &v, const IK::Point_3 &a, const IK::Point_3 &b, std::vector<IK::Point_3> &hull)
{
    if (v.empty ())
        return;
...
double
angle_to_xaxis (IK::Segment_3 &edge)
{
...
IK::Point_3
rotate_to_xaxis (IK::Point_3 &point, const double &angle)
{
    return IK::Point_3 (point.hx () * std::cos (angle) - point.hy () * std::sin (angle), point.hx () * std::sin (angle) + point.hy () * std::cos (angle), 0);
}

bool
orient_polyline_to_xy_and_back (CGAL_Polyline &polyline, CGAL::Aff_transformation_3<IK> &xform_to_xy, CGAL::Aff_transformation_3<IK> &xform_to_xy_inv)
{
    /////////////////////////////////////////////////////////////////////////////////////
...
CGAL_Polyline
quick_hull (const CGAL_Polyline &v)
{
...
bool
bounding_rectangle (CGAL_Polyline &polygon, CGAL_Polyline &result)
{
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
bool
grid_of_points_in_a_polygon (CGAL_Polyline &polygon, const double &offset_distance, const double &division_distance, const int &max_points,
                             std::vector<IK::Point_3> &points) // const double &divisions,
{
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // Orient polygon to 2D
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if (polygon_copy.size () == 5)
    ...
    else
        {
            ...
            //                                                       IK::Segment_3(
            //                                                           IK::Point_3(rectangle.min().hx(),
            //                                                           rectangle.min().hy(), 0),
            //                                                           IK::Point_3(rectangle.min().hx(),
            //                                                           rectangle.max().hy(), 0)),
            //                                                       IK::Segment_3(
            //                                                           IK::Point_3(rectangle.max().hx(),
            //                                                           rectangle.min().hy(), 0),
            //                                                           IK::Point_3(rectangle.max().hx(),
            //                                                           rectangle.max().hy(), 0))}
            //                                                 : std::array<IK::Segment_3,
            //                                                 2>{IK::Segment_3(IK::Point_3(rectangle.min().hx(),
            //                                                 rectangle.max().hy(), 0),
            //                                                 IK::Point_3(rectangle.max().hx(),
            //                                                 rectangle.max().hy(), 0)),
            //                                                 IK::Segment_3(IK::Point_3(rectangle.min().hx(),
            //                                                 rectangle.min().hy(), 0),
            //                                                 IK::Point_3(rectangle.max().hx(),
            //                                                 rectangle.min().hy(), 0))};
            ...
            // std::cout << rectangle.min().hx() << " " << rectangle.min().hy() << " " << 0 <<
            // std::endl; std::cout << rectangle.max().hx() << " " << rectangle.max().hy() << " " << 0
            // << std::endl;
            ...
            //     double smaller_edge_dist = std::min(std::sqrt(half_dir_u.squared_length()),
            //     std::sqrt(half_dir_v.squared_length())); double division_distance = smaller_edge_dist
            //     / (divisions * 2); divisions_u = divisions_v = divisions; std::cout <<
            //     smaller_edge_dist << " " << division_distance << " " << divisions << " " <<
            //     divisions_u << " " << divisions_v << std::endl;
            // }
            ...
            // std::cout << center_of_rect.hx() << " " << center_of_rect.hy() << " " <<
            // center_of_rect.hz() << std::endl;
