 ...
 */
IK::Plane_3
translate_by_normal (const IK::Plane_3 &plane, const double &distance)
{
 ...
 */
bool
is_same_direction (const IK::Plane_3 &plane0, const IK::Plane_3 &plane1, bool can_be_flipped)
{
 ...
 */
bool
is_same_position (const IK::Plane_3 &plane0, const IK::Plane_3 &plane1)
{
 ...
 */
bool
is_coplanar (const IK::Plane_3 &plane0, const IK::Plane_3 &plane1, bool can_be_flipped)
{
