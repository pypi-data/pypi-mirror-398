...
class SmartMessageRenderer:
    ...
    async def send(
        ...
        Args:
            ...
            module: Module name for file path resolution. Defaults to 'main_bot'.
            namespace: Namespace for organizing messages. Required unless override_block is provided.
        ...
        Raises:
            ValueError: If namespace, menu_file, or block_key are missing when
        ...
        if override_block is not None:
            ...
            if not all([namespace, menu_file, block_key]):
                logger.error(
                    f"Missing required parameters for SmartMessageRenderer.send: "
                    f"namespace={namespace}, menu_file={menu_file}, block_key={block_key}"
                )
                raise ValueError(
                    "namespace, menu_file, and block_key are required unless "
        ...
        msg = cls.parse_to_smart(
            block, namespace or "", role, lang, custom_markup, module,
