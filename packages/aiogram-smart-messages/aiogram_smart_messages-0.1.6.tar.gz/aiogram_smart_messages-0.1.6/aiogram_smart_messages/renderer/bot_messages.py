...
class SmartMessageRenderer:
    ...
    def load_json(
        ...
        Args:
            namespace: Namespace for organizing messages (e.g., 'admin_panel', 'user_menu').
        ...
        if block is None:
            raise ValueError(
                ...
                f"in {namespace}/{menu_file}.json (role={role}, lang={lang}). "
    ...
    def parse_to_smart(
        ...
        Args:
            ...
            namespace: Namespace for organizing messages.
    ...
    async def send(
        ...
        Args:
            ...
            module: Module name for file path resolution. Defaults to 'main_bot'.
            namespace: Namespace for organizing messages. If not provided, uses menu_file as namespace.
        ...
        if override_block is not None:
            ...
            effective_namespace = namespace or "main"
        else:
            ...
            # Use namespace if provided, otherwise use menu_file as namespace
            effective_namespace = namespace if namespace is not None else menu_file
            
            block = cls.load_json(
                effective_namespace, role, lang, menu_file, block_key, context, module=module
            )
        
        msg = cls.parse_to_smart(
            block, effective_namespace, role, lang, custom_markup, module,
    ...
    async def edit(
        ...
        if override_block is not None:
            ...
            block = cls.load_json(
                effective_namespace, role, lang, menu_file, block_key, context, module
            )
