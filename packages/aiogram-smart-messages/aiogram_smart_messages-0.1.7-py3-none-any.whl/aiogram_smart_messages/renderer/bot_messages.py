...
class SmartMessageRenderer:
    ...
    def load_json(
        ...
        Args:
            namespace: Namespace for organizing messages (e.g., 'admin_panel', 'user_menu').
                      This is NOT part of the file path, but used for photo organization.
    ...
    def parse_to_smart(
        ...
        Args:
            ...
            namespace: Namespace for organizing photos (used in photo path).
    ...
    async def send(
        ...
        Args:
            ...
            module: Module name for file path resolution. Defaults to 'main_bot'.
            namespace: Namespace for organizing photos. Defaults to 'main'.
