...
public:
		  ...
		  const std::string& tmp_prefix = "buildtmp")
	{
		...
		printf("M=%d,efc=%d,efs=%d\n", P_.M, P_.ef_construction, P_.ef_search);
		l2_ = choose_l2();
