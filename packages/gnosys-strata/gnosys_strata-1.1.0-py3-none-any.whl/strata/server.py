...
async def config_watching_context():
    ...
    # Initialize client manager in background to avoid blocking stdio server startup
    ...
    logger.warning("Strata is loading internal MCPs in background - tools may not be available immediately")
