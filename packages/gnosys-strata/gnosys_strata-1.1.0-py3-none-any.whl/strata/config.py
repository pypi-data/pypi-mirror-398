...
class MCPServerList:
    ...
    def add_set(self, name: str, server_names: List[str], description: str = "") -> None:
    ...
    def get_set(self, name: str) -> Optional[List[str]]:
        """Get servers in a set (legacy compatibility)."""
