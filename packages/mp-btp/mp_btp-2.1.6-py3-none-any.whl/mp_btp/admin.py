...
def accounts_list(status):
    ...
    try:
        ...
        for acc in accounts:
            ...
            click.echo(f"{acc.email:<28} {acc.status:<8} {region:<6} {kyma_str:<12} {cf_str:<12}")
