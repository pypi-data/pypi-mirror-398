...
#define __PYX_HAVE__tasks
#define __PYX_HAVE_API__tasks
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "tasks" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "tasks.__init__"
extern int __pyx_module_is_main_tasks____init__;
int __pyx_module_is_main_tasks____init__ = 0;
...
#define __pyx_kp_u_tasks___init __pyx_string_tab[1]
...
__Pyx_PyMODINIT_FUNC PyInit___init__(void) { return PyInit_tasks(); }
#endif
...
__Pyx_RefNannySetupContext("PyInit_tasks", 0);
  ...
  if (__pyx_module_is_main_tasks____init__) {
  ...
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_mstate_global->__pyx_kp_u_tasks___init) < 0))) __PYX_ERR(0, 2, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 2, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "tasks")) {
      if (unlikely((PyDict_SetItemString(modules, "tasks", __pyx_m) < 0))) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init tasks", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init tasks");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{14},{18},{8},{10},{8},{12},{10},{8}};
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (75 bytes) */
const char* const cstring = "x\332%\214\301\r\2000\014\0037b\005F\261L\033\244\250iQI\272?\001\3748\237?\336\203\336|\003th\000\305tH:\342f\221\203\245\001\235\2713\375\252\313\344\265\301\376\365\\\264\337]\242\312\311e\371\021\342\311\007.\361#\201";
    ...
    #endif
    #else /* compression: none (89 bytes) */
const char* const bytes = "?tasks.__init__cline_in_traceback__main____module____name____qualname__setdefault__test__";
    PyObject *data = NULL;
