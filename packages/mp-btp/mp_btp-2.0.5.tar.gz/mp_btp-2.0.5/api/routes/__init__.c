...
{
    "distutils": {
        "name": "api.routes.__init__",
        "sources": [
            "./api/routes/__init__.py"
        ]
    },
    "module_name": "api.routes.__init__"
}
END: Cython Metadata */
...
#define __PYX_HAVE__api__routes
#define __PYX_HAVE_API__api__routes
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "api.routes" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "api.routes.__init__"
extern int __pyx_module_is_main_api__routes____init__;
int __pyx_module_is_main_api__routes____init__ = 0;
...
#define __pyx_kp_u_api_routes___init __pyx_string_tab[1]
...
__Pyx_PyMODINIT_FUNC PyInit___init__(void) { return PyInit_routes(); }
#endif
...
__Pyx_RefNannySetupContext("PyInit_routes", 0);
  ...
  if (__pyx_module_is_main_api__routes____init__) {
  ...
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_mstate_global->__pyx_kp_u_api_routes___init) < 0))) __PYX_ERR(0, 2, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 2, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "api.routes")) {
      if (unlikely((PyDict_SetItemString(modules, "api.routes", __pyx_m) < 0))) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init api.routes", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init api.routes");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
const char* const cstring = "x\332%\214\301\r\2000\014\0037\352\n\214\022\2316H\021I\013m\262?\001\374\260\317\237\333pI\231#\234W!\222.NTU:'\223OT\336QO\"C\376\214\215\026\312/u\330\267w@\177^\354\215\017\204\246#}\331\017\334;%e";
...
const char* const bytes = "?api.routes.__init__cline_in_traceback__main____module____name____qualname__setdefault__test__";
    PyObject *data = NULL;
