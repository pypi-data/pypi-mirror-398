...
#define __Pyx_MODULE_NAME "api.__init__"
extern int __pyx_module_is_main_api____init__;
int __pyx_module_is_main_api____init__ = 0;
...
#define __pyx_kp_u_api___init __pyx_string_tab[1]
...
__Pyx_RefNannySetupContext("PyInit_api", 0);
  ...
  if (__pyx_module_is_main_api____init__) {
  ...
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_mstate_global->__pyx_kp_u_api___init) < 0))) __PYX_ERR(0, 2, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 2, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "api")) {
      if (unlikely((PyDict_SetItemString(modules, "api", __pyx_m) < 0))) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{12},{18},{8},{10},{8},{12},{10},{8}};
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (74 bytes) */
const char* const cstring = "x\332%\214\301\r\2000\014\0037b\005F\261L\033\244\210\264\024\232\354O\000?\316\347\217W\016]\000\355\352@1\355\222\016\277Ydc9\200\306\334\231v\3260y\255\263}}\005\355\367)^egX~\270\314\344\003\335\340\"\225";
    PyObject *data = __Pyx_DecompressString(cstring, 74, 1);
    if (unlikely(!data)) __PYX_ERR(0, 2, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 2, __pyx_L1_error) }
    #endif
    #else /* compression: none (87 bytes) */
const char* const bytes = "?api.__init__cline_in_traceback__main____module____name____qualname__setdefault__test__";
    PyObject *data = NULL;
