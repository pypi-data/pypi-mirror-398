...
class Statement:
    ...
    def to_dataframe(self,
                     ...
                     standard: bool = True,
                     include_dimensions: bool = True) -> Any:
        """Convert statement to pandas DataFrame in long/tidy format.
        ...
        Returns:
            DataFrame with columns: concept, label, period_type, period_start,
            period_end, fiscal_label, value, abstract, dimension, axis, member, period, level
        """
        rendered_statement: RenderedStatement = self.render(
            period_filter=period_filter,
            period_view=period_view,
            standard=standard,
            include_dimensions=include_dimensions
        )
        return rendered_statement.to_dataframe(period_type=period_type)
    ...
    def available_period_types(self) -> List[str]:
        ...
        Returns:
            List of period types like ['quarterly', 'ytd'] or ['annual']
        """
        rendered_statement: RenderedStatement = self.render()
        return rendered_statement.available_period_types
