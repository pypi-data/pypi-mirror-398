...
Use this tool online at **[DevTools.at](https://devtools.at/tools/phone-formatter)** - Free, fast, and no registration required!

## Installation

```bash
pip install devtools_phone
```

## Usage

```python
from devtools_phone import process, encode, decode
...
**[https://devtools.at/tools/phone-formatter](https://devtools.at/tools/phone-formatter)**
