...
def route_to_importer(
    ...
    **kwargs
    ...
    if fmt == "pyp":
        from usekit.classes.exec.base.post.act.ebp_import_pyp import import_pyp
        return import_pyp(
            path=path,
            func_list=func_list,
            from_list=from_list,
        ...
        from usekit.classes.exec.base.post.act.ebp_import_sql import import_sql
        return import_sql(
            path=path,
            func_list=func_list,
            debug=debug,
        ...
        from usekit.classes.exec.base.post.act.ebp_import_ddl import import_ddl
        return import_ddl(
            path=path,
            func_list=func_list,
            debug=debug,
