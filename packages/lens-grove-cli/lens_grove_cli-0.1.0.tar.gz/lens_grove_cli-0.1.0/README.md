...
# What is Lens?
[Lens](https://lens.xyz) is an onchain social network. Their latest iteration features a storage network called Grove that can store any file below 125MB in size. This CLI allows you to leverage Grove to store small files.

# How do I use this?
You can get it from PyPI with pip/pipx once I upload it.
