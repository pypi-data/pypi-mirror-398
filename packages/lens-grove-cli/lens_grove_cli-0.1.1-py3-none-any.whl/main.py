...
def main():
    ...
    upload_parser.add_argument("-i", "--identity", help="The wallet or Lens Account that will own this file (only used with wallet/lens-account ACL modes)", metavar="[wallet/lensacc friendly name or 0x12AB...]")
