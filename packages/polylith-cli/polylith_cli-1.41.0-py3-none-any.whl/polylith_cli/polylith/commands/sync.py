...
from polylith_cli.polylith import info, interactive, sync
...
def choose_base(root: Path, ns: str, project_data: dict) -> Union[str, None]:
    ...
    if not possible_bases:
        return None
    return interactive.project.choose_base_for_project(root, ns, project_data['name'], possible_bases)
...
def calculate_brick_diff(root: Path, ns: str, project_data: dict, options: dict) -> dict:
