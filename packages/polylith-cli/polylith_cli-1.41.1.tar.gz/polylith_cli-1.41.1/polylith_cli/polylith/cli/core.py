...
@app.command('deps')
def deps_command(directory: Annotated[str, options.directory]='', brick: Annotated[str, options.brick]='', save: Annotated[bool, options.save]=False):
    ...
    cli_options = {'directory': dir_path, 'brick': brick or None, 'save': save, 'output': output}
