...
Use this tool online at **[DevTools.at](https://devtools.at/tools/text-diff)** - Free, fast, and no registration required!

## Installation

```bash
pip install devtools_text_diff
```

## Usage

```python
from devtools_text_diff import process, encode, decode
...
**[https://devtools.at/tools/text-diff](https://devtools.at/tools/text-diff)**
